...
- [ ] 2. Project scaffolding (package.json, Jest config, .gitignore, directory structure)
...
- [ ] 6. Docker Compose test stack (OCIS + Document Server + companion)
...
- [ ] 7. Health check E2E tests (all services)
...
- [ ] 8. WOPI discovery + Companion API endpoint tests
...
- [ ] 10. README + push to Codeberg + create PR
