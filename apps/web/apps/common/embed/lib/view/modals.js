...
common.view.modals = new (function () {
  ...
  const _tplbody_warning =
    '<div class="warning-body">' + '<span class="message">{message}</span>' + "</div>"
      ...
      if (name === "share") {
        ...
        _$dlg = $(
          tplDialog
            ...
            .replace(
              /\{footer}/,
              `<button id="btn-copyshort" type="button" class="btn">${this.txtCopy}</button>`,
            ),
        )
          .appendTo(parent)
          .attr("id", "dlg-share")
        ...
        _$dlg = $(
          tplDialog
            ...
            .replace(
              /\{footer}/,
              `<button id="btn-copyembed" type="button" class="btn">${this.txtCopy}</button>`,
            ),
        )
          .appendTo(parent)
          .attr("id", "dlg-embed")
        ...
        _$dlg = $(
          tplDialog
            ...
            .replace(
              /\{button}/,
              '<button id="password-btn" type="button" class="btn">OK</button>',
            ),
        )
          .appendTo(parent)
        ...
        const footerBtns = (config?.buttons || ["ok"])
          .map(
            (btn) =>
        ...
        _$dlg = $(
          tplDialog
            ...
            .replace(/{body}/g, _tplbody_warning.replace(/{message}/g, config?.message))
