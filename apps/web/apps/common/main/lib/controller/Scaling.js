...
define(["core"], () => {
  ...
  Common.UI.Scaling = new (function () {
    ...
    const _body_classes = document.body.className

    const _from_class_list = (str) => {
    ...
    new MutationObserver(_callback.bind(this)).observe(document.body, {
      attributes: true,
      attributeFilter: ["class"],
    })

    return {
      currentRatio: () => scales_map[_current_ratio_str],
      currentRatioSelector: () => _current_ratio_str,
    }
  })()
})
