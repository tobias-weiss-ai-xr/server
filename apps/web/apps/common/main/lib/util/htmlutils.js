...
window.Common = {
  Utils: {
    injectSvgIcons: (svg_icons_array, force) => {},
  },
}
...
if (!window.is_system_theme_dark) window.is_system_theme_dark = undefined
