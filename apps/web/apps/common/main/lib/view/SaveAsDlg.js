...
define([], () => {
  Common.Views.SaveAsDlg = Common.UI.Window.extend(
    _.extend(
      {
        initialize: function (options) {
          ...
          this.template = ['<div id="id-saveas-folder-placeholder"></div>'].join("")
          ...
          this.saveFolderUrl = this.saveFolderUrl
            .replace("{title}", encodeURIComponent(this.defFileName))
            .replace("{fileuri}", encodeURIComponent(this.saveFileUrl))
