...
define(["common/main/lib/view/AdvancedSettingsWindow"], () => {
  Common.Views.ShapeShadowDialog = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          ...
          _.extend(
            this.options,
            {
              ...
              contentTemplate: [
                ...
                "<tr>",
                "<td>",
                `<label class="header">${this.txtTransparency}</label>`,
                ...
                "<tr>",
                "<td>",
                `<label class="header">${this.txtSize}</label>`,
                '<div style="display: flex; align-items: center; justify-content: space-between;">',
                ...
                "<tr>",
                "<td>",
                `<label class="header">${this.txtAngle}</label>`,
                '<div style="display: flex; align-items: center; justify-content: space-between;">',
                ...
                "<tr>",
                "<td>",
                `<label class="header">${this.txtDistance}</label>`,
                '<div style="display: flex; align-items: center; justify-content: space-between;">',
        ...
        render: function () {
          ...
          if (this.isShadowEmpty) {
            ...
            this.methodApplySettings?.call(this, shapeProps)
          }
          ...
          const metricName = Common.Utils.Metric.getMetricName(Common.Utils.Metric.c_MetricUnits.pt)
        ...
        getFocusedComponents: function () {
          return [this.spinTransparency, this.spinSize, this.spinAngle, this.spinDistance].concat(
        ...
        handleOkClose: function () {
          ...
          this.setAllProperties(
            Number.parseInt(this.spinTransparency.getValue()),
            Number.parseInt(this.spinSize.getValue()),
            Number.parseInt(this.spinAngle.getValue()),
            Number.parseInt(this.spinDistance.getValue()),
          )
          this.handler?.call(this, "ok")
        },
