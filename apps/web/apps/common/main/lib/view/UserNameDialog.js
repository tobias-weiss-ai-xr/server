...
define(["common/main/lib/component/Window"], () => {
  Common.Views.UserNameDialog = Common.UI.Window.extend(
    _.extend(
      {
        options: {
          width: 330,
        ...
        render: function () {
          ...
          this.inputLabel = new Common.UI.InputField({
            el: $("#id-dlg-username-caption"),
            allowBlank: true,
            style: "width: 100%;",
            maxLength: 128,
            validateOnBlur: false,
            validation: this.options.validation || ((value) => (value ? true : "")),
          })
        ...
        _handleInput: function (state) {
          if (this.options.handler) {
            ...
            this.options.handler.call(this, state, {
              input: this.inputLabel.getValue(),
              checkbox: this.chDontShow.getValue() === "checked",
            })
          }
