  ...
  return (lunr) => {
    ...
    lunr.el = function () {
      ...
      if (this.searchPipeline === undefined) {
        this.pipeline.add(lunr.el.trimmer, lunr.el.normilizer)
      }

      this.pipeline.add(lunr.el.stopWordFilter, lunr.el.stemmer)
    ...
    lunr.el.stemmer = (() => {
      ...
      function stem(word) {
        ...
        //step 1
        const stepOneRegExp = new RegExp(`(.*)(${Object.keys(stepOneExceptions).join("|")})$`)
        let match = stepOneRegExp.exec(stemmedWord)
        ...
        //3a
        if (
          (match = /^(.+?)(ΕΙΟ|ΕΙΟΣ|ΕΙΟΙ|ΕΙΑ|ΕΙΑΣ|ΕΙΕΣ|ΕΙΟΥ|ΕΙΟΥΣ|ΕΙΩΝ)$/.exec(stemmedWord)) !==
            null &&
          match[1].length > 4
        ) {
          stemmedWord = match[1]
        ...
        //3b
        if (
          (match = /^(.+?)(ΙΟΥΣ|ΙΑΣ|ΙΕΣ|ΙΟΣ|ΙΟΥ|ΙΟΙ|ΙΩΝ|ΙΟΝ|ΙΑ|ΙΟ)$/.exec(stemmedWord)) !== null
        ) {
          stemmedWord = match[1]
          if (
            endsInVowel(stemmedWord) ||
        ...
        //step 4
        if (
          (match = /^(.+?)(ΙΚΟΣ|ΙΚΟΝ|ΙΚΕΙΣ|ΙΚΟΙ|ΙΚΕΣ|ΙΚΟΥΣ|ΙΚΗ|ΙΚΗΣ|ΙΚΟ|ΙΚΑ|ΙΚΟΥ|ΙΚΩΝ|ΙΚΩΣ)$/.exec(
            stemmedWord,
          )) !== null
        ) {
          stemmedWord = match[1]
        ...
        if ((match = /^(.+?)(ΟΥΣΑ|ΟΥΣΕΣ|ΟΥΣΕ)$/.exec(stemmedWord)) !== null) {
          ...
          if (
            ...
            /(ΠΟΔΑΡ|ΒΛΕΠ|ΠΑΝΤΑΧ|ΦΡΥΔ|ΜΑΝΤΙΛ|ΜΑΛΛ|ΚΥΜΑΤ|ΛΑΧ|ΛΗΓ|ΦΑΓ|ΟΜ|ΠΡΩΤ)$/.test(match[1])
          ) {
            stemmedWord += "ΟΥΣ"
          }
        }
        ...
        if ((match = /^(.+?)(ΑΓΑ|ΑΓΕΣ|ΑΓΕ)$/.exec(stemmedWord)) !== null) {
          ...
          if (
            ...
            (/(ΟΦ|ΠΕΛ|ΧΟΡΤ|ΛΛ|ΣΦ|ΡΠ|ΦΡ|ΠΡ|ΛΟΧ|ΣΜΗΝ)$/.test(match[1]) &&
              !/^(ΨΟΦ|ΝΑΥΛΟΧ)$/.test(match[1])) ||
            /(ΚΟΛΛ)$/.test(match[1])
          ) {
            stemmedWord += "ΑΓ"
          }
        ...
        //6a
        if (
          (match = /^(.+?)(ΜΑΤΟΙ|ΜΑΤΟΥΣ|ΜΑΤΟ|ΜΑΤΑ|ΜΑΤΩΣ|ΜΑΤΩΝ|ΜΑΤΟΣ|ΜΑΤΕΣ|ΜΑΤΗ|ΜΑΤΗΣ|ΜΑΤΟΥ)$/.exec(
            stemmedWord,
          )) != null
        ) {
        ...
        //step 7
        if (
          (match = /^(.+?)(ΕΣΤΕΡ|ΕΣΤΑΤ|ΟΤΕΡ|ΟΤΑΤ|ΥΤΕΡ|ΥΤΑΤ|ΩΤΕΡ|ΩΤΑΤ)$/.exec(stemmedWord)) != null
        ) {
      ...
      return (token) => {
        if (typeof token.update === "function") {
          return token.update((word) => stem(word.toUpperCase()).toLowerCase())
        }
    ...
    lunr.el.stopWordFilter = lunr.generateStopWordFilter(
