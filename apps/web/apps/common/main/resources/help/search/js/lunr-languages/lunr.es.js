...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.es = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.es.trimmer, lunr.es.stopWordFilter, lunr.es.stemmer)
    ...
    lunr.es.stemmer = (() => {
      ...
      const st = new (function SpanishStemmer() {
        const a_0 = [
          new Among("", -1, 6),
          new Among("\u00E1", 0, 1),
          new Among("\u00E9", 0, 2),
        ...
        const a_4 = [new Among("able", -1, 1), new Among("ible", -1, 1), new Among("ante", -1, 1)]
        const a_5 = [new Among("ic", -1, 1), new Among("abil", -1, 1), new Among("iv", -1, 1)]
        const a_6 = [
          new Among("ica", -1, 1),
          new Among("ancia", -1, 2),
          new Among("encia", -1, 5),
        ...
        function habr5(a, n) {
          ...
          sbp.slice_del()
          sbp.ket = sbp.cursor
          const among_var = sbp.find_among_b(a, n)
          if (among_var) {
            sbp.bra = sbp.cursor
