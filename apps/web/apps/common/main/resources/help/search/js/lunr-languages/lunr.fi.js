...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.fi = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.fi.trimmer, lunr.fi.stopWordFilter, lunr.fi.stemmer)
    ...
    lunr.fi.stemmer = (() => {
      ...
      const st = new (function FinnishStemmer() {
        const a_0 = [
          new Among("pa", -1, 1),
          new Among("sti", -1, 2),
          new Among("kaan", -1, 1),
        ...
        const a_3 = [new Among("lle", -1, -1), new Among("ine", -1, -1)]
        const a_4 = [
          new Among("nsa", -1, 3),
          new Among("mme", -1, 3),
          new Among("nne", -1, 3),
        ...
        const a_8 = [new Among("i", -1, -1), new Among("j", -1, -1)]
        const a_9 = [new Among("mma", -1, 1), new Among("imma", 0, -1)]
