...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.fr = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.fr.trimmer, lunr.fr.stopWordFilter, lunr.fr.stemmer)
    ...
    lunr.fr.stemmer = (() => {
      ...
      const st = new (function FrenchStemmer() {
        const a_0 = [new Among("col", -1, -1), new Among("par", -1, -1), new Among("tap", -1, -1)]
        const a_1 = [
          new Among("", -1, 4),
          new Among("I", 0, 1),
          new Among("U", 0, 2),
        ...
        const a_3 = [new Among("ic", -1, 2), new Among("abil", -1, 1), new Among("iv", -1, 3)]
        const a_4 = [
          new Among("iqUe", -1, 1),
          ...
          if (among_var) {
            ...
            switch (among_var) {
              ...
              case 11:
                ...
                break
              case 12:
                if (!r_R1() || !sbp.out_grouping_b(g_v, 97, 251)) return false
                sbp.slice_del()
                break
              case 13:
