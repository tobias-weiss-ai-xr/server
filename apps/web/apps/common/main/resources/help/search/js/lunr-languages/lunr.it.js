...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.it = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.it.trimmer, lunr.it.stopWordFilter, lunr.it.stemmer)
    ...
    lunr.it.stemmer = (() => {
      ...
      const st = new (function ItalianStemmer() {
        const a_0 = [
          new Among("", -1, 7),
          new Among("qu", 0, 6),
          new Among("\u00E1", 0, 1),
        ...
        const a_1 = [new Among("", -1, 3), new Among("I", 0, 1), new Among("U", 0, 2)]
        const a_2 = [
          new Among("la", -1, -1),
          new Among("cela", 0, -1),
