...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.nl = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.nl.trimmer, lunr.nl.stopWordFilter, lunr.nl.stemmer)
    ...
    lunr.nl.stemmer = (() => {
      ...
      const st = new (function DutchStemmer() {
        const a_0 = [
          new Among("", -1, 6),
          new Among("\u00E1", 0, 1),
          new Among("\u00E4", 0, 1),
        ...
        const a_1 = [new Among("", -1, 3), new Among("I", 0, 2), new Among("Y", 0, 1)]
        const a_2 = [new Among("dd", -1, -1), new Among("kk", -1, -1), new Among("tt", -1, -1)]
        const a_3 = [
          new Among("ene", -1, 2),
          new Among("se", -1, 3),
          new Among("en", -1, 2),
          ...
          if (among_var) {
            ...
            switch (among_var) {
              ...
              case 2:
                ...
                break
              case 3:
                if (r_R1() && sbp.out_grouping_b(g_v_j, 97, 232)) sbp.slice_del()
                break
            }
          }
          sbp.cursor = sbp.limit - v_1
