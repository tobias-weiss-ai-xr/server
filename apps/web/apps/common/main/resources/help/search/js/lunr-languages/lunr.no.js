...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.no = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.no.trimmer, lunr.no.stopWordFilter, lunr.no.stemmer)
    ...
    lunr.no.stemmer = (() => {
      ...
      const st = new (function NorwegianStemmer() {
        const a_0 = [
          new Among("a", -1, 1),
          new Among("e", -1, 1),
          new Among("ede", 1, 1),
        ...
        const a_1 = [new Among("dt", -1, -1), new Among("vt", -1, -1)]
        const a_2 = [
          new Among("leg", -1, 1),
          new Among("eleg", 0, 1),
          new Among("ig", -1, 1),
              ...
              switch (among_var) {
                ...
                case 2:
                  ...
                  if (sbp.in_grouping_b(g_s_ending, 98, 122)) sbp.slice_del()
                    ...
                    if (sbp.eq_s_b(1, "k") && sbp.out_grouping_b(g_v, 97, 248)) sbp.slice_del()
                  }
                  break
                case 3:
                  sbp.slice_from("er")
