...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.pt.stemmer = (() => {
      ...
      const st = new (function PortugueseStemmer() {
        const a_0 = [new Among("", -1, 3), new Among("\u00E3", 0, 1), new Among("\u00F5", 0, 2)]
        const a_1 = [new Among("", -1, 3), new Among("a~", 0, 1), new Among("o~", 0, 2)]
        const a_2 = [
          new Among("ic", -1, -1),
          new Among("ad", -1, -1),
          new Among("os", -1, -1),
        ...
        const a_4 = [new Among("ic", -1, 1), new Among("abil", -1, 1), new Among("iv", -1, 1)]
        const a_5 = [
          new Among("ica", -1, 1),
          new Among("\u00E2ncia", -1, 1),
          new Among("\u00EAncia", -1, 4),
        ...
        function habr4() {
          ...
          if (sbp.out_grouping(g_v, 97, 250)) {
            ...
            if (habr2()) {
              sbp.cursor = v_3
              if (!sbp.in_grouping(g_v, 97, 250) || sbp.cursor >= sbp.limit) return
              sbp.cursor++
            }
            I_pV = sbp.cursor
          }
