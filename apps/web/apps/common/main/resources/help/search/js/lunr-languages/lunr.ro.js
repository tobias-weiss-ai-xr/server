...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.ro = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.ro.trimmer, lunr.ro.stopWordFilter, lunr.ro.stemmer)
    ...
    lunr.ro.stemmer = (() => {
      ...
      const st = new (function RomanianStemmer() {
        const a_0 = [new Among("", -1, 3), new Among("I", 0, 1), new Among("U", 0, 2)]
        const a_1 = [
          new Among("ea", -1, 3),
          new Among("a\u0163ia", -1, 7),
          new Among("aua", -1, 2),
        ...
        function habr4() {
          ...
          if (sbp.out_grouping(g_v, 97, 259)) {
            ...
            if (habr2()) {
              sbp.cursor = v_3
              if (sbp.in_grouping(g_v, 97, 259) && sbp.cursor < sbp.limit) sbp.cursor++
            }
            I_pV = sbp.cursor
          }
        }
