...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.ru = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.ru.trimmer, lunr.ru.stopWordFilter, lunr.ru.stemmer)
    ...
    lunr.ru.stemmer = (() => {
      ...
      const st = new (function RussianStemmer() {
        const a_0 = [
          new Among("\u0432", -1, 1),
          new Among("\u0438\u0432", 0, 2),
          new Among("\u044B\u0432", 0, 2),
        ...
        const a_3 = [new Among("\u0441\u044C", -1, 1), new Among("\u0441\u044F", -1, 1)]
        const a_4 = [
          new Among("\u043B\u0430", -1, 1),
          new Among("\u0438\u043B\u0430", 0, 2),
          new Among("\u044B\u043B\u0430", 0, 2),
