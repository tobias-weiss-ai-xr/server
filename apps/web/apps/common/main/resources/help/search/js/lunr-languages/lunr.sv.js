...
;((root, factory) => {
  ...
  return (lunr) => {
    ...
    lunr.sv = function () {
      this.pipeline.reset()
      this.pipeline.add(lunr.sv.trimmer, lunr.sv.stopWordFilter, lunr.sv.stemmer)
    ...
    lunr.sv.stemmer = (() => {
      ...
      const st = new (function SwedishStemmer() {
        const a_0 = [
          new Among("a", -1, 1),
          new Among("arna", 0, 1),
          new Among("erna", 0, 1),
