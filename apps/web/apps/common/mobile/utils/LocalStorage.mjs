class LocalStorage {
  ...
  setItem(name, value, just) {
    if (!this._common_keys.includes(value)) name = this._prefix + name
  ...
  getItem(name) {
    if (!this._common_keys.includes(name)) name = this._prefix + name

    if (this._isAllowed) return localStorage.getItem(name)
