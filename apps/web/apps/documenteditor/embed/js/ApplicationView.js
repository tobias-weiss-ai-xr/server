...
DE.ApplicationView = new (function () {
  ...
  function createView() {
    ...
    $btnTools
      .parent()
      .append(
        `<ul class="dropdown-menu pull-right"><li><a id="idt-download"><span class="mi-icon svg-icon download"></span>${this.txtDownload}</a></li><li><a id="idt-download-docx"><span class="mi-icon svg-icon download"></span>${this.txtDownloadDocx}</a></li><li><a id="idt-download-pdf"><span class="mi-icon"></span>${this.txtDownloadPdf}</a></li><li><a id="idt-print"><span class="mi-icon svg-icon print"></span>${this.txtPrint}</a></li><li class="divider"></li><li><a id="idt-search"><span class="mi-icon svg-icon search"></span>${this.txtSearch}</a></li><li class="divider"></li><li><a id="idt-share" data-toggle="modal"><span class="mi-icon svg-icon share"></span>${this.txtShare}</a></li><li><a id="idt-close" data-toggle="modal"><span class="mi-icon svg-icon go-to-location"></span><span class="caption">${this.txtFileLocation}</span></a></li><li class="divider"></li><li><a id="idt-embed" data-toggle="modal"><span class="mi-icon svg-icon embed"></span>${this.txtEmbed}</a></li><li><a id="idt-fullscreen"><span class="mi-icon svg-icon fullscr"></span>${this.txtFullScreen}</a></li></ul>`,
      )
  }
  ...
  function getMenuForm() {
    if (!$menuForm) {
      $menuForm = $(
        '<div id="menu-container-form" style="position: absolute; z-index: 10000;" data-value="prevent-canvas-click">' +
