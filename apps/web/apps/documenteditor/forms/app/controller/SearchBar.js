...
define(["core", "common/main/lib/view/SearchBar"], () => {
  DE.Controllers.SearchBar = Backbone.Controller.extend(
    _.extend(
      {
        initialize: () => {},
        ...
        setApi: function (api) {
          ...
          if (this.api) {
            this.api.asc_registerCallback(
              ...
              _.bind(this.onApiUpdateSearchCurrent, this),
            )
          }
          return this
        },
        ...
        onSearchNext: function (type, arg) {
          ...
          if (
            text &&
            text.length > 0 &&
            ((type === "keydown" && event.keyCode === 13) || type !== "keydown")
          ) {
