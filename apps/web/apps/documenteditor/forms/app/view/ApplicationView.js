              ...
              items: [
                {
                  ...
                  value: "undo",
                  iconCls: "mi-icon svg-icon undo",
                  cls: "small-resolution",
                },
                {
                  caption: this.textRedo,
                  value: "redo",
                  iconCls: "mi-icon svg-icon redo",
                  cls: "small-resolution",
                },
                { caption: "--" },
                {
                  ...
                  value: "clear",
                  iconCls: "mi-icon svg-icon clear-style",
                  cls: "small-resolution",
                },
                { caption: "--" },
                {
                  ...
                  value: "download",
                  iconCls: "mi-icon svg-icon download",
                },
                {
                  caption: this.txtDownloadDocx,
                  value: "download-docx",
                  iconCls: "mi-icon svg-icon download",
                },
                ...
                {
                  caption: this.txtFileLocation,
                  value: "close",
                  iconCls: "mi-icon svg-icon go-to-location",
                },
                { caption: "--" },
                { caption: this.txtEmbed, value: "embed", iconCls: "mi-icon svg-icon embed" },
                {
                  caption: this.txtFullScreen,
                  value: "fullscr",
                  iconCls: "mi-icon svg-icon fullscr",
                },
              ],
            }),
          })
