...
define([], () => {
  if (window.DE?.Controllers?.DocumentHolder) {
    const dh = window.DE.Controllers.DocumentHolder.prototype
      ...
      if (this.api) {
        ...
        if (this.mode.isEdit === true) {
          this.api.asc_registerCallback(
            ...
            _.bind(this.onImgWrapStyleChanged, this),
          )
          this.api.asc_registerCallback(
          ...
          this.api.asc_SetMathInputType(
            Common.localStorage.getBool("de-equation-input-latex")
    ...
    dh.initExternalEditors = function () {
      ...
      const mergeEditor = this.getApplication()
      ...
      if (mergeEditor) {
        mergeEditor.on(
          ...
          _.bind(function (cmp, message) {
            const command = message.data.command
            const data = message.data.data
            if (this.api) this.api.asc_setMailMergeData(data)
          }, this),
        )
        mergeEditor.on(
          "hide",
    ...
    dh.createDelayedElements = function (view, type) {
      ...
      if (type === "view") {
        ...
        view.menuViewPaste.on("click", _.bind(this.onCutCopyPaste, this))
        view.menuViewCut.on("click", _.bind(this.onCutCopyPaste, this))
        ...
        view.menuViewPrint.on("click", _.bind(this.onPrintSelection, this))
        return
      }
      if (type === "pdf") {
      ...
      view.menuInsertCaption.on("click", _.bind(this.onInsertCaption, this))
      view.menuEquationInsertCaption.on("click", _.bind(this.onInsertCaption, this))
      view.menuTableInsertCaption.on("click", _.bind(this.onInsertCaption, this))
      view.menuChartEdit.on("click", _.bind(this.editChartClick, this))
      ...
      view.menuImgAccept.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuImgReject.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuTableAccept.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuTableReject.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuParaAccept.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuParaReject.on("click", _.bind(this.onAcceptRejectChange, this))
      view.menuImgPrint.on("click", _.bind(this.onPrintSelection, this))
      view.menuTablePrint.on("click", _.bind(this.onPrintSelection, this))
      view.menuParaPrint.on("click", _.bind(this.onPrintSelection, this))
      ...
      view.menuImgRotate.menu.items[0].on("click", _.bind(this.onImgRotate, this))
      view.menuImgRotate.menu.items[1].on("click", _.bind(this.onImgRotate, this))
      view.menuImgRotate.menu.items[3].on("click", _.bind(this.onImgFlip, this))
      view.menuImgRotate.menu.items[4].on("click", _.bind(this.onImgFlip, this))
      ...
      view.menuImgRemoveControl.on("click", _.bind(this.onControlsSelect, this))
      view.menuImgControlSettings.on("click", _.bind(this.onControlsSelect, this))
      view.menuTableRemoveForm.on("click", _.bind(this.onControlsSelect, this))
      view.menuTableRemoveControl.on("click", _.bind(this.onControlsSelect, this))
      view.menuTableControlSettings.on("click", _.bind(this.onControlsSelect, this))
      view.menuImgStretchContentControl.on("click", _.bind(this.onControlsSelect, this))
      view.menuTableStretchContentControl.on("click", _.bind(this.onControlsSelect, this))
      view.menuParaRemoveControl.on("click", _.bind(this.onControlsSelect, this))
      view.menuParaControlSettings.on("click", _.bind(this.onControlsSelect, this))
      view.menuTableCellAlign.menu.on("item:click", _.bind(this.tableCellsVAlign, this))
      view.menuTableAdvanced.on("click", _.bind(this.advancedTableClick, this))
      view.menuParagraphAdvancedInTable.on("click", _.bind(this.advancedParagraphClick, this))
      view.menuStyleSaveInTable.on("click", _.bind(this.onMenuSaveStyle, this))
      view.menuStyleUpdateInTable.on("click", _.bind(this.onMenuUpdateStyle, this))
      view.menuParagraphAdvanced.on("click", _.bind(this.advancedParagraphClick, this))
      ...
      view.menuRemoveHyperlinkPic.on("click", _.bind(this.onRemoveHyperlink, this))
      view.menuRemoveHyperlinkTable.on("click", _.bind(this.onRemoveHyperlink, this))
      view.menuRemoveHyperlinkPara.on("click", _.bind(this.onRemoveHyperlink, this))
      ...
      view.menuTableFollow.on("click", _.bind(this.onFollowMove, this))
      view.menuParaFollow.on("click", _.bind(this.onFollowMove, this))
      view.menuTableStartNewList.on("click", _.bind(this.onStartNumbering, this, 1))
      view.menuParaStartNewList.on("click", _.bind(this.onStartNumbering, this, 1))
      view.menuTableStartNumberingFrom.on("click", _.bind(this.onStartNumbering, this, "advanced"))
      view.menuParaStartNumberingFrom.on("click", _.bind(this.onStartNumbering, this, "advanced"))
      view.menuTableContinueNumbering.on("click", _.bind(this.onContinueNumbering, this))
      view.menuParaContinueNumbering.on("click", _.bind(this.onContinueNumbering, this))
      view.menuFrameAdvanced.on("click", _.bind(this.advancedFrameClick, this, true))
      view.menuDropCapAdvanced.on("click", _.bind(this.advancedFrameClick, this, false))
      view.menuStyleSave.on("click", _.bind(this.onMenuSaveStyle, this))
      view.menuStyleUpdate.on("click", _.bind(this.onMenuUpdateStyle, this))
      ...
      view.menuImageAlign.menu.on("item:click", _.bind(this.onImgAlign, this))
      view.menuShapesMerge.menu.on("item:click", _.bind(this.onShapesMerge, this))
      view.menuImageArrange.menu.on("item:click", _.bind(this.onImgArrange, this))
      view.mnuGroup.on("click", _.bind(this.onImgGroup, this))
      view.mnuUnGroup.on("click", _.bind(this.onImgUnGroup, this))
      view.menuWrapPolygon.on("click", _.bind(this.onImgWrapPolygon, this))
      view.menuImageWrap.menu.on("item:click", _.bind(this.onImgWrap, this))
      view.menuImageAdvanced.on("click", _.bind(this.onImgAdvanced, this))
      view.menuOriginalSize.on("click", _.bind(this.onImgOriginalSize, this))
      ...
      view.menuTableDistRows.on("click", _.bind(this.onTableDist, this))
      view.menuTableDistCols.on("click", _.bind(this.onTableDist, this))
      view.menuTableDirection.menu.on("item:click", _.bind(this.tableDirection, this))
      view.menuTableRefreshField.on("click", _.bind(this.onRefreshField, this))
      view.menuParaRefreshField.on("click", _.bind(this.onRefreshField, this))
      view.menuTableEditField.on("click", _.bind(this.onEditField, this))
      view.menuParaEditField.on("click", _.bind(this.onEditField, this))
      view.menuTableFieldCodes.on("click", _.bind(this.onFieldCodes, this))
      view.menuParaFieldCodes.on("click", _.bind(this.onFieldCodes, this))
      view.menuParagraphBreakBefore.on("click", _.bind(this.onParagraphBreakBefore, this))
      view.menuParagraphKeepLines.on("click", _.bind(this.onParagraphKeepLines, this))
      view.menuParagraphVAlign.menu.on("item:click", _.bind(this.paragraphVAlign, this))
      view.menuParagraphDirection.menu.on("item:click", _.bind(this.paragraphDirection, this))
      ...
      view.menuTableTOC.menu.on("item:click", _.bind(this.onTOCMenu, this))
      view.menuParaTOCRefresh.menu.on("item:click", _.bind(this.onTOCMenu, this))
      view.menuParaTOCSettings.on("click", _.bind(this.onParaTOCSettings, this))
      view.menuTableEquation.menu.on("item:click", _.bind(this.convertEquation, this))
      view.menuParagraphEquation.menu.on("item:click", _.bind(this.convertEquation, this))
      view.menuTableListIndents.on("click", _.bind(this.onListIndents, this))
      view.menuParaListIndents.on("click", _.bind(this.onListIndents, this))
    ...
    dh.fillMenuProps = function (selectedElements) {
      ...
      const menu_props = {}
      let menu_to_show = documentHolder.textMenu
      let noobject = true
      for (let i = 0; i < selectedElements.length; i++) {
        ...
        if (Asc.c_oAscTypeSelectElement.Image === elType) {
          ...
          if (menu_props.imgProps === undefined) menu_props.imgProps = {}
          const shapeprops = elValue.get_ShapeProperties()
          const chartprops = elValue.get_ChartProperties()
          if (shapeprops) {
            if (shapeprops.get_FromChart()) menu_props.imgProps.isChart = true
            else if (shapeprops.get_FromImage()) menu_props.imgProps.isOnlyImg = true
            else {
              if (shapeprops.get_FromSmartArt()) menu_props.imgProps.isSmartArt = true
              if (shapeprops.get_FromSmartArtInternal())
                menu_props.imgProps.isSmartArtInternal = true
              menu_props.imgProps.isShape = true
            }
          } else if (chartprops) menu_props.imgProps.isChart = true
          else menu_props.imgProps.isImg = true
          ...
          if (
            menu_props.imgProps &&
            (menu_props.imgProps.isChart || menu_props.imgProps.isShape) && // text in shape, need to show paragraph menu with vertical align
            menu_props.tableProps === undefined
          )
            menu_to_show = documentHolder.textMenu
          noobject = false
        } else if (Asc.c_oAscTypeSelectElement.Hyperlink === elType) {
          if (menu_props.hyperProps) menu_props.hyperProps.isSeveralLinks = true
          else menu_props.hyperProps = {}
    ...
    dh.fillViewMenuProps = function (selectedElements) {
      ...
      const menu_props = {}
      let menu_to_show = documentHolder.viewModeMenu
      let noobject = true
      for (let i = 0; i < selectedElements.length; i++) {
        const elType = selectedElements[i].get_ObjectType()
        const elValue = selectedElements[i].get_ObjectValue()
    ...
    dh.fillFormsMenuProps = function (selectedElements) {
      ...
      const menu_props = {}
      const menu_to_show = documentHolder.formsPDFMenu
      let noobject = true
      for (let i = 0; i < selectedElements.length; i++) {
        const elType = selectedElements[i].get_ObjectType()
        const elValue = selectedElements[i].get_ObjectValue()
    ...
    dh.onMouseMove = function (moveData) {
      ...
      if (moveData) {
        ...
        if (
          ...
          type === Asc.c_oAscMouseMoveDataTypes.Footnote ||
          type === Asc.c_oAscMouseMoveDataTypes.Form ||
          (type === Asc.c_oAscMouseMoveDataTypes.Review && this.mode.reviewHoverMode) ||
          ...
          if (type === Asc.c_oAscMouseMoveDataTypes.Hyperlink) {
            ...
            let changes = this.getApplication()
              .getController("Common.Controllers.ReviewChanges")
              .readSDKChange([moveData.get_ReviewChange()])
            if (changes && changes.length > 0) changes = changes[0]
            if (changes) {
          ...
          if (!this.screenTip.toolTip) {
            ...
            this.screenTip.toolTip.on("tooltip:show", () => {
              $("#id_main_view").on("mouseleave", this.wrapEvents.onMouseLeave)
            })
            this.screenTip.toolTip.on("tooltip:hide", () => {
              $("#id_main_view").off("mouseleave", this.wrapEvents.onMouseLeave)
            })
          }

          if (
            type !== Asc.c_oAscMouseMoveDataTypes.Review &&
            type !== Asc.c_oAscMouseMoveDataTypes.Placeholder
          )
    ...
    dh.onSingleChartSelectionChanged = function (asc_CRect) {
      ...
      this.getCurrentChartProps = function () {
        const selectedObjects = this.api.getSelectedElements()
      ...
      if (this.chartProps) {
        ...
        let btnTop = y - 28
        const btnWidth = 50
        const offsetLeft = chartContainer.width() === 40 ? 68 : 60
        ...
        if (this.isRtlSheet) {
          ...
          if (rightSide + btnWidth <= this._Width - 10) {
            btn = rightSide
          } else if (leftSide >= 0) {
            btn = leftSide
          } else {
      ...
      const diagramEditor = this.getApplication()
        .getController("Common.Controllers.ExternalDiagramEditor")
        .getView("Common.Views.ExternalDiagramEditor")
      if (diagramEditor?.isVisible() && this._state.currentChartRect) {
        let x
        let y
        this.checkEditorOffsets()
    ...
    dh.onShowSpecialPasteOptions = function (specialPasteShowOptions) {
      ...
      if (pasteContainer.length < 1) {
        ...
        this._arrSpecialPaste[Asc.c_oSpecialPasteProps.insertAsNestedTable] =
          documentHolder.textNest
        this._arrSpecialPaste[Asc.c_oSpecialPasteProps.overwriteCells] =
          documentHolder.txtOverwriteCells
      ...
      let showPoint = [
        coord.asc_getX() + coord.asc_getWidth() + 3,
        coord.asc_getY() + coord.asc_getHeight() + 3,
      ]
      if (
        coord.asc_getX() < 0 ||
        coord.asc_getY() < 0 ||
        showPoint[0] > this._Width ||
        showPoint[1] > this._Height
      ) {
    ...
    dh.disableSpecialPaste = function () {
      const pasteContainer = this.documentHolder.cmpEl.find("#special-paste-container")
      const docProtection = this.documentHolder._docProtection
      const unprotectedRegion = this.documentHolder._unprotectedRegion
      const disabled =
        this._isDisabled ||
        (docProtection.isReadOnly && !unprotectedRegion.canInsObject) ||
        (docProtection.isCommentsOnly && !unprotectedRegion.canInsObject)
    ...
    dh.onImgWrapStyleChanged = function (type) {
      const menuImageWrap = this.documentHolder.menuImageWrap
      switch (type) {
    ...
    dh.onRulerDblClick = function (type) {
      ...
      if (type === "tables") {
        ...
        if (win) win.setActiveCategory(4)
      } else if (type === "indents" || type === "tabs") {
        win = this.advancedParagraphClick({ isChart: false })
        if (win) win.setActiveCategory(type === "indents" ? 0 : 4)
      } else if (type === "margins") {
        if (this._state.lock_doc) return
        ...
        win = new DE.Views.CustomColumnsDialog({
          handler: (dlg, result) => {
            if (result === "ok") {
              this.api.asc_SetColumnsProps(dlg.getSettings())
              this.editComplete()
            }
          },
        })
    ...
    dh.onHideContentControlsActions = function () {
      ...
      this.imageControlMenu?.isVisible() && this.imageControlMenu.hide()
    ...
    dh.onShowContentControlsActions = function (obj, x, y) {
      ...
      switch (type) {
        ...
        case Asc.c_oAscContentControlSpecificType.Picture:
          ...
          if (!this.mode.canSaveToFile) {
            // select picture in viewer only from local file
        ...
        case Asc.c_oAscContentControlSpecificType.Signature:
          ...
          if (this.mode.canSaveToFile) {
            if (!this.fontStore) {
              ...
              const cmbFonts = this.getApplication()
                .getController("Toolbar")
                .getView("Toolbar").cmbFontName
              if (cmbFonts?.store) {
                const fonts = cmbFonts.store.toJSON()
                this.fontStore.add(fonts.filter((font) => !font.cloneid))
              } else {
                const fontsController = app.getController("Common.Controllers.Fonts")
                fontsController && (this.fontStore = fontsController.store())
              }
            }
            const signProps = obj.asc_getSignatureProps(this.api)
            const win = new Common.Views.PdfSignDialog({
              props: signProps,
              api: this.api,
              ...
              handler: (result, value) => {
                if (result === "ok") {
                  this.api.asc_SetSignatureProps(signProps.getResult())
                }
    ...
    dh.onRemoveHyperlink = function (item, e) {
      this.api?.remove_Hyperlink(item.hyperProps.value)
      this.editComplete()
    }
    ...
    dh.advancedFrameClick = (isFrame, item, e, eOpt) => {
          ...
          for (let i = selectedElements.length - 1; i >= 0; i--) {
            ...
            if (Asc.c_oAscTypeSelectElement.Table === elType) {
              win = new DE.Views.TableSettingsAdvanced({
                tableStylerRows:
                  elValue.get_CellBorders().get_InsideH() === null &&
                  elValue.get_CellSelect() === true
                    ? 1
                    : 2,
                tableStylerColumns:
                  elValue.get_CellBorders().get_InsideV() === null &&
                  elValue.get_CellSelect() === true
                    ? 1
                    : 2,
                tableProps: elValue,
    ...
    dh.onMenuSaveStyle = function (item, e, eOpt) {
      if (this.api) {
        Common.NotificationCenter.trigger("style:commitsave", this.api.asc_GetStyleFromFormatting())
      }
    }
    ...
    dh.onMenuUpdateStyle = function (item, e, eOpt) {
      if (this.api) {
        Common.NotificationCenter.trigger(
          "style:commitchange",
          this.api.asc_GetStyleFromFormatting(),
        )
      }
    }
    ...
    dh.onAcceptRejectChange = function (item, e) {
      if (this.api) {
        if (item.value === "accept") this.api.asc_AcceptChangesBySelection(false)
        else if (item.value === "reject") this.api.asc_RejectChangesBySelection(false)
      }
      this.editComplete()
    }
    ...
    dh.onControlsSelect = function (item, e) {
      const props = this.api.asc_GetContentControlProperties()
      if (props) {
        if (item.value === "settings") {
          new DE.Views.ControlSettingsDialog({
            ...
            handler: (result, value) => {
              if (result === "ok") {
                this.api.asc_SetContentControlProperties(value, props.get_InternalId())
              }
          ...
          if (this.api.asc_StretchFormToCell) {
            this.api.asc_StretchFormToCell(this.api.asc_GetCurrentContentControl())
          }
    ...
    dh.onStartNumbering = function (startfrom, item, e) {
      if (startfrom === 1) this.api.asc_RestartNumbering(item.value.start)
      else {
        new DE.Views.NumberingValueDialog({
          title: this.documentHolder.textNumberingValue,
          props: item.value,
          handler: (result, value) => {
            if (result === "ok") this.api.asc_RestartNumbering(value)
            this.editComplete()
          },
        }).show()
      }
    ...
    dh.onCellsRemove = function () {
      new Common.Views.OptionsDialog({
        title: this.documentHolder.textTitleCellsRemove,
        items: [
        ...
        handler: (dlg, result) => {
          if (result === "ok") {
            const value = dlg.getSettings()
            if (value === "row") this.api.remRow()
            else if (value === "col") this.api.remColumn()
            else this.api.asc_RemoveTableCells()
          }
          this.editComplete()
        },
      }).show()
      ...
      new DE.Views.CellsAddDialog({
        handler: (result, settings) => {
          if (result === "ok") {
            if (settings.row) {
              settings.before
                ? this.api.addRowAbove(settings.count)
                : this.api.addRowBelow(settings.count)
            } else {
              settings.before
                ? this.api.addColumnLeft(settings.count)
                : this.api.addColumnRight(settings.count)
            }
          }
          this.editComplete()
        },
      ...
      if (this.api) {
        ...
        const value =
          alignto === 1
            ...
            : (this.api.asc_getSelectedDrawingObjectsCount() < 2 && !alignto) || alignto === 2
    ...
    dh.onImgArrange = function (menu, item, e) {
      if (this.api && item.options.valign !== undefined) {
        const properties = new Asc.asc_CImgProperty()
    ...
    dh.onImgWrap = function (menu, item, e) {
      if (this.api && item.options.wrapType !== undefined) {
        const properties = new Asc.asc_CImgProperty()
        properties.put_WrappingStyle(item.options.wrapType)

        if (
          this.documentHolder.menuImageWrap._originalProps.get_WrappingStyle() ===
            Asc.c_oAscWrapStyle2.Inline &&
          item.wrapType !== Asc.c_oAscWrapStyle2.Inline
        ) {
          ...
          let val = this.documentHolder.menuImageWrap._originalProps.get_Value_X(
            Asc.c_oAscRelativeFromH.Column,
          )
          ...
          val = this.documentHolder.menuImageWrap._originalProps.get_Value_Y(
            Asc.c_oAscRelativeFromV.Paragraph,
          )
        ...
        if (selectedElements && _.isArray(selectedElements)) {
          for (let i = selectedElements.length - 1; i >= 0; i--) {
            ...
            if (Asc.c_oAscTypeSelectElement.Image === elType) {
              let imgsizeOriginal
              if (
                !elValue.get_ChartProperties() &&
                !elValue.get_ShapeProperties() &&
                !this.documentHolder.menuOriginalSize.isDisabled() &&
                this.documentHolder.menuOriginalSize.isVisible()
              ) {
              ...
              const win = new DE.Views.ImageSettingsAdvanced({
                imageProps: elValue,
              ...
              win.show()
              win.btnOriginalSize.setVisible(this.documentHolder.menuOriginalSize.isVisible())
              break
            }
          }
        }
    ...
    dh.onTableDist = function (item, e) {
      this.api?.asc_DistributeTableCells(!!item.value)
      this.editComplete()
    }
    ...
    dh.onRefreshField = function (item, e) {
      this.api?.asc_UpdateFields(true)
      this.editComplete()
    }
    ...
    dh.onFieldCodes = function (item, e) {
      this.api?.asc_ToggleComplexFieldCodes()
      this.editComplete()
    }

    dh.onParagraphBreakBefore = function (item, e) {
      this.api?.put_PageBreak(item.checked)
    }

    dh.onParagraphKeepLines = function (item, e) {
      this.api?.put_KeepLines(item.checked)
    }
    ...
    dh.onTOCMenu = function (menu, item, e) {
      this.documentHolder.fireEvent(item.value === "settings" ? "links:contents" : "links:update", [
        item.value,
        true,
      ])
    }
    ...
    dh.onShowMathTrack = function (bounds) {
      ...
      if (eqContainer.length < 1) {
        ...
        this.equationSettingsBtn.menu.options.initMenu = () => {
          ...
          menu.items[8].setCaption(
            isInlineMath ? this.documentHolder.eqToDisplayText : this.documentHolder.eqToInlineText,
            true,
          )
          menu.items[9].options.isToolbarHide = isEqToolbarHide
          menu.items[9].setCaption(
      ...
      const diffUp =
        this._XY[1] +
        (!Common.Utils.InternalSettings.get("de-hidden-rulers") ? 26 : 0) +
        showPoint[1]
    ...
    dh.onListIndents = function (item, e) {
      ...
      this.api &&
        new DE.Views.ListIndentsDialog({
          api: this.api,
          ...
          handler: (result, value) => {
            if (result === "ok") {
              if (this.api) {
                this.api.asc_ChangeNumberingLvl(item.value.listId, value, item.value.level)
              }
            }
            this.editComplete()
          },
    ...
    dh.onInsertImage = function (obj, x, y) {
      if (
        !this.documentHolder ||
        this.documentHolder._docProtection.isReadOnly ||
        this.documentHolder._docProtection.isFormsOnly ||
        this.documentHolder._docProtection.isCommentsOnly
      )
        return
