...
define([
  ...
  DE.Controllers.Main = Backbone.Controller.extend(
    _.extend(
      (() => {
        let appHeader
        const ApplyEditRights = Common.UI.blockOperations.ApplyEditRights
        const LoadingDocument = Common.UI.blockOperations.LoadingDocument
        ...
        return {
          ...
          onLaunch: function () {
            ...
            if (this.api) {
              ...
              let value = Common.localStorage.getBool("de-settings-cachemode", true)
          ...
          loadConfig: function (data) {
            ...
            this.appOptions.disableNetworkFunctionality = !!(
              ...
              false === window.AscDesktopEditor.isSupportNetworkFunctionality()
            )
            ...
            appHeader.setCanBack(
              ...
              this.appOptions.canBack ? this.appOptions.customization.goback.text : "",
            )
          ...
          loadDocument: function (data) {
            ...
            if (data.doc) {
              ...
              const coEditMode =
                type && typeof type[1] === "string" && !this.appOptions.isPDFForm
                  ? "strict"
                  : // offline viewer for pdf|djvu|xps|oxps
                    !(
            ...
            const type = data.doc ? /^(?:(docxf|oform)|(pdf))$/.exec(data.doc.fileType) : false
            this.appOptions.isFormCreator =
              !!(
                type &&
                (typeof type[1] === "string" ||
                  (typeof type[2] === "string" && this.appOptions.isPDFForm))
              ) && this.appOptions.canFeatureForms // show forms only for docxf or oform
          ...
          onEditingDisable: function (disable, options, type) {
            ...
            if (options.rightMenu && app.getController("RightMenu")) {
              ...
              options.rightMenu.disable &&
                app
                  ...
                  .SetDisabled(disable, options.allowMerge, options.allowSignature)
            }
            ...
            if (options.header) {
              ...
              if (options.header.startfill) appHeader?.lockHeaderBtns("startfill", disable)
          ...
          onEditComplete: function (cmp) {
            ...
            const rightMenu = application.getController("RightMenu").getView("RightMenu")

            if (
              this.appOptions.isEdit &&
              toolbarView &&
              (toolbarView.btnInsertShape.pressed || toolbarView.btnInsertText.pressed) &&
              (!_.isObject(arguments[1]) || arguments[1].id !== "tlbtn-insertshape")
            ) {
            ...
            if (
              this.appOptions.isEdit &&
              (toolbarView?._isEyedropperStart || rightMenu?._isEyedropperStart)
            ) {
          ...
          disableSaveButton: function (isCanSave) {
            ...
            if (!toolbarView || toolbarView._state.previewmode || !toolbarView.btnSave || !this.api)
              return
            ...
            toolbarView.lockToolbar(Common.enumLock.cantSave, isDisabled, {
          ...
          onDocumentContentReady: function () {
            ...
            if (zf === -1) {
              ...
              } else this.api.zoom(zf > 0 ? zf : 100)
            }

            value = Common.localStorage.getItem("de-show-hiddenchars")
            me.api.put_ShowParaMarks(value !== null ? value === "true" : false)

            value = Common.localStorage.getItem("de-show-tableline")
            me.api.put_ShowTableEmptyLine(value !== null ? value === "true" : true)
            ...
            value = value === null ? Asc.c_oNumeralType.arabic : Number.parseInt(value)
            ...
            me.api.asc_registerCallback(
              "asc_onDisconnectEveryone",
              _.bind(me.onDisconnectEveryone, me),
            )
            me.api.asc_registerCallback(
              "asc_onCompletePreparingOForm",
              _.bind(me.onCompletePreparingOForm, me),
            )
            ...
            const fontsController = application.getController("Common.Controllers.Fonts")
            ...
            if (me.appOptions.isEdit) {
              ...
              Common.Utils.InternalSettings.set("de-settings-paste-button", Number.parseInt(value))
              ...
              me.appOptions.canStartFilling &&
                Common.Gateway.on("startfilling", _.bind(me.onStartFilling, me))
              ...
              const timer_sl = setInterval(() => {
                if (window.document_content_ready) {
                  ...
                  const shapes = me.api.asc_getPropertyEditorShapes()
          ...
          onEditorPermissions: function (params) {
            ...
            const isPDFViewer =
              /^(?:(pdf|djvu|xps|oxps))$/.test(this.document.fileType) && !this.appOptions.isPDFForm
            ...
            this.appOptions.canCreateNew =
              this.appOptions.canCreateNew && !(this.appOptions.isOffline && isPDFViewer)
            this.appOptions.isCrypted = this.api.asc_isCrypto()
            this.appOptions.isReviewOnly =
              this.permissions.review === true && this.permissions.edit === false
            this.appOptions.canRequestEditRights = this.editorConfig.canRequestEditRights
            this.appOptions.canEdit =
              (this.permissions.edit !== false || this.permissions.review === true) && // can edit or review
            ...
            this.appOptions.canUseMailMerge =
              this.appOptions.canLicense && this.appOptions.canEdit && !this.appOptions.isOffline
            ...
            this.appOptions.showSaveButton =
              ...
              (!this.appOptions.isRestrictedEdit &&
                this.appOptions.isPDFForm &&
                this.appOptions.canDownload) // save to file or save to file copy (for pdf-form viewer)
            ...
            this.appOptions.canSubmitForms =
              ...
              (typeof this.editorConfig.customization.submitForm !== "object" ||
                this.editorConfig.customization.submitForm.visible !== false)
            this.appOptions.canStartFilling =
              this.editorConfig.canStartFilling &&
              this.appOptions.isEdit &&
              this.appOptions.isPDFForm // show Start Filling button in the header
            ...
            this.appOptions.twoLevelHeader =
              ...
              (this.appOptions.isPDFForm &&
                this.appOptions.canFillForms &&
                this.appOptions.isRestrictedEdit) // when compactHeader=true some buttons move to toolbar
            ...
            this.appOptions.canDownloadForms =
              ...
              this.appOptions.isRestrictedEdit &&
              this.appOptions.canFillForms // don't show download form button in edit mode
          ...
          loadCoAuthSettings: function () {
            ...
            if (
              ...
              Common.Utils.InternalSettings.set(
                "de-settings-showchanges-fast",
                Common.localStorage.getItem("de-settings-showchanges-fast") || "none",
              )
              Common.Utils.InternalSettings.set(
                "de-settings-showchanges-strict",
                Common.localStorage.getItem("de-settings-showchanges-strict") || "last",
              )
          ...
          onDocModeApply: function (mode, force, disableModeButton) {
            // force !== true - change mode only if not in view mode, disableModeButton: disable or not DocMode button in the header
            if (!this.appOptions.canSwitchMode && !force) return

            const disable = mode === "view"
            const inViewMode = !!this.stackDisableActions.get({ type: "view" })
            ...
            if (force) {
              ...
              if (mode === "view-form" || !!this.stackDisableActions.get({ type: "forms" })) {
                ...
                forms?.changeViewFormMode(mode === "view-form", true)
              }
              ...
              this.api.asc_setRestriction(
                ...
                this.api.asc_getRestrictionSettings(),
              )
            }
          ...
          applyModeCommonElements: function () {
            ...
            const app = this.getApplication()
            const viewport = app.getController("Viewport").getView("Viewport")
            ...
            let value = Common.localStorage.getItem("de-settings-unit")
            value =
              value !== null
                ? Number.parseInt(value)
          ...
          applyModeEditorElements: function () {
            ...
            if (this.appOptions.isRestrictedEdit) {
              ...
              fontsControllers?.setApi(this.api)
              ...
              const toolbarView = toolbarController ? toolbarController.getView() : null
              if (toolbarView) {
                toolbarView.setApi(this.api)
                toolbarView.on("editcomplete", _.bind(this.onEditComplete, this))
                toolbarView.on("inserttable", _.bind(this.onInsertTable, this))
                toolbarView.on("insertimage", _.bind(this.onInsertImage, this))
                toolbarView.on("insertshape", _.bind(this.onInsertShape, this))
                toolbarView.on("inserttextart", _.bind(this.onInsertTextArt, this))
                toolbarView.on("insertchart", _.bind(this.onInsertChart, this))
                toolbarView.on("insertcontrol", _.bind(this.onInsertControl, this))
              }

              let value = Common.Utils.InternalSettings.get("de-settings-unit")
              ...
              value = Common.localStorage.itemExists("de-hidden-rulers")
                ...
                : this.appOptions.customization && !!this.appOptions.customization.hideRulers
              Common.Utils.InternalSettings.set("de-hidden-rulers", value)
              this.api.asc_SetViewRulers(!value)
            ...
            if (
              this.appOptions.isEdit ||
              (this.appOptions.isRestrictedEdit && this.appOptions.isPDFForm)
            ) {
                  ...
                  setTimeout(() => {
                    new Common.Views.InsertTableDialog({
                      ...
                      handler: (result, value) => {
                        if (result === "ok") {
                          if (this.api) this.api.SplitCell(value.columns, value.rows)
                        }
                        this.onEditComplete()
                      },
                    }).show()
          ...
          hidePreloader: function () {
            ...
            if (!this._state.customizationDone) {
              ...
              if (this.appOptions.canBrandingExt) {
                ...
                if (
                  this.appOptions.customization?.layout?.toolbar &&
                  typeof this.appOptions.customization.layout.toolbar === "object" &&
                  this.appOptions.customization.layout.toolbar.home &&
                  typeof this.appOptions.customization.layout.toolbar.home === "object" &&
                  this.appOptions.customization.layout.toolbar.home.mailmerge === false
                ) {
                  console.log(
                    "Obsolete: The 'mailmerge' parameter of the 'customization.layout.toolbar.home' section is deprecated. Please use 'mailmerge' parameter in the 'customization.layout.toolbar.collaboration' section instead.",
                  )
                  if (this.appOptions.customization.layout.toolbar.collaboration !== false) {
                    if (
                      typeof this.appOptions.customization.layout.toolbar.collaboration !== "object"
                    )
                      this.appOptions.customization.layout.toolbar.collaboration = {}
                    if (
                      this.appOptions.customization.layout.toolbar.collaboration.mailmerge ===
                      undefined
                    )
                      this.appOptions.customization.layout.toolbar.collaboration.mailmerge =
                        this.appOptions.customization.layout.toolbar.home.mailmerge
                  }
                }
          ...
          fillAutoShapes: function (groupNames, shapes) {
            ...
            const shapeStore = this.getCollection("ShapeGroups")
            const name_arr = {}
          ...
          loadLanguages: function (apiLangs) {
            const langs = []
            let info
            const allLangs = Common.util.LanguageInfo.getLanguages()
            for (const code in allLangs) {
              if (allLangs.hasOwnProperty(code)) {
                info = allLangs[code]
                if (info[2]) {
                  const displayName = Common.util.LanguageInfo.getLocalLanguageDisplayName(code)
                  langs.push({
          ...
          setLanguages: function () {
            ...
            sLangs.forEach((lang) => {
              let rec = _.findWhere(this.languages, { value: lang })
              if (!rec) {
                rec = Common.util.LanguageInfo.getDefaultLanguageCode(lang)
                rec &&
                  (rec = _.findWhere(this.languages, {
                    value: Common.util.LanguageInfo.getLocalLanguageName(rec)[0],
                  }))
              }
              if (!rec)
                rec = _.find(
                  this.languages,
                  (item) => item.spellcheck && item.value.indexOf(lang.toLowerCase()) === 0,
                )
              if (!rec)
                rec = _.find(this.languages, (item) => item.value.indexOf(lang.toLowerCase()) === 0)
              rec && arr.push(rec.value)
            })
            sLangs = _.uniq(arr)

            const recentKey = "app-settings-recent-langs"
            const recentCount = Math.max(5, sLangs.length + 3)
          ...
          onPrintQuick: function () {
            ...
            const value = Common.localStorage.getBool("de-hide-quick-print-warning")
            const handler = () => {
          ...
          DisableMailMerge: function () {
            ...
            const reivewController = this.getApplication().getController(
              "Common.Controllers.ReviewChanges",
            )
            reivewController?.DisableMailMerge()
          },
          ...
          onConvertEquationToMath: function (equation) {
            let win
            const msg = `${this.textConvertEquation}<br><br><a id="id-equation-convert-help" style="cursor: pointer;">${this.textLearnMore}</a>`
          ...
          onRunAutostartMacroses: function () {
            const enable =
              !this.editorConfig.customization || this.editorConfig.customization.macros !== false
            if (enable) {
              const value = Common.Utils.InternalSettings.get("de-macros-mode")
          ...
          onMacrosPermissionRequest: function (url, callback) {
            ...
            const value = Common.Utils.InternalSettings.get("de-allow-macros-request")
            if (value > 0) {
              callback?.(value === 1)
          ...
          loadAutoCorrectSettings: function () {
            let value = Common.localStorage.getItem("de-settings-math-correct-add")
            Common.Utils.InternalSettings.set("de-settings-math-correct-add", value)
            let arrAdd = value ? JSON.parse(value) : []
            ...
            let arrRem = value ? JSON.parse(value) : []
            ...
            this.api.asc_SetAutomaticBulletedLists(value)
            ...
            this.api.asc_SetAutomaticNumberedLists(value)
            ...
            this.api.asc_SetAutoCorrectSmartQuotes(value)
            ...
            this.api.asc_SetAutoCorrectHyphensWithDash(value)

            value = Common.localStorage.getItem("de-settings-letter-exception-sentence")
            value =
              value !== null
                ? Number.parseInt(value) !== 0
                : Common.localStorage.getBool("de-settings-autoformat-fl-sentence", true)
            Common.Utils.InternalSettings.set("de-settings-letter-exception-sentence", value)
            this.api.asc_SetAutoCorrectFirstLetterOfSentences(value)

            value = Common.localStorage.getItem("de-settings-letter-exception-cells")
            value =
              value !== null
                ? Number.parseInt(value) !== 0
                : Common.localStorage.getBool("de-settings-autoformat-fl-cells", true)
            Common.Utils.InternalSettings.set("de-settings-letter-exception-cells", value)
            this.api.asc_SetAutoCorrectFirstLetterOfCells(value)
            ;[0x0409, 0x0419].forEach((lang) => {
              const apiFlManager = this.api
              ...
              let arrRes = _.union(apiFlManager.get_Exceptions(lang), arrAdd)
            ...
            this.api.asc_SetAutoCorrectDoubleSpaceWithPeriod(value)
          },
