    ...
    _.extend(
      {
        ...
        setMode: function (mode) {
          ...
          Common.UI.FeaturesManager.isFeatureEnabled("featuresTips", true) &&
            Common.UI.TooltipManager.addTips({
              commentFilter: {
                name: "help-tip-comment-filter",
                placement: "bottom-right",
                text: this.helpCommentFilter,
                header: this.helpCommentFilterHeader,
                target: "#comments-btn-sort",
                maxwidth: 300,
                closable: false,
                isNewFeature: true,
              ...
              multipageViewStatusbar: {
                name: "de-help-tip-multipage-view-statusbar",
                placement: "top-left",
                text: this.helpMultipageView,
                header: this.helpMultipageViewHeader,
                target: "#status-btn-multiple-pages",
                maxwidth: 300,
                automove: true,
                closable: false,
                isNewFeature: true,
              ...
              headerFooterTab: {
                name: "de-help-tip-header-footer-tab",
                placement: "bottom-left",
                text: this.helpHeaderFooterTab,
                header: this.helpHeaderFooterTabHeader,
                target: "li.ribtab #headerfooter",
                maxwidth: 300,
                automove: true,
                closable: false,
                isNewFeature: true,
              ...
              signature: {
                name: "de-help-tip-signature",
                placement: "bottom-right",
                text: this.helpSignature,
                header: this.helpSignatureHeader,
                target: "#slot-btn-form-signature",
                maxwidth: 300,
                automove: true,
                closable: false,
                isNewFeature: true,
        ...
        attachUIEvents: function (toolbar) {
          ...
          toolbar.mnuMarkersPicker.on(
            "item:click",
            _.bind(this.onSelectBullets, this, toolbar.btnMarkers),
          )
          toolbar.mnuNumbersPicker.on(
            "item:click",
            _.bind(this.onSelectBullets, this, toolbar.btnNumbers),
          )
          toolbar.mnuMultilevelPicker.on(
            "item:click",
            _.bind(this.onSelectBullets, this, toolbar.btnMultilevels),
          )
          toolbar.btnMarkers.menu.on(
            "show:after",
            _.bind(this.onListShowAfter, this, 0, toolbar.mnuMarkersPicker),
          )
          toolbar.btnNumbers.menu.on(
            "show:after",
            _.bind(this.onListShowAfter, this, 1, toolbar.mnuNumbersPicker),
          )
          toolbar.btnMultilevels.menu.on(
            "show:after",
            _.bind(this.onListShowAfter, this, 2, toolbar.mnuMultilevelPicker),
          )
          ...
          toolbar.mnuMarkerChangeLevel &&
            toolbar.mnuMarkerChangeLevel.menu &&
            toolbar.mnuMarkerChangeLevel.menu.on(
              "show:after",
              _.bind(this.onChangeLevelShowAfter, this, 0),
            )
          toolbar.mnuMarkerChangeLevel.menu.on(
            "item:click",
            _.bind(this.onChangeLevelClick, this, 0),
          )
          toolbar.mnuNumberChangeLevel &&
            toolbar.mnuNumberChangeLevel.menu &&
            toolbar.mnuNumberChangeLevel.menu.on(
              "show:after",
              _.bind(this.onChangeLevelShowAfter, this, 1),
            )
          toolbar.mnuNumberChangeLevel.menu.on(
            "item:click",
            _.bind(this.onChangeLevelClick, this, 1),
          )
          toolbar.mnuMultiChangeLevel &&
            toolbar.mnuMultiChangeLevel.menu &&
            toolbar.mnuMultiChangeLevel.menu.on(
              "show:after",
              _.bind(this.onChangeLevelShowAfter, this, 2),
            )
          toolbar.mnuMultiChangeLevel.menu.on(
            "item:click",
            _.bind(this.onChangeLevelClick, this, 2),
          )
          ...
          toolbar.btnParagraphColor.on(
            "color:select",
            _.bind(this.onParagraphColorPickerSelect, this),
          )
          ...
          toolbar.mnuHighlightTransparent.on(
            "click",
            _.bind(this.onHighlightTransparentClick, this),
          )
          ...
          Common.NotificationCenter.on(
            "storage:spreadsheet-load",
            _.bind(this.openSpreadsheetFromStorage, this),
          )
          Common.NotificationCenter.on(
            "storage:spreadsheet-insert",
            _.bind(this.insertSpreadsheetFromStorage, this),
          )
        ...
        setApi: function (api) {
          ...
          if (this.mode.isEdit) {
            ...
            this.api.asc_registerCallback(
              "asc_onVerticalAlign",
              _.bind(this.onApiVerticalAlign, this),
            )
            this.api.asc_registerCallback(
              "asc_onCanUndo",
            ...
            this.api.asc_registerCallback(
              "asc_onLockDocumentSchema",
              _.bind(this.onApiLockDocumentSchema, this),
            )
            this.api.asc_registerCallback(
              "asc_onUnLockDocumentSchema",
              _.bind(this.onApiUnLockDocumentSchema, this),
            )
            this.api.asc_registerCallback("asc_onZoomChange", _.bind(this.onApiZoomChange, this))
            this.api.asc_registerCallback(
              "asc_onMarkerFormatChanged",
              _.bind(this.onApiStartHighlight, this),
            )
            this.api.asc_registerCallback(
              "asc_onTextHighLight",
              _.bind(this.onApiHighlightColor, this),
            )
            this.api.asc_registerCallback(
            ...
            this.api.asc_registerCallback(
              "asc_onLineNumbersProps",
              _.bind(this.onLineNumbersProps, this),
            )
            this.api.asc_registerCallback("asc_onContextMenu", _.bind(this.onContextMenu, this))
            this.api.asc_registerCallback("asc_onShowParaMarks", _.bind(this.onShowParaMarks, this))
            this.api.asc_registerCallback(
              "asc_onChangeSdtGlobalSettings",
              _.bind(this.onChangeSdtGlobalSettings, this),
            )
            this.api.asc_registerCallback("asc_onTextLanguage", _.bind(this.onTextLanguage, this))
            Common.NotificationCenter.on("fonts:change", _.bind(this.onApiChangeFont, this))
            this.api.asc_registerCallback(
              "asc_onTableDrawModeChanged",
              _.bind(this.onTableDraw, this),
            )
            this.api.asc_registerCallback(
              "asc_onTableEraseModeChanged",
              _.bind(this.onTableErase, this),
            )
            Common.NotificationCenter.on(
              "storage:image-load",
            ...
            Common.NotificationCenter.on(
              "dropcap:settings",
              _.bind(this.onDropCapAdvancedClick, this),
            )
            this.api.asc_registerCallback(
            ...
            this.api.asc_registerCallback(
              "asc_updateListPatterns",
              _.bind(this.onApiUpdateListPatterns, this),
            )
            this.api.asc_registerCallback(
              "asc_onTextDirection",
              _.bind(this.onApiTextDirection, this),
            )
          } else if (this.mode.isRestrictedEdit) {
            this.api.asc_registerCallback(
              "asc_onFocusObject",
              _.bind(this.onApiFocusObjectRestrictedEdit, this),
            )
            this.api.asc_registerCallback(
              "asc_onCoAuthoringDisconnect",
              _.bind(this.onApiCoAuthoringDisconnect, this),
        ...
        onChangeCompactView: function (view, compact, suppressSave) {
          ...
          var editmode =
            this.mode.isEdit ||
            (this.mode.isRestrictedEdit && this.mode.canFillForms && this.mode.isFormCreator)
          !suppressSave &&
            Common.localStorage.setBool(
              editmode ? "de-compact-toolbar" : "de-view-compact-toolbar",
              compact,
            )
          ...
          if (which == "undo") {
            if (this._state.can_undo !== can) {
              this.toolbar.btnUndo
                ? this.toolbar.lockToolbar(Common.enumLock.undoLock, !can, {
                    array: [this.toolbar.btnUndo],
                  })
                : this.onBtnChangeState("undo:disabled", null, !can)
              this._state.can_undo = can
            }
          } else {
            if (this._state.can_redo !== can) {
              this.toolbar.btnRedo
                ? this.toolbar.lockToolbar(Common.enumLock.redoLock, !can, {
                    array: [this.toolbar.btnRedo],
                  })
                : this.onBtnChangeState("redo:disabled", null, !can)
        ...
        onApiCanCopyCut: function (can) {
          if (this._state.can_copycut !== can) {
            this.toolbar.lockToolbar(Common.enumLock.copyLock, !can, {
              array: [this.toolbar.btnCopy, this.toolbar.btnCut],
            })
        ...
        onApiParagraphAlign: function (v) {
          if (
            ...
            this.api.asc_isRtlTextDirection() !== this._state.rtlDir
          ) {
            this._state.pralign = v
        ...
        onApiLineSpacing: function (vc) {
          var line =
            vc.get_Line() === null || vc.get_LineRule() === null || vc.get_LineRule() != 1
              ? -1
              : vc.get_Line()
              ...
              _.each(
                ...
                (item) => {
                  if (
                    ...
                    Math.abs(item.value[0] - width) < 0.1 &&
                    Math.abs(item.value[1] - height) < 0.1
                  ) {
        ...
        onApiFocusObjectRestrictedEdit: function (selectedObjects) {
          ...
          if (this.btnsComment) {
            ...
            this.toolbar.lockToolbar(Common.enumLock.imageLock, image_locked, {
              array: this.btnsComment,
            })
            this.mode.compatibleFeatures &&
              this.toolbar.lockToolbar(Common.enumLock.inImage, in_image, {
                array: this.btnsComment,
              })
            if (this.api.asc_IsContentControl()) {
              var control_props = this.api.asc_GetContentControlProperties(),
                spectype = control_props
                  ? control_props.get_SpecificType()
                  : Asc.c_oAscContentControlSpecificType.None
              this.toolbar.lockToolbar(
                Common.enumLock.inSpecificForm,
              ...
              this.toolbar.lockToolbar(Common.enumLock.inSpecificForm, false, {
                array: this.btnsComment,
              })
            this.toolbar.lockToolbar(Common.enumLock.paragraphLock, paragraph_locked, {
              array: this.btnsComment,
            })
            this.toolbar.lockToolbar(Common.enumLock.headerLock, header_locked, {
              array: this.btnsComment,
            })
            this.toolbar.lockToolbar(Common.enumLock.richEditLock, rich_edit_lock, {
              array: this.btnsComment,
            })
            this.toolbar.lockToolbar(Common.enumLock.plainEditLock, plain_edit_lock, {
              array: this.btnsComment,
            })
        ...
        onApiFocusObject: function (selectedObjects) {
          ...
          while (++i < selectedObjects.length) {
            ...
            if (type === Asc.c_oAscTypeSelectElement.Paragraph) {
              ...
              if (pr && pr.get_ChartProperties()) in_chart = true
              if (pr && pr.get_ShapeProperties()) shape_pr = pr.get_ShapeProperties()
            } else if (type === Asc.c_oAscTypeSelectElement.Math) {
              in_equation = true
              if (Asc.c_oAscMathInterfaceType.Common === pr.get_Type()) btn_eq_state = true
          ...
          if (sh) this.onParagraphColor(sh)
          ...
          this.toolbar.lockToolbar(Common.enumLock.paragraphLock, paragraph_locked, {
            array: this.toolbar.paragraphControls.concat([
              toolbar.btnContentControls,
              toolbar.btnClearStyle,
            ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.headerLock, header_locked, {
            array: this.toolbar.paragraphControls.concat([
              toolbar.btnContentControls,
              toolbar.btnClearStyle,
              toolbar.btnWatermark,
            ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.richEditLock, rich_edit_lock, {
            array: this.toolbar.paragraphControls.concat([toolbar.btnClearStyle]),
          })
          this.toolbar.lockToolbar(Common.enumLock.plainEditLock, plain_edit_lock, {
            array: this.toolbar.paragraphControls.concat([toolbar.btnClearStyle]),
          })
          ...
          this.toolbar.lockToolbar(Common.enumLock.richDelLock, rich_del_lock, {
            array: toolbar.btnsPageBreak
              ...
              .concat([
                ...
                toolbar.btnInsertChart,
                toolbar.btnInsertTextArt,
                toolbar.btnBlankPage,
                toolbar.btnInsertEquation,
                toolbar.btnInsertSymbol,
              ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.plainDelLock, plain_del_lock, {
            array: toolbar.btnsPageBreak
          ...
          this.toolbar.lockToolbar(Common.enumLock.inChart, in_chart, {
            array: toolbar.textOnlyControls.concat([
              toolbar.btnClearStyle,
              toolbar.btnInsertEquation,
            ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.inSmartart, in_smart_art, {
            array: toolbar.textOnlyControls.concat([
              toolbar.btnClearStyle,
              toolbar.btnContentControls,
            ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.inSmartartInternal, in_smart_art_internal, {
            array: toolbar.textOnlyControls.concat([
              toolbar.btnClearStyle,
              toolbar.btnDecLeftOffset,
              toolbar.btnIncLeftOffset,
              toolbar.btnContentControls,
            ]),
          })
          this.toolbar.lockToolbar(Common.enumLock.inEquation, in_equation, {
            array: toolbar.btnsPageBreak.concat([
              toolbar.btnDropCap,
              toolbar.btnInsertTable,
              toolbar.btnBlankPage,
              toolbar.btnInsertShape,
              toolbar.btnInsertText,
              toolbar.btnInsertTextArt,
              toolbar.btnInsertSmartArt,
              toolbar.btnSuperscript,
          ...
          if (!toolbar.btnContentControls.isDisabled()) {
            ...
            toolbar.btnContentControls.menu.items[8].setDisabled(
              !in_control ||
                lock_type == Asc.c_oAscSdtLockType.SdtContentLocked ||
          ...
          this.toolbar.lockToolbar(Common.enumLock.fixedForm, if_form && if_form.get_Fixed(), {
            array: [
              toolbar.btnAlignLeft,
              toolbar.btnAlignCenter,
              toolbar.btnAlignRight,
              toolbar.btnAlignJust,
              toolbar.btnMarkers,
              toolbar.btnNumbers,
              toolbar.btnMultilevels,
              toolbar.btnDecLeftOffset,
              toolbar.btnIncLeftOffset,
          ...
          if (enable_dropcap && frame_pr) {
            ...
            if (value !== undefined) {
              ...
              enable_dropcap =
                drop_value === Asc.c_oAscDropCap.Drop || drop_value === Asc.c_oAscDropCap.Margin
              disable_dropcapadv = false
            } else {
              enable_dropcap = frame_pr.get_CanAddDropCap()
            }

            if (enable_dropcap) this.onDropCap(drop_value)
          }
          this.toolbar.lockToolbar(Common.enumLock.dropcapLock, !enable_dropcap, {
            array: [toolbar.btnDropCap],
          })
          if (!toolbar.btnDropCap.isDisabled())
            toolbar.mnuDropCapAdvanced.setDisabled(disable_dropcapadv)

          this.toolbar.lockToolbar(Common.enumLock.cantAddTable, !can_add_table, {
            array: [toolbar.btnInsertTable],
          })
          this.toolbar.lockToolbar(Common.enumLock.inHeader, in_header, {
            array: toolbar.btnsPageBreak.concat([toolbar.btnBlankPage, toolbar.btnColumns]),
          })
          this.toolbar.lockToolbar(Common.enumLock.inControl, in_control, {
            array: [toolbar.btnBlankPage],
          })
          this.toolbar.lockToolbar(Common.enumLock.cantPageBreak, in_image && !btn_eq_state, {
            array: toolbar.btnsPageBreak.concat([toolbar.btnBlankPage]),
          })
          ...
          this.toolbar.lockToolbar(Common.enumLock.inFootnote, in_footnote, {
            array: toolbar.btnsPageBreak.concat([
              toolbar.btnBlankPage,
              toolbar.btnInsertShape,
              toolbar.btnInsertText,
          ...
          this.toolbar.lockToolbar(Common.enumLock.cantAddImagePara, in_para && !can_add_image, {
            array: [toolbar.btnInsertTextArt],
          })
          ...
          var need_disable =
            ...
            plain_del_lock ||
            content_locked ||
            (in_para && !can_add_image)
          need_disable = !in_chart && need_disable
          this.toolbar.lockToolbar(Common.enumLock.cantAddChart, need_disable, {
            array: [toolbar.btnInsertChart],
          })
          this.toolbar.lockToolbar(Common.enumLock.chartLock, in_chart && image_locked, {
            array: [toolbar.btnInsertChart],
          })

          this.toolbar.lockToolbar(
            Common.enumLock.cantAddEquation,
            !can_add_image && !in_equation,
            { array: [toolbar.btnInsertEquation] },
          )
          this.toolbar.lockToolbar(Common.enumLock.noParagraphSelected, !in_para, {
            array: [toolbar.btnInsertSymbol, toolbar.btnLineSpace, toolbar.btnBorders],
          })
          this.toolbar.lockToolbar(Common.enumLock.inImage, in_image, {
            array: [toolbar.btnColumns],
          })
          this.toolbar.lockToolbar(Common.enumLock.inImagePara, in_image && in_para, {
            array: [toolbar.btnLineNumbers],
          })

          if (
            toolbar.listStylesAdditionalMenuItem &&
            (frame_pr === undefined) !== toolbar.listStylesAdditionalMenuItem.isDisabled()
          )
          ...
          if (this._state.inheaderfooter !== in_header) {
            if (!in_header && this.toolbar.isTabActive("headerfooter")) this.toolbar.setTab("home")
            ...
            numformat =
              listId !== null
                ? this.api
                    ...
                    .get_Format()
                : Asc.c_oAscNumberingFormat.None
          this.toolbar.btnMarkers.toggle(
            numformat === Asc.c_oAscNumberingFormat.Bullet ||
              (numformat === Asc.c_oAscNumberingFormat.None && listId !== null),
            true,
          )
          this.toolbar.btnNumbers.toggle(
            numformat !== Asc.c_oAscNumberingFormat.None &&
              numformat !== Asc.c_oAscNumberingFormat.Bullet,
            true,
          )
        },
          ...
          if (this._state.lock_doc !== true) {
            this.toolbar.lockToolbar(Common.enumLock.docPropsLock, true, {
              array: [
                ...
                this.toolbar.btnColumns,
                this.toolbar.btnLineNumbers,
                this.toolbar.btnHyphenation,
                this.toolbar.btnPageColor,
              ],
            })
        ...
        onApiLockDocumentSchema: function () {
          this.toolbar.lockToolbar(Common.enumLock.docSchemaLock, true, {
            array: [this.toolbar.btnColorSchemas],
          })
        },

        onApiUnLockDocumentSchema: function () {
          this.toolbar.lockToolbar(Common.enumLock.docSchemaLock, false, {
            array: [this.toolbar.btnColorSchemas],
          })
        },

        onApiZoomChange: (percent, type) => {},
          ...
          if (textpr) {
            ...
            if (c == -1) {
              ...
              if (this._state.clrhighlight != c.get_hex().toUpperCase()) {
                ...
                if (
                  this.toolbar.mnuHighlightColorPicker &&
                  _.contains(this.toolbar.mnuHighlightColorPicker.colors, this._state.clrhighlight)
                )
        ...
        onChangeSdtGlobalSettings: function () {
          ...
          this.toolbar.mnuControlsColorPicker &&
        ...
        onPrintMenu: function (btn, e) {
          ...
          if (newType != oldType) {
            this.toolbar.btnPrint.changeIcon({
              ...
              curr: this.toolbar.btnPrint.menu.getItems().filter((item) => item.value == oldType)[0]
        ...
        tryToSave: function (e) {
          ...
          if (!mode.canSaveToFile) {
            var canDownload = mode.canDownload && (!mode.isDesktopApp || !mode.isOffline),
              saveSopy =
                mode.canDownload &&
                (!mode.isDesktopApp || !mode.isOffline) &&
                (mode.canRequestSaveAs || mode.saveAsUrl),
              saveAs = mode.canDownload && mode.isDesktopApp && mode.isOffline,
              buttons = (
                saveSopy || saveAs ? [{ value: "copy", caption: this.txtSaveCopy }] : []
              ).concat(canDownload ? [{ value: "download", caption: this.txtDownload }] : []),
              primary = saveSopy || saveAs ? "copy" : canDownload ? "download" : "ok"

            if (saveAs) this.api.asc_DownloadAs()
            else if (canDownload) {
            ...
            Common.UI.info({
              ...
              callback: (btn) => {
                if (saveAs && btn === "copy") this.api.asc_DownloadAs()
                else if (btn === "copy" || btn === "download") {
                  this.isFromFormSaveAs = btn === "copy"
                  var options = new Asc.asc_CDownloadOptions(
                    Asc.c_oAscFileType.PDF,
                    this.isFromFormSaveAs,
                  )
            ...
            var isSyncButton =
              toolbar.btnCollabChanges && toolbar.btnCollabChanges.cmpEl.hasClass("notify")
          ...
          toolbar.btnSave &&
            toolbar.lockToolbar(
              ...
              (!mode.forcesave && !mode.canSaveDocumentToBinary && mode.canSaveToFile) ||
                !mode.showSaveButton,
        ...
        onCopyPaste: function (type, e) {
          if (this.api) {
            var res =
              type === "cut" ? this.api.Cut() : type === "copy" ? this.api.Copy() : this.api.Paste()
            if (!res) {
              if (
                !Common.localStorage.getBool("de-hide-copywarning") &&
        ...
        onIncrease: function (e) {
          if (this.api) this.api.FontSizeIn()
        ...
        onDecrease: function (e) {
          if (this.api) this.api.FontSizeOut()
        ...
        onDecOffset: function (btn, e) {
          if (this.api) this.api.DecreaseIndent()
        ...
        onIncOffset: function (btn, e) {
          if (this.api) this.api.IncreaseIndent()
        ...
        onHorizontalAlign: function (type, btn, e) {
          ...
          if (this.api) {
            if (!btn.pressed) {
              if (this._state.rtlDir) type = type == 0 ? 3 : 0
              else type = type == 1 ? 3 : 1
            }
        ...
        onFontSizeSelect: function (combo, record) {
          ...
          if (this.api)
            this.api.put_TextPrFontSize(
              this._state.type_fontsize === "string"
        ...
        onFontSizeChanged: function (before, combo, record, e) {
          ...
          if (before) {
            ...
            if (!item || isNaN(Common.Utils.String.parseFloat(record.value))) {
              this._state.type_fontsize = "number"
            ...
            this._state.fontsize = undefined
            if (this.api) this.api.put_TextPrFontSize(value)
        ...
        showSelectedBulletOnOpen: function (type, picker) {
          ...
          for (var i = 0; i < store.length; i++) {
            ...
            if (
              item.get("type") > 0 &&
              this.api.asc_IsCurrentNumberingPreset(item.get("numberingInfo"), type !== 2)
            ) {
          ...
          if (type === 2) {
            // multilevel
            this.toolbar.mnuMultiChangeLevel &&
              this.toolbar.mnuMultiChangeLevel.setDisabled(
                format === Asc.c_oAscNumberingFormat.None,
              )
          } else if (type === 0) {
            this.toolbar.mnuMarkerChangeLevel &&
              this.toolbar.mnuMarkerChangeLevel.setDisabled(
                !(
                  format === Asc.c_oAscNumberingFormat.Bullet ||
                  (format === Asc.c_oAscNumberingFormat.None && listId !== null)
                ),
              )
          } else {
            this.toolbar.mnuNumberChangeLevel &&
              this.toolbar.mnuNumberChangeLevel.setDisabled(
                format === Asc.c_oAscNumberingFormat.Bullet ||
                  format === Asc.c_oAscNumberingFormat.None,
              )
          }
        ...
        fillDocListPatterns: function (type, picker) {
          ...
          if (!rec && patterns.length > 0)
            picker.groups.add({
              id: picker.options.listSettings.docGroup,
              caption: picker.options.listSettings.docName,
              type: 2,
            })
          else if (rec && patterns.length === 0) picker.groups.remove(rec)
            ...
            if (res) {
              res.then((data) => {
                if (data) {
                  ...
                  this.addListTypeToRecent(picker, { numberingInfo: data })
                }
              })
            }
          }
        ...
        addListTypeToRecent: function (picker, data) {
          if (
            !picker ||
            !data ||
            this.api.asc_CompareNumberingPresets('{"Type":"remove"}', data.numberingInfo)
          )
            return
          ...
          if (!rec) {
            picker.groups.add(
              {
                id: picker.options.listSettings.recentGroup,
                caption: this.toolbar.txtGroupRecent,
                type: 0,
              },
              { at: 0 },
            )
          ...
          picker.store.add(
            {
              ...
              numberingInfo:
                typeof data.numberingInfo === "string"
                  ? data.numberingInfo
                  : JSON.stringify(data.numberingInfo),
              skipRenderOnChange: true,
          ...
          if (recents && recents.length > picker.options.listSettings.recentCount)
            picker.store.remove(
              recents.slice(picker.options.listSettings.recentCount, recents.length),
            )
                ...
                if (result === "ok") {
                  if (this.api) {
                    ...
                    if (!_.isEmpty(checkUrl)) {
                      this.api.asc_insertTextFromUrl(checkUrl)
                    }
                  }
        ...
        onMarkerSettingsClick: function (type) {
          var listId = this.api.asc_GetCurrentNumberingId(),
            level = this.api.asc_GetCurrentNumberingLvl(),
            levelProps = listId === null ? null : this.api.asc_GetNumberingPr(listId),
            format =
              listId === null
                ? Asc.c_oAscNumberingFormat.None
                : levelProps.get_Lvl(level).get_Format(),
            isNew =
              listId === null ||
              (type === 0 &&
                !(
            ...
            picker =
              type === 0
                ? this.toolbar.mnuMarkersPicker
                : type === 1
                  ? this.toolbar.mnuNumbersPicker
                  : this.toolbar.mnuMultilevelPicker
          ...
          if (props) {
            ...
            new DE.Views.ListSettingsDialog({
              ...
              interfaceLang: this.mode.lang,
              handler: (result, value) => {
                if (result == "ok") {
                  if (this.api) {
                    var numberingInfo = props.get_JSONNumbering(type !== 2)
                    isNew
                      ? this.api.put_ListTypeCustom(numberingInfo)
                      : this.api.asc_ChangeNumberingLvl(listId, value.props, value.num)
                    this.addListTypeToRecent(picker, {
                      numberingInfo: JSON.stringify(numberingInfo),
                    })
                  }
                }
                Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        ...
        onChangeLevelShowAfter: function (type, menu) {
          var listId = this.api.asc_GetCurrentNumberingId(),
            level = this.api.asc_GetCurrentNumberingLvl(),
            props = listId !== null ? this.api.asc_GetNumberingPr(listId) : null
          var item = _.find(menu.items, (item) => item.options.level == level)
          menu.clearAll()
        ...
        onLineSpaceToggle: function (menu, item, state, e) {
          if (!!state) {
            ...
            if (this.api) this.api.put_PrLineSpacing(c_paragraphLinerule.LINERULE_AUTO, item.value)
        ...
        onLineSpaceClick: function (menu, item) {
          if (item.value === "options") {
            this.getApplication()
              ...
              .onRightMenuOpen(Common.Utils.documentSettingsType.Paragraph)
            Common.NotificationCenter.trigger("edit:complete", this.toolbar)
          } else if (item.value === "before") {
            item.options.action === "add"
              ? this.api.asc_addSpaceBeforeParagraph()
              : this.api.asc_removeSpaceBeforeParagraph()
          } else if (item.value === "after") {
            item.options.action === "add"
              ? this.api.asc_addSpaceAfterParagraph()
        ...
        onLineSpaceShow: function (menu) {
          if (this.api) {
            ...
            toolbar.mnuLineSpaceBefore.setCaption(
              before ? toolbar.textRemSpaceBefore : toolbar.textAddSpaceBefore,
            )
            toolbar.mnuLineSpaceBefore.options.action = before ? "remove" : "add"
            toolbar.mnuLineSpaceAfter.setCaption(
              after ? toolbar.textRemSpaceAfter : toolbar.textAddSpaceAfter,
            )
        ...
        onApiTextDirection: function (isRtl) {
          ...
          if (oldRtl !== newRtl) {
            ...
            toolbar.btnDecLeftOffset.cmpEl &&
              toolbar.btnDecLeftOffset.cmpEl[newRtl ? "addClass" : "removeClass"]("icon-mirrored")
            toolbar.btnIncLeftOffset.cmpEl &&
              toolbar.btnIncLeftOffset.cmpEl[newRtl ? "addClass" : "removeClass"]("icon-mirrored")
        ...
        onMenuNonPrintingToggle: function (menu, item, state, e) {
          if (item.value === "characters") {
            ...
            this.toolbar.btnShowHidenChars.toggle(state, true)

            if (this.api) this.api.put_ShowParaMarks(state)
            ...
            this.api && this.api.put_ShowTableEmptyLine(state)
            Common.NotificationCenter.trigger("edit:complete", this)
          }
        },
        ...
        onNonPrintingToggle: function (btn, state) {
          if (state) {
            this.toolbar.mnuNonPrinting.items[0].setChecked(true, true)

            Common.component.Analytics.trackEvent("ToolBar", "Hidden Characters")
          } else {
            this.toolbar.mnuNonPrinting.items[0].setChecked(false, true)
          }
            ...
            new DE.Views.TextToTableDialog({
              ...
              handler: (result, value) => {
                if (result == "ok" && this.api) {
                  this.api.asc_ConvertTextToTable(value)
                }
                Common.NotificationCenter.trigger("edit:complete", this.toolbar)
              },
            }).show()
        ...
        onClearStyleClick: function (btn, e) {
          if (this.api) this.api.ClearFormating()

          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        },

        onCopyStyleToggle: function (btn, state, e) {
          if (this.api) this.api.SetPaintFormat(state ? 1 : 0)
          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
          ...
          if (this.api && state) {
            ...
            if (item.value !== "advanced") {
              if (this.checkPageSize(item.value[0], item.value[1])) {
                ...
                return
              } else this.api.change_DocSize(item.value[0], item.value[1])
            } else {
              var win, props
        ...
        checkPageSize: function (width, height, left, right, top, bottom) {
          ...
          var gutterLeft = section.get_GutterAtTop()
              ? 0
              : Number.parseFloat(section.get_Gutter().toFixed(4)),
            gutterTop = section.get_GutterAtTop()
              ? Number.parseFloat(section.get_Gutter().toFixed(4))
              : 0
        ...
        onLineNumbersSelect: function (menu, item) {
          if (_.isUndefined(item.value)) return
          ...
          switch (item.value) {
            ...
            case 3:
              ...
              if (this.api && item.checked) {
                ...
                props.put_Restart(
                  item.value == 1
                    ? Asc.c_oAscLineNumberRestartType.Continuous
                    : item.value == 2
                      ? Asc.c_oAscLineNumberRestartType.NewPage
                      : Asc.c_oAscLineNumberRestartType.NewSection,
                )
            ...
            case 5:
              ...
              win = new DE.Views.LineNumbersDialog({
                applyTo: this._state.linenum_apply,
                handler: (dlg, result) => {
                  if (result == "ok") {
                    var settings = dlg.getSettings()
                    this.api.asc_SetLineNumbersProps(settings.type, settings.props)
                    this._state.linenum_apply = settings.type
                    Common.NotificationCenter.trigger("edit:complete", this.toolbar)
                  }
                },
              })
              win.show()
              win.setSettings(this.api.asc_GetLineNumbersProps())
              break
          }
          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        },
        ...
        onLineNumbersProps: function (props) {
          ...
          if (this._state.linenum === index) return
        ...
        onHyphenationSelect: function (menu, item) {
          ...
          if (item.value === "custom") {
            ...
            win = new DE.Views.HyphenationDialog({
              handler: (dlg, result) => {
                if (result == "ok") {
                  this.api.asc_setAutoHyphenationSettings(dlg.getSettings())
                  Common.NotificationCenter.trigger("edit:complete", this.toolbar)
                }
              },
            })
            win.show()
            this.api && win.setSettings(this.api.asc_getAutoHyphenationSettings())
          } else {
        ...
        onDropCap: function (v) {
          if (this._state.dropcap === v) return
          ...
          if (index < 0) this.toolbar.btnDropCap.menu.clearAll(true)
          else this.toolbar.btnDropCap.menu.items[index].setChecked(true)
        ...
        onDropCapAdvancedClick: function (isFrame) {
          ...
          if (!isFrame && _.isUndefined(this.fontstore)) {
            this.fontstore = new Common.Collections.Fonts()
            var fonts = this.toolbar.cmbFontName.store.toJSON()
            var arr = []
            _.each(fonts, (font, index) => {
          ...
          if (this.api) {
            ...
            if (props) {
              new DE.Views.DropcapSettingsAdvanced({
                ...
                fontStore: !isFrame ? this.fontstore : null,
                paragraphProps: props,
                borderProps: this.borderAdvancedProps,
                api: this.api,
                isFrame: !!isFrame,
                handler: (result, value) => {
                  if (result == "ok") {
                    this.borderAdvancedProps = value.borderProps
                    if (
                      value.paragraphProps &&
                      ((!isFrame &&
                        value.paragraphProps.get_DropCap() === Asc.c_oAscDropCap.None) ||
                        (isFrame && value.paragraphProps.get_Wrap() === c_oAscFrameWrap.None))
                    ) {
                      this.api.removeDropcap(!isFrame)
                    } else this.api.put_FramePr(value.paragraphProps)
                  }
        ...
        onControlsSelect: function (menu, item) {
          ...
          if (item.value == "settings" || item.value == "remove") {
              ...
              if (props) {
                ...
                if (item.value == "settings") {
                  new DE.Views.ControlSettingsDialog({
                    props: props,
                    api: this.api,
                    controlLang: this._state.lang,
                    interfaceLang: this.mode.lang,
                    handler: (result, value) => {
                      if (result == "ok") {
                        this.api.asc_SetContentControlProperties(value, id)
                      }
            ...
            if (item.value == "plain" || item.value == "rich")
              this.api.asc_AddContentControl(
                item.value == "plain"
                  ? Asc.c_oAscSdtLevelType.Inline
                  : Asc.c_oAscSdtLevelType.Block,
              )
            ...
            } else if (item.value == "date") this.api.asc_AddContentControlDatePicker()
        ...
        onNoControlsColor: function (item) {
          ...
          else this.api.asc_SetGlobalContentControlShowHighlight(false)
        },

        onSelectControlsColor: function (picker, color) {
          var clr = Common.Utils.ThemeColor.getRgbColor(color)
          if (this.api) {
            this.api.asc_SetGlobalContentControlShowHighlight(
              true,
              clr.get_r(),
              clr.get_g(),
              clr.get_b(),
        ...
        onColumnsSelect: function (menu, item) {
          ...
          if (this.api) {
            if (item.value == "advanced") {
              ...
              win.show()
              win.setSettings(this.api.asc_GetColumnsProps())
          ...
          if (props) {
            ...
            if (equal && num < 4 && (num == 1 || Math.abs(props.get_Space() - def_space) < 0.1))
              ...
              if (Math.abs(space - def_space) < 0.1) {
                ...
                if (left < right && Math.abs(left - width) < 0.1) index = 3
                else if (left > right && Math.abs(right - width) < 0.1) index = 4
              }
            }
            if (this._state.columns === index) return

            if (index < 0) this.toolbar.btnColumns.menu.clearAll(true)
            else this.toolbar.btnColumns.menu.items[index].setChecked(true)
        ...
        onInsertPageNumberClick: function (picker, item, record, e) {
          ...
          if (e.type !== "click") this.toolbar.btnEditHeader.menu.hide()
        ...
        onInsertPageCountClick: function (item, e) {
          if (this.api) this.api.asc_AddPageCount()
        ...
        onPageNumCurrentPosClick: function (item, e) {
          if (this.api) this.api.put_PageNum(-1)
        ...
        onBtnBlankPageClick: function (btn) {
          if (this.api) this.api.asc_AddBlankPage()
        ...
        onWatermarkSelect: function (menu, item) {
          if (this.api) {
            if (item.value == "remove") this.api.asc_WatermarkRemove()
            else {
              if (_.isUndefined(this.fontstore)) {
                this.fontstore = new Common.Collections.Fonts()
                var fonts = this.toolbar.cmbFontName.store.toJSON()
              ...
              new DE.Views.WatermarkSettingsDialog({
                props: this.api.asc_GetWatermarkProps(),
                api: this.api,
                lang: this.mode.lang,
                disableNetworkFunctionality: this.mode.disableNetworkFunctionality,
                storage:
                  this.mode.canRequestInsertImage ||
                  (this.mode.fileChoiceUrl &&
                    this.mode.fileChoiceUrl.indexOf("{documentType}") > -1),
                fontStore: this.fontstore,
                handler: (result, value) => {
                  if (result == "ok") {
                    this.api.asc_SetWatermarkProps(value)
                  }
                  Common.NotificationCenter.trigger("edit:complete", this.toolbar)
                },
              }).show()
        ...
        onListStyleSelect: function (combo, record) {
          ...
          if (this.api) this.api.put_Style(record.get("title"))
        ...
        onListStyleContextMenu: function (combo, record, e) {
          if (!this.toolbar.mode.canEditStyles) return
          ...
          if (showPoint != undefined) {
            ...
            if (!menu.rendered) {
              if (menuContainer.length < 1) {
                menuContainer = $(
                  '<div id="menu-style-container" style="position: absolute; z-index: 10000;"><div class="dropdown-toggle" data-toggle="dropdown"></div></div>',
                  menu.id,
                )
          ...
          if (this.api) {
            var handlerDlg = (dlg, result) => {
              if (result == "ok") {
                ...
                this.toolbar.lockToolbar(Common.enumLock.noStyles, !window.styles_loaded, {
                  array: [this.toolbar.listStyles],
                })
              }
              Common.NotificationCenter.trigger("edit:complete", this.toolbar)
            }
        ...
        onMenuSaveStyle: function (item, e) {
          if (this.api && !this.toolbar.listStylesAdditionalMenuItem.isDisabled()) {
            this.onSaveStyle(this.api.asc_GetStyleFromFormatting())
          }
        },
        ...
        onSelectFontColor: function (btn, color) {
          ...
          this.toolbar.btnFontColor.setColor(
            typeof color == "object" ? (color.isAuto ? "000" : color.color) : color,
          )

          this.toolbar.mnuFontColorPicker.currentColor = color
          if (this.api)
            this.api.put_TextColor(
        ...
        onSelectPageColor: function (btn, color) {
          if (this.api) this.api.asc_putPageColor(Common.Utils.ThemeColor.getRgbColor(color))

          Common.component.Analytics.trackEvent("ToolBar", "Page Color")
        },

        onPageNoFillClick: function (item) {
          if (this.api && item.checked) this.api.asc_putPageColor(null)
          ...
          if (!_.isUndefined(item.options.borderId)) {
            ...
            if (selectedElements && _.isArray(selectedElements)) {
              for (var i = 0; i < selectedElementsLenght; i++) {
                if (selectedElements[i].get_ObjectType() == Asc.c_oAscTypeSelectElement.Paragraph) {
                  ...
                  selectedElements[i].get_ObjectType() == Asc.c_oAscTypeSelectElement.Table
                ) {
            ...
            if (inTable) {
              ...
              ;["Left", "Top", "Right", "Bottom", "InsideV", "InsideH"].forEach((side) => {
                ...
                if (border) {
                  var currentSize =
                    border.asc_getValue && border.asc_getValue() === 1 ? border.asc_getSize() : 0
              ...
              if (item.options.borderId === "none") {
                ...
                const outerSame = targetBorder.every(
                  (side) =>
              ...
              if (item.options.borderId === "none") {
                ...
                var outerSame = targetBorder.every(
                  (side) =>
                    toleranceError(currentBorder[side].width, bordersWidth) &&
                    compareColors(currentBorder[side].color, bordersColor) &&
                    currentBorder[side].value === borderStyle.asc_getValue(),
        ...
        onBtnFontColor: function () {
          this.toolbar.mnuFontColorPicker.trigger(
            "select",
            this.toolbar.mnuFontColorPicker,
            this.toolbar.mnuFontColorPicker.currentColor,
          )
        },

        onBtnParagraphColor: function () {
          this.toolbar.mnuParagraphColorPicker.trigger(
            "select",
            this.toolbar.mnuParagraphColorPicker,
            this.toolbar.mnuParagraphColorPicker.currentColor,
          )
        },
        ...
        onInsertSymbolClick: function () {
          ...
          if (this.api) {
            var selected = this.api.asc_GetSelectedText()
            this.dlgSymbolTable = new Common.Views.SymbolTableDialog({
              api: this.api,
              lang: this.mode.lang,
              modal: false,
              type: 1,
            ...
            this.dlgSymbolTable.show()
            this.dlgSymbolTable.on("symbol:dblclick", (cmp, result, settings) => {
              this.insertSymbol(
                settings.font,
                settings.code,
                settings.special,
            ...
            this.dlgSymbolTable.on("close", (obj) => {
              Common.NotificationCenter.trigger("edit:complete", this.toolbar)
            })
          }
        },
        ...
        activateControls: function () {
          ...
          this.toolbar.lockToolbar(Common.enumLock.undoLock, this._state.can_undo !== true, {
            array: [this.toolbar.btnUndo],
          })
          this.toolbar.lockToolbar(Common.enumLock.redoLock, this._state.can_redo !== true, {
            array: [this.toolbar.btnRedo],
          })
          this.toolbar.lockToolbar(Common.enumLock.copyLock, this._state.can_copycut !== true, {
            array: [this.toolbar.btnCopy, this.toolbar.btnCut],
          })
        ...
        updateThemeColors: function () {
          var updateColors = (picker, defaultColorIndex) => {
            if (picker) {
              var clr
          ...
          if (
            this.toolbar.btnFontColor.currentColor === undefined ||
            !this.toolbar.btnFontColor.currentColor.isAuto
          ) {
            this.toolbar.btnFontColor.currentColor = this.toolbar.mnuFontColorPicker.currentColor
              ? this.toolbar.mnuFontColorPicker.currentColor.color ||
                this.toolbar.mnuFontColorPicker.currentColor
              : this.toolbar.mnuFontColorPicker.currentColor
          ...
          this.toolbar.btnParagraphColor.currentColor = this.toolbar.mnuParagraphColorPicker
            .currentColor
            ? this.toolbar.mnuParagraphColorPicker.currentColor.color ||
              this.toolbar.mnuParagraphColorPicker.currentColor
            : this.toolbar.mnuParagraphColorPicker.currentColor
          ...
          if (this.toolbar.mnuBorderColorPicker) {
            updateColors(this.toolbar.mnuBorderColorPicker, {
              color: Common.Utils.ThemeColor.getRgbColor("#000000"),
              isAuto: true,
            })
            var currentColor = {
              color: Common.Utils.ThemeColor.getRgbColor("#000000"),
        ...
        _onInitEditorStyles: function (styles) {
          ...
          if (listStyles.menuPicker.store.length > 0 && listStyles.rendered) {
            ...
            if (this._state.prstyle)
              styleRec = listStyles.menuPicker.store.findWhere({ title: this._state.prstyle })
            listStyles.fillComboView(styleRec ? styleRec : listStyles.menuPicker.store.at(0), true)
            Common.NotificationCenter.trigger("edit:complete", this)
          } else if (listStyles.rendered) listStyles.clearComboView()
        ...
        _setMarkerColor: function (strcolor, h) {
          if (h === "menu") {
            this._state.clrhighlight = undefined
            this.onApiHighlightColor()

            this.toolbar.btnHighlightColor.currentColor = strcolor
            this.toolbar.btnHighlightColor.setColor(this.toolbar.btnHighlightColor.currentColor)
            this.toolbar.btnHighlightColor.toggle(true, true)
          }

          strcolor = strcolor || "transparent"

          if (strcolor == "transparent") {
            this.api.SetMarkerFormat(true, false)
          } else {
            var r = strcolor[0] + strcolor[1],
              g = strcolor[2] + strcolor[3],
              b = strcolor[4] + strcolor[5]
            this.api.SetMarkerFormat(
              true,
              true,
        ...
        onSetupCopyStyleButton: function () {
          ...
          Common.NotificationCenter.on({
            "edit:complete": () => {
              if (this.api && this.modeAlwaysSetStyle) {
                this.api.SetPaintFormat(AscCommon.c_oAscFormatPainterState.kOff)
                this.toolbar.btnCopyStyle.toggle(false, true)
                this.modeAlwaysSetStyle = false
              }
          ...
          $(this.toolbar.btnCopyStyle.cmpEl).dblclick(() => {
            if (this.api) {
              ...
              this.api.SetPaintFormat(AscCommon.c_oAscFormatPainterState.kMultiple)
            }
          })
        },
        ...
        DisableToolbar: function (disable, viewMode, reviewmode, fillformmode, viewDocMode) {
          ...
          if (reviewmode) toolbar.lockToolbar(Common.enumLock.previewReviewMode, disable)
          else if (fillformmode) toolbar.lockToolbar(Common.enumLock.viewFormMode, disable)
          else if (viewDocMode) toolbar.lockToolbar(Common.enumLock.viewMode, disable)

          if (disable) {
            if (reviewmode || fillformmode || viewDocMode)
              mask = $("<div class='toolbar-group-mask'>").appendTo(toolbar.$el.find(".toolbar"))
            else mask = $("<div class='toolbar-mask'>").appendTo(toolbar.$el.find(".toolbar"))
          } else {
            mask.remove()
          }
          ...
          disable =
            disable ||
            (reviewmode || fillformmode || viewDocMode
              ? toolbar_mask.length > 0
              : group_mask.length > 0)
              ...
              handler: (result, value) => {
                if (result == "ok") {
                  if (this.api) {
                    var checkUrl = value.replace(/ /g, "")
                    if (!_.isEmpty(checkUrl)) {
                      this.api.asc_StartMailMerge({ fileType: "csv", url: checkUrl })
                    } else {
                      Common.UI.warning({
                        msg: this.textEmptyMMergeUrl,
                      })
                    }
                  }
        ...
        openSpreadsheetFromStorage: function (type) {
          if (this.toolbar.mode.canRequestSelectSpreadsheet) {
            ...
            console.log(
              "Obsolete: The 'onRequestMailMergeRecipients' event is deprecated. Please use 'onRequestSelectSpreadsheet' event instead.",
            )
            Common.Gateway.requestMailMergeRecipients()
          } else {
            this._mailMergeDlg = new Common.Views.SelectFileDlg({
              fileChoiceUrl: this.toolbar.mode.fileChoiceUrl
                .replace("{fileExt}", "xlsx")
                .replace("{documentType}", ""),
            })
            this._mailMergeDlg
              .on("selectfile", (obj, recepients) => {
                recepients && (recepients.c = type)
                this.setRequestedSpreadsheet(recepients)
              })
              .on("close", (obj) => {
                this._mailMergeDlg = undefined
              })
            this._mailMergeDlg.show()
          }
        },
        ...
        insertSpreadsheetFromStorage: function (data) {
          if (data && data.c === "mailmerge") {
            ...
            if (!this.mergeEditor)
              this.mergeEditor = this.getApplication()
                .getController("Common.Controllers.ExternalMergeEditor")
                .getView("Common.Views.ExternalMergeEditor")
            if (this.mergeEditor) this.mergeEditor.setEditMode(false)
          }
        },
        ...
        onAppShowed: function (config) {
          ...
          var editmode =
              config.isEdit ||
              (config.isRestrictedEdit && config.canFillForms && config.isFormCreator),
          ...
          if ($panel) {
            ...
            this.toolbar.setVisible(
              "review",
              (config.isEdit || (config.canCoAuthoring && config.canComments)) &&
                Common.UI.LayoutManager.isElementVisible("toolbar-collaboration"),
            ) // use config.canViewReview in review controller. set visible review tab in view mode only when asc_HaveRevisionsChanges
          }
          ...
          if (config.isEdit) {
            ...
            if ($panel) {
              ...
              Array.prototype.push.apply(this.toolbar.lockControls, drawtab.getView().getButtons())
              Array.prototype.push.apply(
                this.toolbar.paragraphControls,
                drawtab.getView().getButtons(),
              )
            }

            tab = {
              caption: this.toolbar.textTabHeaderFooter,
              action: "headerfooter",
              extcls: config.isEdit ? "canedit" : "",
              layoutname: "toolbar-headerfooter",
              dataHintTitle: "D",
            }
            var headerfootertab = application.getController("HeaderFooterTab")
            headerfootertab.setApi(this.api).setConfig({ toolbar: this, mode: config })
            $panel = headerfootertab.createToolbarPanel()
            if ($panel) {
              var visible = Common.UI.LayoutManager.isElementVisible("toolbar-headerfooter")
              this.toolbar.addTab(tab, $panel, 12)
            }
            Array.prototype.push.apply(
              this.toolbar.lockControls,
              headerfootertab.getView("HeaderFooterTab").getButtons(),
            )
            ...
            if (config.canProtect) {
              ...
              if ($panel) {
                ...
                Array.prototype.push.apply(this.toolbar.lockControls, doctabButtons)
              }
            }

            var links = application.getController("Links")
            links.setApi(this.api).setConfig({ toolbar: this })
            Array.prototype.push.apply(
              this.toolbar.lockControls,
              links.getView("Links").getButtons(),
            )
            ...
            this.getApplication()
              ...
              .setApi(this.api)
            this.toolbar.lockControls.push(
              application
          ...
          if (
            (config.isEdit && config.canFeatureContentControl && config.canFeatureForms) ||
            (config.isRestrictedEdit && config.canFillForms)
          ) {
            if (config.isFormCreator) {
              tab = {
                caption:
                  config.isRestrictedEdit && config.canFillForms && config.isPDFForm
                    ? this.toolbar.textTabHome
                    : this.textTabForms,
                action: "forms",
                dataHintTitle: "M",
              }
              var forms = application.getController("FormsTab")
              forms.setApi(this.api).setConfig({ toolbar: this, config: config })
              ...
              if ($panel) {
                ...
                Array.prototype.push.apply(
                  this.toolbar.lockControls,
                  forms.getView("FormsTab").getButtons(),
                )
                !compactview &&
                  (config.isFormCreator || (config.isRestrictedEdit && config.canFillForms)) &&
                  this.toolbar.setTab("forms")
              }
            }
          }
          config.isEdit && config.canFeatureContentControl && this.onChangeSdtGlobalSettings()
        ...
        onAppReady: function (config) {
          ...
          if (langPrefix === "zh" && lang !== "zh-tw" && lang !== "zh_tw") {
            this._state.type_fontsize = Common.Utils.InternalSettings.get(
              "de-settings-western-font-size",
            )
              ? "number"
              : "string"
          }
          ...
          if (config.canCoAuthoring && config.canComments) {
            this.btnsComment = Common.Utils.injectButtons(
              ...
              [
                Common.enumLock.paragraphLock,
                Common.enumLock.headerLock,
                Common.enumLock.richEditLock,
                Common.enumLock.plainEditLock,
                Common.enumLock.richDelLock,
                Common.enumLock.plainDelLock,
                Common.enumLock.cantAddQuotedComment,
                Common.enumLock.imageLock,
                Common.enumLock.inSpecificForm,
                Common.enumLock.inImage,
                Common.enumLock.lostConnect,
                Common.enumLock.disableOnStart,
                Common.enumLock.previewReviewMode,
                Common.enumLock.viewFormMode,
                Common.enumLock.docLockView,
                Common.enumLock.docLockForms,
                Common.enumLock.viewMode,
              ],
              undefined,
              undefined,
              undefined,
          ...
          new Promise((accept) => {
            ...
            if (config.isEdit) {
              this.controllers.pageLayout = new DE.Controllers.PageLayout({
                id: "ImageLayout",
                application: this.getApplication(),
              })

              this.controllers.pageLayout.onLaunch(this.toolbar).setApi(this.api).onAppReady(config)
            } else if (config.isRestrictedEdit && config.canFillForms && config.isPDFForm) {
              if (this.toolbar.btnHandTool) {
            ...
            config.isOForm &&
              ...
              Common.UI.warning({
                msg:
                  config.canRequestSaveAs || !!config.saveAsUrl || config.isOffline
                    ? this.textConvertFormSave
                    : this.textConvertFormDownload,
                buttons: [
                  {
                    value: "ok",
                    caption:
                      config.canRequestSaveAs || !!config.saveAsUrl || config.isOffline
                        ? this.textSavePdf
                        : this.textDownloadPdf,
                  },
                  "cancel",
                ],
                callback: (btn) => {
                  if (btn === "ok") {
                    this.isFromFormSaveAs = config.canRequestSaveAs || !!config.saveAsUrl
                    var options = new Asc.asc_CDownloadOptions(
                      Asc.c_oAscFileType.PDF,
                      this.isFromFormSaveAs,
                    )
        ...
        onDownloadUrl: function (url, fileType) {
          if (this.isFromFormSaveAs) {
            var defFileName = this.getApplication()
              .getController("Viewport")
              .getView("Common.Views.Header")
              .getDocumentCaption()
        ...
        onChangeProtectDocument: function (props) {
          ...
          if (props) {
            ...
            if (this.api && this.mode) {
              if (this.mode.isEdit) this.onApiFocusObject(this.api.getSelectedElements())
              else if (this.mode.isRestrictedEdit)
        ...
        applySettings: function () {
          if (
            ...
            Common.Utils.InternalSettings.get("de-settings-western-font-size") !== undefined
          ) {
            this.toolbar.cmbFontSize.setData(
              Common.Utils.InternalSettings.get("de-settings-western-font-size")
                ? this.toolbar._fontSizeWestern.concat(this.toolbar._fontSizeChinese)
            ...
            if (this._state.fontsize !== undefined) {
              ...
              this._state.fontsize = undefined
              this.onApiFontSize(Number.parseFloat(oldval))
            }
          }
        },
        ...
        onDocumentReady: function () {
          ...
          if (this.mode.isPDFForm) {
            ...
            if (
              formsTabView &&
              formsTabView.btnSignField &&
              !formsTabView.btnSignField.isDisabled() &&
