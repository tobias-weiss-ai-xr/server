...
define([], () => {
  DE.Views.CellsAddDialog = Common.UI.Window.extend(
    _.extend(
      {
        options: {
          width: 214,
        ...
        getFocusedComponents: function () {
          return [this.cmbRowCol, this.spnCount, this.radioBefore, this.radioAfter].concat(
        ...
        getSettings: function () {
          const row = this.cmbRowCol.getValue() === 0
          return {
            row: row,
