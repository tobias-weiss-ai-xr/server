...
], (contentTemplate, vertTemplate, horTemplate) => {
  DE.Views.ImageSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 340,
        ...
        render: function () {
          ...
          this.spnWidth.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                this._changedProps.put_Width(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
                this._changedProps.put_Height(
                  Common.Utils.Metric.fnRecalcToMM(this.spnHeight.getNumberValue()),
                )
          ...
          this.spnHeight.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                ...
                this._changedProps.put_Width(
                  Common.Utils.Metric.fnRecalcToMM(this.spnWidth.getNumberValue()),
                )
                this._changedProps.put_ResetCrop(false)
              }
            }, this),
          ...
          this.chRatio.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (field.getValue() === "checked" && this.spnShapeHeight.getNumberValue() > 0) {
                this._nRatio =
                  this.spnShapeWidth.getNumberValue() / this.spnShapeHeight.getNumberValue()
              }
              if (this._changedProps) {
          ...
          this.spnShapeWidth.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (
                this.chRatio.getValue() === "checked" &&
                (!this.chRatio.isDisabled() || this._isSmartArt)
              ) {
                let w = field.getNumberValue()
                let h = w / this._nRatio
                if (h > this.sizeMax.height) {
          ...
          this.spnShapeWidthPc.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_SizeRelH() === null ||
                  this._changedProps.get_SizeRelH() === undefined
                )
          ...
          this.spnShapeHeightPc.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_SizeRelV() === null ||
                  this._changedProps.get_SizeRelV() === undefined
                )
          ...
          this._arrHRelativePc = [
            ...
            },
            {
              ...
              size:
                this.sectionProps.get_W() -
                this.sectionProps.get_LeftMargin() -
                this.sectionProps.get_RightMargin(),
            },
            {
          ...
          this._arrVRelativePc = [
            {
              ...
              size:
                this.sectionProps.get_H() -
                this.sectionProps.get_TopMargin() -
                this.sectionProps.get_BottomMargin(),
            },
            {
          ...
          this.spnTop.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_Paddings() === null ||
                  this._changedProps.get_Paddings() === undefined
                )
                  this._changedProps.put_Paddings(new Asc.asc_CPaddings())

                this._changedProps
                  .get_Paddings()
                  .put_Top(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
          ...
          this.spnBottom.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_Paddings()
                  .put_Bottom(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
          ...
          this.spnLeft.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_Paddings()
                  .put_Left(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
          ...
          this.spnRight.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_Paddings()
                  .put_Right(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
          ...
          this.spnX.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_PositionH() === null ||
                  this._changedProps.get_PositionH() === undefined
                )
                ...
                this._changedProps
                  .get_PositionH()
                  .put_Value(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
          ...
          this.spnY.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_PositionV() === null ||
                  this._changedProps.get_PositionV() === undefined
                )
          ...
          this.chMove.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                const value = this._arrVRelative[field.getValue() === "checked" ? 3 : 4].value
                if (this.cmbVRelative.isDisabled()) {
                  this.cmbVPosition.setValue(value)
                  const rec = this.cmbVPosition.getSelectedRecord()
                  if (rec) this.onVPositionSelect(this.cmbVPosition, rec)
                } else {
                  this.cmbVRelative.setValue(value)
                  const rec = this.cmbVRelative.getSelectedRecord()
          ...
          this.spnMarginTop.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (this.Margins === undefined) this.Margins = new Asc.asc_CPaddings()
          ...
          this.chAutofit.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedShapeProps) {
                this._changedShapeProps.asc_putTextFitType(
                  field.getValue() === "checked" ? AscFormat.text_fit_Auto : AscFormat.text_fit_No,
                )
              }
            }, this),
          )
          ...
          for (let i = 0; i < 6; i++) _arrStyles[i].value = i

          for (i = 0; i < 9; i++) _arrSize.push({ value: i, typearrow: "" })
          ...
          this.btnBeginStyle = new Common.UI.ComboBoxDataView({
            ...
            itemTemplate: _.template(
              '<div id="<%= id %>" class="item-arrow img-arrows">' +
          ...
          if (this.isChart) {
            ...
            this.cmbChartTitle = new Common.UI.ComboBox({
              ...
              data: [
                ...
                {
                  value: Asc.c_oAscChartTitleShowSettings.noOverlay,
            ...
            this.cmbLegendPos = new Common.UI.ComboBox({
              ...
              data: [
                ...
                {
                  value: Asc.c_oAscChartLegendShowSettings.bottom,
                  displayValue: this.textLegendBottom,
                },
                { value: Asc.c_oAscChartLegendShowSettings.top, displayValue: this.textLegendTop },
                {
                  value: Asc.c_oAscChartLegendShowSettings.right,
                  displayValue: this.textLegendRight,
                },
                {
                  value: Asc.c_oAscChartLegendShowSettings.left,
                  displayValue: this.textLegendLeft,
                },
                {
                  value: Asc.c_oAscChartLegendShowSettings.leftOverlay,
                  displayValue: this.textLeftOverlay,
                },
                {
                  value: Asc.c_oAscChartLegendShowSettings.rightOverlay,
            ...
            this.cmbDataLabels.on("selected", _.bind(this.onSelectDataLabels, this))
            ...
            this.cmbLines = new Common.UI.ComboBox({
              ...
              _.bind(function (combo, record) {
                if (this.chartSettings) {
                  ...
                  if (record.value > 0) this.chartSettings.putSmooth(record.value === 2)
                }
              }, this),
            )
            ...
            this.chMarkers = new Common.UI.CheckBox({
              ...
              "change",
              _.bind(function (checkbox, state) {
                if (this.chartSettings) this.chartSettings.putShowMarker(state === "checked")
              }, this),
            )
            ...
            this._arrVertTitle = [
              ...
              {
                value: Asc.c_oAscChartVertAxisLabelShowSettings.rotated,
                displayValue: this.textRotated,
              },
              {
                value: Asc.c_oAscChartVertAxisLabelShowSettings.horizontal,
            ...
            this._arrHorTitle = [
              ...
              {
                value: Asc.c_oAscChartHorAxisLabelShowSettings.noOverlay,
                displayValue: this.textNoOverlay,
              },
            ]
          }
        ...
        onCategoryClick: function (btn, index) {
          ...
          setTimeout(() => {
            switch (index) {
              case 0:
                this.cmbChartTitle.focus()
                break
              case 1:
              case 2: {
                index -= 1
                const ctrlIndex = this.vertAxisPropsIndexes[index]
                this.onVCategoryClick(index)
                this.vertAxisProps[index].getAxisType() === Asc.c_oAscAxisType.val
                  ? this.cmbMinType[ctrlIndex].focus()
                  : this.cmbHCrossType[ctrlIndex].isDisabled()
                    ? this.btnHFormat[ctrlIndex].focus()
                    : this.cmbHCrossType[ctrlIndex].focus()
                break
              }
              case 3:
              case 4: {
                index -= 3
                const ctrlIndex = this.horAxisPropsIndexes[index]
                this.onHCategoryClick(index)
                this.horAxisProps[index].getAxisType() === Asc.c_oAscAxisType.val
                  ? this.cmbMinType[ctrlIndex].focus()
                  : this.cmbHCrossType[ctrlIndex].isDisabled()
                    ? this.btnHFormat[ctrlIndex].focus()
                    : this.cmbHCrossType[ctrlIndex].focus()
              ...
              case 5:
                ...
                break
              case 6:
                if (!this.spnShapeWidth.isDisabled()) this.spnShapeWidth.focus()
                else this.spnShapeWidthPc.focus()
                break
              case 7:
                this.spnAngle.focus()
                break
              case 8:
                if (!this.spnTop.isDisabled()) this.spnTop.focus()
                else if (!this.spnLeft.isDisabled()) this.spnLeft.focus()
                else if (!this.btnWrapInline.isDisabled()) this.btnWrapInline.focus()
                break
              case 9:
                if (!this.cmbHAlign.isDisabled()) this.cmbHAlign.focus()
                else if (!this.spnX.isDisabled()) this.spnX.focus()
                else this.spnXPc.focus()
                break
              case 10:
                this.cmbCapType.focus()
                break
              case 11:
                this.chAutofit.focus()
                break
              case 12:
        ...
        afterRender: function () {
          ...
          if (this.storageName) {
            let value = Common.localStorage.getItem(this.storageName)
        ...
        _setDefaults: function (props) {
          ...
          if (props) {
            ...
            let Position = props.get_PositionH()
            if (Position) {
              if (Position.get_UseAlign()) {
                value = Position.get_Align()
                for (let i = 0; i < this._arrHAlign.length; i++) {
                ...
                for (let i = 0; i < this._arrHRelative.length; i++) {
            ...
            this.chOverlap.setValue(
              props.get_AllowOverlap() !== null && props.get_AllowOverlap() !== undefined
                ? props.get_AllowOverlap()
                : "indeterminate",
              true,
            )

            if (props.get_Height() > 0) this._nRatio = props.get_Width() / props.get_Height()

            const shapeprops = props.get_ShapeProperties()
            ...
            if (control_props) {
              const spectype = control_props.get_SpecificType()
              fixed_size =
                ...
                control_props.get_FormPr().get_Fixed()
            }

            this.isShape = !!shapeprops
            this.btnOriginalSize.setVisible(!(this.isShape || this.isChart))
            this.btnOriginalSize.setDisabled(
              props.get_ImageUrl() === null || props.get_ImageUrl() === undefined,
            )
            this.btnsCategory[10].setVisible(
              this.isShape && !shapeprops.get_FromChart() && !fixed_size,
            ) // Shapes
            this.btnsCategory[11].setVisible(
              this.isShape && !shapeprops.get_FromChart() && !fixed_size,
            ) // Margins
            this.btnsCategory[12].setVisible(!fixed_size) // Alt
            this.btnsCategory[7].setVisible(
              !this.isChart && (pluginGuid === null || pluginGuid === undefined),
            ) // Rotation
            this.btnsCategory[8].setDisabled(
              props.get_FromGroup() ||
                (!!control_props &&
            ...
            if (shapeprops) {
              ...
              const sizeRelH = props.get_SizeRelH()
              if (sizeRelH) {
                ...
                for (i = 0; i < this._arrHRelativePc.length; i++) {
                  if (value === this._arrHRelativePc[i].value) {
                    ...
                    this.spnShapeWidth.setValue(
                      Common.Utils.Metric.fnRecalcFromMM(
                        (this._arrHRelativePc[i].size * sizeRelH.get_Value()) / 100,
                      ).toFixed(2),
                      true,
                    )
                ...
                this.spnShapeWidth.setValue(
                  value !== undefined ? Common.Utils.Metric.fnRecalcFromMM(value).toFixed(2) : "",
                  true,
                )
              }

              const sizeRelV = props.get_SizeRelV()
              if (sizeRelV) {
                ...
                for (i = 0; i < this._arrVRelativePc.length; i++) {
                  if (value === this._arrVRelativePc[i].value) {
                    ...
                    this.spnShapeHeight.setValue(
                      Common.Utils.Metric.fnRecalcFromMM(
                        (this._arrVRelativePc[i].size * sizeRelV.get_Value()) / 100,
                      ).toFixed(2),
                      true,
                    )
              ...
              this.chRatio.setDisabled(
                this.radioVSizePc.getValue() || this.radioHSizePc.getValue() || this._isSmartArt,
              )

              const margins = shapeprops.get_paddings()
              if (margins) {
                let val = margins.get_Left()
                this.spnMarginLeft.setValue(
                  null !== val && undefined !== val ? Common.Utils.Metric.fnRecalcFromMM(val) : "",
                  true,
                )
                val = margins.get_Top()
                this.spnMarginTop.setValue(
                  null !== val && undefined !== val ? Common.Utils.Metric.fnRecalcFromMM(val) : "",
                  true,
                )
                val = margins.get_Right()
                this.spnMarginRight.setValue(
                  null !== val && undefined !== val ? Common.Utils.Metric.fnRecalcFromMM(val) : "",
                  true,
                )
                val = margins.get_Bottom()
                this.spnMarginBottom.setValue(
                  null !== val && undefined !== val ? Common.Utils.Metric.fnRecalcFromMM(val) : "",
                  true,
                )
              }
              ...
              this.btnsCategory[10].setDisabled(
                shapeprops.get_stroke().get_type() === Asc.c_oAscStrokeType.STROKE_NONE,
              ) // Weights & Arrows
            ...
            if (!this.isChart) {
              ...
              this.spnAngle.setValue(
                value === undefined || value === null
                  ? ""
                  : Math.floor((value * 180) / Math.PI + 0.5),
                true,
              )
            ...
            Common.UI.FocusManager.add(this, [
              this.spnWidth,
              this.btnRatio,
              this.spnHeight,
              this.btnOriginalSize, // 6 tab
              this.radioHSize,
              this.spnShapeWidth,
              this.spnShapeWidthPc,
              this.radioHSizePc,
              this.cmbWidthPc,
              this.radioVSize,
              this.spnShapeHeight,
              this.spnShapeHeightPc,
              this.radioVSizePc,
              this.cmbHeightPc,
              this.chRatio, // 7 tab
              this.spnAngle,
              this.chFlipHor,
              this.chFlipVert, // 8 tab
              this.btnWrapInline,
              this.btnWrapSquare,
              this.btnWrapTight,
              this.btnWrapThrough,
              this.btnWrapTopBottom,
              this.btnWrapInFront,
              this.btnWrapBehind,
              this.spnTop,
              this.spnLeft,
              ...
              this.cmbVPositionPc,
              this.chMove,
              this.chOverlap, // 10 tab
              this.cmbCapType,
              this.cmbJoinType,
              this.btnBeginStyle,
              this.btnEndStyle,
              this.btnBeginSize,
              this.btnEndSize, // 11 tab
              this.chAutofit,
              this.spnMarginTop,
              this.spnMarginLeft,
              this.spnMarginBottom,
              this.spnMarginRight, // 12 tab
              this.inputAltTitle,
              this.textareaAltDescription,
            ]) // 13 tab
          }
        ...
        getSettings: function () {
          const properties = this._changedProps

          if (this.isShape) {
            properties.put_ShapeProperties(this._changedShapeProps)
            if (this.Margins) {
              if (
                properties.get_ShapeProperties() === null ||
                properties.get_ShapeProperties() === undefined
              )
          ...
          if (
            this._originalProps.get_WrappingStyle() === Asc.c_oAscWrapStyle2.Inline &&
            properties.get_WrappingStyle() !== undefined &&
            properties.get_WrappingStyle() !== Asc.c_oAscWrapStyle2.Inline
          ) {
            if (properties.get_PositionH() === null || properties.get_PositionH() === undefined) {
              ...
              const val = this._originalProps.get_Value_X(Asc.c_oAscRelativeFromH.Column)
          ...
          if (!this.isChart) {
            ...
            this.chartSettings.putSeparator(
              _.isEmpty(this.txtSeparator.getValue()) ? " " : this.txtSeparator.getValue(),
            )

            this.chMarkers.isVisible() &&
            ...
            if (value) {
              ...
              if (value > 0) this.chartSettings.putSmooth(value === 2)
            }
            properties.asc_putChartProperties(this.chartSettings)
          }

          if (this.isAltTitleChanged) properties.asc_putTitle(this.inputAltTitle.getValue())
        ...
        _setShapeDefaults: function (props) {
          if (props) {
            ...
            const stroke = props.get_stroke()
            if (stroke) {
              let value = stroke.get_linejoin()
              for (let i = 0; i < this._arrJoinType.length; i++) {
              ...
              const canchange = stroke.get_canChangeArrows()
              ...
              if (canchange) {
                ...
                let rec = this.mnuBeginSizePicker.store.findWhere({ type: value })
        ...
        _setChartDefaults: function (props) {
          ...
          this.cmbDataLabels.setDisabled(
            this._state.ChartType === Asc.c_oAscChartTypeSettings.surfaceNormal ||
          ...
          const value = props.getSeparator()
          ...
          if (this.vertAxisProps.length > 0) {
            const el = this.$window.find("#id-chart-settings-dlg-vert")
            this.vertAxisPropsIndexes[0] =
              this.vertAxisProps[0].getAxisType() === Asc.c_oAscAxisType.val
                ? this.addControlsV(el)
                : this.addControlsH(el)
          }
          if (this.vertAxisProps.length > 1) {
            const el = this.$window.find("#id-chart-settings-dlg-vert-sec")
            this.vertAxisPropsIndexes[1] =
              this.vertAxisProps[1].getAxisType() === Asc.c_oAscAxisType.val
                ? this.addControlsV(el)
                : this.addControlsH(el)
          }
          ...
          if (this.horAxisProps.length > 0) {
            const el = this.$window.find("#id-chart-settings-dlg-hor")
            this.horAxisPropsIndexes[0] =
              this.horAxisProps[0].getAxisType() === Asc.c_oAscAxisType.val
                ? this.addControlsV(el)
                : this.addControlsH(el)
          }
          if (this.horAxisProps.length > 1) {
            const el = this.$window.find("#id-chart-settings-dlg-hor-sec")
            this.horAxisPropsIndexes[1] =
              this.horAxisProps[1].getAxisType() === Asc.c_oAscAxisType.val
                ? this.addControlsV(el)
                : this.addControlsH(el)
          }
        ...
        onBtnWrapClick: function (btn, e) {
          ...
          if (this._changedProps) this._changedProps.put_WrappingStyle(btn.options.posId)
        },

        _DisableElem: function (btnId) {
          const disabledLR =
            btnId === Asc.c_oAscWrapStyle2.Inline ||
            btnId === Asc.c_oAscWrapStyle2.Behind ||
            btnId === Asc.c_oAscWrapStyle2.InFront ||
            btnId === Asc.c_oAscWrapStyle2.TopAndBottom
          const disabledTB =
            btnId === Asc.c_oAscWrapStyle2.Inline ||
            btnId === Asc.c_oAscWrapStyle2.Behind ||
            btnId === Asc.c_oAscWrapStyle2.InFront ||
            btnId === Asc.c_oAscWrapStyle2.Tight ||
            btnId === Asc.c_oAscWrapStyle2.Through
        ...
        onHPositionSelect: function (combo, record) {
          if (this._changedProps) {
            ...
            if (!this._state.spnXChanged) {
              const val = this._originalProps.get_Value_X(this._state.HPositionFrom)
              this.spnX.setValue(Common.Utils.Metric.fnRecalcFromMM(val), true)
            }
            this._changedProps
              .get_PositionH()
              .put_Value(Common.Utils.Metric.fnRecalcToMM(this.spnX.getNumberValue()))
          }
        },
        ...
        onHPositionPcSelect: function (combo, record) {
          if (this._changedProps) {
            ...
            if (!this._state.spnXPcChanged) {
              const val = this._originalProps.get_Value_X(this._state.HPositionPcFrom)
              this.spnXPc.setValue(
                Number.parseFloat(((100 * val) / this.pageWidth).toFixed(2)),
                true,
              )
            }
        ...
        onVRelativeSelect: function (combo, record) {
          if (this._changedProps) {
            ...
            this.chMove.setValue(
              this._state.VAlignFrom === Asc.c_oAscRelativeFromV.Line ||
                this._state.VAlignFrom === Asc.c_oAscRelativeFromV.Paragraph,
              true,
            )
          }
        },
        ...
        onVPositionSelect: function (combo, record) {
          if (this._changedProps) {
            ...
            if (!this._state.spnYChanged) {
              const val = this._originalProps.get_Value_Y(this._state.VPositionFrom)
              this.spnY.setValue(Common.Utils.Metric.fnRecalcFromMM(val), true)
            }
            this._changedProps
              .get_PositionV()
              .put_Value(Common.Utils.Metric.fnRecalcToMM(this.spnY.getNumberValue()))
            this.chMove.setValue(
              this._state.VPositionFrom === Asc.c_oAscRelativeFromV.Line ||
                this._state.VPositionFrom === Asc.c_oAscRelativeFromV.Paragraph,
              true,
            )
          }
        },
        ...
        onVPositionPcSelect: function (combo, record) {
          if (this._changedProps) {
            ...
            if (!this._state.spnYPcChanged) {
              const val = this._originalProps.get_Value_Y(this._state.VPositionPcFrom)
              this.spnYPc.setValue(
                Number.parseFloat(((100 * val) / this.pageHeight).toFixed(2)),
                true,
              )
            }
        ...
        onRadioHSizeChange: function (field, newValue, eOpts) {
          if (newValue) {
            if (this._changedProps) {
              this._changedProps.put_Width(
                Common.Utils.Metric.fnRecalcToMM(this.spnShapeWidth.getNumberValue()),
              )
        ...
        onRadioVSizeChange: function (field, newValue, eOpts) {
          if (newValue) {
            if (this._changedProps) {
              this._changedProps.put_Height(
                Common.Utils.Metric.fnRecalcToMM(this.spnShapeHeight.getNumberValue()),
              )
        ...
        updateFormControl: function (record) {
          const formcontrol = $(this.el).find(".form-control > .img-arrows use")
          if (formcontrol.length) {
            let str = ""
            if (record) {
              const styleId = record.get("idsvg")
              str =
                styleId !== undefined
                  ? `${styleId}arrow-5`
                  : `${record.get("typearrow")}arrow-${record.get("value") + 1}`
            }
        ...
        onSelectEndStyle: function (combo, picker, view, record, e) {
          ...
          if (this._endSizeIdx === null || this._endSizeIdx === undefined) this._endSizeIdx = 4
        ...
        addControlsV: function (parentEl) {
          const i = this.chVertHide.length
          const el = $(
            _.template(vertTemplate)({
              scope: this,
              idx: i,
            }),
          )
          ...
          this.chVertHide[i] = new Common.UI.CheckBox({
            el: $(`#chart-dlg-chk-vert-hide-${i}`),
            labelText: this.textHideAxis,
          }).on(
            "change",
            _.bind((checkbox, state) => {
              if (this.currentAxisProps[i]) this.currentAxisProps[i].putShow(state !== "checked")
            }, this),
          )
          Common.UI.FocusManager.add(this, this.chVertHide[i])

          this.cmbVertTitle[i] = new Common.UI.ComboBox({
            el: $(`#chart-dlg-combo-vert-title-${i}`),
            menuStyle: "min-width: 100%;",
            editable: false,
            cls: "input-group-nr",
            data: this._arrVertTitle,
            takeFocusOnClose: true,
          }).on(
            "selected",
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) this.currentAxisProps[i].putLabel(record.value)
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVertTitle[i])

          this.cmbVertGrid[i] = new Common.UI.ComboBox({
            ...
            "selected",
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) this.currentAxisProps[i].putGridlines(record.value)
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVertGrid[i])

          this.cmbMinType[i] = new Common.UI.ComboBox({
            ...
            "selected",
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMinValRule(record.value)
                if (record.value === Asc.c_oAscValAxisRule.auto) {
                  this.spnMinValue[i].setValue(this._originalAxisVValues[i].minAuto, true)
                }
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbMinType[i])

          this.spnMinValue[i] = new Common.UI.MetricSpinner({
            ...
            "change",
            _.bind((field, newValue, oldValue) => {
              this.cmbMinType[i].suspendEvents()
              this.cmbMinType[i].setValue(Asc.c_oAscValAxisRule.fixed)
              this.cmbMinType[i].resumeEvents()
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMinValRule(Asc.c_oAscValAxisRule.fixed)
                this.currentAxisProps[i].putMinVal(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnMinValue[i])

          this.cmbMaxType[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMaxValRule(record.value)
                if (record.value === Asc.c_oAscValAxisRule.auto) {
                  this.spnMaxValue[i].setValue(this._originalAxisVValues[i].maxAuto, true)
                }
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbMaxType[i])

          this.spnMaxValue[i] = new Common.UI.MetricSpinner({
            ...
            "change",
            _.bind((field, newValue, oldValue) => {
              this.cmbMaxType[i].suspendEvents()
              this.cmbMaxType[i].setValue(Asc.c_oAscValAxisRule.fixed)
              this.cmbMaxType[i].resumeEvents()
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMaxValRule(Asc.c_oAscValAxisRule.fixed)
                this.currentAxisProps[i].putMaxVal(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnMaxValue[i])

          this.cmbVCrossType[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putCrossesRule(record.value)
                let value
                switch (record.value) {
                  case Asc.c_oAscCrossesRule.minValue:
                    this.spnVAxisCrosses[i].setValue(this.spnMinValue[i].getNumberValue(), true)
                    break
                  case Asc.c_oAscCrossesRule.maxValue:
                    this.spnVAxisCrosses[i].setValue(this.spnMaxValue[i].getNumberValue(), true)
                    break
                  case Asc.c_oAscCrossesRule.auto:
                    this.spnVAxisCrosses[i].setValue(this._originalAxisVValues[i].crossesAuto, true)
                    break
                }
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVCrossType[i])

          this.spnVAxisCrosses[i] = new Common.UI.MetricSpinner({
            ...
            "change",
            _.bind((field, newValue, oldValue) => {
              this.cmbVCrossType[i].suspendEvents()
              this.cmbVCrossType[i].setValue(Asc.c_oAscCrossesRule.value)
              this.cmbVCrossType[i].resumeEvents()
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putCrossesRule(Asc.c_oAscCrossesRule.value)
                this.currentAxisProps[i].putCrosses(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnVAxisCrosses[i])

          this.cmbUnits[i] = new Common.UI.ComboBox({
            ...
            data: [
              ...
              { displayValue: this.textTenThousands, value: Asc.c_oAscValAxUnits.TEN_THOUSANDS },
              {
                ...
                value: Asc.c_oAscValAxUnits.HUNDRED_THOUSANDS,
              },
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putDispUnitsRule(record.value)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbUnits[i])

          this.chVReverse[i] = new Common.UI.CheckBox({
            ...
            _.bind((checkbox, state) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putInvertValOrder(state === "checked")
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.chVReverse[i])

          this.cmbVMajorType[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMajorTickMark(record.value)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVMajorType[i])

          this.cmbVMinorType[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putMinorTickMark(record.value)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVMinorType[i])

          this.cmbVLabelPos[i] = new Common.UI.ComboBox({
            ...
            data: [
              {
                ...
                value: Asc.c_oAscTickLabelsPos.TICK_LABEL_POSITION_NONE,
              },
              {
                displayValue: this.textLow,
                value: Asc.c_oAscTickLabelsPos.TICK_LABEL_POSITION_LOW,
              },
              {
                displayValue: this.textHigh,
                value: Asc.c_oAscTickLabelsPos.TICK_LABEL_POSITION_HIGH,
              },
              {
                displayValue: this.textNextToAxis,
                value: Asc.c_oAscTickLabelsPos.TICK_LABEL_POSITION_NEXT_TO,
              },
            ],
            takeFocusOnClose: true,
          }).on(
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putTickLabelsPos(record.value)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbVLabelPos[i])

          this.btnVFormat[i] = new Common.UI.Button({
            el: $(`#chart-dlg-btn-v-format-${i}`),
          }).on("click", _.bind(this.openFormat, this, i))
          Common.UI.FocusManager.add(this, this.btnVFormat[i])

          this.chVLogScale[i] = new Common.UI.CheckBox({
            el: $(`#chart-dlg-check-v-logscale-${i}`),
            labelText: this.textLogScale,
          }).on(
            "change",
            _.bind((checkbox, state) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putLogScale(state === "checked")
                state === "checked" &&
                  this.currentAxisProps[i].putLogBase(this.spnBase[i].getNumberValue())
              }
              this.spnBase[i].setDisabled(state !== "checked")
            }, this),
          )
          Common.UI.FocusManager.add(this, this.chVLogScale[i])

          this.spnBase[i] = new Common.UI.MetricSpinner({
            ...
            _.bind((field, newValue, oldValue) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putLogBase(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnBase[i])

          return i
        },

        addControlsH: function (parentEl) {
          const i = this.chHorHide.length
          const el = $(
            _.template(horTemplate)({
              scope: this,
              idx: i,
            }),
          )
          ...
          this.chHorHide[i] = new Common.UI.CheckBox({
          ...
          Common.UI.FocusManager.add(this, this.chHorHide[i])

          this.cmbHorTitle[i] = new Common.UI.ComboBox({
            el: $(`#chart-dlg-combo-hor-title-${i}`),
            menuStyle: "min-width: 100%;",
            editable: false,
            cls: "input-group-nr",
            data: this._arrHorTitle,
            takeFocusOnClose: true,
          }).on(
            "selected",
            _.bind((combo, record) => {
          ...
          Common.UI.FocusManager.add(this, this.cmbHorTitle[i])

          this.cmbHorGrid[i] = new Common.UI.ComboBox({
          ...
          Common.UI.FocusManager.add(this, this.cmbHorGrid[i])

          this.cmbHCrossType[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                ...
                if (record.value === Asc.c_oAscCrossesRule.auto) {
                  this.spnHAxisCrosses[i].setValue(this._originalAxisHValues[i].crossesAuto, true)
                } else if (record.value === Asc.c_oAscCrossesRule.minValue) {
                  this.spnHAxisCrosses[i].setValue(this._originalAxisHValues[i].minAuto, true)
                } else if (record.value === Asc.c_oAscCrossesRule.maxValue) {
                  this.spnHAxisCrosses[i].setValue(this._originalAxisHValues[i].maxAuto, true)
                }
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbHCrossType[i])

          this.spnHAxisCrosses[i] = new Common.UI.MetricSpinner({
            ...
            "change",
            _.bind((field, newValue, oldValue) => {
              this.cmbHCrossType[i].suspendEvents()
              this.cmbHCrossType[i].setValue(Asc.c_oAscCrossesRule.value)
              this.cmbHCrossType[i].resumeEvents()
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putCrossesRule(Asc.c_oAscCrossesRule.value)
                this.currentAxisProps[i].putCrosses(field.getNumberValue())
              }
          ...
          Common.UI.FocusManager.add(this, this.spnHAxisCrosses[i])

          this.cmbAxisPos[i] = new Common.UI.ComboBox({
            ...
            data: [
              { displayValue: this.textOnTickMarks, value: Asc.c_oAscLabelsPosition.byDivisions },
              {
                ...
                value: Asc.c_oAscLabelsPosition.betweenDivisions,
              },
            ],
            takeFocusOnClose: true,
          }).on(
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putLabelsPosition(record.value)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbAxisPos[i])

          this.chHReverse[i] = new Common.UI.CheckBox({
            ...
            _.bind((checkbox, state) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putInvertCatOrder(state === "checked")
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.chHReverse[i])

          this.cmbHMajorType[i] = new Common.UI.ComboBox({
          ...
          Common.UI.FocusManager.add(this, this.cmbHMajorType[i])

          this.cmbHMinorType[i] = new Common.UI.ComboBox({
          ...
          Common.UI.FocusManager.add(this, this.cmbHMinorType[i])

          this.spnMarksInterval[i] = new Common.UI.MetricSpinner({
            ...
            _.bind((field, newValue, oldValue) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putIntervalBetweenTick(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnMarksInterval[i])

          this.cmbHLabelPos[i] = new Common.UI.ComboBox({
          ...
          Common.UI.FocusManager.add(this, this.cmbHLabelPos[i])

          this.spnLabelDist[i] = new Common.UI.MetricSpinner({
            ...
            _.bind((field, newValue, oldValue) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putLabelsAxisDistance(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnLabelDist[i])

          this.spnLabelInterval[i] = new Common.UI.MetricSpinner({
            ...
            "change",
            _.bind((field, newValue, oldValue) => {
              this.cmbLabelInterval[i].suspendEvents()
              this.cmbLabelInterval[i].setValue(Asc.c_oAscBetweenLabelsRule.manual)
              this.cmbLabelInterval[i].resumeEvents()
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putIntervalBetweenLabelsRule(
                  Asc.c_oAscBetweenLabelsRule.manual,
                )
                this.currentAxisProps[i].putIntervalBetweenLabels(field.getNumberValue())
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.spnLabelInterval[i])

          this.cmbLabelInterval[i] = new Common.UI.ComboBox({
            ...
            _.bind((combo, record) => {
              if (this.currentAxisProps[i]) {
                this.currentAxisProps[i].putIntervalBetweenLabelsRule(record.value)
                if (record.value === Asc.c_oAscBetweenLabelsRule.auto)
                  this.spnLabelInterval[i].setValue(1, true)
              }
            }, this),
          )
          Common.UI.FocusManager.add(this, this.cmbLabelInterval[i])

          this.btnHFormat[i] = new Common.UI.Button({
            el: $(`#chart-dlg-btn-h-format-${i}`),
          }).on("click", _.bind(this.openFormat, this, i))
          Common.UI.FocusManager.add(this, this.btnHFormat[i])
        ...
        updateAxisProps: function (type, isDefault) {
          ...
          if (value) {
            ...
            this.cmbLines.setValue(
              this.chartSettings.getLine() ? (this.chartSettings.getSmooth() ? 2 : 1) : 0,
            )
          }
          ...
          for (let i = 0; i < this.cmbAxisPos.length; i++) this.cmbAxisPos[i].setDisabled(value)
        },
        ...
        updateDataLabels: function (chartType, labelPos) {
          if (chartType !== this.currentChartType) {
            ...
            if (
              ...
              chartType === Asc.c_oAscChartTypeSettings.barStacked ||
              ...
              chartType === Asc.c_oAscChartTypeSettings.lineNormal ||
              chartType === Asc.c_oAscChartTypeSettings.lineStacked ||
              chartType === Asc.c_oAscChartTypeSettings.lineStackedPer ||
              chartType === Asc.c_oAscChartTypeSettings.lineNormalMarker ||
              chartType === Asc.c_oAscChartTypeSettings.lineStackedMarker ||
              chartType === Asc.c_oAscChartTypeSettings.lineStackedPerMarker ||
              chartType === Asc.c_oAscChartTypeSettings.stock ||
              chartType === Asc.c_oAscChartTypeSettings.scatter ||
              chartType === Asc.c_oAscChartTypeSettings.scatterSmoothMarker ||
              chartType === Asc.c_oAscChartTypeSettings.scatterSmooth ||
              chartType === Asc.c_oAscChartTypeSettings.scatterLineMarker ||
              chartType === Asc.c_oAscChartTypeSettings.scatterLine
            )
              data.push(
                { value: Asc.c_oAscChartDataLabelsPos.l, displayValue: this.textLeft },
              ...
              data.push(
                { value: Asc.c_oAscChartDataLabelsPos.bestFit, displayValue: this.textFit },
                { value: Asc.c_oAscChartDataLabelsPos.inEnd, displayValue: this.textInnerTop },
                { value: Asc.c_oAscChartDataLabelsPos.outEnd, displayValue: this.textOuterTop },
              )
          ...
          if (labelPos !== undefined) {
            const rec = this.cmbDataLabels.store.findWhere({ value: labelPos })
            if (!rec) labelPos = Asc.c_oAscChartDataLabelsPos.ctr
          } else labelPos = Asc.c_oAscChartDataLabelsPos.none
        ...
        onVCategoryClick: function (index) {
          this.vertAxisProps[index].getAxisType() === Asc.c_oAscAxisType.val
            ? this.fillVProps(this.vertAxisProps[index], this.vertAxisPropsIndexes[index])
            : this.fillHProps(this.vertAxisProps[index], this.vertAxisPropsIndexes[index], true)
        },

        onHCategoryClick: function (index) {
          this.horAxisProps[index].getAxisType() === Asc.c_oAscAxisType.val
            ? this.fillVProps(this.horAxisProps[index], this.horAxisPropsIndexes[index], true)
            : this.fillHProps(this.horAxisProps[index], this.horAxisPropsIndexes[index])
        },

        fillVProps: function (props, index, hor) {
          if (props.getAxisType() !== Asc.c_oAscAxisType.val) return
          if (this._originalAxisVValues === undefined) this._originalAxisVValues = []
          ...
          let value =
            props.getMinValRule() === Asc.c_oAscValAxisRule.auto
              ? this._originalAxisVValues[index].minAuto
              : props.getMinVal()
          this.spnMinValue[index].setValue(value == null ? "" : value, true)

          this.cmbMaxType[index].setValue(props.getMaxValRule())
          value =
            props.getMaxValRule() === Asc.c_oAscValAxisRule.auto
              ? this._originalAxisVValues[index].maxAuto
              : props.getMaxVal()
        ...
        fillHProps: function (props, index, vert) {
          ...
          if (this._originalAxisHValues === undefined) this._originalAxisHValues = []
          ...
          let value = props.getCrossesRule()
          ...
          this.spnLabelInterval[index].setValue(
            value === Asc.c_oAscBetweenLabelsRule.manual ? props.getIntervalBetweenLabels() : 1,
            true,
          )
        ...
        onSelectDataLabels: function (obj, rec, e) {
          const disable = rec.value === Asc.c_oAscChartDataLabelsPos.none
          ...
          if (
            !disable &&
            this.chSeriesName.getValue() !== "checked" &&
            this.chCategoryName.getValue() !== "checked" &&
        ...
        openFormat: function (index, btn) {
          const props = this.currentAxisProps[index]
          const fmt = props.getNumFmt()
          const lang = Common.Utils.InternalSettings.get("de-config-lang")

          const win = new Common.Views.FormatSettingsDialog({
            api: this.api,
            handler: (result, settings) => {
              if (result === "ok" && settings) {
                ...
                this._isEditFormat = false
              }
            },
            linked: true,
            props: {
              format: fmt.getFormatCode(),
              formatInfo: fmt.getFormatCellsInfo(),
              langId: lang,
              chartFormat: fmt,
            },
          }).on("close", () => {
            this._isEditFormat && this.chartSettings.cancelEditData()
            this._isEditFormat = false
            btn.focus()
          })
          this._isEditFormat = true
