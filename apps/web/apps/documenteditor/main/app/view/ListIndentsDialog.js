...
define([], () => {
  DE.Views.ListIndentsDialog = Common.UI.Window.extend(
    _.extend(
      {
        options: {
          width: 305,
        ...
        render: function () {
          ...
          this.spnAlign.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_NumberPosition(
          ...
          this.spnIndents.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_IndentSize(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
              }
            }, this),
          ...
          this.cmbFollow.on(
            ...
            _.bind(function (combo, record) {
              if (this._changedProps) this._changedProps.put_Suff(record.value)
            }, this),
          )
        ...
        _setDefaults: function (props) {
          if (props) {
            this.spnAlign.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.get_NumberPosition()),
              true,
            )
            this.spnIndents.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.get_IndentSize()),
              true,
            )
