...
define([
  ...
  DE.Views.Navigation = Common.UI.BaseView.extend(
    _.extend(
      {
        ...
        render: function (el) {
          ...
          const isWrap = Common.localStorage.getBool("de-outline-wrap", true)
          let fontSizeClass = Common.localStorage.getItem("de-outline-fontsize")
        ...
        changeWrapHeadings: function () {
          ...
          else this.viewNavigationList.$el.addClass("wrap")
        },
        ...
        txtEmpty:
          "There are no headings in the document.<br>Apply a heading style to the text so that it appears in the table of contents.",
