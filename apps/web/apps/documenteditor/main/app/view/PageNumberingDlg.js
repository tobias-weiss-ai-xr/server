...
define([], () => {
  ...
  DE.Views.PageNumberingDlg = Common.UI.Window.extend(
    _.extend(
      {
        initialize: function (options) {
          ...
          this.template =
            ...
            [
              ...
              `<div id="id-headerfooter-radio-from" style="margin-bottom: 8px; display: inline-block; vertical-align: middle;"></div><div id="id-headerfooter-spin-from" style="margin-bottom: 8px; display: inline-block; vertical-align: middle; margin-left: 5px;"></div></div><label id="id-headerfooter-label-format" class="input-label">${this.textNumberFormat}</label><div id="id-headerfooter-combo-format"></div></div>`,
            ].join("")
        ...
        addNewListType: function () {
          ...
          const win = new DE.Views.ListTypesAdvanced({
            ...
            btn !== "ok" && this.cmbFormat.setValue(this.numFormat)
            setTimeout(() => {
              this.cmbFormat.focus()
            }, 1)
          })
          win.show()
        },
        ...
        getFocusedComponents: function () {
          return [this.rbPrev, this.rbFrom, this.numFrom, this.cmbFormat].concat(
            this.getFooterButtons(),
          )
        },
          ...
          if (this.handler) {
            if (state === "ok") {
              if (this.rbPrev.getValue()) {
                ...
                this.from = +this.numFrom.getValue()
              }
              this.format = +this.cmbFormat.getValue()
            }
            this.handler.call(this, state, this.from, this.format)
          }
