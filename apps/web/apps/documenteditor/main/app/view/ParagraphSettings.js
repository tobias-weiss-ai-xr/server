...
define([
  ...
  DE.Views.ParagraphSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        render: function () {
          ...
          this.numLineHeight.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
          this.numSpacingBefore.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
          this.numSpacingAfter.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
          ...
          this.numIndentsLeft.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
          this.numIndentsRight.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
          this.numSpecialBy.on("inputleave", () => {
            this.fireEvent("editcomplete", this)
          })
        ...
        setApi: function (api) {
          ...
          if (this.api) {
            this.api.asc_registerCallback(
              ...
              _.bind(this._onLineSpacing, this),
            )
          }
          return this
        },
        ...
        onNumLineHeightChange: function (field, newValue, oldValue, eOpts) {
          ...
          const type = c_paragraphLinerule.LINERULE_AUTO
          if (this.api)
            this.api.put_PrLineSpacing(
              this.cmbLineRule.getValue(),
        ...
        onAddIntervalChange: function (field, newValue, oldValue, eOpts) {
          if (this.api) this.api.put_AddSpaceBetweenPrg(field.getValue() === "checked")
          this.fireEvent("editcomplete", this)
        },

        onLineRuleSelect: function (combo, record) {
          if (this.api) this.api.put_PrLineSpacing(record.value, record.defaultValue)
        ...
        _onLineSpacing: function (value) {
          const linerule = value.get_LineRule()
          const line = value.get_Line()

          if (this._state.LineRuleIdx !== linerule) {
            this.cmbLineRule.setValue(linerule !== null ? this._arrLineRule[linerule].value : "")
            this.numLineHeight.setMinValue(
              this._arrLineRule[linerule !== null ? linerule : 1].minValue,
            )
            this.numLineHeight.setDefaultUnit(
              this._arrLineRule[linerule !== null ? linerule : 1].defaultUnit,
            )
          ...
          if (
            Math.abs(this._state.LineHeight - line) > 0.001 ||
        ...
        onSpecialSelect: function (combo, record) {
          ...
          let specialBy =
            special === c_paragraphSpecial.NONE_SPECIAL ? 0 : this.numSpecialBy.getNumberValue()
          ...
          if (specialBy < 0 || this._state.FirstLine < 0) {
            const left = this._state.LeftIndent
        ...
        onFirstLineChange: function (field, newValue, oldValue, eOpts) {
          let specialBy = Common.Utils.Metric.fnRecalcToMM(field.getNumberValue())
        ...
        ChangeSettings: function (prop) {
          ...
          if (prop) {
            ...
            if (this._state.LineRuleIdx !== Spacing.LineRule) {
              this.cmbLineRule.setValue(
                Spacing.LineRule !== null ? this._arrLineRule[Spacing.LineRule].value : "",
              )
              this.numLineHeight.setMinValue(
                this._arrLineRule[Spacing.LineRule !== null ? Spacing.LineRule : 1].minValue,
              )
              this.numLineHeight.setDefaultUnit(
                this._arrLineRule[Spacing.LineRule !== null ? Spacing.LineRule : 1].defaultUnit,
              )
              this.numLineHeight.setStep(
                this._arrLineRule[Spacing.LineRule !== null ? Spacing.LineRule : 1].step,
              )
            ...
            if (
              Math.abs(this._state.LineHeight - Spacing.Line) > 0.001 ||
              ((this._state.LineHeight === null || Spacing.Line === null) &&
            ...
            if (
              Math.abs(this._state.LineSpacingBefore - Spacing.Before) > 0.001 ||
              ((this._state.LineSpacingBefore === null || Spacing.Before === null) &&
              ...
              this.numSpacingBefore.setValue(
                Spacing.Before !== null
                  ? Spacing.Before < 0
                    ? Spacing.Before
                    : Common.Utils.Metric.fnRecalcFromMM(Spacing.Before)
                  : "",
                true,
              )
              this._state.LineSpacingBefore = Spacing.Before
            ...
            if (
              Math.abs(this._state.LineSpacingAfter - Spacing.After) > 0.001 ||
              ((this._state.LineSpacingAfter === null || Spacing.After === null) &&
              ...
              this.numSpacingAfter.setValue(
                Spacing.After !== null
                  ? Spacing.After < 0
                    ? Spacing.After
                    : Common.Utils.Metric.fnRecalcFromMM(Spacing.After)
                  : "",
                true,
              )
              this._state.LineSpacingAfter = Spacing.After
            ...
            if (this._state.AddInterval !== other.ContextualSpacing) {
              this.chAddInterval.setValue(
                other.ContextualSpacing !== null && other.ContextualSpacing !== undefined
            ...
            let left = indents !== null ? indents.get_Left() : null
            if (first < 0 && left !== null) left = left + first
            if (
              Math.abs(this._state.LeftIndent - left) > 0.001 ||
              ((this._state.LeftIndent === null || left === null) &&
            ...
            if (
              Math.abs(this._state.FirstLine - first) > 0.001 ||
              ((this._state.FirstLine === null || first === null) &&
                this._state.FirstLine !== first)
            ) {
              this.numSpecialBy.setValue(
                first !== null ? Math.abs(Common.Utils.Metric.fnRecalcFromMM(first)) : "",
                true,
              )
              this._state.FirstLine = first
            }

            let value = indents !== null ? indents.get_Right() : null
            if (
              Math.abs(this._state.RightIndent - value) > 0.001 ||
              ((this._state.RightIndent === null || value === null) &&
            ...
            if (shd !== null && shd !== undefined && shd.get_Value() === Asc.c_oAscShdClear) {
              ...
              if (color) {
                if (color.get_type() === Asc.c_oAscColor.COLOR_TYPE_SCHEME) {
                  ...
                  this.BackColor = Common.Utils.ThemeColor.getHexColor(
                    color.get_r(),
                    color.get_g(),
                    color.get_b(),
                  )
                }
              } else this.BackColor = "transparent"
            } else {
              this.BackColor = "transparent"
            }

            const type1 = typeof this.BackColor
            const type2 = typeof this._state.BackColor
            if (
              type1 !== type2 ||
              (type1 === "object" &&
                (this.BackColor.effectValue !== this._state.BackColor.effectValue ||
                  this._state.BackColor.color.indexOf(this.BackColor.color) < 0)) ||
        ...
        updateMetricUnit: function () {
          if (this.spinners) {
            for (let i = 0; i < this.spinners.length; i++) {
              ...
              if (
                ...
                spinner.el.id === "paragraph-spin-spacing-before" ||
                spinner.el.id === "paragraph-spin-spacing-after"
              )
                spinner.setStep(
          ...
          if (this._state.LineRuleIdx !== null) {
            this.numLineHeight.setDefaultUnit(
              this._arrLineRule[this._state.LineRuleIdx].defaultUnit,
            )
          ...
          let val = this._state.LineSpacingBefore
          this.numSpacingBefore?.setValue(
            val !== null ? (val < 0 ? val : Common.Utils.Metric.fnRecalcFromMM(val)) : "",
            true,
          )
                ...
                if (Asc.c_oAscTypeSelectElement.Paragraph === elType) {
                  if (Common.Utils.checkComponentLoaded(DE.Views.ParagraphSettingsAdvanced))
                    new DE.Views.ParagraphSettingsAdvanced({
                      ...
                      isSmartArtInternal: this.isSmartArtInternal,
                      api: this.api,
        ...
        UpdateThemeColors: function () {
          ...
          this.mnuColorPicker.updateColors(
