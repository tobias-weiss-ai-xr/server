...
define([
  ...
  DE.Views.ParagraphSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 370,
        ...
        initialize: function (options) {
          ...
          this._arrTabAlign.forEach((item) => {
            this._arrKeyTabAlign[item.value] = item.displayValue
          })
          ...
          this._arrTabLeader.forEach((item) => {
            this._arrKeyTabLeader[item.value] = item.displayValue
          })
        },
        ...
        render: function () {
          ...
          this.numIndentsLeft.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.get_Ind() === null ||
                  this._changedProps.get_Ind() === undefined
                )
          ...
          this.numSpacingBefore.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this.Spacing === null) {
                const properties = this._originalProps
                  ? this._originalProps
                  : new Asc.asc_CParagraphProperty()
          ...
          const rec = this.cmbBorderSize.store.at(2)
          ...
          const _arrBorderPresets = [
            [
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-outer",
              "paragraphadv-button-border-outer",
              this.tipOuter,
            ],
            [
              "lrtbm",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-all",
              "paragraphadv-button-border-all",
              this.tipAll,
            ],
            [
              "",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-none",
              "paragraphadv-button-border-none",
              this.tipNone,
            ],
            [
              "l",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-left",
              "paragraphadv-button-border-left",
              this.tipLeft,
            ],
            [
              "r",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-right",
              "paragraphadv-button-border-right",
              this.tipRight,
            ],
            [
              "t",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-top",
              "paragraphadv-button-border-top",
              this.tipTop,
            ],
            [
              "m",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-inner",
              "paragraphadv-button-border-inner-hor",
              this.tipInner,
            ],
            [
              "b",
              "toolbar__icon toolbar__icon-big btn-paragraph-borders-bottom",
              "paragraphadv-button-border-bottom",
              this.tipBottom,
            ],
          ]
          ...
          this.numSpacing.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_TextSpacing(
          ...
          this.numPosition.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_Position(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
              }
              if (this.api && !this._noApply) {
          ...
          this._arrLigatures = [
            ...
            {
              displayValue: this.textStandardHistorical,
              value: Asc.LigaturesType.StandardHistorical,
            },
            {
              displayValue: this.textContextHistorical,
              value: Asc.LigaturesType.ContextualHistorical,
            },
            {
              displayValue: this.textStandardDiscret,
              value: Asc.LigaturesType.StandardDiscretional,
            },
            {
              displayValue: this.textContextDiscret,
              value: Asc.LigaturesType.ContextualDiscretional,
            },
            {
              displayValue: this.textHistoricalDiscret,
              value: Asc.LigaturesType.HistoricalDiscretional,
            },
            {
              displayValue: this.textStandardContextHist,
              value: Asc.LigaturesType.StandardContextualHistorical,
            },
            {
              displayValue: this.textStandardContextDiscret,
              value: Asc.LigaturesType.StandardContextualDiscretional,
            },
            {
              displayValue: this.textStandardHistDiscret,
              value: Asc.LigaturesType.StandardHistoricalDiscretional,
            },
            {
              displayValue: this.textContextHistDiscret,
              value: Asc.LigaturesType.ContextualHistoricalDiscretional,
            },
          ...
          this.numDefaultTab.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_DefaultTab(
                  Number.parseFloat(
                    Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()).toFixed(1),
                  ),
                )
              }
            }, this),
          ...
          this.tabList.store.comparator = (rec) => rec.get("tabPos")
          this.tabList.on("item:select", _.bind(this.onSelectTab, this))

          const storechanged = () => {
            if (!this._noApply) this._tabListChanged = true
          }
          ...
          this.cmbLeader = new Common.UI.ComboBoxCustom({
            ...
            updateFormControl: function (record) {
              this._input?.toggleClass(
                "font-sans-serif",
                record.get("value") !== Asc.c_oAscTabLeader.None,
              )
            },
            takeFocusOnClose: true,
          })
          ...
          this.spnMarginTop.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (!this._noApply) {
                if (this.Margins === undefined) this.Margins = {}
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.chOrphan,
              this.chKeepNext,
              this.chLineNumbers, // 1 tab
              this.cmbBorderSize,
              this.btnBorderColor,
            ])
            .concat(this._btnsBorderPosition)
            .concat([
              this.btnBackColor, // 2 tab
              this.chStrike,
              this.chSubscript,
              this.chDoubleStrike,
              this.chSmallCaps,
              ...
              this.btnAddTab,
              this.btnRemoveTab,
              this.btnRemoveAll, // 4 tab
              this.spnMarginTop,
              this.spnMarginLeft,
              this.spnMarginBottom,
              this.spnMarginRight, // 5 tab
            ])
        ...
        onCategoryClick: function (btn, index, cmp, e) {
          ...
          setTimeout(() => {
            switch (index) {
              case 0:
                this.cmbTextAlignment.focus()
                break
              case 1:
                this.chBreakBefore.focus()
                break
              case 2:
              ...
              case 3:
                ...
                if (e && e instanceof jQuery.Event)
                  this.api.SetDrawImagePlaceParagraph(
                    "paragraphadv-font-img",
                    this._originalProps || new Asc.asc_CParagraphProperty(),
                  )
                break
              case 4:
                this.numDefaultTab.focus()
                break
              case 5:
                this.spnMarginTop.focus()
                break
            }
          }, 10)
        },
        ...
        getSettings: function () {
          ...
          if (this.Margins) {
            let borders = this._changedProps.get_Borders()
          ...
          if (this._tabListChanged) {
            if (
              this._changedProps.get_Tabs() === null ||
              this._changedProps.get_Tabs() === undefined
            )
              this._changedProps.put_Tabs(new Asc.asc_CParagraphTabs())
            this.tabList.store.each(function (item, index) {
              const tab = new Asc.asc_CParagraphTab(
                Common.Utils.Metric.fnRecalcToMM(item.get("tabPos")),
                item.get("tabAlign"),
                item.get("tabLeader"),
              )
          ...
          if (this._changedProps.get_Ind() !== null && this._changedProps.get_Ind() !== undefined) {
            let left = this._changedProps.get_Ind().get_Left()
            let first = this._changedProps.get_Ind().get_FirstLine()
            if ((left !== undefined || first !== undefined) && (first < 0 || this.FirstLine < 0)) {
              if (first < 0 || first === undefined || first === null) {
                if (first === undefined || first === null) first = this.FirstLine
                if (left === undefined || left === null) left = this.LeftIndent
                if (left !== undefined && left !== null)
                  this._changedProps.get_Ind().put_Left(left - first)
              } else {
                if (left === undefined || left === null) left = this.LeftIndent
                if (left !== undefined && left !== null) this._changedProps.get_Ind().put_Left(left)
              }
            }
          }
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            this.numIndentsLeft.setValue(
              this.LeftIndent !== null ? Common.Utils.Metric.fnRecalcFromMM(this.LeftIndent) : "",
              true,
            )
            this.numIndentsRight.setValue(
              props.get_Ind() !== null && props.get_Ind().get_Right() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.get_Ind().get_Right())
                : "",
              true,
            )

            let value = props.get_Spacing() ? props.get_Spacing().get_Before() : null
            this.numSpacingBefore.setValue(
              value !== null ? (value < 0 ? value : Common.Utils.Metric.fnRecalcFromMM(value)) : "",
              true,
            )
            value = props.get_Spacing() ? props.get_Spacing().get_After() : null
            this.numSpacingAfter.setValue(
              value !== null ? (value < 0 ? value : Common.Utils.Metric.fnRecalcFromMM(value)) : "",
              true,
            )

            const linerule = props.get_Spacing().get_LineRule()
            this.cmbLineRule.setValue(linerule !== null ? linerule : "")

            if (props.get_Spacing() !== null && props.get_Spacing().get_Line() !== null) {
              this.numLineHeight.setValue(
                linerule === c_paragraphLinerule.LINERULE_AUTO
                  ? props.get_Spacing().get_Line()
                  : Common.Utils.Metric.fnRecalcFromMM(props.get_Spacing().get_Line()),
                true,
              )
            } else {
            ...
            this.chAddInterval.setValue(
              props.get_ContextualSpacing() !== null && props.get_ContextualSpacing() !== undefined
                ? props.get_ContextualSpacing()
                : "indeterminate",
              true,
            )
            ...
            if (this.CurSpecial === undefined) {
              this.CurSpecial =
                props.get_Ind().get_FirstLine() === 0
                  ? c_paragraphSpecial.NONE_SPECIAL
                  : props.get_Ind().get_FirstLine() > 0
                    ? c_paragraphSpecial.FIRST_LINE
                    : c_paragraphSpecial.HANGING
            }
            this.cmbSpecial.setValue(this.CurSpecial)
            this.numSpecialBy.setValue(
              this.FirstLine !== null
                ? Math.abs(Common.Utils.Metric.fnRecalcFromMM(this.FirstLine))
                : "",
              true,
            )
            ...
            this.lblIndentsRight.text(
              value ? this.strIndentsSpacingAfter : this.strIndentsRightText,
            )

            this.cmbTextAlignment.setValue(
              props.get_Jc() !== undefined && props.get_Jc() !== null ? props.get_Jc() : "",
            )

            this.chKeepLines.setValue(
              props.get_KeepLines() !== null && props.get_KeepLines() !== undefined
                ? props.get_KeepLines()
                : "indeterminate",
              true,
            )
            this.chBreakBefore.setValue(
              props.get_PageBreakBefore() !== null && props.get_PageBreakBefore() !== undefined
                ? props.get_PageBreakBefore()
                : "indeterminate",
              true,
            )

            this.chKeepNext.setValue(
              props.get_KeepNext() !== null && props.get_KeepNext() !== undefined
                ? props.get_KeepNext()
                : "indeterminate",
              true,
            )
            this.chOrphan.setValue(
              props.get_WidowControl() !== null && props.get_WidowControl() !== undefined
                ? props.get_WidowControl()
                : "indeterminate",
              true,
            )

            this.chLineNumbers.setValue(
              props.get_SuppressLineNumbers() !== null &&
                props.get_SuppressLineNumbers() !== undefined
                ? props.get_SuppressLineNumbers()
                : "indeterminate",
              true,
            )
            ...
            // Margins
            if (this.Borders) {
              let brd = this.Borders.get_Left()
              let val =
                null !== brd &&
                undefined !== brd &&
                null !== brd.get_Space() &&
                undefined !== brd.get_Space()
                  ? Common.Utils.Metric.fnRecalcFromMM(brd.get_Space())
                  : ""
            ...
            if (shd !== null && shd !== undefined && shd.get_Value() === Asc.c_oAscShdClear) {
              ...
              if (color) {
                if (color.get_type() === Asc.c_oAscColor.COLOR_TYPE_SCHEME) {
                  ...
                  this.paragraphShade = Common.Utils.ThemeColor.getHexColor(
                    color.get_r(),
                    color.get_g(),
                    color.get_b(),
                  )
                }
              } else this.paragraphShade = "transparent"
            } else {
              this.paragraphShade = "transparent"
            }
            ...
            // Font
            this._noApply = true
            this.chStrike.setValue(
              props.get_Strikeout() !== null && props.get_Strikeout() !== undefined
                ? props.get_Strikeout()
                : "indeterminate",
              true,
            )
            this.chDoubleStrike.setValue(
              props.get_DStrikeout() !== null && props.get_DStrikeout() !== undefined
                ? props.get_DStrikeout()
                : "indeterminate",
              true,
            )
            this.chSubscript.setValue(
              props.get_Subscript() !== null && props.get_Subscript() !== undefined
                ? props.get_Subscript()
                : "indeterminate",
              true,
            )
            this.chSuperscript.setValue(
              props.get_Superscript() !== null && props.get_Superscript() !== undefined
                ? props.get_Superscript()
                : "indeterminate",
              true,
            )
            this.chSmallCaps.setValue(
              props.get_SmallCaps() !== null && props.get_SmallCaps() !== undefined
                ? props.get_SmallCaps()
                : "indeterminate",
              true,
            )
            this.chAllCaps.setValue(
              props.get_AllCaps() !== null && props.get_AllCaps() !== undefined
                ? props.get_AllCaps()
                : "indeterminate",
              true,
            )

            this.numSpacing.setValue(
              props.get_TextSpacing() !== null && props.get_TextSpacing() !== undefined
                ? Common.Utils.Metric.fnRecalcFromMM(props.get_TextSpacing())
                : "",
              true,
            )
            this.numPosition.setValue(
              props.get_Position() !== null && props.get_Position() !== undefined
                ? Common.Utils.Metric.fnRecalcFromMM(props.get_Position())
                : "",
              true,
            )
            ...
            this.numDefaultTab.setValue(
              props.get_DefaultTab() !== null && props.get_DefaultTab() !== undefined
                ? Common.Utils.Metric.fnRecalcFromMM(
                    Number.parseFloat(props.get_DefaultTab().toFixed(1)),
                  )
                : "",
              true,
            )

            const store = this.tabList.store
            const tabs = props.get_Tabs()
            if (tabs) {
              const arr = []
              const count = tabs.get_Count()
              for (let i = 0; i < count; i++) {
                const tab = tabs.get_Tab(i)
                const pos = Common.Utils.Metric.fnRecalcFromMM(
                  Number.parseFloat(tab.get_Pos().toFixed(1)),
                )
                const rec = new Common.UI.DataViewModel()
                rec.set({
                  tabPos: pos,
                  value: `${Number.parseFloat(pos.toFixed(3))} ${Common.Utils.Metric.getCurrentMetricName()}`,
            ...
            this.cmbOutlinelevel.setValue(
              props.get_OutlineLvl() === undefined || props.get_OutlineLvl() === null
                ? -1
                : props.get_OutlineLvl(),
            )
            this.cmbOutlinelevel.setDisabled(!!props.get_OutlineLvlStyle())
            this.cmbLigatures.setValue(
              props.get_Ligatures() === undefined || props.get_Ligatures() === null
                ? ""
                : props.get_Ligatures(),
            )
        ...
        updateMetricUnit: function () {
          if (this.spinners) {
            for (let i = 0; i < this.spinners.length; i++) {
              ...
              if (
                spinner.el.id === "paragraphadv-spin-spacing" ||
                spinner.el.id === "paragraphadv-spin-position" ||
                spinner.el.id === "paragraphadv-spin-spacing-before" ||
                spinner.el.id === "paragraphadv-spin-spacing-after"
              )
                spinner.setStep(
          ...
          this._arrLineRule[2].defaultUnit = this._arrLineRule[0].defaultUnit =
            Common.Utils.Metric.getCurrentMetricName()
          this._arrLineRule[2].minValue = this._arrLineRule[0].minValue = Number.parseFloat(
            Common.Utils.Metric.fnRecalcFromMM(0.3).toFixed(2),
          )
          this._arrLineRule[2].step = this._arrLineRule[0].step =
            Common.Utils.Metric.getCurrentMetric() === Common.Utils.Metric.c_MetricUnits.pt
              ? 1
              : 0.01
          if (this.CurLineRuleIdx !== null) {
            const rec = this._arrLineRule[this.CurLineRuleIdx !== -1 ? this.CurLineRuleIdx : 0]
        ...
        afterRender: function () {
          ...
          const colorstr =
            typeof this.paragraphShade === "object"
          ...
          if (this.borderProps !== undefined) {
            ...
            this.BordersImage.setVirtualBorderColor(
        ...
        onStrikeChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_DStrikeout(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onDoubleStrikeChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_Strikeout(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSuperscriptChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_Subscript(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSubscriptChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_Superscript(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSmallCapsChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_AllCaps(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onAllCapsChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.put_SmallCaps(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onColorsBackSelect: function (btn, color) {
          ...
          if (this._changedProps) {
            if (
              this._changedProps.get_Shade() === undefined ||
              this._changedProps.get_Shade() === null
            ) {
            ...
            if (this.paragraphShade === "transparent") {
              ...
              this._changedProps
                .get_Shade()
                .put_Color(Common.Utils.ThemeColor.getRgbColor(this.paragraphShade))
            }
          }
        ...
        _ApplyBorderPreset: function (btn) {
          const border = btn.options.strId
          this.ChangedBorders = null

          this.Borders.put_Left(
            this._UpdateBorderStyle(this.Borders.get_Left(), border.indexOf("l") > -1),
          )
          this.Borders.put_Top(
            this._UpdateBorderStyle(this.Borders.get_Top(), border.indexOf("t") > -1),
          )
          this.Borders.put_Right(
            this._UpdateBorderStyle(this.Borders.get_Right(), border.indexOf("r") > -1),
          )
          this.Borders.put_Bottom(
            this._UpdateBorderStyle(this.Borders.get_Bottom(), border.indexOf("b") > -1),
          )
          this.Borders.put_Between(
            this._UpdateBorderStyle(this.Borders.get_Between(), border.indexOf("m") > -1),
          )
        ...
        _UpdateBorderStyle: function (border, visible) {
          if (null == border) border = new Asc.asc_CTextBorder()
        ...
        _UpdateBorders: function () {
          ...
          if (this.Borders.get_Between() !== null) {
            for (let i = 0; i < this.BordersImage.rows - 1; i++) {
              this._UpdateCellBorder(
                this.Borders.get_Between(),
                this.BordersImage.getCellBorder(i, -1),
              )
            }
          }
        ...
        _UpdateBorder: function (BorderParam, borderName) {
          if (null !== BorderParam && undefined !== BorderParam) {
            if (
              ...
              this.BordersImage.setBordersSize(
                borderName,
                this._BorderPt2Px((BorderParam.get_Size() * 72) / 25.4),
              )
              this.BordersImage.setBordersColor(
                borderName,
                `rgb(${BorderParam.get_Color().get_r()},${BorderParam.get_Color().get_g()},${BorderParam.get_Color().get_b()})`,
              )
            } else this.BordersImage.setBordersSize(borderName, 0)
          } else {
        ...
        addTab: function (btn, eOpts) {
          const val = this.numTab.getNumberValue()
          const align = this.cmbAlign.getValue()
          const leader = this.cmbLeader.getValue()
          const displayAlign = this._arrKeyTabAlign[align]
          const displayLeader = this._arrKeyTabLeader[leader]

          const store = this.tabList.store
          let rec = store.find((record) => Math.abs(record.get("tabPos") - val) < 0.001)
          if (rec) {
        ...
        removeTab: function (btn, eOpts) {
          const rec = this.tabList.getSelectedRec()
          if (rec) {
            const store = this.tabList.store
            let idx = _.indexOf(store.models, rec)
            store.remove(rec)
        ...
        onLineRuleSelect: function (combo, record) {
          ...
          if (this.CurLineRuleIdx !== this.Spacing.get_LineRule()) {
            ...
            const value = this.numLineHeight.getNumberValue()
            if (this.Spacing.get_LineRule() === c_paragraphLinerule.LINERULE_AUTO) {
              ...
              this.numLineHeight.setValue(
                Common.Utils.Metric.fnRecalcFromMM(this._arrLineRule[record.value].defaultValue),
              )
            } else {
        ...
        onNumLineHeightChange: function (field, newValue, oldValue, eOpts) {
          if (this.cmbLineRule.getRawValue() === "") return
          if (this.Spacing === null) {
            const properties = this._originalProps
              ? this._originalProps
              : new Asc.asc_CParagraphProperty()
          ...
          this.Spacing.put_Line(
            this.cmbLineRule.getValue() === c_paragraphLinerule.LINERULE_AUTO
        ...
        onSpecialSelect: function (combo, record) {
          ...
          if (this._changedProps) {
            if (this._changedProps.get_Ind() === null || this._changedProps.get_Ind() === undefined)
              this._changedProps.put_Ind(new Asc.asc_CParagraphInd())
            let value = Common.Utils.Metric.fnRecalcToMM(this.numSpecialBy.getNumberValue())
            if (value === 0) {
              this.numSpecialBy.setValue(
                Common.Utils.Metric.fnRecalcFromMM(this._arrSpecial[record.value].defaultValue),
                true,
              )
        ...
        onFirstLineChange: function (field, newValue, oldValue, eOpts) {
          if (this._changedProps) {
            if (this._changedProps.get_Ind() === null || this._changedProps.get_Ind() === undefined)
              this._changedProps.put_Ind(new Asc.asc_CParagraphInd())
            let value = Common.Utils.Metric.fnRecalcToMM(field.getNumberValue())
        ...
        onTextDirChange: function (field, newValue, eOpts) {
          if (newValue && this._changedProps) {
            ...
            this.lblIndentsLeft.text(
              field.options.value ? this.strIndentsSpacingBefore : this.strIndentsLeftText,
            )
            this.lblIndentsRight.text(
              field.options.value ? this.strIndentsSpacingAfter : this.strIndentsRightText,
            )
          }
        },
