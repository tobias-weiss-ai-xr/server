...
define([], () => {
  DE.Views.ProtectDialog = Common.UI.Window.extend(
    _.extend(
      {
        initialize: function (options) {
          ...
          this.template =
            ...
            [
              ...
              `<label class="font-weight-bold" style="margin-bottom: 5px;">${this.txtAllow}</label>`,
              "</div>",
        ...
        render: function () {
          ...
          this.inputPwd = new Common.UI.InputFieldBtnPassword({
            ...
            validation: (value) => (value.length > 15 ? this.txtLimit : true),
          })
        ...
        getSettings: function () {
          if (this.rbView.getValue()) return Asc.c_oAscEDocProtect.ReadOnly
          if (this.rbForms.getValue()) return Asc.c_oAscEDocProtect.Forms
          if (this.rbReview.getValue()) return Asc.c_oAscEDocProtect.TrackedChanges
          if (this.rbComments.getValue()) return Asc.c_oAscEDocProtect.Comments
        },
