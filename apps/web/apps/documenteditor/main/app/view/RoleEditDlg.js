...
define([], () => {
  DE.Views.RoleEditDlg = Common.UI.Window.extend(
    _.extend(
      {
        options: {
          width: 330,
        ...
        render: function () {
          ...
          this.inputName = new Common.UI.InputField({
            ...
            allowBlank: false,
            blankError: this.textEmptyError,
            style: "width: 100%;",
            placeHolder: this.textNameEx,
            ...
            validation: (value) => {
              ...
              if (
                ...
                this.oformManager.asc_haveRole(value)
              )
          ...
          this.btnColor = new Common.UI.ColorButton({
            ...
            additionalItemsBefore: [
              (this.mnuNoFormsColor = new Common.UI.MenuItem({
        ...
        setSettings: function (props) {
          if (props) {
            ...
            const arr = _.difference(this.btnColor.options.colors, this.colors)
            if (arr.length > 0) {
        ...
        getSettings: function () {
          return {
            ...
            color: this.mnuNoFormsColor.isChecked()
              ? null
              : Common.Utils.ThemeColor.getRgbColor(this.lastColor),
          }
        },
