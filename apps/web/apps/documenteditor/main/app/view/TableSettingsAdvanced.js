...
define([
  ...
  DE.Views.TableSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 340,
        ...
        render: function () {
          ...
          this._marginsChange = function (field, newValue, oldValue, eOpts, source, property) {
            if (source === "table") this.TableMargins[property] = field.getNumberValue()
            else this.CellMargins[property] = field.getNumberValue()
          }
              ...
              if (this._changedProps) {
                if (value && this.nfWidth.getNumberValue() > 0)
                  this._changedProps.put_Width(
                    this.cmbUnit.getValue()
                      ? -this.nfWidth.getNumberValue()
                      : Common.Utils.Metric.fnRecalcToMM(this.nfWidth.getNumberValue()),
                  )
                else this._changedProps.put_Width(null)
              }
            }, this),
          )
          ...
          this.nfWidth.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps)
                this._changedProps.put_Width(
                  this.cmbUnit.getValue()
                    ? -field.getNumberValue()
                    : Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
            }, this),
          )

          const currmetric = Common.Utils.Metric.getCurrentMetric()
            ...
            data: [
              {
                value: 0,
                displayValue:
                  currmetric === Common.Utils.Metric.c_MetricUnits.pt
                    ? this.txtPt
                    : currmetric === Common.Utils.Metric.c_MetricUnits.inch
                      ? this.txtInch
                      : this.txtCm,
              },
          ...
          this.cmbUnit.on(
            ...
            _.bind(function (combo, record) {
              if (this._changedProps) {
                const maxwidth = Common.Utils.Metric.fnRecalcFromMM(558)
                this.nfWidth.setDefaultUnit(
                  record.value ? "%" : Common.Utils.Metric.getCurrentMetricName(),
                )
                this.nfWidth.setMaxValue(
                  record.value
                    ? Number.parseFloat(((100 * maxwidth) / this.pageWidth).toFixed(2))
                    : maxwidth,
                )
                this.nfWidth.setStep(
                  record.value ||
                    Common.Utils.Metric.getCurrentMetric() === Common.Utils.Metric.c_MetricUnits.pt
                    ? 1
                    : 0.1,
                )
                this.nfWidth.setValue(
                  record.value
                    ? (100 * this.nfWidth.getNumberValue()) / this.pageWidth
                    : (this.pageWidth * this.nfWidth.getNumberValue()) / 100,
                )
                this._changedProps.put_Width(
                  record.value
                    ? -this.nfWidth.getNumberValue()
              ...
              if (this._changedProps) {
                ...
                if (this._changedProps) {
                  if (value && this.nfSpacing.getNumberValue() > 0)
                    this._changedProps.put_Spacing(
                      Common.Utils.Metric.fnRecalcToMM(this.nfSpacing.getNumberValue()),
                    )
                  else this._changedProps.put_Spacing(null)
                }
              }
            }, this),
          )
          ...
          this.chAutofit.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.put_TableLayout(
                  field.getValue() === "checked"
                    ? Asc.c_oAscTableLayout.AutoFit
                    : Asc.c_oAscTableLayout.Fixed,
                )
              }
            }, this),
          )
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_DefaultMargins()
                  .put_Top(
                    this.TableMargins.Top !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.TableMargins.Top)
                      : null,
                  )
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_DefaultMargins()
                  .put_Bottom(
                    this.TableMargins.Bottom !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.TableMargins.Bottom)
                      : null,
                  )
                this.TableMargins.isChanged = true
              }
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_DefaultMargins()
                  .put_Left(
                    this.TableMargins.Left !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.TableMargins.Left)
                      : null,
                  )
                this.TableMargins.isChanged = true
              }
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_DefaultMargins()
                  .put_Right(
                    this.TableMargins.Right !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.TableMargins.Right)
                      : null,
                  )
                this.TableMargins.isChanged = true
              }
          ...
          const setCellFlag = () => {
            ...
            else if (this.CellMargins.Flag === "checked")
              this._changedProps.get_CellMargins().put_Flag(0)
            else this._changedProps.get_CellMargins().put_Flag(2)
          }
          ...
          this.chCellMargins.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (
                oldValue === "checked" &&
                this._originalProps &&
                this._originalProps.get_CellMargins().get_Flag() === 1
              ) {
                // allow to set the indeterminate value only if the original values did not match
              ...
              if (this._changedProps) {
                ...
                this._changedProps
                  .get_CellMargins()
                  .put_Left(
                    this.CellMargins.Left !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.CellMargins.Left)
                      : null,
                  )
                this._changedProps
                  .get_CellMargins()
                  .put_Top(
                    this.CellMargins.Top !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.CellMargins.Top)
                      : null,
                  )
                this._changedProps
                  .get_CellMargins()
                  .put_Bottom(
                    this.CellMargins.Bottom !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.CellMargins.Bottom)
                      : null,
                  )
                this._changedProps
                  .get_CellMargins()
                  .put_Right(
                    this.CellMargins.Right !== null
                      ? Common.Utils.Metric.fnRecalcToMM(this.CellMargins.Right)
                      : null,
                  )
                setCellFlag()
              }
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                if (value && this.nfPrefWidth.getNumberValue() > 0)
                  this._changedProps.put_CellsWidth(
                    this.cmbPrefWidthUnit.getValue()
                      ? -this.nfPrefWidth.getNumberValue()
                      : Common.Utils.Metric.fnRecalcToMM(this.nfPrefWidth.getNumberValue()),
                  )
                else this._changedProps.put_CellsWidth(null)
              }
            }, this),
          )
          ...
          this.cmbPrefWidthUnit.on(
            "selected",
            _.bind(function (combo, record) {
              if (this._changedProps) {
                const defUnit = record.value ? "%" : Common.Utils.Metric.getCurrentMetricName()
                if (this.nfPrefWidth.getUnitValue() !== defUnit) {
                  const maxwidth = Common.Utils.Metric.fnRecalcFromMM(558)
                  this.nfPrefWidth.setDefaultUnit(defUnit)
                  this.nfPrefWidth.setMaxValue(
                    record.value
                      ? Number.parseFloat(((100 * maxwidth) / this.pageWidth).toFixed(2))
                      : maxwidth,
                  )
                  this.nfPrefWidth.setStep(
                    record.value ||
                      Common.Utils.Metric.getCurrentMetric() ===
                        Common.Utils.Metric.c_MetricUnits.pt
                      ? 1
                      : 0.1,
                  )
                  this.nfPrefWidth.setValue(
                    record.value
                      ? (100 * this.nfPrefWidth.getNumberValue()) / this.pageWidth
                      : (this.pageWidth * this.nfPrefWidth.getNumberValue()) / 100,
                  )
                  this._changedProps.put_CellsWidth(
                    record.value
                      ? -this.nfPrefWidth.getNumberValue()
          ...
          this.btnAlignLeft.on(
            "click",
            _.bind(function (btn) {
              if (this._changedProps && btn.pressed) {
                this._changedProps.put_TableAlignment(btn.options.posId)
                this._changedProps.put_TableIndent(
                  Common.Utils.Metric.fnRecalcToMM(this.spnIndentLeft.getNumberValue()),
                )
          ...
          this.chMove.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                const value = this._arrVRelative[field.getValue() === "checked" ? 2 : 1].value
          ...
          const rec = this.cmbBorderSize.store.at(1)
          ...
          const _arrBorderPresets = [
            [
              "cm",
              "toolbar__icon toolbar__icon-big btn-borders-inner-only",
              "tableadv-button-border-inner",
              this.tipInner,
            ],
            [
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-borders-outer-only",
              "tableadv-button-border-outer",
              this.tipOuter,
            ],
            [
              "lrtbcm",
              "toolbar__icon toolbar__icon-big btn-borders-all",
              "tableadv-button-border-all",
              this.tipAll,
            ],
            [
              "",
              "toolbar__icon toolbar__icon-big btn-borders-none",
              "tableadv-button-border-none",
              this.tipNone,
            ],
          ]
          ...
          _.each(
            ...
            function (item, index, list) {
              const _btn = new Common.UI.Button({
                parentEl: $(`#${item[2]}`),
          ...
          const _arrTableBorderPresets = [
            [
              "cm",
              "",
              "toolbar__icon toolbar__icon-big btn-borders-twin-none-inner",
              "tableadv-button-border-inner-none",
              this.tipCellInner,
            ],
            [
              "lrtb",
              "",
              "toolbar__icon toolbar__icon-big btn-borders-twin-none-outer",
              "tableadv-button-border-outer-none",
              this.tipCellOuter,
            ],
            [
              "lrtbcm",
              "",
              "toolbar__icon toolbar__icon-big btn-borders-twin-none-all",
              "tableadv-button-border-all-none",
              this.tipCellAll,
            ],
            [
              "",
              "",
              "toolbar__icon toolbar__icon-big btn-borders-twin-none",
              "tableadv-button-border-none-none",
              this.tipNone,
            ],
            [
              "lrtbcm",
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-borders-twin-all",
              "tableadv-button-border-all-table",
              this.tipTableOuterCellAll,
            ],
            [
              "",
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-borders-twin-outer-none",
              "tableadv-button-border-none-table",
              this.tipOuter,
            ],
            [
              "cm",
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-borders-twin-outer-inner",
              "tableadv-button-border-inner-table",
              this.tipTableOuterCellInner,
            ],
            [
              "lrtb",
              "lrtb",
              "toolbar__icon toolbar__icon-big btn-borders-twin-outer-outer",
              "tableadv-button-border-outer-table",
              this.tipTableOuterCellOuter,
            ],
          ]

          this._btnsTableBorderPosition = []
          _.each(
            _arrTableBorderPresets,
            function (item, index, list) {
              const _btn = new Common.UI.Button({
                parentEl: $(`#${item[3]}`),
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.cmbUnit,
              this.chAutofit,
              this.spnTableMarginTop,
              this.spnTableMarginLeft,
              this.spnTableMarginBottom,
              this.spnTableMarginRight,
              this.chAllowSpacing,
              this.nfSpacing, // 0 tab
              this.chPrefWidth,
              this.nfPrefWidth,
              this.cmbPrefWidthUnit,
              this.chCellMargins,
              this.spnMarginTop,
              this.spnMarginLeft,
              this.spnMarginBottom,
              this.spnMarginRight,
              this.chWrapText, // 1 tab
              this.cmbBorderSize,
              this.btnBorderColor,
            ])
            .concat(this._btnsBorderPosition)
            .concat(this._btnsTableBorderPosition)
            .concat([
              this.btnBackColor,
              this.btnTableBackColor,
              this.radioHAlign,
              this.cmbHAlign,
              this.radioHPosition,
              this.cmbHRelative,
              ...
              this.cmbVPosition,
              this.chMove,
              this.chOverlap, // 3 tab
              this.btnWrapNone,
              this.btnWrapParallel,
              this.btnAlignLeft,
              this.btnAlignCenter,
              this.btnAlignRight,
              this.spnIndentLeft,
              this.spnDistanceTop,
              this.spnDistanceLeft,
              this.spnDistanceBottom,
              this.spnDistanceRight, // 4 tab
              this.inputAltTitle,
              this.textareaAltDescription, // 5 tab
            ])
        ...
        onCategoryClick: function (btn, index) {
          ...
          setTimeout(() => {
            switch (index) {
              case 0:
                if (!this.nfWidth.isDisabled()) this.nfWidth.focus()
                else this.spnTableMarginTop.focus()
                break
              case 1:
                this.onCellCategoryClick(btn)
                if (!this.nfPrefWidth.isDisabled()) this.nfPrefWidth.focus()
                else this.chPrefWidth.focus()
                break
              case 2:
                this.cmbBorderSize.focus()
                break
              case 3:
                if (!this.cmbHAlign.isDisabled()) this.cmbHAlign.focus()
                else this.spnX.focus()
                break
              case 4:
                if (this.spnIndentLeft.isVisible()) {
                  if (!this.spnIndentLeft.isDisabled()) this.spnIndentLeft.focus()
                  else this.btnWrapNone.focus()
                } else this.spnDistanceTop.focus()
                break
              case 5:
        ...
        afterRender: function () {
          ...
          const cellcolorstr =
            typeof this.CellColor.Color === "object"
              ? this.CellColor.Color.color
              : this.CellColor.Color
          const tablecolorstr =
            typeof this.TableColor.Color === "object"
          ...
          if (this.borderProps !== undefined) {
            ...
            const colorstr =
              typeof this.btnBorderColor.color === "object"
                ? this.btnBorderColor.color.color
            ...
            if (this.borderProps.borderColor === "auto") this.colorsBorder.clearSelection()
            else this.colorsBorder.select(this.borderProps.borderColor, true)

            this.cmbBorderSize.setValue(this.borderProps.borderSize.ptValue)
            const rec = this.cmbBorderSize.getSelectedRecord()
            if (rec) this.onBorderSizeSelect(this.cmbBorderSize, rec)
          }

          this.tableBordersImageSpacing.on(
            "borderclick:cellborder",
            function (ct, border, size, color) {
              if (this.ChangedCellBorders === undefined) {
                this.ChangedCellBorders = new Asc.CBorders()
              }
              this._UpdateCellBordersStyle(
                ct,
                border,
                size,
                color,
                this.CellBorders,
                this.ChangedCellBorders,
              )
            },
            this,
          )
          ...
          this.tableBordersImageSpacing.on(
            ...
            function (ct, border, size, color) {
              ...
              this._UpdateTableBordersStyle(
                ...
                color,
                this.TableBorders,
                this.ChangedTableBorders,
              )
            },
            this,
          )

          this.tableBordersImage.on(
            "borderclick",
            function (ct, border, size, color) {
              if (this._allTable) {
                if (this.ChangedTableBorders === undefined) {
              ...
              this._UpdateTableBordersStyle(
                ...
                size,
                color,
                this._allTable ? this.TableBorders : this.CellBorders,
                this._allTable ? this.ChangedTableBorders : this.ChangedCellBorders,
              )
            },
            this,
          )
        ...
        getSettings: function () {
          if (this._cellBackground) {
            if (this._allTable) {
              if (
                this._changedProps.get_Spacing() === null ||
                (this._changedProps.get_Spacing() === undefined &&
                  this._originalProps.get_Spacing() === null)
              )
                this._changedProps.put_CellsBackground(null)
              else this._changedProps.put_CellsBackground(this._cellBackground)
            } else this._changedProps.put_CellsBackground(this._cellBackground)
          }
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            let value
            const TableWidth = props.get_Width()
            const currmetric = Common.Utils.Metric.getCurrentMetric()
            ...
            this.nfWidth.setDefaultUnit(
              TableWidth < 0 ? "%" : Common.Utils.Metric.getCurrentMetricName(),
            )
            if (TableWidth < 0)
              //%
              this.nfWidth.setMaxValue(
                Number.parseFloat(
                  ((100 * Common.Utils.Metric.fnRecalcFromMM(558)) / this.pageWidth).toFixed(2),
                ),
              )
            this.nfWidth.setStep(
              TableWidth < 0 ||
            ...
            if (TableWidth !== null)
              this.nfWidth.setValue(
                TableWidth > 0 ? Common.Utils.Metric.fnRecalcFromMM(TableWidth) : -TableWidth,
                true,
              )
            ...
            const TableSpacing = props.get_Spacing()
            ...
            const autoFit = props.get_TableLayout()
            this.chAutofit.setDisabled(autoFit === undefined)
            this.chAutofit.setValue(autoFit === Asc.c_oAscTableLayout.AutoFit, true)

            // margins
            let margins = props.get_DefaultMargins()
            if (margins) {
              this.TableMargins = {
                Left:
                  margins.get_Left() !== null
                    ? Common.Utils.Metric.fnRecalcFromMM(margins.get_Left())
                    : null,
                Right:
                  margins.get_Right() !== null
                    ? Common.Utils.Metric.fnRecalcFromMM(margins.get_Right())
                    : null,
                Top:
                  margins.get_Top() !== null
                    ? Common.Utils.Metric.fnRecalcFromMM(margins.get_Top())
                    : null,
                Bottom:
                  margins.get_Bottom() !== null
                    ? Common.Utils.Metric.fnRecalcFromMM(margins.get_Bottom())
                    : null,
              }
            }
            ...
            if (margins) {
              ...
              this.CellMargins.Flag =
                flag === 1 ? "indeterminate" : flag === 0 ? "checked" : "unchecked"
            ...
            // Cell Size
            const cellWidth = props.get_CellsWidth()

            this.cmbPrefWidthUnit.store
              .at(0)
              .set(
                "displayValue",
                currmetric === Common.Utils.Metric.c_MetricUnits.pt
            ...
            this.nfPrefWidth.setDefaultUnit(
              cellWidth < 0 ? "%" : Common.Utils.Metric.getCurrentMetricName(),
            )
            if (cellWidth < 0)
              //%
              this.nfPrefWidth.setMaxValue(
            ...
            if (cellWidth !== null)
              this.nfPrefWidth.setValue(
                cellWidth > 0 ? Common.Utils.Metric.fnRecalcFromMM(cellWidth) : -cellWidth,
                true,
              )

            this.chPrefWidth.setValue(
              props.get_CellsWidthNotEqual() ? "indeterminate" : cellWidth !== null,
              true,
            )
            ...
            const wrapText = !props.get_CellsNoWrap()
            ...
            // align props
            const tableAlign = props.get_TableAlignment()
            if (tableAlign !== null) {
              this._TblAlignChanged(tableAlign)
              this.spnIndentLeft.setValue(
                tableAlign !== c_tableAlign.TABLE_ALIGN_LEFT
                  ? 0
                  : Common.Utils.Metric.fnRecalcFromMM(props.get_TableIndent()),
                true,
              )
            ...
            // distances & position
            const paddings = props.get_TablePaddings()
            if (paddings) {
              this.spnDistanceTop.setValue(
                Common.Utils.Metric.fnRecalcFromMM(paddings.get_Top()),
                true,
              )
              this.spnDistanceLeft.setValue(
                Common.Utils.Metric.fnRecalcFromMM(paddings.get_Left()),
                true,
              )
              this.spnDistanceBottom.setValue(
                Common.Utils.Metric.fnRecalcFromMM(paddings.get_Bottom()),
                true,
              )
              this.spnDistanceRight.setValue(
                Common.Utils.Metric.fnRecalcFromMM(paddings.get_Right()),
                true,
              )
            }
            ...
            if (Position) {
              ...
              if (value === Asc.c_oAscVAnchor.Text) this.chMove.setValue(true, true)
            ...
            this.chOverlap.setValue(
              props.get_AllowOverlap() !== null ? props.get_AllowOverlap() : "indeterminate",
              true,
            )
            ...
            const disable_inner =
              this.CellBorders.get_InsideV() === null && this.CellBorders.get_InsideH() === null
            ...
            // background colors
            let background = props.get_TableBackground()
            if (background && background.get_Value() === 0) {
              ...
              } else this.TableColor = { Value: 1, Color: "transparent" }
        ...
        fillMargins: function (checkMarginsState) {
          this.spnMarginLeft.setValue(
            this.CellMargins.Left !== null ? this.CellMargins.Left : "",
            true,
          )
          this.spnMarginTop.setValue(
            this.CellMargins.Top !== null ? this.CellMargins.Top : "",
            true,
          )
          this.spnMarginRight.setValue(
            this.CellMargins.Right !== null ? this.CellMargins.Right : "",
            true,
          )
          this.spnMarginBottom.setValue(
            this.CellMargins.Bottom !== null ? this.CellMargins.Bottom : "",
            true,
          )
          const disabled = checkMarginsState === "checked"
          ...
          this.spnTableMarginLeft.setValue(
            this.TableMargins.Left !== null ? this.TableMargins.Left : "",
            true,
          )
          this.spnTableMarginTop.setValue(
            this.TableMargins.Top !== null ? this.TableMargins.Top : "",
            true,
          )
          this.spnTableMarginRight.setValue(
            this.TableMargins.Right !== null ? this.TableMargins.Right : "",
            true,
          )
          this.spnTableMarginBottom.setValue(
            this.TableMargins.Bottom !== null ? this.TableMargins.Bottom : "",
            true,
          )
        },

        _TblWrapStyleChanged: function (style) {
          if (style === c_tableWrap.TABLE_WRAP_NONE) this.btnWrapNone.toggle(true)
          else this.btnWrapParallel.toggle(true)
          this._state.fromWrapInline = style === c_tableWrap.TABLE_WRAP_NONE
        },

        _TblAlignChanged: function (style) {
          if (style === c_tableAlign.TABLE_ALIGN_LEFT) this.btnAlignLeft.toggle(true, true)
          else if (style === c_tableAlign.TABLE_ALIGN_CENTER) this.btnAlignCenter.toggle(true, true)
          else this.btnAlignRight.toggle(true, true)
        },
        ...
        onBtnInlineWrapClick: function (btn, e) {
          ...
          if (this._changedProps && btn.pressed) {
            if (this._state.alignChanged) {
              if (this._state.HAlignType === Asc.c_oAscXAlign.Left) this.btnAlignLeft.toggle(true)
            ...
            else if (this.btnAlignCenter.pressed)
        ...
        onColorsBorderSelect: function (btn, color) {
          const colorstr = typeof color === "object" ? color.color : color
          this.tableBordersImage.setVirtualBorderColor(colorstr)
          this.tableBordersImageSpacing.setVirtualBorderColor(colorstr)
        },
        ...
        onColorsBackSelect: function (btn, color) {
          ...
          if (this._cellBackground === null) this._cellBackground = new Asc.CBackground()
          ...
          if (this.CellColor.Color === "transparent") {
            ...
            this._cellBackground.put_Color(
        ...
        onColorsTableBackSelect: function (btn, color) {
          ...
          if (this._changedProps) {
            let background = this._changedProps.get_TableBackground()
          ...
          if (this._allTable) this.tableBordersImage.setCellsColor(colorstr)
          this.tableBordersImage.redrawTable()
          this.tableBordersImageSpacing.redrawTable()
        },

        _UpdateBordersSpacing_: function () {
          let source = this.TableBorders

          const oldSize = this.BorderSize
          const oldColor = this.btnBorderColor.color
          ...
          this._UpdateCellBorderSpacing_(
            source.get_Top(),
            this.tableBordersImageSpacing.getCellBorder(0, -1, 0),
          )
          this._UpdateCellBorderSpacing_(
            source.get_Left(),
            this.tableBordersImageSpacing.getCellBorder(-1, 0, 0),
          )
          this._UpdateCellBorderSpacing_(
            source.get_Bottom(),
            this.tableBordersImageSpacing.getCellBorder(
              this.tableBordersImageSpacing.rows - 1,
              -1,
              1,
            ),
          )
          this._UpdateCellBorderSpacing_(
            ...
            this.tableBordersImageSpacing.getCellBorder(
              -1,
              this.tableBordersImageSpacing.columns - 1,
              1,
            ),
          )
          ...
          if (source.get_InsideV() !== null) {
            for (let i = 0; i < this.tableBordersImageSpacing.columns - 1; i++) {
              this._UpdateCellBorderSpacing_(
                source.get_InsideV(),
                this.tableBordersImageSpacing.getCellBorder(-1, i, 1),
              )
              this._UpdateCellBorderSpacing_(
                source.get_InsideV(),
                this.tableBordersImageSpacing.getCellBorder(-1, i + 1, 0),
              )
            }
          }
          ...
          if (source.get_InsideH() !== null) {
            for (let i = 0; i < this.tableBordersImageSpacing.rows - 1; i++) {
              this._UpdateCellBorderSpacing_(
                source.get_InsideH(),
                this.tableBordersImageSpacing.getCellBorder(i, -1, 1),
              )
              this._UpdateCellBorderSpacing_(
                source.get_InsideH(),
                this.tableBordersImageSpacing.getCellBorder(i + 1, -1, 0),
              )
            }
          }

          this.tableBordersImageSpacing.setVirtualBorderSize(oldSize.pxValue)
          this.tableBordersImageSpacing.setVirtualBorderColor(
            typeof oldColor === "object" ? oldColor.color : oldColor,
          )
        ...
        _UpdateCellBorderSpacing_: function (BorderParam, cell) {
          if (null !== BorderParam && undefined !== BorderParam) {
            if (
              null !== BorderParam.get_Value() &&
              null !== BorderParam.get_Size() &&
              null !== BorderParam.get_Color()
            ) {
              if (1 === BorderParam.get_Value()) {
                cell.setBordersSize(this._BorderPt2Px((BorderParam.get_Size() * 72) / 25.4))
                cell.setBordersColor(
                  `rgb(${BorderParam.get_Color().get_r()},${BorderParam.get_Color().get_g()},${BorderParam.get_Color().get_b()})`,
                )
              } else cell.setBordersSize(0)
            } else {
        ...
        _UpdateTableBorderSpacing_: function (BorderParam, borderName) {
          if (null !== BorderParam && undefined !== BorderParam) {
            if (
              ...
              if (1 === BorderParam.get_Value()) {
                this.tableBordersImageSpacing.setBordersSize(
                  borderName,
                  this._BorderPt2Px((BorderParam.get_Size() * 72) / 25.4),
                )
                this.tableBordersImageSpacing.setBordersColor(
                  borderName,
                  `rgb(${BorderParam.get_Color().get_r()},${BorderParam.get_Color().get_g()},${BorderParam.get_Color().get_b()})`,
                )
              } else this.tableBordersImageSpacing.setBordersSize(borderName, 0)
            } else {
        ...
        _UpdateBordersNoSpacing_: function () {
          const source = this._allTable ? this.TableBorders : this.CellBorders
          ...
          if (source.get_InsideV() !== null) {
            for (let i = 0; i < this.tableBordersImage.columns - 1; i++) {
              this._UpdateCellBorderNoSpacing_(
                source.get_InsideV(),
                this.tableBordersImage.getCellBorder(-1, i),
              )
            }
          }
          ...
          if (source.get_InsideH() !== null) {
            for (i = 0; i < this.tableBordersImage.rows - 1; i++) {
              this._UpdateCellBorderNoSpacing_(
                source.get_InsideH(),
                this.tableBordersImage.getCellBorder(i, -1),
              )
            }
          }

          this.tableBordersImage.setVirtualBorderSize(oldSize.pxValue)
          this.tableBordersImage.setVirtualBorderColor(
            typeof oldColor === "object" ? oldColor.color : oldColor,
          )
        },
        ...
        _UpdateTableBorderNoSpacing_: function (BorderParam, borderName) {
          if (null !== BorderParam && undefined !== BorderParam) {
            if (
              ...
              if (1 === BorderParam.get_Value()) {
                this.tableBordersImage.setBordersSize(
                  borderName,
                  this._BorderPt2Px((BorderParam.get_Size() * 72) / 25.4),
                )
                this.tableBordersImage.setBordersColor(
                  borderName,
                  `rgb(${BorderParam.get_Color().get_r()},${BorderParam.get_Color().get_g()},${BorderParam.get_Color().get_b()})`,
                )
              } else this.tableBordersImage.setBordersSize(borderName, 0)
            } else {
        ...
        _ApplyBorderPreset: function (btn) {
          const cellborder =
            btn.options.strId !== undefined ? btn.options.strId : btn.options.strCellId
          const tableborder = btn.options.strTableId
        ...
        _UpdateCellBordersStyle: function (
          ct,
          border,
          size,
          color,
          ...
          const updateBorders = destination
        ...
        _UpdateTableBordersStyle: function (
          ct,
          border,
          size,
          color,
        ...
        _UpdateBorderStyle: function (border, visible) {
          ...
          if (visible && this.BorderSize.ptValue > 0) {
            const size = Number.parseFloat(this.BorderSize.ptValue)
            border.put_Value(1)
        ...
        updateThemeColors: function () {
          this.colorsBorder.updateColors(
            Common.Utils.ThemeColor.getEffectColors(),
            Common.Utils.ThemeColor.getStandartColors(),
          )
          this.colorsBack.updateColors(
            Common.Utils.ThemeColor.getEffectColors(),
            Common.Utils.ThemeColor.getStandartColors(),
          )
          this.colorsTableBack.updateColors(
            Common.Utils.ThemeColor.getEffectColors(),
            Common.Utils.ThemeColor.getStandartColors(),
          )
        },
