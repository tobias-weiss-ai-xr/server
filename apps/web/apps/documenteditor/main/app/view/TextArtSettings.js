...
define([
  ...
  DE.Views.TextArtSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        ChangeSettings: function (props) {
          ...
          this._state.isFromSmartArtInternal = props
            .get_ShapeProperties()
            ?.get_FromSmartArtInternal()
          this._state.isFromChart = props.get_ShapeProperties()?.get_FromChart()
          this.hideTransformSettings(this._state.isFromSmartArtInternal || this._state.isFromChart)

          if (props?.get_ShapeProperties()?.get_TextArtProperties()) {
            const shapeprops = props.get_ShapeProperties().get_TextArtProperties()
