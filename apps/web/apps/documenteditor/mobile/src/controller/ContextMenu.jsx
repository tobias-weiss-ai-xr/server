...
class ContextMenu extends ContextMenuController {
  ...
  onMenuItemClick(action) {
    ...
    switch (action) {
      ...
      case "copy":
        ...
        break
      case "paste":
        if (!LocalStorage.getBool("de-hide-copy-cut-paste-warning")) this.showCopyCutPasteModal()
        break
      case "viewcomment":
        ...
        buttons: [
          ...
          },
          {
            ...
            onClick: () => {
              ...
              Common.EditorApi.get().SplitCell(Number.parseInt(size[0]), Number.parseInt(size[1]))
            },
          },
        ],
        on: {
  ...
  initMenuItems() {
    ...
    stack.forEach((item) => {
      ...
      const objectValue = item.get_ObjectValue()
    ...
    if (!isDisconnected) {
      ...
      if (
        ...
        (isAllowedEditing || isAllowedCommenting)
      ) {
        itemsText.push({
