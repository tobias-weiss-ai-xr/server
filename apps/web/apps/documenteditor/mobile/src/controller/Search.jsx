import { Link, List, ListItem, NavRight, Navbar, Page, Toggle, f7 } from "framework7-react"
      ...
      <Page>
        ...
        <List>
          <ListItem
            ...
            checked={!this.state.useReplace || isViewer}
...
const Search = withTranslation()((props) => {
  ...
  const onSearchQuery = (params, isSearchByTyping) => {
    ...
    api.asc_findText(options, params.forward, (resultCount) => {
      if (!resultCount) {
