...
class EditChartController extends Component {
  ...
  onMoveText(value) {
    ...
    if (api) {
      ...
      properties
        .get_PositionV()
        .put_RelativeFrom(value ? Asc.c_oAscRelativeFromV.Paragraph : Asc.c_oAscRelativeFromV.Page)
      api.ImgApply(properties)
    }
  }
  ...
  onWrapDistance(value) {
    ...
    if (api) {
      ...
      const distance = Common.Utils.Metric.fnRecalcToMM(Number.parseInt(value))
  ...
  onBorderSize(value) {
    ...
    this.props.storeChartSettings.initBorderColor(
      this.props.storeFocusObjects.shapeObject.get_ShapeProperties().get_stroke(),
