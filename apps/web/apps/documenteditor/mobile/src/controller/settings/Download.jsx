...
const DownloadWithTranslation = inject(
  "storeAppOptions",
  "storeDocumentInfo",
)(observer(withTranslation()(DownloadController)))
...
const onAdvancedOptions = (type, _t, isDocReady, canRequestClose, isDRM) => {
  ...
  f7.dialog
    .create({
      ...
      content: Device.ios
        ? `<div class="input-field modal-password"><input type="password" class="modal-text-input" name="modal-password" placeholder="${_t.advDRMPassword}" id="modal-password"><i class="modal-password__icon icon icon-show-password"></i></div>`
        : `<div class="input-field modal-password"><div class="inputs-list list inline-labels"><ul><li><div class="item-content item-input"><div class="item-inner"><div class="item-input-wrap"><input type="password" name="modal-password" id="modal-password" placeholder=${_t.advDRMPassword}><i class="modal-password__icon icon icon-show-password"></i></div></div></div></li></ul></div></div>`,
      buttons: buttons,
...
export { DownloadWithTranslation as DownloadController, onAdvancedOptions }
