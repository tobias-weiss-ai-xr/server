...
export class storeTextSettings {
  ...
  initEditorFonts(fonts, select) {
    ...
    this.thumbs = [
      {
        ratio: 1,
        path: `../../../../../sdkjs/common/Images/${sprite}.png`,
        width: this.iconWidth,
        height: this.iconHeight,
      },
      {
        ratio: 1.25,
        path: `../../../../../sdkjs/common/Images/${sprite}@1.25x.png`,
        width: this.iconWidth * 1.25,
        height: this.iconHeight * 1.25,
      },
      {
        ratio: 1.5,
        path: `../../../../../sdkjs/common/Images/${sprite}@1.5x.png`,
        width: this.iconWidth * 1.5,
        height: this.iconHeight * 1.5,
      },
      {
        ratio: 1.75,
        path: `../../../../../sdkjs/common/Images/${sprite}@1.75x.png`,
        width: this.iconWidth * 1.75,
        height: this.iconHeight * 1.75,
      },
      {
        ratio: 2,
        path: `../../../../../sdkjs/common/Images/${sprite}@2x.png`,
  ...
  resetFontName(font) {
    const name = typeof font.get_Name === "function" ? font.get_Name() : font.asc_getName()
    this.fontName = name
  }
  ...
  addFontToRecent(font) {
    this.arrayRecentFonts.forEach((item) => {
      if (item.name === font.name)
        this.arrayRecentFonts.splice(this.arrayRecentFonts.indexOf(item), 1)
    })
