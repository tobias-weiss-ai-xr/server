...
const ToolbarView = (props) => {
  ...
  const disableEditBtn =
    props.isObjectLocked || props.stateDisplayMode || props.disabledEditControls || isDisconnected
      ...
      <NavLeft>
        {!isViewer && !isVersionHistoryMode && (
          <Link
            ...
            onClick={() => props.turnOnViewerMode()}
          >
            {Device.android && (
        ...
        {!isEditableForms
          ? [
              ...
              (isViewer || !Device.phone) &&
                props.isMobileViewAvailable &&
                !props.disabledControls &&
                !isVersionHistoryMode && (
                  <Link
                    iconOnly
                    key="toggle-view-link"
                  ...
                  >
                    {isMobileView ? (
                      <SvgIcon
                        slot="media"
                        symbolId={IconStandardView.id}
                        className={"icon icon-svg"}
                      />
                    ) : (
                      <SvgIcon
                        slot="media"
                        symbolId={IconMobileView.id}
                        className={"icon icon-svg"}
                      />
                    )}
                  </Link>
              ...
              props.showEditDocument && !isVersionHistoryMode && isViewer && (
                ...
                >
                  {Device.ios ? (
                    <SvgIcon
                      slot="media"
                      symbolId={IconEditForIos.id}
                      className={"icon icon-svg"}
                    />
                  ) : (
                    <SvgIcon
                      slot="media"
                      symbolId={IconEditForAndroid.id}
                      className={"icon icon-svg"}
                    />
                  )}
                </Link>
              ...
              Device.phone ? null : (
                <Link
                  ...
                  key="search-link"
                  className={
                    (props.disabledControls || props.readerMode || isOpenModal) && "disabled"
                  }
              ...
              isVersionHistoryMode ? (
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconVersionHistory.id}
                    className={"icon icon-svg"}
                  />
                </Link>
              ) : null,
          ...
          : [
              ...
              <Link
                ...
                id="btn-prev-field"
                href={false}
                onClick={() => props.movePrevField()}
              >
                <SvgIcon symbolId={IconPrevField.id} className={"icon icon-svg"} />
              </Link>,
              <Link
                iconOnly
                key="next-field-link"
                ...
                id="btn-next-field"
                href={false}
                onClick={() => props.moveNextField()}
              >
                <SvgIcon symbolId={IconNextField.id} className={"icon icon-svg"} />
              </Link>,
                    ...
                    <Link
                      ...
                      className={
                        (props.disabledSettings ||
                          ...
                          isDisconnected ||
                          isOpenModal ||
                          props.isSignatureForm) &&
                        "disabled"
                      }
                      text={t("Toolbar.btnSend")}
                      href={false}
