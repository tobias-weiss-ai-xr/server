  ...
  return (
    ...
    >
      <Page>
        ...
        <List>
          <ListItem title={_t.textPictureFromLibrary} onClick={() => addPictureFromLibrary()}>
            {Device.ios ? (
...
class SheetAddImageListView extends Component {
  render() {
    return Device.isPhone ? (
      <Sheet
        id="dropdown-image-list-popup"
        className="dropdown-image-list-popup"
      ...
      <Popover
        id="dropdown-image-list-popover"
        className="popover__titled"
        verticalPosition={this.props.vertPos}
        closeByOutsideClick={true}
