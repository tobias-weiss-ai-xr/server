                            ...
                            return (
                              ...
                              >
                                <div
                                  className={"thumb"}
                                  style={{
                                    backgroundImage: `url('resources/img/charts/${type.thumb}')`,
                                  }}
                                ></div>
                              </li>
                            )
...
const PageChartBorder = (props) => {
  ...
  if (shapeObject) {
    ...
    borderColor = !storeChartSettings.borderColor
      ? storeChartSettings.initBorderColor(shapeStroke)
      : storeChartSettings.borderColor
  }
...
const PageDesign = (props) => {
  ...
  const chartProperties = props.storeFocusObjects.chartObject
    ? props.storeFocusObjects.chartObject.get_ChartProperties()
    : null
  ...
  return (
    <Fragment>
      <List>
        ...
        />
        <ListItem
          title={t("Edit.textWrap")}
          link="/edit-chart-wrap/"
          routeProps={{
