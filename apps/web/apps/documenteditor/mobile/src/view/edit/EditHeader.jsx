...
import { BlockTitle, Button, Icon, List, ListItem, Segmented, Toggle } from "framework7-react"
          ...
          <div slot="after">
            <Segmented>
              ...
              <Button
                ...
                onClick={() => {
                  props.onStartAt(_startAt, false)
                }}
              >
                {isAndroid ? (
