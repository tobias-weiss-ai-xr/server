...
const PageWrap = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("Edit.textWrappingStyle")}
          after={typesWrapping[wrappingStyle]}
          link="/edit-image-wrapping-style/"
          routeProps={{
      ...
      <List>
        ...
        >
          {Device.ios ? (
            ...
            <SvgIcon
              slot="media"
              symbolId={IconImageLibraryAndroid.id}
              className={"icon icon-svg"}
            />
          )}
        </ListItem>
          ...
          <NavRight>
            <Link sheetClose="#edit-sheet">
              {Device.ios ? (
                ...
                <SvgIcon
                  slot="media"
                  symbolId={IconExpandDownAndroid.id}
...
const EditImage = (props) => {
  ...
  return (
    <Fragment>
      <List>
        <ListItem
          title={t("Edit.textTextWrapping")}
          link="/edit-image-wrap/"
          routeProps={{
            onWrapType: props.onWrapType,
        ...
        />
        <ListItem
          title={t("Edit.textReplaceImage")}
          link="/edit-image-replace/"
          className={pluginGuid ? "disabled" : ""}
          routeProps={{
