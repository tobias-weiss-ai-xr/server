...
const PaletteFill = inject(
  ...
  observer((props) => {
    ...
    const curFillColor = storeShapeSettings.fillColor
      ? storeShapeSettings.fillColor
      : storeShapeSettings.getFillColor(shapeObject)
      ...
      <Fragment>
        ...
        <List>
          <ListItem
            ...
            link={"/edit-shape-custom-fill-color/"}
            routeProps={{
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textAddCustomColor}
          link={"/edit-shape-custom-border-color/"}
          routeProps={{
...
const PageStyle = (props) => {
  ...
  // Init border color
  const borderColor = !storeShapeSettings.borderColorView
    ? storeShapeSettings.initBorderColorView(shapeObject)
    : storeShapeSettings.borderColorView
    ...
    <Page>
      <Navbar backLink={_t.textBack}>
        <div className="tab-buttons tabbar">
          <Link key={"de-link-shape-fill"} tabLink={"#edit-shape-fill"} tabLinkActive={true}>
            {_t.textFill}
          </Link>
          <Link key={"de-link-shape-border"} tabLink={"#edit-shape-border"}>
            {_t.textBorder}
          </Link>
          <Link key={"de-link-shape-effects"} tabLink={"#edit-shape-effects"}>
            {_t.textEffects}
          </Link>
      ...
      <Tabs animated>
        ...
        <Tab
          key={"de-tab-shape-border"}
          id={"edit-shape-border"}
          className="page-content no-padding-top"
        >
          <List>
            <ListItem>
        ...
        <Tab
          key={"de-tab-shape-effects"}
          id={"edit-shape-effects"}
          className="page-content no-padding-top"
        >
          <List>
            <ListItem>
  ...
  return (
    <Page>
      ...
      <List>
        ...
        >
          <span className="color-preview" slot="after" style={{ background: displayBorderColor }} />
        </ListItem>
      </List>
    </Page>
  )
  ...
  return (
    <Page>
      ...
      <List>
        ...
        <ListItem
          title={_t.textThrough}
          radio
          checked={wrapType === "through"}
          onClick={() => {
        ...
        <ListItem
          title={_t.textTopAndBottom}
          radio
          checked={wrapType === "top-bottom"}
          onClick={() => {
        ...
        <ListItem
          title={_t.textInFront}
          radio
          checked={wrapType === "infront"}
          onClick={() => {
        ...
        <Fragment>
          ...
          <List>
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${align === Asc.c_oAscAlignH.Left ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconTextAlignLeft.id}
                    className={"icon icon-svg"}
                  />
                </a>
                <a
                  className={`button${align === Asc.c_oAscAlignH.Center ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${align === Asc.c_oAscAlignH.Right ? " active" : ""}`}
                  onClick={() => {
...
const PageReplace = (props) => {
  ...
  const _t = t("Edit", { returnObjects: true })
  const storeShapeSettings = props.storeShapeSettings
  const shapes = storeShapeSettings.getStyleGroups()
...
const EditShape = (props) => {
  ...
  const hideChangeType =
    shapeObject.get_ShapeProperties().get_FromChart() ||
    shapeObject.get_ShapeProperties().get_FromSmartArt() ||
    shapeType === "line" ||
  ...
  if (controlProps) {
    const spectype = controlProps.get_SpecificType()
    fixedSize =
      ...
      controlProps.get_FormPr() &&
      controlProps.get_FormPr().get_Fixed()
  }

  const disableRemove =
    !!props.storeFocusObjects.paragraphObject ||
    lockType === Asc.c_oAscSdtLockType.SdtContentLocked ||
    lockType === Asc.c_oAscSdtLockType.SdtLocked
    ...
    <Fragment>
      <List>
        ...
        {!hideChangeType && !fixedSize && (
          <ListItem
            title={t("Edit.textChangeShape")}
            link="/edit-shape-replace/"
            routeProps={{
        ...
        {wrapType !== "inline" && !isSmartArtInternal && settings.indexOf("image") === -1 && (
          <ListItem
            title={t("Edit.textArrange")}
            link="/edit-shape-reorder/"
            routeProps={{
