...
const PageTableOptions = (props) => {
  ...
  let columnWidth
  let rowHeight
  let displayRowHeight
  let displayColumnWidth
  let isCellNoWrap
  if (tableObject) {
        ...
        <Fragment>
          ...
          <List>
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${align === c_tableAlign.TABLE_ALIGN_LEFT ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconBlockAlignLeft.id}
                    className={"icon icon-svg"}
                  />
                </a>
                <a
                  className={`button${align === c_tableAlign.TABLE_ALIGN_CENTER ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconBlockAlignCenter.id}
                    className={"icon icon-svg"}
                  />
                </a>
                <a
                  className={`button${align === c_tableAlign.TABLE_ALIGN_RIGHT ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconBlockAlignRight.id}
                    className={"icon icon-svg"}
                  />
                </a>
              </div>
...
const StyleTemplates = inject(
  ...
  observer(({ onStyleClick, storeTableSettings, storeFocusObjects, onGetTableStylesPreviews }) => {
    const tableObject = storeFocusObjects.tableObject
    const styleId = tableObject?.get_TableStyle()
...
const PageBorderColor = (props) => {
  ...
  return (
    <Page>
      ...
      />
      <List>
        <ListItem title={t("Edit.textAddCustomColor")} link={"/edit-table-custom-border-color/"} />
      </List>
    </Page>
  )
}
    ...
    <Page>
      <Navbar backLink={_t.textBack}>
        <div className="tab-buttons tabbar">
          <Link key={"de-link-table-style"} tabLink={"#edit-table-style"} tabLinkActive={true}>
            {_t.textStyle}
          </Link>
          <Link key={"de-link-table-fill"} tabLink={"#edit-table-fill"}>
            {_t.textFill}
          </Link>
          <Link key={"de-link-table-border"} tabLink={"#edit-table-border"}>
            {_t.textBorder}
          </Link>
...
const EditTable = (props) => {
  ...
  return (
    <Fragment>
      ...
      <List>
        <ListItem
          title={_t.textTableOptions}
          link="/edit-table-options/"
          routeProps={{
...
const PageTableOptionsContainer = inject(
  "storeFocusObjects",
  "storeTableSettings",
)(observer(PageTableOptions))
