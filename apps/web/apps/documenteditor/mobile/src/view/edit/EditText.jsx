...
const PageFonts = (props) => {
  ...
  const displaySize =
    typeof size === "undefined" ? t("Edit.textAuto") : `${size} ${t("Edit.textPt")}`
...
const PageAdditionalFormatting = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("Edit.textStrikethrough")}
          radio
          checked={isStrikeout}
          onClick={() => {
        ...
        />
        <ListItem
          title={t("Edit.textDoubleStrikethrough")}
          radio
      ...
      <List className="row" style={{ listStyle: "none" }}>
        {bulletArrays.map((bullet) => (
          <ListItem
            ...
            className={bullet.subtype === typeBullets ? "active" : ""}
            onClick={() => {
      ...
      <List className="row" style={{ listStyle: "none" }}>
        {numberArrays.map((number) => (
          <ListItem
            ...
            className={number.subtype === typeNumbers ? "active" : ""}
            onClick={() => {
    ...
    <View className="multilevels dataview">
      <List className="row" style={{ listStyle: "none" }}>
        {arrayMultiLevel.map((item) => (
          ...
          >
            <div id={item.id} className="item-multilevellist"></div>
          </ListItem>
        ))}
      </List>
    </View>
...
const PageFontColor = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          className={`item-color-auto${textColor === "auto" ? " active" : ""}`}
          title={_t.textAutomatic}
          onClick={() => {
...
const PageOrientationTextShape = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("Edit.textHorizontalText")}
          radio
        ...
        <ListItem
          title={t("Edit.textRotateTextDown")}
          radio
...
const PageDirection = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("Edit.textLtrTextDirection")}
          radio
        ...
        <ListItem
          title={t("Edit.textRtlTextDirection")}
          radio
          checked={isRtlTextDirection}
          radioIcon="end"
          onChange={() => {
...
const EditText = (props) => {
  ...
  const inSmartArt = shapePr?.asc_getFromSmartArt()
  const inSmartArtInternal = shapePr?.asc_getFromSmartArtInternal()
  ...
  const displaySize =
    typeof fontSize === "undefined" ? t("Edit.textAuto") : `${fontSize} ${t("Edit.textPt")}`
  ...
  return (
    <Fragment>
      <List>
        ...
        <ListItem
          title={t("Edit.textHighlightColor")}
        ...
        <ListItem
          title={t("Edit.textAdditionalFormatting")}
      ...
      <List>
        ...
        {shapePr && (
          <ListItem
            title={t("Edit.textTextOrientation")}
        ...
        {!inSmartArt && !inSmartArtInternal && (
          <ListItem
            title={t("Edit.textBulletsAndNumbers")}
        ...
        <ListItem
          key="direction"
          title={t("Edit.textTextDirection")}
