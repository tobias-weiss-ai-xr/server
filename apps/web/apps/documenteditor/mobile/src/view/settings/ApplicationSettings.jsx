...
const PageApplicationSettings = (props) => {
  ...
  const _isShowMacros =
    !appOptions.isDisconnected && appOptions.customization
      ? appOptions.customization.macros !== false
      : true
    ...
    <Page>
      ...
      {_isEdit && !isViewer && (
        <>
          ...
          <List>
            <ListItem title={_t.textNoCharacters} disabled={displayMode !== "markup"}>
              {/*ToDo: if (DisplayMode == "final" || DisplayMode == "original") {disabled} */}
              <Toggle
                checked={isNonprintingCharacters}
                onToggleChange={() => {
            ...
            <ListItem title={_t.textHiddenTableBorders} disabled={displayMode !== "markup"}>
              {/*ToDo: if (DisplayMode == "final" || DisplayMode == "original") {disabled} */}
              <Toggle
                checked={isHiddenTableBorders}
                onToggleChange={() => {
