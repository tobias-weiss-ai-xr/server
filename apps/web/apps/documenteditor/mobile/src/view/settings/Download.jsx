        ...
        {!isEditableForms && !isDjvuFormat
          ? [
              <ListItem
                title="PDF/A"
                key="PDF/A"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.PDFA)}
              >
              ...
              <ListItem
                title="TXT"
                key="TXT"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.TXT)}
              >
              ...
              <ListItem
                title="RTF"
                key="RTF"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.RTF)}
              >
              ...
              <ListItem
                title="ODT"
                key="ODT"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.ODT)}
              >
              ...
              <ListItem
                title="HTML"
                key="HTML"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.HTML)}
              >
              ...
              <ListItem
                title="DOTX"
                key="DOTX"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.DOTX)}
              >
              ...
              <ListItem
                title="OTT"
                key="OTT"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.OTT)}
              >
              ...
              <ListItem
                title="FB2"
                key="FB2"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.FB2)}
              >
              ...
              <ListItem
                title="EPUB"
                key="EPUB"
                onClick={() => props.onSaveFormat(Asc.c_oAscFileType.EPUB)}
              >
