...
const EncryptionView = inject("storeAppOptions")(
  observer((props) => {
    ...
    const isDisabledEncryption =
      isFileEncrypted && !isRequiredPassword ? false : !password.length || !passwordRepeat.length
        ...
        <Navbar title={t("Settings.textEncryptFile")} backLink={_t.textBack}>
          <NavRight>
            <Link
              ...
              className={isDisabledEncryption && "disabled"}
