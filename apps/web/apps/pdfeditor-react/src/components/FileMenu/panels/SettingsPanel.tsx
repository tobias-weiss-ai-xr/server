export function SettingsPanel({ visible }: { visible: boolean }) {
  return (
    <div className="pdf-file-menu-content-box" style={{ display: visible ? "block" : "none", padding: 0, flexDirection: "column" }}>
      ...
      <table className="pdf-file-menu-settings-table">
        <tbody>
          <tr className="pdf-file-menu-settings-group">
            <td className="pdf-file-menu-settings-label" colSpan={2}>Theme</td>
          </tr>
          <tr>
          ...
          <tr className="pdf-file-menu-settings-group">
            <td className="pdf-file-menu-settings-label" colSpan={2}>Font Rendering</td>
          </tr>
          <tr>
            <td className="pdf-file-menu-settings-left">
