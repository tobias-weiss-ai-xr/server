...
define([
  ...
  PDFE.Controllers.PageThumbnails = Backbone.Controller.extend(
    _.extend(
      {
        models: [],
        /*collections: [
          ...
          this.addListeners({
            PageThumbnails: {
              show: _.bind(function () {
                ...
                if (this.firstShow) {
                  this.api.asc_setViewerThumbnailsUsePageRect(
                    Common.localStorage.getBool("de-thumbnails-highlight", true),
                  )
        ...
        setApi: function (api) {
          ...
          this.api.asc_registerCallback(
            "asc_onViewerThumbnailsZoomUpdate",
            _.bind(this.updateSize, this),
          )
          return this
        },
        ...
        onAfterRender: function (panelThumbnails) {
          ...
          panelThumbnails.buttonSettings.menu.on(
            "item:click",
            _.bind(this.onHighlightVisiblePart, this),
          )
          panelThumbnails.buttonSettings.menu.on(
            "show:before",
            _.bind(function () {
