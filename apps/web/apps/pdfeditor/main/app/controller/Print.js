 ...
 */
define(["core"], () => {
  PDFE.Controllers.Print = Backbone.Controller.extend(
    _.extend(
      {
        ...
        onApiPageOrient: function (isportrait) {
          ...
          if (this.printSettings?.isVisible()) {
            const item = this.printSettings.cmbPaperOrientation.store.findWhere({
              value: this._state.pgorient
        ...
        onUpdateLastCustomMargins: function (props) {
          ...
          if (this.printSettings?.isVisible()) {
            const top = props
              ? props.get_TopMargin()
              : Common.localStorage.getItem("pdfe-pgmargins-top")
            const left = props
              ? props.get_LeftMargin()
              : Common.localStorage.getItem("pdfe-pgmargins-left")
            const bottom = props
              ? props.get_BottomMargin()
              : Common.localStorage.getItem("pdfe-pgmargins-bottom")
            const right = props
              ? props.get_RightMargin()
              : Common.localStorage.getItem("pdfe-pgmargins-right")
