...
define([
  ...
  PDFE.Controllers.Statusbar = Backbone.Controller.extend(
    _.extend(
      {
        models: [],
        collections: [],
        ...
        onAppReady: function (config) {
          ...
          new Promise((resolve) => {
            ...
            this.statusbar.btnPagePrev.on("click", _.bind(this.onGotoPage, this, false))
            this.statusbar.btnPageNext.on("click", _.bind(this.onGotoPage, this, true))
            if (config.canUseSelectHandTools) {
              ...
              this.statusbar.btnHandTool.toggle(true, true)
            }
          })
        },
        ...
        onGotoPage: function (next, btn, e) {
          this.api?.goToPage(this.api.getCurrentPage() + (next ? 1 : -1))
        },
