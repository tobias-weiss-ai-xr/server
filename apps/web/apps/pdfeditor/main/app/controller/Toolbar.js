...
define(["core", "common/main/lib/component/Window", "pdfeditor/main/app/view/Toolbar"], () => {
  PDFE.Controllers.Toolbar = Backbone.Controller.extend(
    _.extend(
      {
        models: [],
        collections: [],
        ...
        initialize: function () {
          ...
          Common.NotificationCenter.on(
            "comments:tryshowcomments",
            _.bind(this.turnOnShowComments, this),
          )
          Common.NotificationCenter.on(
            "tab:set-active",
        ...
        setMode: function (mode) {
          ...
          const url = "https://www.Word Office.com/blog/2025/10/docs-9-1-released"
          ...
          Common.UI.FeaturesManager.isFeatureEnabled("featuresTips", true) &&
            Common.UI.TooltipManager.addTips({
              ...
              annotRect: {
                name: "pdfe-help-tip-annot-rect",
                placement: "bottom",
                text: this.helpAnnotRect,
                header: this.helpAnnotRectHeader,
                target: "#slot-btn-shape-comment",
                isNewFeature: true,
                maxwidth: 300,
                closable: false,
                noHighlight: true,
              ...
              redactTab: {
                name: "help-tip-redact-tab",
                placement: "bottom-right",
                offset: { x: Common.UI.isRTL() ? -10 : 10, y: 0 },
                text: this.helpRedactTab,
                header: this.helpRedactTabHeader,
                target: "li.ribtab #red",
                automove: true,
                maxwidth: 300,
                closable: false,
                isNewFeature: true,
              ...
              createLink: {
                name: "pdfe-help-tip-create-link",
                placement: "bottom-left",
                text: this.helpCreateLink,
                header: this.helpCreateLinkHeader,
                target: "#slot-btn-insertlink",
                maxwidth: 300,
                automove: true,
                closable: false,
                isNewFeature: true,
        ...
        attachCommonUIEvents: function (toolbar) {
          ...
          toolbar.fieldPages.on("inputleave", () => {
            Common.NotificationCenter.trigger("edit:complete", toolbar)
          })
          toolbar.fieldPages.cmpEl?.on("focus", "input.form-control", () => {
            setTimeout(() => {
              toolbar.fieldPages._input?.select()
            }, 1)
          })
        ...
        attachRestrictedEditUIEvents: function (toolbar) {
          if (this.mode?.isRestrictedEdit) {
            ...
            toolbar.btnSubmit?.on("click", _.bind(this.onSubmitClick, this))
            toolbar.btnSaveForm?.on("click", _.bind(this.onSaveFormClick, this))
          }
        },
        ...
        attachPDFAnnotateUIEvents: function (toolbar) {
          ...
          toolbar.btnAddComment.on("click", (btn, e) => {
            Common.NotificationCenter.trigger("app:comment:add", "toolbar")
          })
          toolbar.btnEditMode?.on("click", (btn, e) => {
          ...
          toolbar.btnShapeComment.menu.on(
            "show:after",
            _.bind(this.onMenuShapeCommentShowAfter, this),
          )
        ...
        onCreateAnnotBar: function (btnStrikeout, btnUnderline, btnHighlight) {
          ...
          const mnuStrikeoutColorPicker = toolbar.createPen(btnStrikeout, "strikeout", true)
          ...
          const mnuUnderlineColorPicker = toolbar.createPen(btnUnderline, "underline", true)
          ...
          const mnuHighlightColorPicker = toolbar.createPen(btnHighlight, "highlight", true)
        ...
        attachPDFEditUIEvents: function (toolbar) {
          ...
          toolbar.btnVerticalAlign.menu.on(
            "item:click",
            _.bind(this.onMenuVerticalAlignSelect, this),
          )
          ...
          toolbar.mnuTextHighlightColorPicker.on(
            "select",
            _.bind(this.onSelectTextHighlightColor, this),
          )
          toolbar.mnuTextHighlightTransparent.on(
            "click",
            _.bind(this.onTextHighlightTransparentClick, this),
          )
        ...
        attachUIEvents: function (toolbar) {
          ...
          } else if (this.mode.isRestrictedEdit) this.attachRestrictedEditUIEvents(toolbar)
        },
        ...
        attachRestrictedEditApiEvents: function () {
          ...
          this.api.asc_registerCallback(
            "sync_onAllRequiredFormsFilled",
            _.bind(this.onFillRequiredFields, this),
          )
        },
        ...
        attachPDFAnnotateApiEvents: function () {
          ...
          this.api.asc_registerCallback(
            "asc_onFocusObject",
            _.bind(this.onApiFocusObjectAnnotate, this),
          )
          this.api.asc_registerCallback("asc_onCanUndo", _.bind(this.onApiCanRevert, this, "undo"))
          this.api.asc_registerCallback("asc_onCanRedo", _.bind(this.onApiCanRevert, this, "redo"))
          this.api.asc_registerCallback("asc_onZoomChange", _.bind(this.onApiZoomChange, this))
          ...
          this.api.asc_registerCallback(
            "asc_onStartAddShapeChanged",
            _.bind(this.onStartAddShapeChanged, this),
          ) //for shape comments
          ...
          if (this.mode.canPDFEdit) {
            ...
            this.api.asc_registerCallback(
              ...
              _.bind(this.onInitStandartTextures, this),
            )
          }
        },
        ...
        attachPDFEditApiEvents: function () {
          ...
          this.api.asc_registerCallback(
            ...
            _.bind(this.onApiCanIncreaseIndent, this),
          )
          this.api.asc_registerCallback(
            "asc_canDecreaseIndent",
            _.bind(this.onApiCanDecreaseIndent, this),
          )
          ...
          this.api.asc_registerCallback(
            "asc_onVerticalTextAlign",
            _.bind(this.onApiVerticalTextAlign, this),
          )
          this.api.asc_registerCallback("asc_onTextColor", _.bind(this.onApiTextColor, this))
          this.api.asc_registerCallback(
            "asc_onTextHighLight",
            _.bind(this.onApiTextHighlightColor, this),
          )
          this.api.asc_registerCallback(
            "asc_onTextDirection",
        ...
        setApi: function (api) {
          ...
          } else if (this.mode.isRestrictedEdit) this.attachRestrictedEditApiEvents()
        },
        ...
        onChangeCompactView: function (view, compact, suppressSave) {
          ...
          const editmode = this.mode.isEdit || this.mode.isRestrictedEdit
          !suppressSave &&
            Common.localStorage.setBool(
              editmode ? "pdfe-compact-toolbar" : "pdfe-view-compact-toolbar",
              compact,
            )
        ...
        onCountPages: function (count) {
          ...
          this.toolbar?.fieldPages?.setFixedValue(`/ ${count}`)
          this.toolbar.lockToolbar(Common.enumLock.singlePage, count < 2, {
            array: [this.toolbar.btnDelPage],
          })
          this.toolbar.lockToolbar(Common.enumLock.firstPage, this._state.currentPage < 1, {
            array: [this.toolbar.btnFirstPage, this.toolbar.btnPrevPage],
          })
          this.toolbar.lockToolbar(
            Common.enumLock.lastPage,
            this._state.currentPage >= this._state.pageCount - 1,
            { array: [this.toolbar.btnLastPage, this.toolbar.btnNextPage] },
          )
        },
        ...
        onCurrentPage: function (value) {
          ...
          if (this.toolbar) {
            this.toolbar.fieldPages?.setValue(value + 1)
            this.toolbar.lockToolbar(Common.enumLock.firstPage, value < 1, {
              array: [this.toolbar.btnFirstPage, this.toolbar.btnPrevPage],
            })
            this.toolbar.lockToolbar(Common.enumLock.lastPage, value >= this._state.pageCount - 1, {
              array: [this.toolbar.btnLastPage, this.toolbar.btnNextPage],
            })
          }
        },
        ...
        onPagesChanged: function () {
          let value = Number.parseInt(this.toolbar.fieldPages.getValue())
          if (value > this._state.pageCount) value = this._state.pageCount
          this.api?.goToPage(value - 1)
        },

        onGotoPage: function (type, btn, e) {
          if (!this.api) return

          if (type === "first") this.api.goToPage(0)
          else if (type === "last") this.api.goToPage(this._state.pageCount - 1)
          else this.api.goToPage(this.api.getCurrentPage() + (type === "next" ? 1 : -1))
        },
        ...
        onApiCanCopyCut: function (cancopy, cancut) {
          if (this._state.can_copy !== cancopy) {
            this.toolbar.lockToolbar(Common.enumLock.copyLock, !cancopy, {
              array: [this.toolbar.btnCopy],
            })
            this._state.can_copy = cancopy
          }
          cancut === undefined && (cancut = cancopy)
          if (this._state.can_cut !== cancut) {
            this.toolbar.lockToolbar(Common.enumLock.cutLock, !cancut, {
              array: [this.toolbar.btnCut],
            })
        ...
        onApiCanPastePage: function (canpaste) {
          if (this._state.can_paste !== canpaste) {
            this.toolbar.lockToolbar(Common.enumLock.pasteLock, !canpaste, {
              array: [this.toolbar.btnPaste],
            })
        ...
        onApiFocusObjectAnnotate: function (selectedObjects) {
          ...
          if (
            ...
            !this.toolbar.btnShapeComment.isDisabled() &&
            this.toolbar.isTabActive("comment")
          )
        ...
        onApiFocusObject: function (selectedObjects) {
          ...
          let shape_locked = undefined
          let no_paragraph = true
          let no_text = true
          let no_object = true
          let in_equation = false
          const toolbar = this.toolbar
          let no_columns = false
          let in_smartart = false
          let in_smartart_internal = false
          let in_annot = false
          let in_text_annot = false
          const annot_lock = false
          let page_deleted = false
          let page_rotate_lock = false
          let page_edit_text = false
          let in_form = false
          let in_check_form = false
          let in_text_form = false
          ...
          while (++i < selectedObjects.length) {
            ...
            if (type === Asc.c_oAscTypeSelectElement.Paragraph) {
              ...
              if (type === Asc.c_oAscTypeSelectElement.Shape) {
                const shapetype = pr.asc_getType()
                if (
                  shapetype === "line" ||
                  ...
                  no_columns = true
                if (pr.get_FromSmartArt()) in_smartart = true
                if (pr.get_FromSmartArtInternal()) in_smartart_internal = true
              }
              if (
                type === Asc.c_oAscTypeSelectElement.Image ||
                type === Asc.c_oAscTypeSelectElement.Table
              ...
              const annotPr = pr.asc_getAnnotProps()
              in_annot = true
              if (annotPr?.asc_getCanEditText?.()) {
                in_text_annot = true
                no_text = false
              }
              ...
              const ft = pr.asc_getType()
              in_form = true
              no_text = false
              in_text_form =
                ft === AscPDF.FIELD_TYPES.text ||
                ft === AscPDF.FIELD_TYPES.combobox ||
                ft === AscPDF.FIELD_TYPES.listbox
              in_check_form =
                ft === AscPDF.FIELD_TYPES.checkbox || ft === AscPDF.FIELD_TYPES.radiobutton
            }
          }
          ...
          if (this._state.prcontrolsdisable !== paragraph_locked) {
            ...
            if (paragraph_locked !== undefined)
              toolbar.lockToolbar(Common.enumLock.paragraphLock, paragraph_locked, {
                array: toolbar.paragraphControls,
              })
          }

          if (this._state.no_paragraph !== no_paragraph) {
            if (this._state.activated) this._state.no_paragraph = no_paragraph
            toolbar.lockToolbar(Common.enumLock.noParagraphSelected, no_paragraph, {
              array: toolbar.paragraphControls,
            })
          ...
          if (this._state.no_text !== no_text) {
            ...
            toolbar.lockToolbar(Common.enumLock.noTextSelected, no_text, {
              array: toolbar.paragraphControls,
            })
          }
          ...
          if (this._state.in_annot !== in_annot) {
            ...
            toolbar.lockToolbar(Common.enumLock.inAnnotation, in_annot, {
              array: toolbar.paragraphControls,
            })
          }
          ...
          if (this._state.in_form !== in_form) {
            ...
            toolbar.lockToolbar(Common.enumLock.inForm, in_form, {
              array: toolbar.paragraphControls,
            })
          }
          ...
          if (this._state.in_check_form !== in_check_form) {
            ...
            toolbar.lockToolbar(Common.enumLock.inCheckForm, in_check_form, {
              array: toolbar.paragraphControls,
            })
          }

          const cant_align = no_paragraph && !in_text_form && !in_text_annot
          toolbar.lockToolbar(Common.enumLock.cantAlign, cant_align, {
            array: [toolbar.btnHorizontalAlign],
          })
          !cant_align &&
            toolbar.btnHorizontalAlign.menu.items[3].setDisabled(in_text_form || in_text_annot)

          if (this._state.no_object !== no_object) {
            if (this._state.activated) this._state.no_object = no_object
            toolbar.lockToolbar(Common.enumLock.noObjectSelected, no_object, {
              array: [toolbar.btnVerticalAlign],
            })
          }

          const no_drawing_objects = this.api.asc_getSelectedDrawingObjectsCount() < 1
          if (this._state.no_drawing_objects !== no_drawing_objects) {
            ...
            toolbar.lockToolbar(Common.enumLock.noDrawingObjects, no_drawing_objects, {
              array: [toolbar.btnShapeAlign, toolbar.btnShapeArrange, toolbar.btnShapesMerge],
            })
          }
          ...
          if (shape_locked !== undefined && this._state.shapecontrolsdisable !== shape_locked) {
            ...
            toolbar.lockToolbar(Common.enumLock.shapeLock, shape_locked, {
              array: toolbar.shapeControls.concat(toolbar.paragraphControls),
            })
          }

          if (shape_locked === undefined && !this._state.no_drawing_objects) {
          ...
          if (this._state.in_equation !== in_equation) {
            ...
            toolbar.lockToolbar(Common.enumLock.inEquation, in_equation, {
              array: [toolbar.btnSuperscript, toolbar.btnSubscript],
            })
          }

          if (this._state.no_columns !== no_columns) {
            if (this._state.activated) this._state.no_columns = no_columns
            toolbar.lockToolbar(Common.enumLock.noColumns, no_columns, {
              array: [toolbar.btnColumns],
            })
          }

          if (this._state.in_smartart !== in_smartart) {
            toolbar.lockToolbar(Common.enumLock.inSmartart, in_smartart, {
              array: toolbar.paragraphControls,
            })
          ...
          if (this._state.in_smartart_internal !== in_smartart_internal) {
            toolbar.lockToolbar(Common.enumLock.inSmartartInternal, in_smartart_internal, {
              array: toolbar.paragraphControls,
            })
          ...
          toolbar.lockToolbar(Common.enumLock.pageRotateLock, page_rotate_lock, {
            array: [toolbar.btnRotatePage],
          })
          toolbar.lockToolbar(
            Common.enumLock.cantRotatePage,
            !this.api.asc_CanRotatePages([this.api.getCurrentPage()]),
            { array: [toolbar.btnRotatePage] },
          )
          toolbar.lockToolbar(Common.enumLock.pageEditText, page_edit_text, {
            array: [toolbar.btnEditText],
          })
          toolbar.lockToolbar(
            Common.enumLock.cantDelPage,
            !this.api.asc_CanRemovePages([this.api.getCurrentPage()]),
            { array: [toolbar.btnDelPage] },
          )

          if (
            toolbar.btnShapeComment &&
            !toolbar.btnShapeComment.isDisabled() &&
            toolbar.isTabActive("comment")
          ) {
            Common.UI.TooltipManager.getNeedShow("annotRect") &&
        ...
        onPrintMenu: function (btn, e) {
          const oldType = this.toolbar.btnPrint.options.printType
          const newType = e.value

          if (newType !== oldType) {
            this.toolbar.btnPrint.changeIcon({
              next: e.options.iconClsForMainBtn,
              curr: this.toolbar.btnPrint.menu
                .getItems()
        ...
        tryToSave: function () {
          ...
          if (!mode.canSaveToFile) {
            const canDownload = mode.canDownload && (!mode.isDesktopApp || !mode.isOffline)
            const saveSopy =
              mode.canDownload &&
              (!mode.isDesktopApp || !mode.isOffline) &&
              (mode.canRequestSaveAs || mode.saveAsUrl)
            const saveAs = mode.canDownload && mode.isDesktopApp && mode.isOffline
            const buttons = (
              saveSopy || saveAs ? [{ value: "copy", caption: this.txtSaveCopy }] : []
            ).concat(canDownload ? [{ value: "download", caption: this.txtDownload }] : [])
            const primary = saveSopy || saveAs ? "copy" : canDownload ? "download" : "ok"
            ...
            Common.UI.info({
              ...
              callback: (btn) => {
                if (saveAs && btn === "copy") this.api.asc_DownloadAs()
                  ...
                  this._state.isFromToolbarDownloadAs = btn === "copy"
                  const options = new Asc.asc_CDownloadOptions()
                  options.asc_setIsDownloadEvent(this._state.isFromToolbarDownloadAs)
            ...
            const isSyncButton = toolbar.btnCollabChanges?.cmpEl.hasClass("notify")
            if (
              !isModified &&
              !isSyncButton &&
              !toolbar.mode.forcesave &&
              !toolbar.mode.canSaveDocumentToBinary
            )
              return
            ...
            toolbar.btnSave &&
              toolbar.lockToolbar(
                ...
                (!toolbar.mode.forcesave &&
                  toolbar.mode.canSaveToFile &&
                  !toolbar.mode.canSaveDocumentToBinary) ||
                  !toolbar.mode.showSaveButton,
        ...
        onBtnChangeState: function (prop) {
          if (/\:disabled$/.test(prop)) {
            const _is_disabled = arguments[2]
        ...
        turnOnSelectTool: function () {
          if (
            (this.mode.isEdit || this.mode.isRestrictedEdit) &&
            this.toolbar &&
            this.toolbar.btnSelectTool &&
            !this.toolbar.btnSelectTool.isActive()
          ) {
        ...
        clearSelectTools: function () {
          if (
            this.toolbar?.btnSelectTool &&
            (this.toolbar.btnSelectTool.pressed || this.toolbar.btnHandTool.pressed)
          ) {
        ...
        updateSelectTools: function () {
          if (
            this.toolbar?.btnSelectTool &&
            !this._state.inDrawingMode &&
            !this.toolbar.btnStrikeout.pressed &&
            !this.toolbar.btnHighlight.pressed &&
            !this.toolbar.btnUnderline.pressed
          ) {
        ...
        turnOnShowComments: function () {
          this.toolbar &&
            !this.toolbar.chShowComments.isChecked() &&
            this.toolbar.chShowComments.setValue(true)
        },
        ...
        onBtnStrikeout: function (btn) {
          if (btn.pressed) {
            ...
            this.toolbar.btnsStrikeout.forEach((button) => {
        ...
        _setStrikeoutColor: function (strcolor, h) {
          ...
          if (strcolor === "transparent") {
            this.api.SetMarkerFormat(this.toolbar.btnStrikeout.options.type, true, 0)
            this.toolbar.mnusStrikeoutColorPicker.forEach((picker) => {
            ...
            this.api.SetMarkerFormat(
              this.toolbar.btnStrikeout.options.type,
              true,
              Common.Utils.InternalSettings.get("pdfe-annot-opacity-strikeout"),
        ...
        onBtnUnderline: function (btn) {
          if (btn.pressed) {
            ...
            this.api.SetMarkerFormat(btn.options.type, false)
            this.toolbar.btnsUnderline.forEach((button) => {
              button.toggle(false, true)
            })
            this.updateSelectTools()
          }
        ...
        _setUnderlineColor: function (strcolor, h) {
          ...
          if (h === "menu") {
            this._state.clrunderline = undefined
            // me.onApiHighlightColor();
          ...
          if (strcolor === "transparent") {
            this.api.SetMarkerFormat(this.toolbar.btnUnderline.options.type, true, 0)
            this.toolbar.mnusUnderlineColorPicker.forEach((picker) => {
              picker?.clearSelection()
            })
            ...
            const b = strcolor[4] + strcolor[5]
            this.api.SetMarkerFormat(
              this.toolbar.btnUnderline.options.type,
              true,
              Common.Utils.InternalSettings.get("pdfe-annot-opacity-underline"),
              Number.parseInt(r, 16),
              Number.parseInt(g, 16),
              Number.parseInt(b, 16),
            )
        ...
        onBtnHighlight: function (btn) {
          if (btn.pressed) {
            ...
            this.api.SetMarkerFormat(btn.options.type, false)
            this.toolbar.btnsHighlight.forEach((button) => {
              button.toggle(false, true)
            })
            this.updateSelectTools()
          }
        ...
        _setHighlightColor: function (strcolor, h) {
          ...
          if (strcolor === "transparent") {
            this.api.SetMarkerFormat(this.toolbar.btnHighlight.options.type, true, 0)
            this.toolbar.mnusHighlightColorPicker.forEach((picker) => {
              picker?.clearSelection()
            })
            ...
            const b = strcolor[4] + strcolor[5]
            this.api.SetMarkerFormat(
              this.toolbar.btnHighlight.options.type,
              true,
              Common.Utils.InternalSettings.get("pdfe-annot-opacity-highlight"),
              Number.parseInt(r, 16),
              Number.parseInt(g, 16),
              Number.parseInt(b, 16),
            )
        ...
        onApiStartHighlight: function (type, pressed) {
          ...
          else if (type === undefined) this.toolbar.btnTextHighlightColor?.toggle(pressed, true)
          if (type !== undefined) {
        ...
        onClearHighlight: function () {
          this.toolbar.btnsHighlight
            .concat(this.toolbar.btnsStrikeout)
            .concat(this.toolbar.btnsUnderline)
            .forEach((button) => {
              button.toggle(false, true)
            })
          this.toolbar.btnTextHighlightColor?.toggle(false, true)
        },
        ...
        onShowCommentsChange: function (checkbox, state) {
          ...
          value
            ? this.api.asc_showComments(
                Common.Utils.InternalSettings.get("pdfe-settings-resolvedcomment"),
              )
        ...
        onMenuTextCommentClick: function (btn, e) {
          const oldType = this.toolbar.btnTextComment.options.textboxType
          const newType = e.value

          if (newType !== oldType) {
            this.toolbar.btnTextComment.changeIcon({
              next: e.options.iconClsForMainBtn,
              curr: this.toolbar.btnTextComment.menu
                .getItems(true)
                .filter((item) => item.value === oldType)[0].options.iconClsForMainBtn,
            })
        ...
        onInsertTextComment: function (type, btn, e) {
          this.api?.AddFreeTextAnnot(type)

          Common.NotificationCenter.trigger(
            "edit:complete",
            this.toolbar,
            this.toolbar.btnTextComment,
          )
        ...
        onBtnShapeCommentClick: function (btn, e) {
          ...
          btn.menu
            .getItems(true)
            .filter((item) => item.value === btn.options.shapeType)[0]
            .setChecked(true)
          if (!btn.pressed) {
        ...
        onMenuShapeCommentClick: function (menu, item, e) {
          ...
          const oldType = this.toolbar.btnShapeComment.options.shapeType
          if (newType !== oldType) {
            this.toolbar.btnShapeComment.changeIcon({
              next: item.options.iconClsForMainBtn,
              curr: this.toolbar.btnShapeComment.menu
                .getItems(true)
                .filter((mnu) => mnu.value === oldType)[0].options.iconClsForMainBtn,
            })
        ...
        onMenuShapeCommentShowAfter: (menu) => {
          Common.UI.TooltipManager.closeTip("annotRect")
        },

        onShapeCommentSizeClick: function (direction) {
          const btn = this.toolbar.btnShapeComment
          if (!btn.pressed) {
            btn.toggle(true, true)
          }
          const size = btn.options.currentSize
          size.idx =
            direction === "up"
              ? Math.min(size.idx + 1, size.arr.length - 1)
              : Math.max(size.idx - 1, 0)
        ...
        checkInsertShapeComment: function (e) {
          ...
          if (cmp.attr("id") !== "editor_sdk" && cmp_sdk.length <= 0) {
            if (
              this.toolbar.btnShapeComment.pressed &&
              this.toolbar.btnShapeComment.id !== btn_id
            ) {
              this.api.StartAddAnnot("", undefined, false)
              $(document.body).off("mouseup", this.binding.checkInsertShapeComment)
              this.toolbar.btnShapeComment.toggle(false, true)
        ...
        onMenuStampClick: function (btn, e) {
          const oldType = this.toolbar.btnStamp.options.stampType
          const newType = e.value
        ...
        onStampShowAfter: function (menu) {
          if (menu.getItemsLength(true) < 1 && this.api) {
            const arr = this.api.asc_getPropertyEditorStamps()
        ...
        onApiStampsReady: function () {
          this.toolbar.btnStamp.menu.isVisible() &&
            this.onStampShowAfter(this.toolbar.btnStamp.menu)
        },

        onFillRequiredFields: function (isFilled) {
          this.toolbar?.btnSubmit &&
            this.toolbar.lockToolbar(Common.enumLock.requiredNotFilled, !isFilled, {
              array: [this.toolbar.btnSubmit],
            })
        },
        ...
        onSaveFormClick: function () {
          if (this.api && this.mode && this.mode.canDownload) {
            if (this.mode.isOffline)
              ...
              this._state.isFromToolbarDownloadAs =
                this.mode.canRequestSaveAs || !!this.mode.saveAsUrl
              const options = new Asc.asc_CDownloadOptions(
        ...
        onLongActionBegin: function (type, id) {
          if (id === Asc.c_oAscAsyncAction.Submit && this.toolbar.btnSubmit) {
            ...
            this.toolbar.lockToolbar(Common.enumLock.submit, true, {
              array: [this.toolbar.btnSubmit],
            })
          }
        },
        ...
        onLongActionEnd: function (type, id) {
          if (id === Asc.c_oAscAsyncAction.Submit && this.toolbar.btnSubmit) {
            this.toolbar.lockToolbar(Common.enumLock.submit, false, {
              array: [this.toolbar.btnSubmit],
            })
        ...
        activateControls: function () {
          ...
          this.toolbar.lockToolbar(Common.enumLock.copyLock, this._state.can_copy !== true, {
            array: [this.toolbar.btnCopy],
          })
          this.toolbar.lockToolbar(Common.enumLock.cutLock, this._state.can_cut !== true, {
            array: [this.toolbar.btnCut],
          })
          this.api &&
            ...
            this.toolbar.lockToolbar(
              Common.enumLock.cantSave,
              (this.mode.canSaveToFile && !this.api.isDocumentModified()) ||
                !this.mode.showSaveButton,
              { array: [this.toolbar.btnSave] },
            )
        ...
        DisableToolbar: function (disable, viewMode) {
          ...
          const hkComments = Common.Utils.isMac ? "command+alt+a" : "alt+h"
          disable
        ...
        onAppShowed: function (config) {
          const editmode = config.isEdit || config.isRestrictedEdit
          ...
          if (config.isEdit || config.isRestrictedEdit) {
            ...
            if (!config.compactHeader) {
              ...
              const $box = this.toolbar.btnUndo.$el.hide().next().hide().parent()
          ...
          if (config.isEdit) {
            ...
            const drawtab = this.getApplication().getController("Common.Controllers.Draw")
            drawtab.setApi(this.api).setMode(config)
            $panel = drawtab.createToolbarPanel(true)
            if ($panel) {
              this.toolbar.$el.find(".draw-groups").after($panel)
            ...
            this.getApplication()
              ...
              .setApi(this.api)
            !config.canComments && this.toolbar.setVisible("comment", false)
            ...
            if ($panel) {
              ...
              this.toolbar.setVisible(
                "review",
                (config.isPDFAnnotate || config.isPDFEdit) &&
          ...
          let $panel = viewtab.createToolbarPanel()
          if ($panel) {
          ...
          if (config.isPDFEdit) {
            ...
            tab = {
              caption: this.toolbar.textTabInsert,
              action: "ins",
              extcls: config.isEdit ? "canedit" : "",
              layoutname: "toolbar-insert",
              dataHintTitle: "I",
            }
            const instab = this.getApplication().getController("InsTab")
            instab.setApi(this.api).setConfig({ toolbar: this, mode: config })
            $panel = instab.createToolbarPanel()
            if ($panel) {
              this.toolbar.addTab(tab, $panel, 1)
              this.toolbar.setVisible("ins", true)
            }

            tab = {
              caption: this.toolbar.textTabRedact,
              action: "red",
              extcls: config.isEdit ? "canedit" : "",
              layoutname: "toolbar-redact",
              dataHintTitle: "X",
            }
            const redacttab = this.getApplication().getController("RedactTab")
            redacttab.setApi(this.api).setConfig({ toolbar: this, mode: config })
            redacttab.onAppReady(config)
            $panel = redacttab.createToolbarPanel()
            if ($panel) {
              this.toolbar.addTab(tab, $panel, 2)
              this.toolbar.setVisible("red", true)
              redacttab.onDocumentReady()
            }

            if (config.canFeatureForms) {
              tab = {
                caption: this.textTabForms,
                action: "forms",
                layoutname: "toolbar-forms",
                dataHintTitle: "M",
              }
        ...
        applyMode: function (activeTab) {
          ...
          if (this.mode.isPDFEdit && this._state.initEditing) {
            ...
            setTimeout(() => {
              ...
              this.attachPDFEditUIEvents(toolbar)
              this.fillFontsStore(toolbar.cmbFontName, this._state.fontname)
              toolbar.lockToolbar(Common.enumLock.disableOnStart, false)
              this.getApplication()
                .getController("Main")
                .disableSaveButton(this.api.asc_isDocumentCanSave())
              this.onCountPages(this._state.pageCount)
              this.onApiFocusObject([])
              this.api.UpdateInterfaceState()
            }, 50)

            const tab = {
              caption: toolbar.textTabInsert,
              action: "ins",
              extcls: this.mode.isEdit ? "canedit" : "",
              layoutname: "toolbar-insert",
              dataHintTitle: "I",
            }
            const instab = this.getApplication().getController("InsTab")
            ...
            if (this.mode.canFeatureForms) {
              ...
              const forms = this.getApplication().getController("FormsTab")
              forms.setApi(this.api).setConfig({ toolbar: this, config: this.mode })
          ...
          if (activeTab) toolbar.setTab(activeTab)
          else if (
            this.mode.isPDFEdit ||
            toolbar.isTabActive("ins") ||
            toolbar.isTabActive("forms") ||
            toolbar.isTabActive("red")
          )
            toolbar.setTab("home")
          ...
          this.mode.isPDFEdit
            ? Common.UI.TooltipManager.showTip("redactTab")
            : Common.UI.TooltipManager.closeTip("redactTab")
        },
        ...
        onAppReady: function (config) {
          ...
          new Promise((accept) => {
            ...
            const hand = !config.isEdit
            this.toolbar?.btnHandTool &&
              this.toolbar[hand ? "btnHandTool" : "btnSelectTool"].toggle(true, true)
            this.api?.asc_setViewerTargetType(hand ? "hand" : "select")
            if (
              config.isRestrictedEdit &&
              this.toolbar &&
              this.toolbar.btnSubmit &&
              this.api &&
              !this.api.asc_IsAllRequiredFormsFilled()
            ) {
              this.toolbar.lockToolbar(Common.enumLock.requiredNotFilled, true, {
                array: [this.toolbar.btnSubmit],
              })
              if (!Common.localStorage.getItem("pdfe-embed-hide-submittip")) {
                this.requiredTooltip = new Common.UI.SynchronizeTip({
                  extCls: "colored",
                  placement: Common.UI.isRTL() ? "bottom-left" : "bottom-right",
                  target: this.toolbar.btnSubmit.$el,
                ...
                const onclose = () => {
                  this.requiredTooltip.hide()
                  this.api.asc_MoveToFillingForm(true, true, true)
                  this.toolbar.btnSubmit.updateHint(this.textRequired)
                }
                this.requiredTooltip.on("buttonclick", () => {
                  onclose()
                  Common.localStorage.setItem("pdfe-embed-hide-submittip", 1)
                })
                this.requiredTooltip.on("closeclick", onclose)
                this.requiredTooltip.show()
              } else {
                this.toolbar.btnSubmit.updateHint(this.textRequired)
              }
            }
            ...
            if (config.canComments) {
              ...
              if (this.btnsComment.length) {
                const _comments = PDFE.getController("Common.Controllers.Comments").getView()
                ...
                Array.prototype.push.apply(this.toolbar.toolbarControls, this.btnsComment)
              }
            }
          })
        },
        ...
        onActiveTab: function (tab) {
          ...
          } else Common.UI.TooltipManager.closeTip("annotRect")

          tab === "ins"
            ? Common.UI.TooltipManager.showTip("createLink")
        ...
        applySettings: function () {
          this.toolbar?.chShowComments?.setValue(
            Common.Utils.InternalSettings.get("pdfe-settings-livecomment"),
            true,
          )
        },
        ...
        fillFontsStore: function (combo, name) {
          if (combo.store.length === 0) {
            const fontstore = new Common.Collections.Fonts()
            const fonts = this.getCollection("Common.Collections.Fonts").toJSON()
            const arr = []
        ...
        onApiCanIncreaseIndent: function (value) {
          ...
          if (this._state.can_increase !== value) {
            this.toolbar.lockToolbar(Common.enumLock.incIndentLock, !value, {
        ...
        onApiCanDecreaseIndent: function (value) {
          ...
          if (this._state.can_decrease !== value) {
            this.toolbar.lockToolbar(Common.enumLock.decIndentLock, !value, {
        ...
        onApiBullets: function (v) {
          if (!this.mode.isPDFEdit || !this.mode.isEdit) return
          if (!this.toolbar.mnuMarkersPicker?.store) {
          ...
          if (
            ...
            (v.get_ListType() === 0 && v.get_ListSubType() === 0x1000)
          ) {
            this._state.bullets.type = v.get_ListType()
            this._state.bullets.subtype = v.get_ListSubType()

            const rec = this.toolbar.mnuMarkersPicker.store.at(8)
            let drawDefBullet =
              rec.get("data").subtype === 0x1000 &&
              (this._state.bullets.type === 1 || this._state.bullets.subtype !== 0x1000)
            ...
            switch (this._state.bullets.type) {
              case 0: {
                let idx
                if (this._state.bullets.subtype !== 0x1000) idx = this._state.bullets.subtype
                else {
                  // custom
                  const bullet = v.asc_getListCustom()
                  if (bullet) {
                    const type = bullet.asc_getType()
                    if (type === Asc.asc_PreviewBulletType.char) {
                      const symbol = bullet.asc_getChar()
                      if (symbol) {
                        const custombullet = new Asc.asc_CBullet()
                ...
                idx !== undefined
                  ? this.toolbar.mnuMarkersPicker.selectByIndex(idx, true)
            ...
            if (drawDefBullet) {
              ...
              this.toolbar.mnuMarkersPicker.dataViewItems &&
                this.updateBulletTip(
                  this.toolbar.mnuMarkersPicker.dataViewItems[8],
                  this.toolbar.tipMarkersDash,
                )
            }
          }
        },
        ...
        onApiParagraphAlign: function (v) {
          ...
          if (this._state.pralign !== v) {
            ...
            let index = -1
            let align
            const btnHorizontalAlign = this.toolbar.btnHorizontalAlign
        ...
        onApiVerticalTextAlign: function (v) {
          ...
          if (this._state.vtextalign !== v) {
            ...
            let index = -1
            let align = ""
            const btnVerticalAlign = this.toolbar.btnVerticalAlign
        ...
        onApiLineSpacing: function (vc) {
          ...
          if (this._state.linespace !== line) {
            ...
            const mnuLineSpace = this.toolbar.btnLineSpace.menu
            mnuLineSpace.clearAll(true)
            if (line < 0) return

            if (Math.abs(line - 1) < 0.0001) mnuLineSpace.items[0].setChecked(true, true)
            else if (Math.abs(line - 1.15) < 0.0001) mnuLineSpace.items[1].setChecked(true, true)
            else if (Math.abs(line - 1.5) < 0.0001) mnuLineSpace.items[2].setChecked(true, true)
            else if (Math.abs(line - 2) < 0.0001) mnuLineSpace.items[3].setChecked(true, true)
            else if (Math.abs(line - 2.5) < 0.0001) mnuLineSpace.items[4].setChecked(true, true)
            else if (Math.abs(line - 3) < 0.0001) mnuLineSpace.items[5].setChecked(true, true)
          }
        },
        ...
        onMenuVerticalAlignSelect: function (menu, item) {
          ...
          if (this.api && item.checked) this.api.setVerticalAlign(item.value)
        ...
        onMarkerSettingsClick: function (type) {
          ...
          if (props) {
            new Common.Views.ListSettingsDialog({
              ...
              interfaceLang: this.toolbar.mode.lang,
        ...
        onListShowAfter: function (type, picker) {
          ...
          if (this.api?.SetDrawImagePreviewBulletForMenu) {
        ...
        onSelectBullets: function (btn, picker, itemView, record) {
          ...
          if (this.api) {
            if (rawData.data.type === 0 && rawData.data.subtype === 0x1000) {
              // custom bullet
              const bullet = rawData.customBullet
              if (bullet) {
                const selectedElements = this.api.getSelectedElements()
                if (selectedElements && _.isArray(selectedElements)) {
                  for (let i = 0; i < selectedElements.length; i++) {
                    if (
                      Asc.c_oAscTypeSelectElement.Paragraph === selectedElements[i].get_ObjectType()
                    ) {
                      const props = selectedElements[i].get_ObjectValue()
            ...
            } else this.api.put_ListType(rawData.data.type, rawData.data.subtype)
          }
              ...
              if (selectedElements && selectedElements.length > 0) {
                ...
                for (let i = selectedElements.length - 1; i >= 0; i--) {
                  ...
                  if (Asc.c_oAscTypeSelectElement.Shape === elType) {
                    const win = new PDFE.Views.ShapeSettingsAdvanced({
                      shapeProps: elValue,
                      slideSize: {
                        width: this.api.get_PageWidth(),
                        height: this.api.get_PageHeight(),
                      },
                      handler: (result, value) => {
                        if (result === "ok") {
                          if (this.api) {
          ...
          if (selectedElements && selectedElements.length > 0) {
            ...
            for (let i = selectedElements.length - 1; i >= 0; i--) {
              if (Asc.c_oAscTypeSelectElement.Shape === selectedElements[i].get_ObjectType()) {
                const value = selectedElements[i].get_ObjectValue().asc_getColumnNumber()
                if (value < 4) index = value - 1
                break
              }
            }
          }
        ...
        onShapeAlign: function (menu, item) {
          if (this.api) {
            const value = this.toolbar.mniAlignToSlide.isChecked()
        ...
        onDelPage: function () {
          this.api?.asc_RemovePage([this.api.getCurrentPage()])
          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        },

        onRotatePage: function () {
          this.api?.asc_RotatePage(90, [this.api.getCurrentPage()])
          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        },

        onRotatePageMenu: function (menu, item) {
          this.api?.asc_RotatePage(item.value, [this.api.getCurrentPage()])
          Common.NotificationCenter.trigger("edit:complete", this.toolbar)
        },
        ...
        onBtnFontColor: function () {
          this.toolbar.mnuFontColorPicker.trigger(
            ...
            this.toolbar.mnuFontColorPicker.currentColor || this.toolbar.btnFontColor.currentColor,
          )
        },
        ...
        onApiTextColor: function (color) {
          if (!this.mode.isPDFEdit || !this.mode.isEdit) return
          let clr
          const picker = this.toolbar.mnuFontColorPicker
          ...
          if (c) {
            if (c === -1) {
              ...
              if (this._state.textclrhighlight !== c.get_hex().toUpperCase()) {
                ...
                if (
                  this.toolbar.mnuTextHighlightColorPicker &&
                  _.contains(
                    this.toolbar.mnuTextHighlightColorPicker.colors,
                    this._state.textclrhighlight,
                  )
                )
                  this.toolbar.mnuTextHighlightColorPicker.selectByRGB(
                    this._state.textclrhighlight,
                    true,
                  )
              }
        ...
        _setMarkerColor: function (strcolor, h) {
          ...
          if (h === "menu") {
            this._state.textclrhighlight = undefined
            this.onApiTextHighlightColor()

            this.toolbar.btnTextHighlightColor.currentColor = strcolor
            this.toolbar.btnTextHighlightColor.setColor(
              this.toolbar.btnTextHighlightColor.currentColor,
            )
            this.toolbar.btnTextHighlightColor.toggle(true, true)
          }

          strcolor = strcolor || "transparent"

          if (strcolor === "transparent") {
            this.api.SetMarkerFormat(undefined, true, false)
          } else {
            const r = strcolor[0] + strcolor[1]
            const g = strcolor[2] + strcolor[3]
            const b = strcolor[4] + strcolor[5]
          ...
          Common.NotificationCenter.trigger(
            "edit:complete",
            this.toolbar,
            this.toolbar.btnTextHighlightColor,
          )
        ...
        onApiTextDirection: function (isRtl) {
          const toolbar = this.toolbar
          const oldRtl = toolbar.btnTextDir.options.dirRtl
          const newRtl = !!isRtl
          if (oldRtl !== newRtl) {
        ...
        changePDFMode: function (data) {
          this.toolbar?.btnEditMode?.toggle(!!this.mode.isPDFEdit, true)
        },
        ...
        txtNeedCommentMode:
          "To save changes to the file, switch to Сommenting mode. Or you can download a copy of the modified file.",
        txtNeedDownload:
          "At the moment, PDF viewer can only save new changes in separate file copies. It doesn't support co-editing and other users won't see your changes unless you share a new file version.",
        ...
        confirmAddFontName:
          "The font you are going to save is not available on the current device.<br>The text style will be displayed using one of the device fonts, the saved font will be used when it is available.<br>Do you want to continue?",
