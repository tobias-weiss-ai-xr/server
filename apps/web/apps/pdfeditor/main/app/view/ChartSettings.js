...
define([
  ...
  PDFE.Views.ChartSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        ChangeSettings: function (props) {
          ...
          if (props) {
            ...
            let value = props.get_SeveralCharts() || this._locked
        ...
        createDelayedControls: function () {
          ...
          this.btnRatio.on(
            ...
            _.bind(function (btn, e) {
              ...
              if (this.api) {
                const props = new Asc.CAscChartProp()
          ...
          if (this.api && !this._noApply) {
            ...
            if (isCombo && this.chartProps.getSeries().length < 2) {
              ...
              this.mnuChartTypePicker.selectRecord(
                this.mnuChartTypePicker.store.findWhere({ type: this._originalProps.getType() }),
                true,
              )
            } else {
