...
define([
  ...
  PDFE.Views.ChartSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 340,
        ...
        _setDefaults: function (props) {
          ...
          if (props) {
            ...
            this.spnWidth.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.asc_getWidth()).toFixed(2),
              true,
            )
            this.spnHeight.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.asc_getHeight()).toFixed(2),
              true,
            )
            ...
            if (props.asc_getPosition()) {
              const Position = {
                X: props.asc_getPosition().get_X(),
                Y: props.asc_getPosition().get_Y(),
              }
              this.spnX.setValue(
        ...
        getSettings: function () {
          ...
          if (this.spnX.getValue() !== "") {
            let x = Common.Utils.Metric.fnRecalcToMM(this.spnX.getNumberValue())
          ...
          if (this.spnY.getValue() !== "") {
            let y = Common.Utils.Metric.fnRecalcToMM(this.spnY.getNumberValue())
          ...
          if (this.isAltTitleChanged) this._changedProps.asc_putTitle(this.inputAltTitle.getValue())
        ...
        _setChartDefaults: function (props) {
          ...
          this.cmbDataLabels.setDisabled(
            this.currentChartType === Asc.c_oAscChartTypeSettings.surfaceNormal ||
