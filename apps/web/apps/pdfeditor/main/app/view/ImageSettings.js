...
define([
  ...
  PDFE.Views.ImageSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        createDelayedControls: function () {
          ...
          let w = Math.max(this.btnOriginalSize.cmpEl.width(), this.btnFitSlide.cmpEl.width())
        ...
        ChangeSettings: function (props) {
          ...
          if (props) {
            ...
            if (this._state.isOleObject) {
              const plugin = PDFE.getCollection("Common.Collections.Plugins").findWhere({
                guid: pluginGuid,
              })
