...
define([
  ...
  PDFE.Views.ImageSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            if (props.get_Position()) {
              const Position = { X: props.get_Position().get_X(), Y: props.get_Position().get_Y() }
              this.spnX.setValue(
        ...
        getSettings: function () {
          ...
          if (this.isImgNameChanged) properties.asc_putName(this.inputImageName.getValue())
