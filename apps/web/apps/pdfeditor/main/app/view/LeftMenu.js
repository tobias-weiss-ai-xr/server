...
define([
  ...
  PDFE.Views.LeftMenu = Common.UI.SideMenu.extend(
    _.extend(
      {
        el: "#left-menu",
        ...
        onBtnMenuClick: function (btn, e) {
          ...
          if (btn.pressed) {
            if (!(this.$el.width() > SCALE_MIN)) {
              this.$el.width(
                Number.parseInt(Common.localStorage.getItem("pdfe-mainmenu-width")) ||
                  MENU_SCALE_PART,
              )
            }
            ...
            this.isVisible() &&
              width > SCALE_MIN &&
              Common.localStorage.setItem("pdfe-mainmenu-width", width)
          ...
          btn.pressed &&
            btn.options.action === "advancedsearch" &&
        ...
        setOptionsPanel: function (name, panel) {
          ...
          } /** coauthoring end **/ else if (name === "navigation" && !this.panelNavigation) {
