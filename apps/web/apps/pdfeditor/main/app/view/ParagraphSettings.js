...
define([
  ...
  PDFE.Views.ParagraphSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        onNumSpacingBeforeChange: function (field, newValue, oldValue, eOpts) {
          if (this.api) {
            ...
            if (num < 0) this.api.put_LineSpacingBeforeAfter(0, -1)
            else
              this.api.put_LineSpacingBeforeAfter(
                0,
                Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
              )
          }
        ...
        onNumSpacingAfterChange: function (field, newValue, oldValue, eOpts) {
          if (this.api) {
            const num = field.getNumberValue()
            if (num < 0) this.api.put_LineSpacingBeforeAfter(1, -1)
            else
              this.api.put_LineSpacingBeforeAfter(
                1,
                Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
