...
define([
  ...
  PDFE.Views.ParagraphSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 370,
        ...
        initialize: function (options) {
          ...
          const curLineRule = this._originalProps.get_Spacing().get_LineRule()
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            this.numIndentsLeft.setValue(
              props.get_Ind() !== null && props.get_Ind().get_Left() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.get_Ind().get_Left())
                : "",
              true,
            )
