...
define([
  ...
  PDFE.Views.RightMenu = Common.UI.SideMenu.extend(
    _.extend(
      {
        el: "#right-menu",
        ...
        render: function (mode) {
          ...
          if (mode?.canFeatureForms) {
            ...
            this.btnForm.setElement($("#id-right-menu-form"), false)
        ...
        setButtons: function () {
          const allButtons = [
            ...
            this.btnTable,
            this.btnTextArt,
            this.btnChart /*, this.btnSignature*/,
            this.btnForm,
          ]
        ...
        setInnerWidth: function (value) {
          ...
          this.$el.css(
            "width",
            `${!Common.Utils.InternalSettings.get("pdfe-hide-right-settings") ? MENU_SCALE_PART : SCALE_MIN}px`,
          )
        },
