...
define([
  ...
  PDFE.Views.ShapeSettings = Backbone.View.extend(
    _.extend(
      {
                ...
                (this.mnuShadowShapeColor = new Common.UI.MenuItem({
                  ...
                  menu: new Common.UI.Menu({
                    ...
                    items: [
                      {
                        template: _.template(
                          '<div id="shape-button-shadow-shape-menu-picker" style="width: 174px;display: inline-block;"></div>',
                        ),
        ...
        onInitStandartTextures: function (texture) {
          if (
            (!texture || texture.length < 1) &&
            (!this._texturearray || this._texturearray.length < 1)
          ) {
        ...
        fillAutoShapes: function () {
          const recents = Common.localStorage.getItem("pdfe-recent-shapes")
