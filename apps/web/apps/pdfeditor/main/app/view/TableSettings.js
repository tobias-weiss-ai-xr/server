...
define([
  ...
  PDFE.Views.TableSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        _UpdateBorderStyle: function (border, visible) {
          ...
          if (visible && this.BorderSize > 0) {
            ...
            const color = Common.Utils.ThemeColor.getRgbColor(this.btnBorderColor.color)
        ...
        onBeginTableStylesPreview: function (count) {
          ...
          this._state.groups = {
            ...
            "menu-table-group-optimal": {
              id: "menu-table-group-optimal",
              caption: this.txtGroupTable_Optimal,
              index: 1,
              templateCount: 0,
            },
            "menu-table-group-light": {
              id: "menu-table-group-light",
              caption: this.txtGroupTable_Light,
              index: 2,
              templateCount: 0,
            },
            "menu-table-group-medium": {
              id: "menu-table-group-medium",
              caption: this.txtGroupTable_Medium,
              index: 3,
              templateCount: 0,
            },
            "menu-table-group-dark": {
              id: "menu-table-group-dark",
              caption: this.txtGroupTable_Dark,
              index: 4,
              templateCount: 0,
            },
        ...
        onAddTableStylesPreview: function (Templates) {
          _.each(Templates, (template) => {
            ...
            if (template.asc_getType() === 0) {
              ...
              if (/No Style|Themed Style/i.test(tip)) {
              ...
              ;[
                ...
                const str = `txtTable_${item.replace(" ", "")}`
                if (this[str]) tip = tip.replace(new RegExp(item, "g"), this[str])
              })
            } else {
