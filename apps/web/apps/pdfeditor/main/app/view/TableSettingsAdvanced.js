...
define([
  ...
  PDFE.Views.TableSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.spnTableMarginRight, // 2 tab
              this.inputAltTitle,
              this.textareaAltDescription, // 3 tab
            ])
        ...
        onCategoryClick: function (btn, index) {
          ...
          setTimeout(() => {
            switch (index) {
              case 0:
                this.inputTableName.focus()
                break
              case 1:
                this.spnWidth.focus()
                break
              case 2:
                if (!this.spnMarginTop.isDisabled()) this.spnMarginTop.focus()
        ...
        getSettings: function () {
          ...
          if (this.spnHeight.getValue() !== "")
            this._changedProps.put_FrameHeight(
              Common.Utils.Metric.fnRecalcToMM(this.spnHeight.getNumberValue()),
            )
          if (this.spnWidth.getValue() !== "")
            this._changedProps.put_FrameWidth(
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            this.spnWidth.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.get_FrameWidth()).toFixed(2),
              true,
            )
            this.spnHeight.setValue(
              Common.Utils.Metric.fnRecalcFromMM(props.get_FrameHeight()).toFixed(2),
              true,
            )
            ...
            const position = { x: props.get_FrameX(), y: props.get_FrameY() }
            this.spnX.setValue(
