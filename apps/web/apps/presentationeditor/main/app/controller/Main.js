...
define([
  ...
  PE.Controllers.Main = Backbone.Controller.extend(
    _.extend(
      (() => {
        let appHeader
        ...
        return {
          ...
          initialize: function () {
            ...
            themeNames.forEach((item) => {
              translate[item] = this[`txtTheme_${item.replace(/ /g, "_")}`] || item
            })
          ...
          onLaunch: function () {
            ...
            if (this.api) {
              ...
              let value = Common.localStorage.getBool("pe-settings-cachemode", true)
              ...
              this.api.asc_registerCallback(
                "asc_onThumbnailsShow",
                _.bind(this.onThumbnailsShow, this),
              )
              this.api.asc_registerCallback(
              ...
              this.api.asc_registerCallback(
                ...
                _.bind(this.onEndDemonstration, this),
              )
          ...
          loadConfig: function (data) {
            ...
            if (
              ...
              $("#editor-container").append(
                '<div class="doc-placeholder"><div class="slide-h"><div class="slide-v"><div class="slide-container"><div class="line"></div><div class="line empty"></div><div class="line"></div></div></div></div></div>',
              )
            }
          ...
          onDownloadAs: function (format) {
            ...
            if (!_format || _supported.indexOf(_format) < 0) _format = Asc.c_oAscFileType.PPTX
          ...
          onEditComplete: function (cmp) {
            ...
            const toolbarView = application.getController("Toolbar").getView("Toolbar")
          ...
          disableSaveButton: function (isCanSave) {
            const toolbarView = this.getApplication().getController("Toolbar").getView("Toolbar")
          ...
          onDocumentContentReady: function () {
            ...
            value = Common.localStorage.getBool(
              "pe-hidden-notes",
              this.appOptions.customization && this.appOptions.customization.hideNotes === true,
            )
            ...
            this.appOptions.customization?.slidePlayerBackground &&
              this.api.asc_setDemoBackgroundColor(
                this.appOptions.customization.slidePlayerBackground,
              )
            ...
            if (me.appOptions.isEdit) {
              ...
              Common.Utils.InternalSettings.set("pe-settings-paste-button", Number.parseInt(value))
          ...
          onEditingDisable: function (disable, options, type) {
            ...
            if (options.documentPreview) {
              options.documentPreview.draw &&
                app.getController("Viewport").setDisabledPreview(disable)
            }
            if (prev_options) {
            ...
            if (
              ...
              if (!this.appOptions.canChangeCoAuthoring) {
                ...
                if (value === null) {
                  ...
                  if (
                    value === null &&
                    !Common.localStorage.itemExists("pe-settings-autosave") &&
                    this.appOptions.customization &&
                    this.appOptions.customization.autosave === false
                  ) {
          ...
          applyModeCommonElements: function () {
            ...
            viewport?.setMode(this.appOptions, true)
          ...
          applyModeEditorElements: function (prevmode) {
            /** coauthoring begin **/
            const commentsController = this.getApplication().getController(
              "Common.Controllers.Comments",
            )
            if (commentsController) {
              commentsController.setMode(this.appOptions)
              commentsController.setConfig(
                { config: this.editorConfig, sdkviewname: "#id_main_parent" },
                this.api,
              )
            }
            const application = this.getApplication()
            ...
            if (this.appOptions.isEdit) {
              ...
              const toolbarView = toolbarController ? toolbarController.getView("Toolbar") : null
              if (toolbarView) {
              ...
              let value = Common.localStorage.getItem("pe-settings-unit")
              value =
                value !== null
                  ? Number.parseInt(value)
              ...
              value = Common.localStorage.itemExists("pe-hidden-rulers")
                ? Common.localStorage.getBool("pe-hidden-rulers")
                : !this.appOptions.customization ||
                  this.appOptions.customization.hideRulers !== false
              Common.Utils.InternalSettings.set("pe-hidden-rulers", value)
              if (this.api.asc_SetViewRulers) this.api.asc_SetViewRulers(!value)

              this.api.asc_registerCallback(
                "asc_onChangeObjectLock",
                _.bind(this._onChangeObjectLock, this),
              )
              this.api.asc_registerCallback(
          ...
          showTips: function (strings) {
            ...
            tooltip.on("tooltip:hideonclick", () => {
          ...
          fillUserStore: function (users) {
            if (!_.isEmpty(users)) {
              const userStore = this.getCommonStoreUsersStore()

              if (userStore) userStore.add(users)
            }
          },
          ...
          initNames: function () {
            ...
            this.layoutNames = [
              this.txtSldLtTBlank,
              this.txtSldLtTChart,
              this.txtSldLtTChartAndTx,
              this.txtSldLtTClipArtAndTx,
              this.txtSldLtTClipArtAndVertTx,
              this.txtSldLtTCust,
              this.txtSldLtTDgm,
              this.txtSldLtTFourObj,
              this.txtSldLtTMediaAndTx,
              this.txtSldLtTObj,
              this.txtSldLtTObjAndTwoObj,
              this.txtSldLtTObjAndTx,
              this.txtSldLtTObjOnly,
              this.txtSldLtTObjOverTx,
              this.txtSldLtTObjTx,
              this.txtSldLtTPicTx,
              this.txtSldLtTSecHead,
              this.txtSldLtTTbl,
              this.txtSldLtTTitle,
              this.txtSldLtTTitleOnly,
              this.txtSldLtTTwoColTx,
              this.txtSldLtTTwoObj,
              this.txtSldLtTTwoObjAndObj,
              this.txtSldLtTTwoObjAndTx,
              this.txtSldLtTTwoObjOverTx,
              this.txtSldLtTTwoTxTwoObj,
              this.txtSldLtTTx,
              this.txtSldLtTTxAndChart,
              this.txtSldLtTTxAndClipArt,
              this.txtSldLtTTxAndMedia,
              this.txtSldLtTTxAndObj,
              this.txtSldLtTTxAndTwoObj,
              this.txtSldLtTTxOverObj,
              this.txtSldLtTVertTitleAndTx,
              this.txtSldLtTVertTitleAndTxOverChart,
              this.txtSldLtTVertTx,
            ]
          },
          ...
          onFocusObject: function (SelectedObjects) {
            const rightpan = this.getApplication().getController("RightMenu")
            if (rightpan) rightpan.onFocusObject.call(rightpan, SelectedObjects)
          },

          _onChangeObjectLock: function () {
            const elements = this.api.getSelectedElements()
          ...
          fillLayoutsStore: function (layouts) {
            if (!_.isEmpty(layouts)) {
              const layoutStore = this.getCollection("SlideLayouts")
              if (layoutStore) {
                const layoutarray = []
                _.each(layouts, (layout) => {
                  const name = layout.get_Name()
                  layoutarray.push({
                    imageUrl: layout.get_Image(),
                    title: name !== "" ? name : this.layoutNames[layout.getType()],
          ...
          onPrintQuick: function () {
            ...
            const value = Common.localStorage.getBool("pe-hide-quick-print-warning")
            const handler = () => {
          ...
          onRunAutostartMacroses: function () {
            const enable =
              !this.editorConfig.customization || this.editorConfig.customization.macros !== false
            if (enable) {
              const value = Common.Utils.InternalSettings.get("pe-macros-mode")
          ...
          onMacrosPermissionRequest: function (url, callback) {
            ...
            const value = Common.Utils.InternalSettings.get("pe-allow-macros-request")
            if (value > 0) {
              callback?.(value === 1)
          ...
          loadAutoCorrectSettings: function () {
            let value = Common.localStorage.getItem("pe-settings-math-correct-add")
            ...
            value =
              value !== null
                ...
                : Common.localStorage.getBool("pe-settings-autoformat-fl-sentence", true)
            ...
            value =
              value !== null
                ? Number.parseInt(value) !== 0
                : Common.localStorage.getBool("pe-settings-autoformat-fl-cells", true)
            ...
            value = Common.localStorage.getBool(
              "pe-settings-autoformat-double-space",
              Common.Utils.isMac,
          ...
          onPreviewStart: function () {
            ...
            if (this._renameDialog?.isVisible()) this._renameDialog.hide()
          },

          onEndDemonstration: function () {
            this._state.previewStarted = false
            if (this._renameDialog && !this._renameDialog.isVisible()) this._renameDialog.show()
          },
