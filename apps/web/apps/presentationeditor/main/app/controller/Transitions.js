...
define([
  ...
  PE.Controllers.Transitions = Backbone.Controller.extend(
    _.extend(
      {
        models: [],
        collections: [],
        views: ["PE.Views.Transitions"],
        options: {
          alias: "Transitions",
        },
        sdkViewName: "#id_main",
        ...
        onEffectSelect: function (combo, record) {
          ...
          let parameter = this._state.EffectType

          if (
            this._state.Effect !== type &&
            !(
              (this._state.Effect === Asc.c_oAscSlideTransitionTypes.Wipe ||
                this._state.Effect === Asc.c_oAscSlideTransitionTypes.UnCover ||
                this._state.Effect === Asc.c_oAscSlideTransitionTypes.Cover) &&
              (type === Asc.c_oAscSlideTransitionTypes.Wipe ||
                type === Asc.c_oAscSlideTransitionTypes.UnCover ||
                type === Asc.c_oAscSlideTransitionTypes.Cover)
            )
          )
        ...
        onFocusObject: function (selectedObjects) {
          for (let i = 0; i < selectedObjects.length; i++) {
            ...
            if (eltype === undefined) continue

            if (eltype === Asc.c_oAscTypeSelectElement.Slide) {
              let locked_transition = undefined
              const pr = selectedObjects[i].get_ObjectValue()
              locked_transition = pr.get_LockTransition()

              if (
                locked_transition !== undefined &&
                this._state.lockedtransition !== locked_transition
              )
                if (this.view.toolbar._state.activated)
                  this._state.lockedtransition = locked_transition
        ...
        loadSettings: function (props) {
          const transition = props.get_transition()

          if (transition) {
            this._state.Effect = transition.get_TransitionType()
            this._state.EffectType = transition.get_TransitionOption()

            let value = transition.get_TransitionDuration()
            if (
              Math.abs(this._state.Duration - value) > 0.001 ||
              ((this._state.Duration === null || value === null) &&
                this._state.Duration !== value) ||
              ((this._state.Duration === undefined || value === undefined) &&
                this._state.Duration !== value)
            ) {
              this._state.Duration = value
            }
        ...
        setSettings: function () {
          ...
          if (this._state.Effect !== undefined) {
            const item = me.listEffects.store.findWhere({ value: this._state.Effect })
          ...
          me.numDuration.setValue(
            this._state.Duration !== null && this._state.Duration !== undefined
              ? this._state.Duration / 1000
              : "",
            true,
          )
          me.numDelay.setValue(
            this._state.Delay !== null && this._state.Delay !== undefined
              ? this._state.Delay / 1000
              : "",
            true,
          )
          me.chStartOnClick.setValue(
            this._state.OnMouseClick !== null && this._state.OnMouseClick !== undefined
              ? this._state.OnMouseClick
              : "indeterminate",
            true,
          )
          me.chDelay.setValue(
            this._state.AdvanceAfter !== null && this._state.AdvanceAfter !== undefined
              ? this._state.AdvanceAfter
              : "indeterminate",
            true,
          )
