...
define([], () => {
  ...
  PE.Views.FileMenuPanels.Settings = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-settings",
        menu: undefined,
        ...
        render: function (node) {
          ...
          this.chAutosave = new Common.UI.CheckBox({
            ...
            if (field.getValue() !== "checked" && this.rbCoAuthModeFast.getValue()) {
              this.rbCoAuthModeStrict.setValue(1)
            }
          })
          ...
          this.cmbMacros = new Common.UI.ComboBox({
            ...
            this.lblMacrosDesc.text(record.descValue)
          })
        ...
        setMode: function (mode) {
          ...
          const fast_coauth = Common.Utils.InternalSettings.get("pe-settings-coauthmode")
        ...
        updateSettings: function () {
          if (Common.UI.FeaturesManager.canChange("spellcheck")) {
            ...
            this.chIgnoreUppercase.setValue(
              Common.Utils.InternalSettings.get("pe-spellcheck-ignore-uppercase-words"),
            )
            this.chIgnoreNumbers.setValue(
              Common.Utils.InternalSettings.get("pe-spellcheck-ignore-numbers-words"),
            )
          }
          ...
          let value = Common.Utils.InternalSettings.get("pe-settings-zoom")
          value =
            value !== null
          ...
          this.chAlignGuides.setValue(
            Common.Utils.InternalSettings.get("pe-settings-showsnaplines"),
          )

          item = this.cmbMacros.store.findWhere({
            value: Common.Utils.InternalSettings.get("pe-macros-mode"),
          })
        ...
        applySettings: function () {
          ...
          if (
            this.mode.isEdit &&
            (this.mode.canChangeCoAuthoring ||
              !Common.Utils.InternalSettings.get("pe-settings-coauthmode"))
          )
  ...
  PE.Views.FileMenuPanels.CreateNew = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-createnew",
        menu: undefined,
  ...
  PE.Views.FileMenuPanels.DocumentInfo = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-info",
        menu: undefined,
  ...
  PE.Views.FileMenuPanels.DocumentRights = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-rights",
        menu: undefined,
      ...
      this.en_data = [
        {
          ...
          name: "Introducing Presentation Editor user interface",
        ...
        { src: "ProgramInterface/PluginsTab.htm", name: "Plugins tab" },
        {
          ...
          name: "Create a new presentation or open an existing one",
          headername: "Basic operations",
        },
        {
          src: "UsageInstructions/CopyPasteUndoRedo.htm",
          name: "Copy/paste data, undo/redo your actions",
        },
        {
          src: "UsageInstructions/ManageSlides.htm",
          name: "Manage slides",
          headername: "Working with slides",
        },
        ...
        { src: "UsageInstructions/PreviewPresentation.htm", name: "Preview your presentation" },
        {
          ...
          name: "Insert and format your text",
        ...
        { src: "UsageInstructions/CopyClearFormatting.htm", name: "Copy/clear formatting" },
        {
          ...
          name: "Insert and format autoshapes",
        ...
        { src: "UsageInstructions/InsertTables.htm", name: "Insert and format tables" },
        {
          ...
          name: "Fill objects and select colors",
        },
        { src: "UsageInstructions/ManipulateObjects.htm", name: "Manipulate objects on a slide" },
        {
          ...
          name: "Align and arrange objects on a slide",
        },
        {
        ...
        },
        {
          ...
          name: "Collaborative presentation editing",
          headername: "Presentation co-editing",
        },
        {
          src: "UsageInstructions/ViewPresentationInfo.htm",
          name: "View presentation information",
          headername: "Tools and settings",
        },
        {
          src: "UsageInstructions/SavePrintDownload.htm",
          name: "Save/print/download your presentation",
        },
        {
          src: "HelpfulHints/AdvancedSettings.htm",
          name: "Advanced settings of Presentation Editor",
        },
        ...
        { src: "HelpfulHints/SpellChecking.htm", name: "Spell-checking" },
        {
          ...
          name: "About Presentation Editor",
          headername: "Helpful hints",
        },
        {
          src: "HelpfulHints/SupportedFormats.htm",
          name: "Supported formats of electronic presentations",
        },
  ...
  PE.Views.FileMenuPanels.ProtectDoc = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-protect",
        menu: undefined,
        ...
        render: function () {
          ...
          const protection = PE.getController("Common.Controllers.Protection").getView()
        ...
        onView: function () {
          this.menu?.hide()
          PE.getController("RightMenu").rightmenu.SetActivePane(
        ...
        txtSigned:
          "Valid signatures has been added to the presentation. The presentation is protected from editing.",
        txtSignedInvalid:
        ...
        txtEditWarning:
          "Editing will remove the signatures from the presentation.<br>Are you sure you want to continue?",
        ...
        txtAddSignature:
          "Ensure the integrity of the presentation by adding an<br>invisible digital signature",
        txtAddedSignature:
          "Valid signatures have been added to the presentation.<br>The presentation is protected from editing.",
      },
      PE.Views.FileMenuPanels.ProtectDoc || {},
    ),
  )

  PE.Views.PrintWithPreview = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-print",
        menu: undefined,
