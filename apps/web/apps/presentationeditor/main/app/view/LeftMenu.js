...
define([
  ...
  PE.Views.LeftMenu = Common.UI.SideMenu.extend(
    _.extend(
      {
        el: "#left-menu",
          ...
          if (btn.options.action === "thumbs") {
            if (!btn.pressed && this._state.pluginIsRunning) {
              ...
              if (this._state.pluginIsRunning)
                // hide comments or chat panel when plugin is running
        ...
        showHistory: function () {
          ...
          this.panelHistory.$el.width(
            (Number.parseInt(Common.localStorage.getItem("pe-mainmenu-width")) || MENU_SCALE_PART) -
              SCALE_MIN,
          )
