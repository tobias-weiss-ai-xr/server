...
define([
  ...
  PE.Views.RightMenu = Common.UI.SideMenu.extend(
    _.extend(
      {
        el: "#right-menu",
        ...
        render: function (mode) {
          ...
          this.btnText.render()
          this.btnTable.setElement($("#id-right-menu-table"), false)
          this.btnTable.render()
          this.btnImage.setElement($("#id-right-menu-image"), false)
          this.btnImage.render()
          this.btnSlide.setElement($("#id-right-menu-slide"), false)
        ...
        setApi: function (api) {
          ...
          this.slideSettings
            .setApi(api)
            .on("editcomplete", _.bind(fire, this))
          ...
          if (this.signatureSettings)
            this.signatureSettings.setApi(api).on("editcomplete", _.bind(fire, this))
        },
        ...
        setMode: function (mode) {
          ...
          this.slideSettings?.setMode(mode)
        ...
        setInnerWidth: function (value) {
          ...
          this.$el.css(
            "width",
            `${!Common.Utils.InternalSettings.get("pe-hide-right-settings") ? MENU_SCALE_PART : SCALE_MIN}px`,
          )
        },
