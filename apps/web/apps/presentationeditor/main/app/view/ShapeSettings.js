...
define([
  ...
  PE.Views.ShapeSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        onGradientChangeComplete: function (slider, newValue, oldValue) {
          ...
          for (let index = 0; index < slider.thumbs.length; index++) {
        ...
        ChangeSettings: function (props) {
          ...
          if (props) {
            ...
            const shapetype = props.asc_getType()
            ...
            this.hideRotationSettings(
              props.get_FromChart() || !!props.get_FromImage() || props.get_FromSmartArt(),
            )
            ...
            if (!hidechangetype && this.btnChangeShape.menu.items.length) {
              this.btnChangeShape.shapePicker.hideTextRect(
                props.get_FromImage() || this._state.isFromSmartArtInternal,
              )
            }

            // background colors
            let rec = null
            let fill = props.get_fill()
            ...
            const shadow = props.asc_getShadow()
        ...
        fillAutoShapes: function () {
          const recents = Common.localStorage.getItem("pe-recent-shapes")
          ...
          this.btnChangeShape.shapePicker.on("item:click", (picker, item, record, e) => {
            if (this.api) {
              PE.getController("Toolbar").toolbar.cmbsInsertShape.forEach((cmb) => {
