...
define([
  ...
  PE.Views.ShapeSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 300,
        ...
        render: function () {
          ...
          this.spnColumns.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) this._changedProps.asc_putColumnNumber(field.getNumberValue())
            }, this),
          )
          ...
          this.spnSpacing.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps)
                this._changedProps.asc_putColumnSpace(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
            }, this),
          )
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.spnAngle,
              this.chFlipHor,
              this.chFlipVert, // 2 tab
              this.cmbCapType,
              this.cmbJoinType,
              this.btnBeginStyle,
              this.btnEndStyle,
              this.btnBeginSize,
              this.btnEndSize, // 3 tab
              this.radioNofit,
              this.radioShrink,
              this.radioFit,
              this.spnMarginTop,
              ...
              this.spnMarginRight, // 4 tab
              this.spnColumns,
              this.spnSpacing, // 5 tab
              this.inputAltTitle,
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            const margins = props.get_paddings()
            if (margins) {
            ...
            this.btnsCategory[5].setDisabled(
              props.get_FromSmartArtInternal() ||
            ...
            this.chFlipVert.setValue(
              value === undefined || value === null ? "indeterminate" : value,
            )
        ...
        _setShapeDefaults: function (props) {
          if (props) {
            ...
            if (stroke) {
              this.btnsCategory[3].setDisabled(
                stroke.get_type() === Asc.c_oAscStrokeType.STROKE_NONE,
              ) // Weights & Arrows
