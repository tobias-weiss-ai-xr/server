...
define([
  ...
  PE.Views.TextArtSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        ChangeSettings: function (props) {
          ...
          if (props?.get_TextArtProperties()) {
            const shapeprops = props.get_TextArtProperties()
            this._noApply = true
            ...
            const fill_type = fill ? fill.get_type() : null
            let color = null

            if (fill) {
              const transparency = fill.get_transparent()
              if (
            ...
            const strokeType = stroke ? stroke.get_type() : null
            let borderType
            const update =
            ...
            if (stroke) {
              const transparency = stroke.get_transparent()
              if (
