...
define([
  ...
  PE.Views.Viewport = Backbone.View.extend({
    ...
    applyEditorMode: function () {
      const rightMenuView = PE.getController("RightMenu").getView("RightMenu")

      this._rightMenu = rightMenuView.render(this.mode)
      let value = Common.UI.LayoutManager.getInitValue("rightMenu")
      value = value !== undefined ? !value : false
      Common.localStorage.getBool("pe-hidden-rightmenu", value) && this._rightMenu.hide()
      Common.Utils.InternalSettings.set(
        "pe-hidden-rightmenu",
        Common.localStorage.getBool("pe-hidden-rightmenu", value),
      )
    },
    ...
    applyCommonMode: () => {
      ...
      value = value !== undefined ? !value : false
      Common.localStorage.getBool("pe-hidden-leftmenu", value) &&
