...
)(({ storeAppOptions, storePresentationInfo, LoadingDocument }) => {
  ...
  const onError = (id, level, errData) => {
    ...
    switch (id) {
      ...
      case Asc.c_oAscError.ID.ConvertationOpenFormat: {
        const docExt = storePresentationInfo.dataDoc
          ? storePresentationInfo.dataDoc.fileType || ""
          : ""
    ...
    if (level === Asc.c_oAscError.Level.Critical) {
      ...
      config.callback = (btn) => {
        if (
          ...
          btn === "ok" &&
          (storeAppOptions.canDownload || storeAppOptions.canDownloadOrigin)
        ) {
