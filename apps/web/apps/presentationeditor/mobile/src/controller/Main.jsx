...
class MainController extends Component {
  ...
  bindEvents() {
    ...
    this.api.asc_registerCallback("asc_onListType", (data) => {
      const type = data.get_ListType()
      const subtype = data.get_ListSubType()
  ...
  onDocumentContentReady() {
    ...
    const zf =
      value !== null
        ...
        : appOptions.customization?.zoom
          ? Number.parseInt(appOptions.customization.zoom)
          : -1
    zf === -1
    ...
    value = LocalStorage.getBool(
      "pe-mobile-spellcheck",
      !(appOptions.customization && appOptions.customization.spellcheck === false),
    )
    ...
    appOptions.customization?.slidePlayerBackground &&
      this.api.asc_setDemoBackgroundColor(appOptions.customization.slidePlayerBackground)
    this.api.Resize()
    this.api.zoomFitToPage()
  ...
  onOrientationChange(event) {
    ...
    let position = Common.Locale.isCurrentLangRtl
      ? AscCommon.thumbnailsPositionMap.right
      : AscCommon.thumbnailsPositionMap.left
    if (isPortrait) {
    ...
    if (type === Asc.c_oAscAdvancedOptionsID.DRM) {
      ...
      f7.dialog
        .create({
          ...
          content: Device.ios
            ? `<div class="input-field"><input type="password" class="modal-text-input" name="modal-password" placeholder="${_t.advDRMPassword}" id="modal-password"></div>`
            : `<div class="input-field"><div class="inputs-list list inline-labels"><ul><li><div class="item-content item-input"><div class="item-inner"><div class="item-input-wrap"><input type="password" name="modal-password" id="modal-password" placeholder=${_t.advDRMPassword}></div></div></div></li></ul></div></div>`,
          buttons: buttons,
