    ...
    if (url === null || url === undefined || url === "") {
      ...
      if (0 === indAction) {
        if (url === "ppaction://hlinkshowjump?jump=firstslide") {
          ...
          if (0 === indSlide) {
            this.slideNum = Number.parseInt(url.substring(mask.length))
...
const EditLinkWithTranslation = inject("storeFocusObjects")(
  observer(withTranslation()(EditLinkController)),
)
