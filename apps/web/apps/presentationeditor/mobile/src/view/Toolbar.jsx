  ...
  return (
    <Fragment>
      <NavLeft>
        ...
        {props.isShowBack && !props.isDrawMode && !isVersionHistoryMode && (
          <Link
            iconOnly
      ...
      <NavRight>
        ...
        {!isVersionHistoryMode && !props.isDrawMode && (
          <Link
            iconOnly
            className={
              (props.disabledControls || props.disabledPreview || isOpenModal) && "disabled"
            }
            href={false}
            onClick={() => {
          ...
          >
            <SvgIcon symbolId={IconPlay.id} className={"icon icon-svg"} />
          </Link>
        )}
