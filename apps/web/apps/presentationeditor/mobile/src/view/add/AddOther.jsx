...
const AddOther = (props) => {
  ...
  const showInsertLink =
    props.storeLinkSettings.canAddLink && !props.storeFocusObjects.paragraphLocked
  ...
  return (
    <List>
      <ListItem
        title={_t.textTable}
        link={"/add-table/"}
        onClick={() => props.onGetTableStylesPreviews()}
        routeProps={{
...
export { AddOtherContainer as AddOther, PageAddTable }
