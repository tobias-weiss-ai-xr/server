...
const EditImage = (props) => {
  ...
  return (
    <Fragment>
      <List>
        <ListItem
          title={t("View.Edit.textReplaceImage")}
          link="/edit-replace-image/"
      ...
      <List className="buttons-list">
        <ListButton className="button-fill button-raised" onClick={props.onDefaultSize}>
          {_t.textActualSize}
        </ListButton>
        <ListButton className="button-red button-fill button-raised" onClick={props.onRemoveImage}>
