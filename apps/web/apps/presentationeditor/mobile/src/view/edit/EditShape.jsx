...
const EditShape = (props) => {
  ...
  const canFill = shapeObject?.get_CanFill()
  const shapeType = shapeObject.asc_getType()
  const hideChangeType =
    shapeObject.get_FromChart() ||
    shapeObject.get_FromSmartArt() ||
    shapeType === "line" ||
  ...
  const disableRemove = !!props.storeFocusObjects.paragraphObject
  ...
  return (
    <Fragment>
      <List>
        ...
        {!hideChangeType && (
          <ListItem
            title={t("View.Edit.textChangeShape")}
            link="/edit-replace-shape/"
            routeProps={{
    ...
    <Page>
      <Navbar backLink={_t.textBack}>
        <div className="tab-buttons tabbar">
          <Link key={"pe-link-shape-fill"} tabLink={"#edit-shape-fill"} tabLinkActive={true}>
            {_t.textFill}
          </Link>
          <Link key={"pe-link-shape-border"} tabLink={"#edit-shape-border"}>
            {_t.textBorder}
          </Link>
          <Link key={"pe-link-shape-effects"} tabLink={"#edit-shape-effects"}>
            {_t.textEffects}
          </Link>
