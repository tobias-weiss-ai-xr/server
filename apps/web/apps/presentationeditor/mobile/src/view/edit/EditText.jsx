...
import {
  CustomColorPicker,
  ThemeColorPalette,
} from "../../../../../common/mobile/lib/component/ThemeColorPalette.jsx"
...
const EditText = (props) => {
  ...
  const shapeTextOrientationIconMap = {
    [Asc.c_oAscVertDrawingText.normal]: IconTextOrientationHorizontal.id,
    [Asc.c_oAscVertDrawingText.vert]: IconTextOrientationRotatedown.id,
    [Asc.c_oAscVertDrawingText.vert270]: IconTextOrientationRotateup.id,
  }
  const getShapeTextOrientationIcon = (dir) =>
    shapeTextOrientationIconMap[dir] || IconTextOrientationHorizontal.id
  const tableObject = storeFocusObjects.tableObject
  const tableTextOrientationIconMap = {
    [Asc.c_oAscCellTextDirection.LRTB]: IconTextOrientationHorizontal.id,
    [Asc.c_oAscCellTextDirection.TBRL]: IconTextOrientationRotatedown.id,
    [Asc.c_oAscCellTextDirection.BTLR]: IconTextOrientationRotateup.id,
  }
  const getTableTextOrientationIcon = (dir) =>
    tableTextOrientationIconMap[dir] || IconTextOrientationHorizontal.id
  ...
  const displaySize =
    typeof fontSize === "undefined" || fontSize === "" ? _t.textAuto : `${fontSize} ${_t.textPt}`
  ...
  if (paragraphObj) {
    spaceBefore =
      paragraphObj.get_Spacing().get_Before() < 0
        ? paragraphObj.get_Spacing().get_Before()
        : Common.Utils.Metric.fnRecalcFromMM(paragraphObj.get_Spacing().get_Before())
    spaceAfter =
      paragraphObj.get_Spacing().get_After() < 0
        ? paragraphObj.get_Spacing().get_After()
        : Common.Utils.Metric.fnRecalcFromMM(paragraphObj.get_Spacing().get_After())
  }

  const displayBefore =
    typeof spaceBefore === "undefined" || spaceBefore < 0
      ? _t.textAuto
      : `${Number.parseFloat(spaceBefore.toFixed(2))} ${metricText}`
  const displayAfter =
    typeof spaceAfter === "undefined" || spaceAfter < 0
      ? _t.textAuto
      : `${Number.parseFloat(spaceAfter.toFixed(2))} ${metricText}`

  const fontColorPreview =
    fontColor !== "auto" ? (
      <span
        className="color-preview"
        style={{ background: `#${typeof fontColor === "object" ? fontColor.color : fontColor}` }}
      />
    ) : (
      <span className="color-preview auto" />
    )

  const highlightColorPreview =
    highlightColor !== "transparent" ? (
      <span
        className="color-preview"
        style={{
          background: `#${typeof highlightColor === "object" ? highlightColor.color : highlightColor}`,
        }}
      />
    ) : (
  ...
  return (
    <Fragment>
      <List>
        ...
        <ListItem className="buttons">
          <div className="row">
            ...
            <a
              ...
              onClick={() => {
                props.toggleUnderline(!isUnderline)
              }}
            >
              <SvgIcon slot="media" symbolId={IconTextUnderline.id} className={"icon icon-svg"} />
            </a>
            <a
              className={`button${isStrikethrough ? " active" : ""}`}
              onClick={() => {
                props.toggleStrikethrough(!isStrikethrough)
              }}
            >
              <SvgIcon
                slot="media"
                symbolId={IconTextStrikethrough.id}
        ...
        <ListItem
          title={_t.textFontColor}
          link="/edit-text-font-color/"
          routeProps={{
        ...
        <ListItem
          title={t("View.Edit.textHighlightColor")}
          link="/edit-text-highlight-color/"
          routeProps={{
            onHighlightColor: props.onHighlightColor,
          }}
        >
          {!isAndroid ? (
            <SvgIcon slot="media" symbolId={IconTextSelection.id} className="icon icon-svg" />
          ) : (
            highlightColorPreview
          )}
        </ListItem>
        <ListItem
          title={_t.textAdditionalFormatting}
          link="/edit-text-add-formatting/"
          routeProps={{
        ...
        <Fragment>
          <List>
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${paragraphAlign === "left" ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphAlign === "center" ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconTextAlignCenter.id}
                    className="icon icon-svg"
                  />
                </a>
                <a
                  className={`button${paragraphAlign === "right" ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconTextAlignRight.id}
                    className="icon icon-svg"
                  />
                </a>
                <a
                  className={`button${paragraphAlign === "just" ? " active" : ""}`}
                  onClick={() => {
            ...
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${paragraphValign === "top" ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphValign === "center" ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconTextValignMiddle.id}
                    className="icon icon-svg"
                  />
                </a>
                <a
                  className={`button${paragraphValign === "bottom" ? " active" : ""}`}
                  onClick={() => {
                ...
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconTextValignBottom.id}
                    className="icon icon-svg"
                  />
                </a>
              </div>
            ...
            <ListItem className="buttons">
              <div dir={isRtlTextDirection ? "rtl" : ""} className="row">
                <a
                  className={`button item-link${!canDecreaseIndent ? " disabled" : ""}`}
                  onClick={() => {
                    props.onParagraphMove("left")
                  }}
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconDeIndent.id}
                    className={`icon icon-svg ${isRtlTextDirection ? "icon-svg-rtl" : ""}`}
                  />
                </a>
                <a
                  className={`button item-link${!canIncreaseIndent ? " disabled" : ""}`}
                  onClick={() => {
                    props.onParagraphMove("right")
                  }}
                >
                  <SvgIcon
                    slot="media"
                    symbolId={IconInIndent.id}
                    className={`icon icon-svg ${isRtlTextDirection ? "icon-svg-rtl" : ""}`}
                  />
                </a>
              </div>
            ...
            {shapeObject && (
              <ListItem
                title={t("View.Edit.textTextOrientation")}
                link="/edit-text-shape-orientation/"
                routeProps={{
              ...
              >
                {!isAndroid && (
                  <SvgIcon
                    slot="media"
                    symbolId={getShapeTextOrientationIcon(shapeObject.get_Vert())}
                    className="icon icon-svg "
                  />
                )}
              </ListItem>
            ...
            {tableObject && (
              <ListItem
                title={_t.textTextOrientation}
                link="/edit-text-table-orientation/"
                routeProps={{
              ...
              >
                {!isAndroid && (
                  <SvgIcon
                    slot="media"
                    symbolId={getTableTextOrientationIcon(tableObject.get_CellsTextDirection())}
                    className="icon icon-svg"
                  />
                )}
              </ListItem>
            ...
            <ListItem
              title={_t.textBulletsAndNumbers}
              link="/edit-bullets-and-numbers/"
              routeProps={{
            ...
            >
              ...
              {!isAndroid && (
                <SvgIcon
                  slot="media"
                  symbolId={IconBullets.id}
                  className={`icon icon-svg ${isRtlTextDirection ? "icon-svg-rtl" : ""}`}
                />
              )}
            </ListItem>
            <ListItem
              title={_t.textTextDirection}
              link="/edit-text-direction/"
              routeProps={{
            ...
            >
              {!isAndroid && (
                <SvgIcon
                  slot="media"
                  symbolId={isRtlTextDirection ? IconTextDirectionRtl.id : IconTextDirectionLtr.id}
                  className="icon icon-svg"
                />
              )}
            </ListItem>
            <ListItem
              title={_t.textLineSpacing}
              link="/edit-text-line-spacing/"
              routeProps={{
            ...
            <ListItem title={_t.textBefore}>
              ...
              <div slot="after">
                <Segmented>
                  <Button
                    outline
                    className="decrement item-link"
                    onClick={() => {
                      props.onDistanceBefore(spaceBefore, true)
                    }}
                  >
                    {isAndroid ? (
                  ...
                  <Button
                    outline
                    className="increment item-link"
                    onClick={() => {
                      props.onDistanceBefore(spaceBefore, false)
                    }}
                  >
                    {isAndroid ? (
              ...
              <div slot="after">
                <Segmented>
                  <Button
                    ...
                    className="decrement item-link"
                    onClick={() => {
                      props.onDistanceAfter(spaceAfter, true)
                    }}
                  >
                    {isAndroid ? (
                      <SvgIcon symbolId={IconExpandDownAndroid.id} className="icon icon-svg" />
                  ...
                  <Button
                    ...
                    className="increment item-link"
                    onClick={() => {
                      props.onDistanceAfter(spaceAfter, false)
                    }}
                  >
                    {isAndroid ? (
                      <SvgIcon symbolId={IconExpandUp.id} className="icon icon-svg" />
...
const PageOrientationTextShape = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("View.Edit.textHorizontalText")}
          radio
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationHorizontal.id}
            className="icon icon-svg"
          />
        </ListItem>
        <ListItem
          title={t("View.Edit.textRotateTextDown")}
          radio
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationRotatedown.id}
            className="icon icon-svg"
          />
        </ListItem>
        <ListItem
          title={t("View.Edit.textRotateTextUp")}
          radio
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationRotateup.id}
            className="icon icon-svg"
          />
        </ListItem>
      </List>
...
const PageFonts = (props) => {
  ...
  const displaySize =
    typeof size === "undefined" || size === "" ? _t.textAuto : `${size} ${_t.textPt}`
  ...
  const getImageUri = (fonts) => {
    return fonts.map((font) => {
      const index = Math.floor(font.imgidx / spriteCols)
  ...
  const renderExternal = (vl, vlData) => {
    setVlFonts((prevState) => {
      const fonts = [...prevState.vlData.items]
      const drawFonts = [...vlData.items]

      const images = []
      const drawImages = getImageUri(drawFonts)
          ...
          <div slot="after">
            <Segmented>
              <Button
                ...
                className="decrement item-link"
                onClick={() => {
                  props.changeFontSize(size, true)
                }}
              >
                {isAndroid ? (
                  <SvgIcon symbolId={IconExpandDownAndroid.id} className="icon icon-svg" />
              ...
              <Button
                ...
                className="increment item-link"
                onClick={() => {
                  props.changeFontSize(size, false)
                }}
              >
                {isAndroid ? (
                  <SvgIcon symbolId={IconExpandUp.id} className="icon icon-svg" />
            ...
            return (
              ...
              >
                {vlFonts.vlData.images[index] && (
                  <img
                    src={vlFonts.vlData.images[index]}
                    style={{ width: `${iconWidth}px`, height: `${iconHeight}px` }}
                  />
                )}
              </ListItem>
...
const PageFontColor = (props) => {
  ...
  const changeColor = (color, effectId) => {
    if (color !== "empty") {
      ...
      props.f7router.navigate("/edit-text-custom-font-color/", {
        props: { onTextColor: props.onTextColor },
      })
    }
  }
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textAddCustomColor}
          link={"/edit-text-custom-font-color/"}
          routeProps={{
            onTextColor: props.onTextColor,
          }}
        />
...
const PageCustomFontColor = (props) => {
  ...
  const autoColor =
    textColor === "auto"
      ? window.getComputedStyle(document.getElementById("font-color-auto")).backgroundColor
      : null
...
const PageAdditionalFormatting = (props) => {
  ...
  if (paragraphObj) {
    ...
    letterSpacing =
      paragraphObj.get_TextSpacing() === null || paragraphObj.get_TextSpacing() === undefined
        ? paragraphObj.get_TextSpacing()
        : Common.Utils.Metric.fnRecalcFromMM(paragraphObj.get_TextSpacing())
  }
  ...
  return (
    <Page>
      ...
      <List title={_t.textStrikethrough}>
        ...
        />
        <ListItem
          title={_t.textDoubleStrikethrough}
          radio
          checked={isDStrikeout}
          onClick={() => {
      ...
      <List>
        <ListItem title={_t.textLetterSpacing}>
          {!isAndroid && (
            <div slot="after-start">{`${Number.isInteger(letterSpacing) ? letterSpacing : letterSpacing.toFixed(2)} ${Common.Utils.Metric.getCurrentMetricName()}`}</div>
          )}
          <div slot="after">
            <Segmented>
              <Button
                ...
                className="decrement item-link"
                onClick={() => {
                  props.changeLetterSpacing(letterSpacing, true)
                }}
              >
                {isAndroid ? (
                  <SvgIcon symbolId={IconExpandDownAndroid.id} className="icon icon-svg" />
              ...
              {isAndroid && (
                <label>{`${Number.isInteger(letterSpacing) ? letterSpacing : letterSpacing.toFixed(2)} ${Common.Utils.Metric.getCurrentMetricName()}`}</label>
              )}
              <Button
                outline
                className="increment item-link"
                onClick={() => {
                  props.changeLetterSpacing(letterSpacing, false)
                }}
              >
                {isAndroid ? (
                  <SvgIcon symbolId={IconExpandUp.id} className="icon icon-svg" />
    ...
    <View className="bullets dataview">
      <List className="row" style={{ listStyle: "none" }}>
        {bulletArrays.map((bullet) => (
          <ListItem
            key={`bullet-${bullet.subtype}`}
            data-type={bullet.subtype}
            className={
              bullet.subtype === typeBullets &&
              (storeTextSettings.listType === 0 || storeTextSettings.listType === -1)
                ? "active"
                : ""
            }
            onClick={() => {
    ...
    <View className="numbers dataview">
      <List className="row" style={{ listStyle: "none" }}>
        {numberArrays.map((number) => (
          <ListItem
            key={`number-${number.subtype}`}
            data-type={number.subtype}
            className={
              number.subtype === typeNumbers &&
              (storeTextSettings.listType === 1 || storeTextSettings.listType === -1)
                ? "active"
                : ""
            }
            onClick={() => {
...
const PageTextFontColor = inject(
  "storeTextSettings",
  "storePalette",
  "storeFocusObjects",
)(observer(PageFontColor))
const PageTextHighlightColor = inject("storeTextSettings")(observer(PageHighlightColor))
const PageTextCustomFontColor = inject(
  "storeTextSettings",
  "storePalette",
)(observer(PageCustomFontColor))
const PageTextAddFormatting = inject(
  "storeTextSettings",
  "storeFocusObjects",
)(observer(PageAdditionalFormatting))
const PageTextBulletsAndNumbers = inject(
  "storeTextSettings",
  "storeFocusObjects",
)(observer(PageBulletsAndNumbers))
const PageTextDirection = inject("storeTextSettings", "storeFocusObjects")(observer(PageDirection))
const PageTextLineSpacing = inject(
  "storeTextSettings",
  "storeFocusObjects",
)(observer(PageLineSpacing))
const PageTextBulletsLinkSettings = inject(
  "storeTextSettings",
  "storeFocusObjects",
)(observer(PageBulletLinkSettings))
