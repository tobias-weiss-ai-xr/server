import { BlockTitle, List, ListItem, Navbar, Page, Toggle } from "framework7-react"
    ...
    <Page>
      ...
      <List>
        <ListItem
          radio
          name="slide-size"
          checked={slideSizeIndex === 0}
          onChange={() => props.onSlideSize(slideSizeArr[0])}
          title={_t.mniSlideStandard}
        />
        <ListItem
          radio
          name="slide-size"
          checked={slideSizeIndex === 1}
          onChange={() => props.onSlideSize(slideSizeArr[1])}
          title={_t.mniSlideWide}
        />
      </List>
      <List mediaList>
        <ListItem
      ...
      <List>
        <ListItem title={_t.textLoopSlideshow}>
          <Toggle
            checked={isLoopSlideshow}
            onToggleChange={() => {
              props.onToggleLoopSlideshow(!isLoopSlideshow)
            }}
          />
        </ListItem>
      </List>
...
const PresentationColorSchemes = inject("storePresentationSettings")(
  observer(PagePresentationColorSchemes),
)
