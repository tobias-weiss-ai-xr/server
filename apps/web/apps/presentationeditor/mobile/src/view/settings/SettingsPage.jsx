...
import { Icon, Link, List, ListItem, NavRight, Navbar, Page, f7 } from "framework7-react"
    ...
    return (
      <Page>
        ...
        <List>
          ...
          {!props.inPopover && (
            <ListItem
              disabled={!!(appOptions.readerMode || disabledPreview)}
              title={!_isEdit ? _t.textFind : _t.textFindAndReplace}
              link="#"
          ...
          {_isEdit && canUseHistory && (
            <ListItem
              title={t("View.Settings.textVersionHistory")}
          ...
          {_canPrint && (
            <ListItem
              className={disabledPreview && "disabled"}
              title={_t.textPrint}
          ...
          {_canFeedback && (
            <ListItem
              title={t("View.Settings.textFeedback")}
              link="#"
              className="no-indicator"
            ...
            >
              {Device.ios ? (
                ...
                <SvgIcon
                  slot="media"
                  symbolId={IconFeedbackAndroid.id}
          ...
          {canCloseEditor && (
            <ListItem
              title={closeButtonText ?? t("View.Settings.textClose")}
              link="#"
