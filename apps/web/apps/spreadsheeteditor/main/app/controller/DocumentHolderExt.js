...
define([], () => {
  if (window.SSE && window.SSE.Controllers && window.SSE.Controllers.DocumentHolder) {
    const dh = window.SSE.Controllers.DocumentHolder.prototype
    ...
    dh.setEvents = function () {
      ...
      Common.NotificationCenter.on({
        "tabs:dragend": _.bind(this.onDragEndMouseUp, this),
        "pivot:dragend": _.bind(this.onDragEndMouseUp, this),
      })
      Common.Gateway.on("setactionlink", _.bind(this.onSetActionLink, this))
      ...
      if (this.api) {
        ...
        this.api.asc_registerCallback(
          ...
          _.bind(this.onApiHyperlinkClick, this),
        )
        this.api.asc_registerCallback(
        ...
        if (this.permissions.isEdit === true) {
          ...
          this.api.asc_registerCallback(
            ...
            _.bind(this.onEntriesListMenu, this, false),
          ) // Alt + Down
          this.api.asc_registerCallback(
            "asc_onValidationListMenu",
            _.bind(this.onEntriesListMenu, this, true),
          )
          this.api.asc_registerCallback(
            "asc_onFormulaCompleteMenu",
            _.bind(this.onApiFormulaCompleteMenu, this),
          )
          this.api.asc_registerCallback(
          ...
          this.api.asc_registerCallback(
            "asc_onToggleAutoCorrectOptions",
            _.bind(this.onToggleAutoCorrectOptions, this),
          )
          ...
          this.api.asc_registerCallback(
            "asc_onShowPivotHeaderDetailsDialog",
            _.bind(this.onShowPivotHeaderDetailsDialog, this),
          )
          this.api.asc_registerCallback(
            "asc_onShowPivotGroupDialog",
            _.bind(this.onShowPivotGroupDialog, this),
          )
          if (
          ...
          this.api.asc_registerCallback(
            "asc_onHideEyedropper",
            _.bind(this.hideEyedropperTip, this),
          )
          this.api.asc_SetMathInputType(
            Common.localStorage.getBool("sse-equation-input-latex")
    ...
    dh.onCreateDelayedElements = function (view, type) {
      ...
      if (type === "edit") {
        view.pmiCut.on("click", _.bind(this.onCopyPaste, this))
        view.pmiCopy.on("click", _.bind(this.onCopyPaste, this))
        view.pmiPaste.on("click", _.bind(this.onCopyPaste, this))
        view.pmiImgCut.on("click", _.bind(this.onCopyPaste, this))
        view.pmiImgCopy.on("click", _.bind(this.onCopyPaste, this))
        view.pmiImgPaste.on("click", _.bind(this.onCopyPaste, this))
        view.pmiTextCut.on("click", _.bind(this.onCopyPaste, this))
        view.pmiTextCopy.on("click", _.bind(this.onCopyPaste, this))
        view.pmiTextPaste.on("click", _.bind(this.onCopyPaste, this))
        view.pmiCommonCut.on("click", _.bind(this.onCopyPaste, this))
        view.pmiCommonCopy.on("click", _.bind(this.onCopyPaste, this))
        view.pmiCommonPaste.on("click", _.bind(this.onCopyPaste, this))
        view.pmiInsertEntire.on("click", _.bind(this.onInsertEntire, this))
        view.pmiDeleteEntire.on("click", _.bind(this.onDeleteEntire, this))
        view.pmiInsertCells.menu.on("item:click", _.bind(this.onInsertCells, this))
        view.pmiDeleteCells.menu.on("item:click", _.bind(this.onDeleteCells, this))
        view.pmiSparklines.menu.on("item:click", _.bind(this.onClear, this))
        view.pmiSortCells.menu.on("item:click", _.bind(this.onSortCells, this))
        view.pmiFilterCells.menu.on("item:click", _.bind(this.onFilterCells, this))
        view.pmiReapply.on("click", _.bind(this.onReapply, this))
        view.pmiCondFormat.on("click", _.bind(this.onCondFormat, this))
        view.mnuRefreshPivot.on("click", _.bind(this.onRefreshPivot, this))
        view.mnuExpandCollapsePivot.menu.on("item:click", _.bind(this.onExpandCollapsePivot, this))
        view.mnuGroupPivot.on("click", _.bind(this.onGroupPivot, this))
        view.mnuUnGroupPivot.on("click", _.bind(this.onGroupPivot, this))
        view.mnuPivotSettings.on("click", _.bind(this.onPivotSettings, this))
        view.mnuFieldSettings.on("click", _.bind(this.onFieldSettings, this))
        view.mnuDeleteField.on("click", _.bind(this.onDeleteField, this))
        view.mnuSubtotalField.on("click", _.bind(this.onSubtotalField, this))
        view.mnuSummarize.menu.on("item:click", _.bind(this.onSummarize, this))
        view.mnuShowAs.menu.on("item:click", _.bind(this.onShowAs, this))
        view.mnuShowDetails.on("click", _.bind(this.onShowDetails, this))
        view.mnuPivotSort.menu.on("item:click", _.bind(this.onPivotSort, this))
        view.mnuPivotFilter.menu.on("item:click", _.bind(this.onPivotFilter, this))
        view.pmiClear.menu.on("item:click", _.bind(this.onClear, this))
        view.pmiSelectTable.menu.on("item:click", _.bind(this.onSelectTable, this))
        view.pmiInsertTable.menu.on("item:click", _.bind(this.onInsertTable, this))
        view.pmiDeleteTable.menu.on("item:click", _.bind(this.onDeleteTable, this))
        view.pmiInsFunction.on("click", _.bind(this.onInsFunction, this))
        view.menuAddHyperlink.on("click", _.bind(this.onInsHyperlink, this))
        view.menuEditHyperlink.on("click", _.bind(this.onInsHyperlink, this))
        view.menuRemoveHyperlink.on("click", _.bind(this.onDelHyperlink, this))
        view.pmiRowHeight.menu.on("item:click", _.bind(this.onSetSize, this))
        view.pmiColumnWidth.menu.on("item:click", _.bind(this.onSetSize, this))
        view.pmiEntireHide.on("click", _.bind(this.onEntireHide, this))
        view.pmiEntireShow.on("click", _.bind(this.onEntireShow, this))
        view.pmiFreezePanes.on("click", _.bind(this.onFreezePanes, this))
        view.pmiEntriesList.on("click", _.bind(this.onEntriesList, this))
        /** coauthoring begin **/
        view.pmiAddComment.on("click", _.bind(this.onAddComment, this))
        /** coauthoring end **/
        view.pmiAddNamedRange.on("click", _.bind(this.onAddNamedRange, this))
        view.menuImageArrange.menu.on("item:click", _.bind(this.onImgMenu, this))
        view.menuImgRotate.menu.on("item:click", _.bind(this.onImgMenu, this))
        ...
        view.menuImageAlign.menu.on("item:click", _.bind(this.onImgMenuAlign, this))
        ...
        view.menuParagraphBullets.menu.on("item:click", _.bind(this.onSelectBulletMenu, this))
        // view.menuParagraphBullets.menu.on('render:after',   _.bind(me.onBulletMenuShowAfter, me));
        view.menuParagraphBullets.menu.on("show:after", _.bind(this.onBulletMenuShowAfter, this))
        view.menuAddHyperlinkShape.on("click", _.bind(this.onInsHyperlink, this))
        view.menuEditHyperlinkShape.on("click", _.bind(this.onInsHyperlink, this))
        view.menuAddHyperlinkPic.on("click", _.bind(this.onInsHyperlink, this))
        view.menuEditHyperlinkPic.on("click", _.bind(this.onInsHyperlink, this))
        view.menuRemoveHyperlinkPic.on("click", _.bind(this.onDelHyperlink, this))
        view.menuRemoveHyperlinkShape.on("click", _.bind(this.onDelHyperlink, this))
        view.pmiTextAdvanced.on("click", _.bind(this.onTextAdvanced, this))
        view.mnuShapeAdvanced.on("click", _.bind(this.onShapeAdvanced, this))
        view.mnuChartEdit.on("click", _.bind(this.onChartEdit, this))
        view.mnuChartData.on("click", _.bind(this.onChartData, this))
        view.mnuChartType.on("click", _.bind(this.onChartType, this))
        view.mnuImgAdvanced.on("click", _.bind(this.onImgAdvanced, this))
        view.mnuSlicerAdvanced.on("click", _.bind(this.onSlicerAdvanced, this))
        view.textInShapeMenu.on("render:after", _.bind(this.onTextInShapeAfterRender, this))
        view.menuSignatureEditSign.on("click", _.bind(this.onSignatureClick, this))
        view.menuSignatureEditSetup.on("click", _.bind(this.onSignatureClick, this))
        view.menuImgOriginalSize.on("click", _.bind(this.onOriginalSizeClick, this))
        view.menuImgReplace.menu.on("item:click", _.bind(this.onImgReplace, this))
        view.pmiCellFormat.on("click", _.bind(this.onCellFormat, this))
        view.pmiNumFormat.menu.on("item:click", _.bind(this.onNumberFormatSelect, this))
        view.pmiNumFormat.menu.on("show:after", _.bind(this.onNumberFormatOpenAfter, this))
        view.pmiAdvancedNumFormat.on("click", _.bind(this.onCustomNumberFormat, this))
        view.tableTotalMenu.on("item:click", _.bind(this.onTotalMenuClick, this))
        view.menuImgMacro.on("click", _.bind(this.onImgMacro, this))
        view.menuImgEditPoints.on("click", _.bind(this.onImgEditPoints, this))
        view.pmiGetRangeList.on("click", _.bind(this.onGetLink, this))
        view.menuParagraphEquation.menu.on("item:click", _.bind(this.convertEquation, this))
        view.menuSaveAsPicture.on("click", _.bind(this.saveAsPicture, this))
        view.fillMenu.on("item:click", _.bind(this.onFillSeriesClick, this))
        view.fillMenu.on("hide:after", _.bind(this.onFillSeriesHideAfter, this))
        view.menuEditObject.on("click", _.bind(this.onEditObject, this))
      } else {
        view.menuViewCopy.on("click", _.bind(this.onCopyPaste, this))
        view.menuViewUndo.on("click", _.bind(this.onUndo, this))
        view.menuViewAddComment.on("click", _.bind(this.onAddComment, this))
        view.menuSignatureViewSign.on("click", _.bind(this.onSignatureClick, this))
        view.menuSignatureDetails.on("click", _.bind(this.onSignatureClick, this))
        view.menuSignatureViewSetup.on("click", _.bind(this.onSignatureClick, this))
        view.menuSignatureRemove.on("click", _.bind(this.onSignatureClick, this))
        view.pmiViewGetRangeList.on("click", _.bind(this.onGetLink, this))
      }

      var addEvent = (elem, type, fn, options) => {
      ...
      if (documentHolderEl) {
          ...
          click: (e) => {
            if (this.api) {
              ...
              if (
                ...
                (!this.isEditFormula || this.rangeSelectionMode)
              ) {
                if (this._preventClick) this._preventClick = false
                else {
                  if (e.target.getAttribute && e.target.getAttribute("oo_no_focused")) return
        ...
        this.cellEditor = $("#ce-cell-content")
      }
      Common.Utils.isChrome
        ? addEvent(document, "mousewheel", _.bind(this.onDocumentWheel, this), { passive: false })
    ...
    dh.initExternalEditors = function () {
      if (
        ...
        var oleEditor = this.getApplication()
        ...
        if (oleEditor) {
          oleEditor.on(
            ...
            _.bind((cmp, message) => {
              ...
              if (this.api) {
                if (oleEditor.isEditMode()) this.api.asc_editTableOleObject(data)
              }
            }, this),
          )
          oleEditor.on(
      ...
      if (this.api) {
        ...
        if (!res) {
          ...
          if (
            ...
            (item.value === "paste" || this.permissions.canCopy)
          ) {
    ...
    dh.onSortCells = function (menu, item) {
      Common.NotificationCenter.trigger("protect:check", this.onSortCellsCallback, this, [
        menu,
        item,
      ])
    }
              ...
              callback: _.bind(function (btn) {
                if (btn == "expand" || btn == "sort") {
                  this.api.asc_sortColFilter(
                    ...
                    "",
                    undefined,
                    item.value == Asc.c_oAscSortOptions.ByColorFill
                      ? this.documentHolder.ssMenu.cellColor
                      : this.documentHolder.ssMenu.fontColor,
                    btn == "expand",
                  )
                }
                Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
    ...
    dh.onCondFormat = function () {
      ...
      !value &&
        (value = this.permissions.lang
          ? Number.parseInt(Common.util.LanguageInfo.getLocalLanguageCode(this.permissions.lang))
          : 0x0409)
    ...
    dh.onExpandCollapsePivot = function (menu, item, e) {
      this.propsPivot.originalProps.asc_setExpandCollapseByActiveCell(
        this.api,
        item.value.isAll,
        item.value.visible,
      )
    ...
    dh.onShowPivotHeaderDetailsDialog = function (isRow, isAll) {
      var pivotInfo = this.api.asc_getCellInfo().asc_getPivotTableInfo(),
        ...
        fieldsNames = _.map(pivotFields, (item, index) => ({
          index: index,
      ...
      excludedFields &&
        (excludedFields = _.filter(excludedFields, (item) => {
          var pivotIndex = item.asc_getIndex()
          return pivotIndex > -1 || pivotIndex == -2
        }))

      excludedFields.forEach((excludedItem) => {
        var indexInFieldsNames = _.findIndex(
          fieldsNames,
          (item) => excludedItem.asc_getIndex() == item.index,
        )
      ...
      new SSE.Views.PivotShowDetailDialog({
        handler: (result, value) => {
          if (result == "ok" && value) {
            this.api.asc_pivotShowDetailsHeader(value.index, isAll)
          }
        },
      ...
      win = new SSE.Views.PivotGroupDialog({
        ...
        handler: (dlg, result) => {
          if (result == "ok") {
            ...
            this.api.asc_groupPivot(props[0], props[1])
            Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
          }
        },
      })
    ...
    dh.onPivotSettings = function () {
      ...
      if (this.api) {
        new SSE.Views.PivotSettingsAdvanced({
          ...
          api: this.api,
          handler: (result, value) => {
            if (result == "ok" && this.api && value) {
              props.asc_set(this.api, value)
              Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
            }
    ...
    dh.onFieldSettings = function () {
      ...
      if (this.api) {
        if (this.propsPivot.fieldType === 2) {
          // value field
          var field = this.propsPivot.field
          new SSE.Views.ValueFieldSettingsDialog({
            props: props,
            field: field,
            showAsValue: this.propsPivot.showAsValue,
            api: this.api,
            handler: (result, value) => {
              if (result === "ok" && this.api && value) {
                field.asc_set(this.api, props, this.propsPivot.index, value)
                Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
              }
          ...
          new SSE.Views.FieldSettingsDialog({
            props: props,
            fieldIndex: this.propsPivot.pivotIndex,
            api: this.api,
            type: this.propsPivot.fieldType,
            handler: (result, value) => {
              if (result === "ok" && this.api && value) {
                this.propsPivot.field.asc_set(this.api, props, this.propsPivot.pivotIndex, value)
                Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
              }
      ...
      if (this.api && this.propsPivot.originalProps && this.propsPivot.field) {
        if (this.propsPivot.fieldType === 2) {
          ...
          if (this.propsPivot.rowTotal || this.propsPivot.colTotal) {
            ...
            props.asc_setRowGrandTotals(
              this.propsPivot.rowTotal
                ? false
                : this.propsPivot.originalProps.asc_getRowGrandTotals(),
            )
            props.asc_setColGrandTotals(
              this.propsPivot.colTotal
                ? false
                : this.propsPivot.originalProps.asc_getColGrandTotals(),
            )
            this.propsPivot.originalProps.asc_set(this.api, props)
          } else
            this.propsPivot.originalProps.asc_removeDataField(
              this.api,
              this.propsPivot.pivotIndex,
    ...
    dh.onSummarize = function (menu, item, e) {
      ...
      if (item.value === -1) this.onFieldSettings()
      else if (item.value !== undefined && item.value !== null) {
        var field = new Asc.CT_DataField()
        field.asc_setSubtotal(item.value)
        this.propsPivot.fieldSourceName &&
          field.asc_setName(
            this.txtByField
              .replace("%1", item.caption)
              .replace("%2", this.propsPivot.fieldSourceName),
          )
        this.propsPivot.field.asc_set(
          this.api,
    ...
    dh.onShowAs = function (menu, item, e) {
      ...
      if (item.value === -1 || item.options.showMore) {
        if (item.options.showMore) this.propsPivot.showAsValue = item.value
        ...
        info.asc_setDecimalPlaces(
          item.options.numFormat === Asc.c_oAscNumFormatType.Percent ? 2 : 0,
        )
    ...
    dh.showCustomFilterDlg = function (filter, type) {
      ...
      var dlgDigitalFilter = new SSE.Views.PivotDigitalFilterDialog({
        api: this.api,
        type: type,
      }).on({
        close: () => {
    ...
    dh.onPivotSort = function (menu, item, e) {
      if (!(this.propsPivot.filter || this.propsPivot.rowFilter || this.propsPivot.colFilter))
        return
      if (item.value === "advanced") {
        ...
        dlgSort.setSettings({
          filter: this.propsPivot.filter,
          rowFilter: this.propsPivot.rowFilter,
          colFilter: this.propsPivot.colFilter,
        })
        dlgSort.show()
      } else {
        var filter =
          this.propsPivot.filter || this.propsPivot.rowFilter || this.propsPivot.colFilter
    ...
    dh.onShowDetails = function (item, e) {
      this.propsPivot.originalProps &&
        this.api &&
        this.api.asc_pivotShowDetails(this.propsPivot.originalProps)
    }
      ...
      if (colFieldIndex > -1) {
        ...
        if (fprops) {
          ...
          if (pivotIndex > -1) {
            ...
            this.propsPivot.fieldName =
              this.propsPivot.field.asc_getName() ||
              props.asc_getCacheFields()[pivotIndex].asc_getName()
          }
        }
    ...
    dh.onClear = function (menu, item, e) {
      if (
        (item.value == Asc.c_oAscCleanOptions.Format && !this._state.wsProps["FormatCells"]) ||
      ...
      if (this.api) {
        if (item.value == Asc.c_oAscCleanOptions.Comments) {
          ...
          this.api.asc_emptyCells(
            item.value,
            item.value == Asc.c_oAscCleanOptions.All && !this.permissions.canDeleteComments,
          )
    ...
    dh.onSelectTable = function (menu, item) {
      if (this.api && this.documentHolder.ssMenu.formatTableName) {
        this.api.asc_changeSelectionFormatTable(
          this.documentHolder.ssMenu.formatTableName,
          item.value,
        )
    ...
    dh.onInsFunction = function (item) {
      ...
      if (controller && this.api) {
        controller.showDialog(
          undefined,
          item.value == Asc.ETotalsRowFunction.totalrowfunctionCustom,
        )
      }
    }
    ...
    dh.onSetSize = function (menu, item) {
      if (item.value == "row-height" || item.value == "column-width") {
        new SSE.Views.SetValueDialog({
          title: item.caption,
          startvalue:
            item.value == "row-height"
              ? this.api.asc_getRowHeight()
              : this.api.asc_getColumnWidth(),
          ...
          defaultUnit:
            item.value == "row-height"
              ? Common.Utils.Metric.getMetricName(Common.Utils.Metric.c_MetricUnits.pt)
              : this.textSym,
          handler: (dlg, result) => {
            if (result == "ok") {
              ...
              if (!isNaN(val))
                item.value == "row-height"
                  ? this.api.asc_setRowHeight(val)
                  : this.api.asc_setColumnWidth(val)
            }
        ...
        item.value == "auto-row-height"
          ? this.api.asc_autoFitRowHeight()
          : this.api.asc_autoFitColumnWidth()
        Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
      }
    }

    dh.onEntireHide = function (item) {
      if (this.api) this.api[item.isrowmenu ? "asc_hideRows" : "asc_hideColumns"]()
    }

    dh.onEntireShow = function (item) {
      if (this.api) this.api[item.isrowmenu ? "asc_showRows" : "asc_showColumns"]()
    }

    dh.onFreezePanes = function (item) {
      if (this.api) this.api.asc_freezePane()
    }

    dh.onEntriesList = function (item) {
      if (this.api) {
        setTimeout(() => {
          this.api.asc_showAutoComplete()
        }, 10)
      }
    }
    ...
    dh.onAddNamedRange = function (item) {
      ...
      var handlerDlg = (result, settings) => {
        if (result == "ok" && settings) {
      ...
      if (this.api) {
        if (item.options.type == "arrange") {
          ...
          Common.component.Analytics.trackEvent(
            "DocumentHolder",
            item.value == "grouping" ? "Grouping" : "Ungrouping",
          )
    ...
    dh.onSelectBulletMenu = function (menu, item) {
      if (this.api) {
        if (item.options.value == -1) {
          ...
          if (props) {
            var listtype = this.api.asc_getCurrentListType()
            new Common.Views.ListSettingsDialog({
              api: this.api,
              props: props,
              type: 0,
              storage:
                this.permissions.canRequestInsertImage ||
                (this.permissions.fileChoiceUrl &&
                  this.permissions.fileChoiceUrl.indexOf("{documentType}") > -1),
              interfaceLang: this.permissions.lang,
              handler: (result, value) => {
                if (result == "ok") {
                  if (this.api) {
    ...
    dh.onSelectBullets = function (picker, itemView, record, e) {
      ...
      if (rawData.type === 0 && rawData.subtype === 0x1000) {
        // custom bullet
      ...
      } else this.api.asc_setListType(rawData.type, rawData.subtype)

      if (e.type !== "click") this.documentHolder.textInShapeMenu.hide()
    ...
    dh.onTextAdvanced = function (item) {
      new SSE.Views.ParagraphSettingsAdvanced({
        ...
        handler: (result, value) => {
          if (result == "ok") {
            if (this.api) {
              this.api.asc_setGraphicObjectProps(value.paragraphProps)

              Common.component.Analytics.trackEvent(
                "DocumentHolder",
                "Apply advanced paragraph settings",
              )
            }
          }
    ...
    dh.onShapeAdvanced = function (item) {
      new SSE.Views.ShapeSettingsAdvanced({
        ...
        handler: (result, value) => {
          if (result == "ok") {
            if (this.api) {
              this.api.asc_setGraphicObjectProps(value.shapeProps)

              Common.component.Analytics.trackEvent(
                "DocumentHolder",
                "Apply advanced shape settings",
              )
            }
          }
          Common.NotificationCenter.trigger("edit:complete", this)
      ...
      if (this.api) {
        ...
        if (props) {
          ...
          var win = new SSE.Views.ChartTypeDialog({
            ...
            this._isEditType && props.cancelEdit()
            this._isEditType = false
          })
          win.show()
        }
    ...
    dh.onImgMacro = function (item) {
      new SSE.Views.MacroDialog({
        props: {
          macroList: this.api.asc_getAllMacrosNames(),
          current: this.api.asc_getCurrentDrawingMacrosName(),
        },
        handler: (result, value) => {
          if (result == "ok") {
            if (this.api) {
              this.api.asc_assignMacrosToCurrentDrawing(value)
            }
          }
          Common.NotificationCenter.trigger("edit:complete", this)
        },
    ...
    dh.onGetLink = function (item) {
      if (this.api) {
        var range = this.api.asc_getActiveRangeStr(Asc.referenceType.A, false, true),
          name = this.api.asc_getEscapeSheetName(
    ...
    dh.onSetActionLink = function (url) {
      if (Common.Utils.InternalSettings.get("sse-dialog-link-visible")) return
      navigator.clipboard &&
        navigator.clipboard
          .writeText(url)
          .then(() => {
            Common.NotificationCenter.trigger(
              "showmessage",
              { msg: this.txtCopySuccess },
              { timeout: 3000, hideCloseTip: true },
            )
          })
          .catch((err) => {
            console.log(err)
    ...
    dh.onApiMouseMove = function (dataarray) {
      if (!this._isFullscreenMenu && dataarray.length) {
        ...
        var showPoint = [0, 0],
          /** coauthoring begin **/
          coAuthTip = this.tooltips.coauth,
          commentTip = this.tooltips.comment,
          /** coauthoring end **/
          hyperlinkTip = this.tooltips.hyperlink,
          row_columnTip = this.tooltips.row_column,
          filterTip = this.tooltips.filter,
          slicerTip = this.tooltips.slicer,
          foreignSelect = this.tooltips.foreignSelect,
          eyedropperTip = this.tooltips.eyedropper,
          placeholderTip = this.tooltips.placeholder,
          pos = [
        ...
        if (this.permissions.isEdit || this.permissions.canViewComments) {
          if (!index_comments || this.popupmenu) {
            commentTip.moveCommentId = undefined
            if (commentTip.viewCommentId != undefined) {
              commentTip = {}

              var commentsController = this.getApplication().getController(
              ...
              if (commentsController) {
                ...
                else commentsController.onApiHideComment(true)
              }
            }
          }
        }
        if (this.permissions.isEdit) {
          ...
          if (!index_placeholder) {
            this.hidePlaceholderTip()
          }
        }
        if (
          index_filter === undefined ||
          (this.dlgFilter && this.dlgFilter.isVisible()) ||
        ...
        if (!index_eyedropper) {
          this.hideEyedropperTip()
        }
        // show tooltips

        if (index_hyperlink) {
          if (!hyperlinkTip.parentEl) {
            hyperlinkTip.parentEl = $(
              '<div id="tip-container-hyperlinktip" style="position: absolute; z-index: 10000;"></div>',
            )
            this.documentHolder.cmpEl.append(hyperlinkTip.parentEl)
          }
          ...
          if (props.asc_getType() == Asc.c_oAscHyperlinkType.WebLink) {
            ...
            if (linkstr.length > 256) linkstr = linkstr.substr(0, 256) + "..."
            linkstr =
              Common.Utils.String.htmlEncode(linkstr) + "<br><b>" + this.textCtrlClick + "</b>"
          } else {
            linkstr = Common.Utils.String.htmlEncode(
              props.asc_getTooltip() || props.asc_getLocation(),
            )
            linkstr += "<br><b>" + this.textCtrlClick + "</b>"
          }
        ...
        if (index_column !== undefined || index_row !== undefined) {
          if (!row_columnTip.parentEl) {
            row_columnTip.parentEl = $(
              '<div id="tip-container-rowcolumntip" style="position: absolute; z-index: 10000;"></div>',
            )
            this.documentHolder.cmpEl.append(row_columnTip.parentEl)
          }

          var data = dataarray[index_column !== undefined ? index_column - 1 : index_row - 1]
          var str = Common.Utils.String.format(
            index_column !== undefined ? this.textChangeColumnWidth : this.textChangeRowHeight,
            data.asc_getSizeCCOrPt().toFixed(2),
            data.asc_getSizePx().toFixed(),
          )
          ...
          if (!row_columnTip.ref || !row_columnTip.ref.isVisible()) {
            ...
            if (showPoint[0] + tipwidth > this.tooltips.coauth.bodyWidth)
              showPoint[0] = this.tooltips.coauth.bodyWidth - tipwidth - 20
        ...
        if (this.permissions.isEdit || this.permissions.canViewComments) {
          if (index_comments && !this.popupmenu) {
            ...
            if (
              ...
              commentTip.moveCommentTimer = setTimeout(() => {
        ...
        if (this.permissions.isEdit) {
          if (index_locked && this.isUserVisible(dataarray[index_locked - 1].asc_getUserId())) {
            ...
            if (!coAuthTip.XY) this.onDocumentResize()
            ...
            if (coAuthTip.x_point != data.asc_getX() || coAuthTip.y_point != data.asc_getY()) {
              ...
              var src = $(document.createElement("div")),
                is_sheet_lock =
                  data.asc_getLockedObjectType() == Asc.c_oAscMouseMoveLockedObjectType.Sheet ||
                  data.asc_getLockedObjectType() ==
                    Asc.c_oAscMouseMoveLockedObjectType.TableProperties
              ...
              showPoint = [
                is_sheet_lock
                  ? coAuthTip.x_point + coAuthTip.rightMenuWidth
                  : coAuthTip.bodyWidth - (coAuthTip.x_point + coAuthTip.XY[0]),
                coAuthTip.y_point + coAuthTip.XY[1],
              ]

              if (
                showPoint[1] >= coAuthTip.XY[1] &&
          ...
          if (index_placeholder) {
            if (!placeholderTip.parentEl) {
              placeholderTip.parentEl = $(
                '<div id="tip-container-placeholdertip" style="position: absolute; z-index: 10000;"></div>',
              )
              this.documentHolder.cmpEl.append(placeholderTip.parentEl)
            }
            ...
            switch (data.asc_getPlaceholderType()) {
              case AscCommon.PlaceholderButtonType.Image:
                phstr = this.documentHolder.txtInsImage
                break
              case AscCommon.PlaceholderButtonType.ImageUrl:
                phstr = this.documentHolder.txtInsImageUrl
                break
            }
        ...
        if (index_foreign && this.isUserVisible(dataarray[index_foreign - 1].asc_getUserId())) {
          ...
          if (
            ...
            src.css({
              visibility: "visible",
              left:
                (showPoint[0] + foreignSelect.ref.outerWidth() >
                coAuthTip.bodyWidth - coAuthTip.rightMenuWidth
                  ? coAuthTip.bodyWidth - coAuthTip.rightMenuWidth - foreignSelect.ref.outerWidth()
                  : showPoint[0]) + "px",
              top: showPoint[1] + "px",
            })
          }
        ...
        if (
          ...
          if (!filterTip.parentEl) {
            filterTip.parentEl = $(
              '<div id="tip-container-filtertip" style="position: absolute; z-index: 10000;"></div>',
            )
            this.documentHolder.cmpEl.append(filterTip.parentEl)
          }

          var data = dataarray[index_filter - 1],
            str = this.makeFilterTip(data.asc_getFilter())
          ...
          if (!filterTip.ref || !filterTip.ref.isVisible()) {
            ...
            if (showPoint[1] + tipheight > this.tooltips.coauth.bodyHeight) {
              showPoint[1] = this.tooltips.coauth.bodyHeight - tipheight - 5
              showPoint[0] += 20
            }
        ...
        if (index_slicer !== undefined && this.permissions.isEdit) {
          if (!slicerTip.parentEl) {
            slicerTip.parentEl = $(
              '<div id="tip-container-slicertip" style="position: absolute; z-index: 10000;"></div>',
            )
            this.documentHolder.cmpEl.append(slicerTip.parentEl)
          }
        ...
        if (index_eyedropper) {
          ...
          if (r !== undefined && r !== null) {
            ...
            eyedropperTip.tipInterval = setInterval(() => {
              clearInterval(eyedropperTip.tipInterval)
              if (!this.tooltips.eyedropper.isHidden) {
                if (!eyedropperTip.parentEl) {
                  eyedropperTip.parentEl = $(
                    '<div id="tip-container-eyedroppertip" style="position: absolute; z-index: 10000;"></div>',
                  )
                  this.documentHolder.cmpEl.append(eyedropperTip.parentEl)
                }

                var title =
                  "<div>RGB (" + r + "," + g + "," + b + ")</div>" + "<div>" + name + "</div>"
                if (!eyedropperTip.ref) {
                ...
                if (showPoint[0] + eyedropperTip.tipWidth > this.tooltips.coauth.bodyWidth) {
    ...
    dh.onApiAutofilter = function (config) {
      if (!this.tooltips.filter.isHidden && this.tooltips.filter.ref) {
        this.tooltips.filter.ref.hide()
        this.tooltips.filter.ref = undefined
        this.tooltips.filter.text = ""
        this.tooltips.filter.isHidden = true
      }
      if (this.permissions.isEdit) {
        if (!this.dlgFilter) {
          if (
            (this._state.wsProps["PivotTables"] && config.asc_getPivotObj()) ||
            (this._state.wsProps["AutoFilter"] && !config.asc_getPivotObj())
          )
            return

          this.dlgFilter = new SSE.Views.AutoFilterDialog({ api: this.api }).on({
            close: () => {
              if (this.api) {
                this.api.asc_enableKeyEvents(true)
              }
              this.dlgFilter = undefined
            },
          })
          ...
          Common.UI.Menu.Manager.hideAll()
          this.dlgFilter.setSettings(config)
          var offset = Common.Utils.getOffset(this.documentHolder.cmpEl),
          ...
          if (x + this.dlgFilter.options.width > docwidth)
            x = docwidth - this.dlgFilter.options.width - 5
          if (y + this.dlgFilter.options.height > docheight)
            y = docheight - this.dlgFilter.options.height - 5
          this.dlgFilter.show(x, y)
        } else this.dlgFilter.close()
      }
    }
    ...
    dh.makeFilterTip = function (props) {
      ...
      if (filterType === Asc.c_oAscAutoFilterTypes.CustomFilters) {
        ...
        str =
          this.getFilterName(
            Asc.c_oAscAutoFilterTypes.CustomFilters,
            customFilters[0].asc_getOperator(),
          ) +
          ' "' +
          Common.Utils.String.htmlEncode(customFilters[0].asc_getVal()) +
          '"'
        if (customFilters.length > 1) {
          ...
          str =
            ...
            this.getFilterName(
              Asc.c_oAscAutoFilterTypes.CustomFilters,
              customFilters[1].asc_getOperator(),
            ) +
            ' "' +
            Common.Utils.String.htmlEncode(customFilters[1].asc_getVal()) +
            '"'
        }
      } else if (filterType === Asc.c_oAscAutoFilterTypes.ColorFilter) {
        var colorFilter = filterObj.asc_getFilter()
        if (colorFilter.asc_getCellColor() === null) {
          // cell color
          str = this.txtEqualsToCellColor
        } else if (colorFilter.asc_getCellColor() === false) {
          // font color
          str = this.txtEqualsToFontColor
        }
      } else if (filterType === Asc.c_oAscAutoFilterTypes.DynamicFilter) {
        str = this.getFilterName(
          Asc.c_oAscAutoFilterTypes.DynamicFilter,
          filterObj.asc_getFilter().asc_getType(),
        )
        ...
        str +=
          " " +
          top10Filter.asc_getVal() +
          " " +
          (percent || percent === null ? this.txtPercent : this.txtItems)
      } else if (filterType === Asc.c_oAscAutoFilterTypes.Filters) {
        var strlen = 0,
          visibleItems = 0,
          isBlankVisible = undefined,
        ...
        values.forEach((item) => {
          ...
          if (!item.asc_getText()) isBlankVisible = item.asc_getVisible()
        })
        if (visibleItems == values.length) str = this.txtAll
      ...
      if (colName.length > 100) colName = colName.substring(0, 100) + "..."
      str =
        "<b>" +
        (Common.Utils.String.htmlEncode(colName) ||
          "(" +
            this.txtColumn +
            " " +
            Common.Utils.String.htmlEncode(props.asc_getSheetColumnName()) +
            ")") +
        ":</b><br>" +
        str
      return str
    ...
    dh.onSelectionChanged = function (info) {
      if (
        ...
        this.permissions.isEdit && !this._isDisabled
          ? this.fillMenuProps(info, true)
          : this.fillViewMenuProps(info, true)
      }
      if (this.dlgFilter && this.dlgFilter.isVisible()) this.dlgFilter.close()
    ...
    dh.fillMenuProps = function (cellinfo, showMenu, event) {
      ...
      switch (seltype) {
        ...
        case Asc.c_oAscSelectionType.RangeImage:
          isimagemenu = !(this.permissions.isEditMailMerge || this.permissions.isEditDiagram)
          break
        case Asc.c_oAscSelectionType.RangeShape:
          isshapemenu = !(this.permissions.isEditMailMerge || this.permissions.isEditDiagram)
          break
        case Asc.c_oAscSelectionType.RangeChart:
          ischartmenu = !(this.permissions.isEditMailMerge || this.permissions.isEditDiagram)
          break
        case Asc.c_oAscSelectionType.RangeChartText:
          istextchartmenu = !(this.permissions.isEditMailMerge || this.permissions.isEditDiagram)
          break
        case Asc.c_oAscSelectionType.RangeShapeText:
          istextshapemenu = !(this.permissions.isEditMailMerge || this.permissions.isEditDiagram)
          break
      }

      if (this.api.asc_getHeaderFooterMode()) {
        if (
          !documentHolder.copyPasteMenu ||
          (!showMenu && !documentHolder.copyPasteMenu.isVisible())
        )
          return
        ...
        for (var i = 0; i < selectedObjects.length; i++) {
          if (selectedObjects[i].asc_getObjectType() == Asc.c_oAscTypeSelectElement.Image) {
            ...
            if (this._state.wsProps["Objects"] && elValue.asc_getProtectionLocked())
              // don't show menu for locked shape
              return

            var shapeprops = elValue.asc_getShapeProperties()
            if (shapeprops) {
              if (shapeprops.asc_getFromChart()) ischartmenu = true
              else if (shapeprops.asc_getFromImage()) isimageonly = true
              else {
                documentHolder.mnuShapeAdvanced.shapeInfo = elValue
                isshapemenu = true
                if (shapeprops.asc_getFromSmartArt()) isSmartArt = true
                if (shapeprops.asc_getFromSmartArtInternal()) isSmartArtInternal = true
              }
            ...
            if (this.permissions.isSignatureSupport) signGuid = elValue.asc_getSignatureId()
          }
        }
        ...
        documentHolder.mnuUnGroupImg.setDisabled(
          isObjLocked || !this.api.asc_canUnGroupGraphicsObjects(),
        )
        ...
        documentHolder.menuShapesMerge.setDisabled(
          isObjLocked || !this.api.asc_canMergeSelectedShapes(),
        )
        if (!documentHolder.menuShapesMerge.isDisabled()) {
          documentHolder.menuShapesMerge.menu.items.forEach((item) => {
        ...
        documentHolder.menuHyperlinkPic.setVisible(
          (isimagemenu || isshapemenu) && can_add_hyperlink !== false && hyperinfo,
        )
        documentHolder.menuAddHyperlinkPic.setVisible(
          (isimagemenu || isshapemenu) && can_add_hyperlink !== false && !hyperinfo,
        )
        documentHolder.menuHyperlinkPicSeparator.setVisible(
          (isimagemenu || isshapemenu) && can_add_hyperlink !== false,
        )
        documentHolder.menuHyperlinkPic.setDisabled(
          isObjLocked || this._state.wsProps["InsertHyperlinks"],
        )
        documentHolder.menuAddHyperlinkPic.setDisabled(
          isObjLocked || this._state.wsProps["InsertHyperlinks"],
        )
        ...
        documentHolder.mnuChartEdit.setVisible(
          ischartmenu && !isimagemenu && !isshapemenu && has_chartprops,
        )
        documentHolder.mnuChartEdit.setDisabled(isObjLocked)
        documentHolder.mnuChartData.setVisible(
          this.permissions.isEditOle &&
            ischartmenu &&
            !isimagemenu &&
            !isshapemenu &&
        ...
        documentHolder.mnuChartType.setVisible(
          this.permissions.isEditOle &&
            ischartmenu &&
            !isimagemenu &&
            !isshapemenu &&
        ...
        documentHolder.mnuImgAdvanced.setVisible(
          isimagemenu && (!isshapemenu || isimageonly) && !ischartmenu,
        )
        documentHolder.mnuImgAdvanced.setDisabled(isObjLocked)
        documentHolder.menuImgOriginalSize.setVisible(
          isimagemenu && (!isshapemenu || isimageonly) && !ischartmenu,
        )
        if (documentHolder.mnuImgAdvanced.imageInfo)
          documentHolder.menuImgOriginalSize.setDisabled(
            isObjLocked ||
              documentHolder.mnuImgAdvanced.imageInfo.get_ImageUrl() === null ||
              documentHolder.mnuImgAdvanced.imageInfo.get_ImageUrl() === undefined,
          )
        ...
        var pluginGuid = documentHolder.mnuImgAdvanced.imageInfo
          ? documentHolder.mnuImgAdvanced.imageInfo.asc_getPluginGuid()
          : null
        documentHolder.menuImgReplace.setVisible(
          isimageonly && (pluginGuid === null || pluginGuid === undefined),
        )
        ...
        if (pluginGuidAvailable) {
          var plugin = SSE.getCollection("Common.Collections.Plugins").findWhere({
            guid: pluginGuid,
          })
          documentHolder.menuEditObject.setDisabled(
            (!this.api.asc_canEditTableOleObject() && (plugin === null || plugin === undefined)) ||
              isObjLocked,
          )
        }

        documentHolder.menuImgRotate.setVisible(
          !ischartmenu && (pluginGuid === null || pluginGuid === undefined) && !isslicermenu,
        )
        ...
        documentHolder.menuImgResetCrop.setVisible(
          isimagemenu && documentHolder.mnuImgAdvanced.imageInfo.asc_getIsCrop(),
        )
        ...
        documentHolder.mnuShapeSeparator.setVisible(
          documentHolder.mnuShapeAdvanced.isVisible() ||
            documentHolder.mnuChartEdit.isVisible() ||
            documentHolder.mnuImgAdvanced.isVisible(),
        )
        ...
        if (
          !documentHolder.textInShapeMenu ||
          (!showMenu && !documentHolder.textInShapeMenu.isVisible())
        )
          return
        ...
        for (var i = 0; i < selectedObjects.length; i++) {
          ...
          if (elType == Asc.c_oAscTypeSelectElement.Image) {
            ...
            if (this._state.wsProps["Objects"] && value.asc_getProtectionLockText())
              // don't show menu for locked text
              return
            ...
            documentHolder.menuParagraphDirectH.setChecked(
              direct == Asc.c_oAscVertDrawingText.normal,
            )
            documentHolder.menuParagraphDirect90.setChecked(
              direct == Asc.c_oAscVertDrawingText.vert,
            )
            documentHolder.menuParagraphDirect270.setChecked(
              direct == Asc.c_oAscVertDrawingText.vert270,
            )
            ...
            if (type === 1 || subtype !== 0x1000) {
              rec = documentHolder.paraBulletsPicker.store.findWhere({
                type: type,
                subtype: subtype,
              })
            } else {
            ...
            if (drawDefBullet) {
              ...
              documentHolder.paraBulletsPicker.dataViewItems &&
                this.updateBulletTip(
                  documentHolder.paraBulletsPicker.dataViewItems[7],
                  documentHolder.tipMarkersDash,
                )
            }
        ...
        documentHolder.menuHyperlinkShape.setVisible(
          istextshapemenu && can_add_hyperlink !== false && hyperinfo,
        )
        documentHolder.menuAddHyperlinkShape.setVisible(
          istextshapemenu && can_add_hyperlink !== false && !hyperinfo,
        )
        ...
        documentHolder.textInShapeMenu.items[3].setVisible(
          istextchartmenu !== true || (istextshapemenu && can_add_hyperlink !== false),
        )
        documentHolder.pmiTextAdvanced.setVisible(
          documentHolder.pmiTextAdvanced.textInfo !== undefined,
        )

        _.each(documentHolder.textInShapeMenu.items, (item) => {
          item.setDisabled(isObjLocked)
        })
        documentHolder.pmiTextCopy.setDisabled(false)
        documentHolder.menuHyperlinkShape.setDisabled(
          isObjLocked || this._state.wsProps["InsertHyperlinks"],
        )
        documentHolder.menuAddHyperlinkShape.setDisabled(
          isObjLocked || this._state.wsProps["InsertHyperlinks"],
        )
        ...
        } else documentHolder.clearEquationMenu(documentHolder.textInShapeMenu, 4)
        ...
        if (isEquation) {
          ...
          documentHolder.menuParagraphEquation.menu.items[5].setChecked(
            eq === Asc.c_oAscMathInputType.Unicode,
          )
          documentHolder.menuParagraphEquation.menu.items[6].setChecked(
            eq === Asc.c_oAscMathInputType.LaTeX,
          )
          documentHolder.menuParagraphEquation.menu.items[8].options.isToolbarHide = isEqToolbarHide
          documentHolder.menuParagraphEquation.menu.items[8].setCaption(
            isEqToolbarHide ? documentHolder.showEqToolbar : documentHolder.hideEqToolbar,
          )
        }
        ...
        (seltype !== Asc.c_oAscSelectionType.RangeImage &&
          seltype !== Asc.c_oAscSelectionType.RangeShape &&
          seltype !== Asc.c_oAscSelectionType.RangeChart &&
          seltype !== Asc.c_oAscSelectionType.RangeChartText &&
          seltype !== Asc.c_oAscSelectionType.RangeShapeText &&
          seltype !== Asc.c_oAscSelectionType.RangeSlicer)
      ) {
        ...
        documentHolder.ssMenu.formatTableName = isintable
          ? formatTableInfo.asc_getTableName()
          : null
        ...
        documentHolder.pmiInsertEntire.setCaption(
          isrowmenu ? this.textInsertTop : this.textInsertLeft,
        )
        documentHolder.pmiDeleteEntire.setVisible(isrowmenu || iscolmenu)
        documentHolder.pmiInsertCells.setVisible(
          iscellmenu && !iscelledit && !isintable && !inPivot,
        )
        documentHolder.pmiDeleteCells.setVisible(
          iscellmenu && !iscelledit && !isintable && !inPivot,
        )
        ...
        documentHolder.pmiFilterCells.setVisible(
          iscellmenu && !iscelledit && !diagramOrMergeEditor && !inPivot,
        )
        documentHolder.pmiReapply.setVisible(
          (iscellmenu || isallmenu) && !iscelledit && !diagramOrMergeEditor && !inPivot,
        )
        ...
        documentHolder.pmiCellSeparator.setVisible(
          ((iscellmenu || isallmenu || isinsparkline) && !iscelledit && !inPivot) || needshow,
        )
        ...
        documentHolder.mnuPivotSort.setVisible(
          this.propsPivot.filter || this.propsPivot.rowFilter || this.propsPivot.colFilter,
        )
        documentHolder.mnuPivotFilter.setVisible(!!this.propsPivot.filter)
        documentHolder.mnuPivotFilterSeparator.setVisible(
          this.propsPivot.filter || this.propsPivot.rowFilter || this.propsPivot.colFilter,
        )
        documentHolder.mnuSubtotalField.setVisible(
          !!this.propsPivot.field &&
            (this.propsPivot.fieldType === 0 || this.propsPivot.fieldType === 1),
        )
        documentHolder.mnuPivotSubtotalSeparator.setVisible(
          !!this.propsPivot.field &&
            (this.propsPivot.fieldType === 0 || this.propsPivot.fieldType === 1),
        )
        documentHolder.mnuExpandCollapsePivot.setVisible(!!this.propsPivot.canExpandCollapse)
        documentHolder.mnuPivotExpandCollapseSeparator.setVisible(
          !!this.propsPivot.canExpandCollapse,
        )
        ...
        documentHolder.mnuSummarize.setVisible(
          !!this.propsPivot.field && this.propsPivot.fieldType === 2,
        )
        documentHolder.mnuShowAs.setVisible(
          !!this.propsPivot.field &&
            this.propsPivot.fieldType === 2 &&
            !this.propsPivot.rowTotal &&
            !this.propsPivot.colTotal,
        )
        documentHolder.mnuPivotValueSeparator.setVisible(
          !!this.propsPivot.field && this.propsPivot.fieldType === 2,
        )
        ...
        if (this.propsPivot.field) {
          documentHolder.mnuDeleteField.setCaption(
            documentHolder.txtDelField +
              " " +
              (this.propsPivot.rowTotal || this.propsPivot.colTotal
                ? documentHolder.txtGrandTotal
                : '"' + this.propsPivot.fieldName + '"'),
          )
          documentHolder.mnuSubtotalField.setCaption(
            documentHolder.txtSubtotalField + ' "' + this.propsPivot.fieldName + '"',
          )
          documentHolder.mnuFieldSettings.setCaption(
            this.propsPivot.fieldType === 2
              ? documentHolder.txtValueFieldSettings
              : documentHolder.txtFieldSettings,
          )
          if (this.propsPivot.fieldType === 2) {
            ...
            documentHolder.mnuSubtotalField.setChecked(
              !!this.propsPivot.field.asc_getDefaultSubtotal(),
              true,
            )
          }
        }
        if (this.propsPivot.filter) {
          documentHolder.mnuPivotFilter.menu.items[0].setCaption(
            this.propsPivot.fieldName
              ? Common.Utils.String.format(
                  documentHolder.txtClearPivotField,
                  ' "' + this.propsPivot.fieldName + '"',
                )
              : documentHolder.txtClear,
          ) // clear filter
          documentHolder.mnuPivotFilter.menu.items[0].setDisabled(
            this.propsPivot.filter.asc_getFilterObj().asc_getType() ===
              Asc.c_oAscAutoFilterTypes.None,
          ) // clear filter
        }
        if (inPivot) {
          documentHolder.mnuPivotSort.menu.items[2].setDisabled(
            !(this.propsPivot.filter || (this.propsPivot.rowFilter && this.propsPivot.colFilter)),
          )
        }

        if (isintable) {
          documentHolder.pmiInsertTable.menu.items[0].setDisabled(
            !formatTableInfo.asc_getIsInsertRowAbove(),
          )
          documentHolder.pmiInsertTable.menu.items[1].setDisabled(
            !formatTableInfo.asc_getIsInsertRowBelow(),
          )
          documentHolder.pmiInsertTable.menu.items[2].setDisabled(
            !formatTableInfo.asc_getIsInsertColumnLeft(),
          )
          documentHolder.pmiInsertTable.menu.items[3].setDisabled(
            !formatTableInfo.asc_getIsInsertColumnRight(),
          )

          documentHolder.pmiDeleteTable.menu.items[0].setDisabled(
            !formatTableInfo.asc_getIsDeleteRow(),
          )
          documentHolder.pmiDeleteTable.menu.items[1].setDisabled(
            !formatTableInfo.asc_getIsDeleteColumn(),
          )
          documentHolder.pmiDeleteTable.menu.items[2].setDisabled(
            !formatTableInfo.asc_getIsDeleteTable(),
          )
        }

        var hyperinfo = cellinfo.asc_getHyperlink()
        documentHolder.menuHyperlink.setVisible(
          iscellmenu &&
            hyperinfo &&
            !iscelledit &&
            !ismultiselect &&
            !diagramOrMergeEditor &&
            !inPivot,
        )
        documentHolder.menuAddHyperlink.setVisible(
          iscellmenu &&
            !hyperinfo &&
            !iscelledit &&
            !ismultiselect &&
        ...
        documentHolder.pmiFreezePanes.setCaption(
          this.api.asc_getSheetViewSettings().asc_getIsFreezePane()
            ? documentHolder.textUnFreezePanes
            : documentHolder.textFreezePanes,
        )

        /** coauthoring begin **/
        var celcomments = cellinfo.asc_getComments() // celcomments===null - has comment, but no permissions to view it
        documentHolder.pmiAddCommentSeparator.setVisible(
          iscellmenu &&
            !iscelledit &&
            this.permissions.canCoAuthoring &&
            this.permissions.canComments &&
            celcomments &&
            celcomments.length < 1,
        )
        documentHolder.pmiAddComment.setVisible(
          iscellmenu &&
            !iscelledit &&
            this.permissions.canCoAuthoring &&
            this.permissions.canComments &&
        ...
        /** coauthoring end **/
        documentHolder.pmiCellMenuSeparator.setVisible(
          (iscellmenu && !iscelledit) || isrowmenu || iscolmenu || isallmenu,
        )
        ...
        documentHolder.pmiClear.menu.items[2].setDisabled(
          iscelledit || !this.permissions.canModifyFilter,
        )
        ...
        documentHolder.pmiCellFormat.setVisible(
          !iscelledit &&
            !(
              (this.permissions.canBrandingExt &&
                this.permissions.customization &&
                this.permissions.customization.rightMenu === false) ||
        ...
        documentHolder.pmiAdvancedNumFormat.options.numformatinfo =
          documentHolder.pmiNumFormat.menu.options.numformatinfo = xfs.asc_getNumFormatInfo()
        documentHolder.pmiAdvancedNumFormat.options.numformat = xfs.asc_getNumFormat()

        documentHolder.pmiGetRangeList.setVisible(
          !Common.Utils.isIE &&
            iscellmenu &&
            !iscelledit &&
            !ismultiselect &&
            !internaleditor &&
            this.permissions.canMakeActionLink &&
            !!navigator.clipboard,
        )

        _.each(documentHolder.ssMenu.items, (item) => {
          item.setDisabled(isCellLocked || isUserProtected)
        })
        documentHolder.pmiCopy.setDisabled(false)
        documentHolder.pmiSelectTable.setDisabled(this._state.wsLock)
        documentHolder.pmiInsertEntire.setDisabled(
          isCellLocked ||
            isTableLocked ||
            (isrowmenu && this._state.wsProps["InsertRows"]) ||
            (iscolmenu && this._state.wsProps["InsertColumns"]) ||
            isUserProtected,
        )
        documentHolder.pmiInsertCells.setDisabled(
          isCellLocked || isTableLocked || inPivot || this._state.wsLock || isUserProtected,
        )
        documentHolder.pmiInsertTable.setDisabled(
          isCellLocked || isTableLocked || this._state.wsLock || isUserProtected,
        )
        documentHolder.pmiDeleteEntire.setDisabled(
          isCellLocked ||
            isTableLocked ||
            (isrowmenu && this._state.wsProps["DeleteRows"]) ||
            (iscolmenu && this._state.wsProps["DeleteColumns"]) ||
            isUserProtected,
        )
        documentHolder.pmiDeleteCells.setDisabled(
          isCellLocked || isTableLocked || inPivot || this._state.wsLock || isUserProtected,
        )
        documentHolder.pmiDeleteTable.setDisabled(
          isCellLocked || isTableLocked || this._state.wsLock || isUserProtected,
        )
        documentHolder.pmiClear.setDisabled(isCellLocked || inPivot || isUserProtected)
        documentHolder.pmiFilterCells.setDisabled(
          isCellLocked ||
            isTableLocked ||
            filterInfo == null ||
            inPivot ||
            (!filterInfo && !this.permissions.canModifyFilter) ||
            this._state.wsLock ||
            isUserProtected,
        )
        documentHolder.pmiSortCells.setDisabled(
          isCellLocked ||
            isTableLocked ||
            filterInfo == null ||
            inPivot ||
            !this.permissions.canModifyFilter ||
            this._state.wsProps["Sort"] ||
            isUserProtected,
        )
        documentHolder.pmiReapply.setDisabled(
          isCellLocked || isTableLocked || isApplyAutoFilter !== true || isUserProtected,
        )
        documentHolder.pmiCondFormat.setDisabled(
          isCellLocked || isTableLocked || this._state.wsProps["FormatCells"] || isUserProtected,
        )
        documentHolder.menuHyperlink.setDisabled(
          isCellLocked || inPivot || this._state.wsProps["InsertHyperlinks"] || isUserProtected,
        )
        documentHolder.menuAddHyperlink.setDisabled(
          isCellLocked || inPivot || this._state.wsProps["InsertHyperlinks"] || isUserProtected,
        )
        documentHolder.pmiInsFunction.setDisabled(isCellLocked || inPivot || isUserProtected)
        documentHolder.pmiFreezePanes.setDisabled(
          this.api.asc_isWorksheetLockedOrDeleted(this.api.asc_getActiveWorksheetIndex()),
        )
        documentHolder.pmiRowHeight.setDisabled(isCellLocked || this._state.wsProps["FormatRows"])
        documentHolder.pmiColumnWidth.setDisabled(
          isCellLocked || this._state.wsProps["FormatColumns"],
        )
        documentHolder.pmiEntireHide.setDisabled(
          isCellLocked ||
            (iscolmenu && this._state.wsProps["FormatColumns"]) ||
            (isrowmenu && this._state.wsProps["FormatRows"]),
        )
        documentHolder.pmiEntireShow.setDisabled(
          isCellLocked ||
            (iscolmenu && this._state.wsProps["FormatColumns"]) ||
            (isrowmenu && this._state.wsProps["FormatRows"]),
        )
        documentHolder.pmiNumFormat.setDisabled(
          isCellLocked || this._state.wsProps["FormatCells"] || isUserProtected,
        )
        documentHolder.pmiSparklines.setDisabled(
          isCellLocked || this._state.wsLock || isUserProtected,
        )
        documentHolder.pmiEntriesList.setDisabled(
          isCellLocked || this._state.wsLock || isUserProtected,
        )
        ...
        if (inPivot) {
          ...
          documentHolder.mnuShowDetails.setDisabled(
            this.api.asc_isWorkbookLocked() || this.api.asc_isProtectedWorkbook(),
          )
        ...
        documentHolder.pmiFunctionSeparator.setVisible(
          documentHolder.pmiInsFunction.isVisible() ||
            documentHolder.menuAddHyperlink.isVisible() ||
            documentHolder.menuHyperlink.isVisible() ||
            isrowmenu ||
            iscolmenu ||
            isallmenu,
        )
    ...
    dh.fillViewMenuProps = function (cellinfo, showMenu, event) {
      ...
      var signProps = signGuid ? this.api.asc_getSignatureSetup(signGuid) : null,
        ...
        canComment =
          ...
          this.permissions.canComments &&
          !this._isDisabled &&
          cellinfo.asc_getComments() &&
          cellinfo.asc_getComments().length < 1

      documentHolder.menuViewUndo.setVisible(
        this.permissions.canCoAuthoring && this.permissions.canComments && !this._isDisabled,
      )
      ...
      commentsController && commentsController.blockPopover(true)
      documentHolder.menuViewAddComment.setDisabled(
        isCellLocked || isTableLocked || this._state.wsProps["Objects"],
      )
    ...
    dh.onEntriesListMenu = function (validation, textarr, addarr) {
      if (textarr && textarr.length > 0) {
        var documentHolderView = this.documentHolder,
        ...
        _.each(textarr, (menuItem, index) => {
          var mnu = new Common.UI.MenuItem({
            caption: menuItem,
            value: addarr ? addarr[index] : menuItem,
            style:
              typeof menuItem == "string" && _.isEmpty(menuItem.trim()) ? "min-height: 25px;" : "",
          }).on("click", (item, e) => {
            this.api.asc_insertInCell(item.value, Asc.c_oAscPopUpSelectorType.None, false)
          })
          menu.addItem(mnu)
        })
        ...
        var coord = this.api.asc_getActiveCellCoord(validation), // get merged cell for validation
          offset = { left: 0, top: 0 },
          showPoint = [
            coord.asc_getX() + offset.left + (validation ? coord.asc_getWidth() : 0),
    ...
    dh.onTableTotalMenu = function (current) {
      if (current !== undefined) {
        ...
        menu.clearAll()
        var func = _.find(menu.items, (item) => item.value == current)
        if (func) func.setChecked(true, true)

        var coord = this.api.asc_getActiveCellCoord(),
          offset = { left: 0, top: 0 },
          showPoint = [
            coord.asc_getX() + offset.left + coord.asc_getWidth(),
            (coord.asc_getY() < 0 ? 0 : coord.asc_getY()) + coord.asc_getHeight() + offset.top,
          ]
        menuContainer.css({ left: showPoint[0], top: showPoint[1] })
    ...
    dh.onApiFormulaCompleteMenu = function (funcarr, offset) {
      setTimeout(() => {
        this.onFormulaCompleteMenu(funcarr, offset)
      }, 0)
    }

    dh.onFormulaCompleteMenu = function (funcarr, offset) {
      if (
        !this.documentHolder.funcMenu ||
      ...
      if (funcarr) {
        var documentHolderView = this.documentHolder,
          ...
          funcdesc = this.getApplication()
            .getController("FormulaDialog")
            .getDescription(Common.Utils.InternalSettings.get("sse-settings-func-locale"))
        ...
        _.each(funcarr, (menuItem, index) => {
          var type = menuItem.asc_getType(),
            name = menuItem.asc_getName(true),
            origname = this.api.asc_getFormulaNameByLocale(name),
            iconCls = "",
            caption = name,
            hint = ""
          switch (type) {
            case Asc.c_oAscPopUpSelectorType.Func:
              ...
              if (funcdesc && funcdesc[origname]) hint = funcdesc[origname].d
              else {
                var custom = this.api.asc_getCustomFunctionInfo(origname)
          ...
          var mnu = new Common.UI.MenuItem({
            ...
            setTimeout(() => {
              this.api.asc_insertInCell(item.options.name, type, false)
            }, 10)
          })
          menu.addItem(mnu)
        })
        ...
        if (!menu.rendered) {
          ...
          if (menuContainer.length < 1) {
            menuContainer = $(
              Common.Utils.String.format(
                '<div id="menu-formula-selection" style="position: absolute; z-index: 10000;" class="no-stop-propagate"><div class="dropdown-toggle" data-toggle="dropdown"></div></div>',
              ),
            )
            documentHolderView.cmpEl.append(menuContainer)
          }

          menu.onAfterKeydownMenu = (e) => {
            ...
            if (menuContainer.hasClass("open")) {
              if (
                ...
                (e.keyCode == Common.UI.Keys.RETURN && !e.ctrlKey && !e.altKey)
              )
                ...
                var innerEl = menu.cmpEl,
                  ...
                  newpos
                if (pos < 0) newpos = innerEl.scrollTop() + pos - padding
        ...
        if (infocus) {
          menu.menuAlignEl = this.cellEditor
          menu.offset = [
            0,
            (offset ? offset[1] : 0) +
              (isFunctipShow ? this.tooltips.func_arg.ref.getBSTip().$tip.height() + 2 : 0),
          ]
          this.focusInCellEditor = true
        } else {
          menu.menuAlignEl = undefined
          menu.offset = [0, 0]
          this.focusInCellEditor = false
          var coord = this.api.asc_getActiveCellCoord(),
            showPoint = [
              coord.asc_getX() + (offset ? offset[0] : 0),
              (coord.asc_getY() < 0 ? 0 : coord.asc_getY()) +
                coord.asc_getHeight() +
                (offset ? offset[1] : 0) +
                (isFunctipShow ? this.tooltips.func_arg.ref.getBSTip().$tip.height() + 2 : 0),
            ]
        ...
        if (!menu.isVisible()) Common.UI.Menu.Manager.hideAll()
        _.delay(() => {
          ...
          if (infocus) this.cellEditor.focus()
    ...
    dh.fillRepeatedNames = (argsNames, repeatedArg) => {
      var repeatedIdx = 1
    ...
    dh.getArgumentName = function (
      ...
      } else name = this.textArgument + (maxArgCount > 1 ? " " + (argcount + 1) : "")
    ...
    dh.onFormulaInfo = function (name, shiftpos, funcInfo) {
      ...
      if (name) {
        if (!functip.parentEl) {
          functip.parentEl = $(
            '<div id="tip-container-functip" style="position: absolute; z-index: 10000;"></div>',
          )
          this.documentHolder.cmpEl.append(functip.parentEl)
        }
        var funcdesc = this.getApplication()
            .getController("FormulaDialog")
            .getDescription(Common.Utils.InternalSettings.get("sse-settings-func-locale")),
          hint = "",
        ...
        if (argstype && activeArgsCount) {
          ...
          if (funcdesc && funcdesc[name]) {
            ...
            args =
              ...
              arr_args
                ...
                .join(this.api.asc_getFunctionArgumentSeparator() + " ") +
              ")"
          }
          ...
          function fillArgs(types) {
            ...
            for (var j = 0; j < types.length; j++) {
              ...
              activeArg &&
                argcount === activeArg - 1 &&
                (str = '<span class="contrast">' + str + "</span>")
              arr.push(str)
              argcount++
            }
          }
          ...
          if (funcdesc && funcdesc[name]) {
            ...
            var custom = this.api.asc_getCustomFunctionInfo(name),
              arr_args = custom ? custom.asc_getArg() || [] : []
            hint =
              this.api.asc_getFormulaLocaleName(name) +
              "(" +
              arr_args
                .map((item) =>
                  item.asc_getIsOptional() ? "[" + item.asc_getName() + "]" : item.asc_getName(),
        ...
        if (infocus || this.focusInCellEditor) {
          ...
          showPoint = [
            coord.asc_getX() + pos[0] + 9,
            coord.asc_getY() + pos[1] + coord.asc_getHeight() + 4,
          ]
        }
        ...
        if (showPoint[0] < 0) {
          ...
          functip.ref
            ...
            .css("max-width", this.tooltips.coauth.bodyWidth)
        }
    ...
    dh.changeInputMessagePosition = function (inputTip) {
      var pos = [
        ...
        coord = this.api.asc_getActiveCellCoord(),
        showPoint = [
          coord.asc_getX() + pos[0] - 3,
          coord.asc_getY() + pos[1] - inputTip.ref.getBSTip().$tip.height() - 5,
        ]
    ...
    dh.onInputMessage = function (title, message) {
      ...
      if (message) {
        if (!inputtip.parentEl) {
          inputtip.parentEl = $(
            '<div id="tip-container-inputtip" style="position: absolute; z-index: 10000;"></div>',
          )
        ...
        case "bShowHorAxis":
          if (hBarChart) {
            chartProps.setDisplayAxes(
              VertAxis && VertAxis.getShow(),
              SecVertAxis && SecVertAxis.getShow(),
              item.checked,
              SecHorAxis && SecHorAxis.getShow(),
              DepthAxis && DepthAxis.getShow(),
            )
    ...
    dh.updateChartElementMenu = (menu, chartProps) => {
      const type = chartProps.getType(),
        ...
        comboType = ComboChart
          ? chartProps.getSeries &&
            chartProps.getSeries()[0] &&
            chartProps.getSeries()[0].asc_getChartType()
          : type,
      ...
      titlesMenu.items[0].setChecked(
        horAxes &&
          horAxes[0] &&
          horAxes[0].getLabel() === Asc.c_oAscChartHorAxisLabelShowSettings.noOverlay,
      )
    ...
    dh.onSingleChartSelectionChanged = function (asc_CRect) {
      ...
      this.isRtl = this.api ? Common.UI.isRTL() : false
      ...
      if (this.chartProps) {
        ...
        this.tooltips.coauth.XY = undefined
        ...
        if (this.isRtlSheet) {
          if (rtlSheet >= 0 && rtlSheet + btnWidth <= this.tooltips.coauth.apiWidth) {
            btnLeft = rtlSheet
          } else if (leftSide >= 0) {
            btnLeft = leftSide - 32
          } else {
          ...
          if (leftSide >= 0) {
            btnLeft = leftSide + 18
          } else if (rightSide + btnWidth <= this.tooltips.coauth.apiWidth) {
            btnLeft = rightSide
          } else {
            chartContainer.hide()
            Common.UI.TooltipManager.closeTip("chartElements")
          ...
          if (rightSide + btnWidth <= this.tooltips.coauth.apiWidth + 5) {
            btnLeft = rightSide
          } else if (leftSide >= 0) {
            btnLeft = leftSide + 18
          } else {
    ...
    dh.onShowSpecialPasteOptions = function (specialPasteShowOptions) {
      ...
      if (pasteItems.length > 0) {
        ...
        this._state.lastSpecPasteChecked = menu.items.length > 0 ? menu.items[0] : null
        if (lastSelected) {
          var foundItem = null
          if (
            this.btnSpecialPaste &&
            this.btnSpecialPaste.menu &&
            this.btnSpecialPaste.menu.items.length > 0
          ) {
            for (var i = 0; i < this.btnSpecialPaste.menu.items.length; i++) {
              var menuItem = this.btnSpecialPaste.menu.items[i]
        ...
        if (menu.items.length > 0 && specialPasteShowOptions.asc_getShowPasteSpecial()) {
          ...
          var mnu = new Common.UI.MenuItem({
            ...
            new SSE.Views.SpecialPasteDialog({
              ...
              handler: (result, settings) => {
                if (result == "ok") {
                  this._state.lastSpecPasteChecked &&
                    this._state.lastSpecPasteChecked.setChecked(false, true)
                  this._state.lastSpecPasteChecked =
                    settings && this._arrSpecialPaste[settings.asc_getProps()]
                      ? this._arrSpecialPaste[settings.asc_getProps()][2]
                      : null
                  this._state.lastSpecPasteChecked &&
                    this._state.lastSpecPasteChecked.setChecked(true, true)
                  if (this && this.api) {
                    this.api.asc_SpecialPaste(settings)
                  }
                }
              },
            }).show()
      ...
      var rightBottom = coord[0],
        leftTop = coord[1],
        width =
          this.tooltips.coauth.bodyWidth -
          this.tooltips.coauth.XY[0] -
          this.tooltips.coauth.rightMenuWidth -
          15,
        height = this.tooltips.coauth.apiHeight - 15, // height - scrollbar height
        showPoint = [],
        showAtBottom = false
      ...
      if (controller) {
        ...
        showAtBottom =
          comments &&
          comments.length > 0 &&
          controller.getPopover().isVisible() &&
          controller.findPopupComment(controller.findComment(comments[0].asc_getId()).get("id"))
      }
      ...
      var isRtlSheet = !!this.api.asc_getSheetViewSettings().asc_getRightToLeft(),
        btnSize = this.btnSpecialPaste.cmpEl
          ? [this.btnSpecialPaste.cmpEl.width(), this.btnSpecialPaste.cmpEl.height()]
          : [70, 20],
      ...
      if (isRtlSheet) {
        ...
        if (left < 0 || showAtBottom) {
          showPoint[0] =
            leftTop !== undefined ? leftTop.asc_getX() + leftTop.asc_getWidth() - btnSize[0] : 0
          if (bottom > height) showPoint[0] += btnSize[0] + 3
          if (showPoint[0] < 0 || showPoint[0] + btnSize[0] > width) showPoint[0] = 0
        } else showPoint[0] = left
      } else {
        ...
        if (right > width || showAtBottom) {
          ...
          if (bottom > height) showPoint[0] -= btnSize[0] + 3
          if (showPoint[0] < 0 || showPoint[0] + btnSize[0] > width)
            showPoint[0] = width - 3 - btnSize[0]
        } else showPoint[0] = right - btnSize[0]
      }
    ...
    dh.onSpecialPasteItemClick = function (item, e) {
          ...
          handler: (result, settings) => {
            if (result == "ok") {
              if (this && this.api) {
                ...
                this.api.asc_SpecialPaste(props)
              }
              this._state.lastSpecPasteChecked = item
            } else if (item.cmpEl) {
      ...
      if (!item.cmpEl && this._state.lastSpecPasteChecked) {
        for (var i = 0; i < menu.items.length; i++) {
          menu.items[i].setChecked(
            menu.items[i].value === this._state.lastSpecPasteChecked.value,
            true,
          )
          if (menu.items[i].value === this._state.lastSpecPasteChecked.value)
            this._state.lastSpecPasteChecked = menu.items[i]
        }
      }
      return false
    }
    ...
    dh.onToggleAutoCorrectOptions = function (autoCorrectOptions) {
      ...
      // Prepare menu container
      if (pasteContainer.length < 1) {
        this._arrAutoCorrectPaste = []
        this._arrAutoCorrectPaste[Asc.c_oAscAutoCorrectOptions.UndoTableAutoExpansion] = {
          caption: this.txtUndoExpansion,
          icon: "menu__icon btn-undo icon-rtl",
        }
        this._arrAutoCorrectPaste[Asc.c_oAscAutoCorrectOptions.RedoTableAutoExpansion] = {
          caption: this.txtRedoExpansion,
          icon: "menu__icon btn-redo icon-rtl",
        }

        pasteContainer = $(
          '<div id="autocorrect-paste-container" style="position: absolute;"><div id="id-document-holder-btn-autocorrect-paste"></div></div>',
        )
        documentHolderView.cmpEl.append(pasteContainer)

        this.btnAutoCorrectPaste = new Common.UI.Button({
        ...
        this.btnAutoCorrectPaste.menu.on("show:after", _.bind(this.onAutoCorrectOpenAfter, this))
      }

      if (pasteItems.length > 0) {
        var menu = this.btnAutoCorrectPaste.menu
        for (var i = 0; i < menu.items.length; i++) {
          menu.removeItem(menu.items[i])
          i--
        }
        ...
        _.each(pasteItems, (menuItem, index) => {
          var mnu = new Common.UI.MenuItem({
            caption: this._arrAutoCorrectPaste[menuItem].caption,
            value: menuItem,
            iconCls: this._arrAutoCorrectPaste[menuItem].icon,
          }).on("click", (item, e) => {
            this.api.asc_applyAutoCorrectOptions(item.value)
            setTimeout(() => {
              menu.hide()
            }, 100)
          })
        ...
        this.mnuAutoCorrectStop = new Common.UI.MenuItem({
          caption: this.textStopExpand,
          checkable: true,
          allowDepress: true,
          ...
          this.api.asc_setIncludeNewRowColTable(!item.checked)
          setTimeout(() => {
            menu.hide()
          }, 100)
        })
        menu.addItem(this.mnuAutoCorrectStop)
        menu.addItem({ caption: "--" })
        var mnu = new Common.UI.MenuItem({
          caption: this.textAutoCorrectSettings,
        }).on("click", _.bind(this.onAutoCorrectOptions, this))
        menu.addItem(mnu)
      }
    ...
    dh.onChangeCropState = function (state) {
      this.documentHolder.menuImgCrop &&
    ...
    dh.onBulletMenuShowAfter = function () {
      ...
      store.each((item) => {
        ;(item.get("group") === "menu-list-bullet-group" ? arrMarker : arrNum).push({
          numberingInfo: {
            bullet:
              item.get("numberingInfo") === "undefined"
                ? undefined
                : JSON.parse(item.get("numberingInfo")),
          },
          divId: item.get("id"),
        })
      })
    ...
    dh.isPivotNumberFormat = function () {
      if (this.propsPivot && this.propsPivot.originalProps && this.propsPivot.field) {
        return (
          this.propsPivot.originalProps.asc_getFieldGroupType(this.propsPivot.pivotIndex) !==
          Asc.c_oAscGroupType.Text
        )
      }
      return false
    }
      ...
      if (item.value !== undefined && item.value !== "advanced") {
        if (this.api)
          if (this.isPivotNumberFormat()) {
            var field =
              this.propsPivot.fieldType === 2 ? new Asc.CT_DataField() : new Asc.CT_PivotField()
            field.asc_setNumFormat(item.options.format)
            this.propsPivot.field.asc_set(
              this.api,
              this.propsPivot.originalProps,
              this.propsPivot.fieldType === 2 ? this.propsPivot.index : this.propsPivot.pivotIndex,
              field,
            )
          } else this.api.asc_setCellFormat(item.options.format)
      }
      Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
    }
      ...
      new Common.Views.FormatSettingsDialog({
        ...
        handler: (result, settings) => {
          if (settings) {
            ...
            } else this.api.asc_setCellFormat(settings.format)
          }
          Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
        },
        props: {
          format: item.options.numformat,
          formatInfo: item.options.numformatinfo,
          langId: value,
        },
      }).show()
      Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
    ...
    dh.onNumberFormatOpenAfter = function (menu) {
      if (this.api) {
        ...
        for (var i = 0; i < menu.items.length - 2; i++) {
          ...
          mnu.options.exampleval = this.api.asc_getLocaleExample(mnu.options.format)
    ...
    dh.onAutoCorrectOpenAfter = function (menu) {
      this.mnuAutoCorrectStop &&
        this.mnuAutoCorrectStop.setChecked(
          !Common.Utils.InternalSettings.get("sse-settings-autoformat-new-rows"),
        )
    }
    ...
    dh.onShowForeignCursorLabel = function (UserId, X, Y, color) {
      ...
      if (
        this.tooltips &&
        this.tooltips.foreignSelect &&
        this.tooltips.foreignSelect.userId == UserId
      ) {
        this.hideForeignSelectTips()
      }
      for (var i = 0; i < this.fastcoauthtips.length; i++) {
      ...
      if (
        X < 0 ||
        X + coAuthTip.XY[0] > coAuthTip.bodyWidth - coAuthTip.rightMenuWidth ||
        Y < 0 ||
        Y > coAuthTip.apiHeight
      ) {
      ...
      src.css({
        left:
          (X + coAuthTip.XY[0] + src.outerWidth() > coAuthTip.bodyWidth - coAuthTip.rightMenuWidth
            ? coAuthTip.bodyWidth - coAuthTip.rightMenuWidth - src.outerWidth() - coAuthTip.XY[0]
            : X) + "px",
        top: Y - this._TtHeight + "px",
      })
      /** coauthoring end **/
    }
    ...
    dh.onDoubleClickOnTableOleObject = function (frameBinary) {
      ...
      if (this.permissions.isEdit && !this._isDisabled) {
        var oleEditor = SSE.getController("Common.Controllers.ExternalOleEditor").getView(
    ...
    dh.onShowMathTrack = function (bounds) {
      ...
      if (eqContainer.length < 1) {
        ...
        var bringForward = (menu) => {
          eqContainer.addClass("has-open-menu")
        }
        var sendBackward = (menu) => {
          ...
          var btn = new Common.UI.Button({
            ...
            menu: new Common.UI.Menu({
              ...
              items: [
                {
                  template: _.template(
                    '<div id="id-document-holder-btn-equation-menu-' +
                      i +
        ...
        this.equationSettingsBtn.menu.options.initMenu = () => {
          var eq = this.api.asc_GetMathInputType(),
            menu = this.equationSettingsBtn.menu,
            isEqToolbarHide = Common.Utils.InternalSettings.get("sse-equation-toolbar-hide")
      ...
      if (!this.tooltips.coauth.XY) this.onDocumentResize()
      ...
      showPoint[1] = Math.min(
        this.tooltips.coauth.apiHeight - eqContainer.outerHeight(),
        Math.max(0, showPoint[1]),
      )
      eqContainer.css({ left: showPoint[0], top: showPoint[1] })

      var diffDown = this.tooltips.coauth.apiHeight - showPoint[1] - eqContainer.outerHeight(),
        diffUp = this.tooltips.coauth.XY[1] + showPoint[1],
          ...
          var res,
            win = new SSE.Views.FillSeriesDialog({
              handler: (result, settings) => {
                if (result == "ok" && settings) {
                  res = result
                  this.api.asc_FillCells(item.value, settings)
                }
                Common.NotificationCenter.trigger("edit:complete", this.documentHolder)
              },
              props: menu.seriesinfo,
            }).on("close", () => {
              res !== "ok" && this.api.asc_CancelFillCells()
            })
          win.show()
        } else {
