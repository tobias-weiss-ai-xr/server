...
define([
  ...
  SSE.Views.DataValidationDialog = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 320,
        ...
        render: function () {
          ...
          this.cmbData = new Common.UI.ComboBox({
            ...
            data: [
              ...
              {
                value: Asc.EDataValidationOperator.GreaterThanOrEqual,
                displayValue: this.txtGreaterThanOrEqual,
              },
              {
                value: Asc.EDataValidationOperator.LessThanOrEqual,
                displayValue: this.txtLessThanOrEqual,
              },
            ],
            style: "width: 100%;",
            menuStyle: "min-width: 100%;",
          ...
          this.inputRangeMin = new Common.UI.InputFieldBtn({
            ...
            .on("changed:after", _.bind(this.onRangeChange, this, 1))
          ...
          this.inputRangeMax = new Common.UI.InputFieldBtn({
            ...
            .on("changed:after", _.bind(this.onRangeChange, this, 2))
          ...
          this.inputRangeSource = new Common.UI.InputFieldBtn({
            ...
            .on("changed:after", _.bind(this.onRangeChange, this, 3))
          ...
          this.textareaInput.on("changed:after", () => {
          ...
          this.cmbStyle = new Common.UI.ComboBox({
            ...
            data: [
              {
                value: Asc.c_oAscEDataValidationErrorStyle.Stop,
                clsText: "error",
                displayValue: this.textStop,
              },
              {
                value: Asc.c_oAscEDataValidationErrorStyle.Warning,
                clsText: "warn",
                displayValue: this.textAlert,
              },
              {
                value: Asc.c_oAscEDataValidationErrorStyle.Information,
                clsText: "info",
                displayValue: this.textMessage,
              },
            ],
            style: "width: 110px;",
          ...
          this.textareaError.on("changed:after", () => {
            this.isErrorChanged = true
          })
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.chIgnore,
              this.chShowDropDown,
              this.inputRangeSource,
              this.inputRangeMin,
              this.inputRangeMax,
              this.chApply, // 0 tab
              this.chShowInput,
              this.inputInputTitle,
              this.textareaInput, // 1 tab
              this.chShowError,
              this.cmbStyle,
              this.inputErrorTitle,
              this.textareaError, // 2 tab
            ])
          ...
          setTimeout(() => {
            switch (index) {
              case 0:
                ...
                break
              case 1:
                if (!this.inputInputTitle.isDisabled()) this.inputInputTitle.focus()
                else this.chShowInput.focus()
                break
              case 2:
                if (!this.cmbStyle.isDisabled()) this.cmbStyle.focus()
                else this.chShowError.focus()
                break
            }
          }, 10)
        },
        ...
        onSelectData: function (type, input) {
          if (this.api) {
            const handlerDlg = (dlg, result) => {
              if (result === "ok") {
                const val = dlg.getSettings()
                input.setValue(val)
                this.onRangeChange(type, input, val)
              }
            }
        ...
        onRangeChange: function (type, input, newValue, oldValue, e) {
          ...
          if (!this._noApply) {
            if (type === 1 || type === 3) {
              if (!this.props.asc_getFormula1()) this.props.asc_setFormula1(new Asc.CDataFormula())
              this.props.asc_getFormula1().asc_setValue(newValue)
            } else if (type === 2) {
              if (!this.props.asc_getFormula2()) this.props.asc_setFormula2(new Asc.CDataFormula())
        ...
        onAllowSelect: function (combo, record) {
          this.ShowHideElem()
          if (!this._noApply) this.props.asc_setType(record.value)
          this.inputRangeMin.setValue(
            this.props.asc_getFormula1() ? this.props.asc_getFormula1().asc_getValue() || "" : "",
          )
          this.inputRangeSource.setValue(
            this.props.asc_getFormula1() ? this.props.asc_getFormula1().asc_getValue() || "" : "",
          )
          this.inputRangeMax.setValue(
            this.props.asc_getFormula2() ? this.props.asc_getFormula2().asc_getValue() || "" : "",
          )
        },

        onDataSelect: function (combo, record) {
          this.ShowHideElem()
          if (!this._noApply) this.props.asc_setOperator(record.value)
          this.inputRangeMin.setValue(
            this.props.asc_getFormula1() ? this.props.asc_getFormula1().asc_getValue() || "" : "",
          )
          this.inputRangeSource.setValue(
        ...
        onStyleSelect: function (combo, record) {
          ...
          if (!this._noApply) this.props.asc_setErrorStyle(record.value)
        },
        ...
        _setDefaults: function (props) {
          this._noApply = true
          if (props) {
            let value = props.asc_getAllowBlank()
            ...
            this.cmbAllow.setValue(
              value !== null ? value : Asc.c_oAscEDataValidationType.None,
              true,
            )
            this.chApply.setDisabled(value === Asc.c_oAscEDataValidationType.None)
            value = props.asc_getOperator()
            this.cmbData.setValue(
              value !== null ? value : Asc.EDataValidationOperator.Between,
              true,
            )
            this.inputRangeMin.setValue(
              props.asc_getFormula1() ? props.asc_getFormula1().asc_getValue() || "" : "",
            )
            this.inputRangeSource.setValue(
              props.asc_getFormula1() ? props.asc_getFormula1().asc_getValue() || "" : "",
            )
            this.inputRangeMax.setValue(
              props.asc_getFormula2() ? props.asc_getFormula2().asc_getValue() || "" : "",
            )
            ...
            const rec = this.cmbStyle.getSelectedRecord()
            if (rec) {
              this.errorIcon.removeClass("error warn info")
        ...
        getSettings: function () {
          ...
          if (this.isInputChanged) this.props.asc_setPrompt(this.textareaInput.getValue())
          if (this.isErrorTitleChanged)
            this.props.asc_setErrorTitle(this.inputErrorTitle.getValue())
          if (this.isErrorChanged) this.props.asc_setError(this.textareaError.getValue())
          return this.props
        },
        ...
        ShowHideElem: function () {
          const allow = this.cmbAllow.getValue()
          const data = this.cmbData.getValue()
          const between =
            data === Asc.EDataValidationOperator.Between ||
            data === Asc.EDataValidationOperator.NotBetween
          const source =
            allow === Asc.c_oAscEDataValidationType.Custom ||
            allow === Asc.c_oAscEDataValidationType.List
          this.minMaxTr.toggleClass(
            "hidden",
            allow === Asc.c_oAscEDataValidationType.None || source || !between,
          )
          this._isMinMaxVisible = !(
            allow === Asc.c_oAscEDataValidationType.None ||
            source ||
            !between
          )
          this.sourceTr.toggleClass(
            "hidden",
            allow === Asc.c_oAscEDataValidationType.None || (!source && between),
          )
          ...
          this.cmbData.setDisabled(
            allow === Asc.c_oAscEDataValidationType.None ||
              allow === Asc.c_oAscEDataValidationType.Custom ||
              allow === Asc.c_oAscEDataValidationType.List,
          )

          let str = this.textSource
          if (allow === Asc.c_oAscEDataValidationType.List) str = this.textSource
          else if (allow === Asc.c_oAscEDataValidationType.Custom) str = this.textFormula
          else if (
            data === Asc.EDataValidationOperator.Equal ||
            data === Asc.EDataValidationOperator.NotEqual
          ) {
            // equals, not equals
            if (allow === Asc.c_oAscEDataValidationType.Date) str = this.txtDate
            else if (allow === Asc.c_oAscEDataValidationType.TextLength) str = this.txtLength
            else if (allow === Asc.c_oAscEDataValidationType.Time) str = this.txtElTime
            else str = this.textCompare
          } else if (
            data === Asc.EDataValidationOperator.GreaterThan ||
            data === Asc.EDataValidationOperator.GreaterThanOrEqual
          ) {
            // greater, greater or equals
            if (allow === Asc.c_oAscEDataValidationType.Date) str = this.txtStartDate
            else if (allow === Asc.c_oAscEDataValidationType.Time) str = this.txtStartTime
            else str = this.textMin
          } else if (
            data === Asc.EDataValidationOperator.LessThan ||
            data === Asc.EDataValidationOperator.LessThanOrEqual
          ) {
            // less, less or equals
            if (allow === Asc.c_oAscEDataValidationType.Date) str = this.txtEndDate
            else if (allow === Asc.c_oAscEDataValidationType.Time) str = this.txtEndTime
            else str = this.textMax
          }
          this.lblRangeSource.text(str)

          let str1 = this.textMin
          let str2 = this.textMax
        ...
        isRangeValid: function (callback) {
          let isvalid = Asc.c_oAscError.ID.No
          const type = this.cmbAllow.getValue()
          if (type !== Asc.c_oAscEDataValidationType.None) {
            let focusedInput
            let lblField
            let error
            const minVisible = this._isMinMaxVisible
            const callback2 = (isvalid) => {
              if (isvalid === Asc.c_oAscError.ID.No) {
                isvalid = this.props.asc_checkValid()
                isvalid !== Asc.c_oAscError.ID.No &&
              ...
              switch (isvalid) {
                ...
                case Asc.c_oAscError.ID.DataValidateNegativeTextLength:
                  error = Common.Utils.String.format(
                    this.errorNegativeTextLength,
                    this.cmbAllow.getDisplayValue(this.cmbAllow.getSelectedRecord()),
                  )
                  break
                case Asc.c_oAscError.ID.DataValidateMustEnterValue:
                  error = minVisible
                    ? Common.Utils.String.format(
                        this.errorMustEnterBothValues,
                        this.lblRangeMin.text(),
                        this.lblRangeMax.text(),
                      )
                    : Common.Utils.String.format(
                        this.errorMustEnterValue,
                        this.lblRangeSource.text(),
                      )
                  break
                case Asc.c_oAscError.ID.DataValidateMinGreaterMax:
                  error = Common.Utils.String.format(
                    this.errorMinGreaterMax,
                    this.lblRangeMin.text(),
                    this.lblRangeMax.text(),
                  )
                  break
                case Asc.c_oAscError.ID.DataValidateInvalid:
                  error = Common.Utils.String.format(
                    type === Asc.c_oAscEDataValidationType.Time
                      ? this.errorInvalidTime
                      : type === Asc.c_oAscEDataValidationType.Date
                ...
                case Asc.c_oAscError.ID.NamedRangeNotFound:
                  error = this.errorNamedRange
                  break
                case Asc.c_oAscError.ID.DataValidateInvalidList:
                  error = this.errorInvalidList
                  break
              }
              error &&
                Common.UI.warning({
              ...
              isvalid === Asc.c_oAscError.ID.No && callback.call(this)
            }
            const callback1 = (isvalid) => {
              if (this._isMinMaxVisible && isvalid === Asc.c_oAscError.ID.No) {
                isvalid = this.api.asc_checkDataRange(
                  Asc.c_oAscSelectionDialogType.DataValidation,
                  this.props.asc_getFormula2() ? this.props.asc_getFormula2().asc_getValue() : null,
                  true,
                  undefined,
                  type,
                )
                ...
                if (isvalid === Asc.c_oAscError.ID.FormulaEvaluateError) {
                  Common.UI.warning({
                    ...
                    callback: (btn) => {
                      ...
                      } else focusedInput.focus()
                    },
                  })
                } else callback2(isvalid)
              } else callback2(isvalid)
            }
            isvalid = this.api.asc_checkDataRange(
              Asc.c_oAscSelectionDialogType.DataValidation,
              this.props.asc_getFormula1() ? this.props.asc_getFormula1().asc_getValue() : null,
              true,
              undefined,
              type,
            )
        ...
        errorNotNumeric:
          'The field "{0}" must be a numeric value, numeric expression, or refer to a cell containing a numeric value.',
