...
define([
  ...
  SSE.Views.FieldSettingsDialog = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 284,
        ...
        _setDefaults: function (props) {
          if (props) {
            const field = props.asc_getPivotFields()[this.fieldIndex]

            this.format.formatStr = field.asc_getNumFormat()
            this.format.formatInfo = field.asc_getNumFormatInfo()
            this.lblSourceName.html(
              Common.Utils.String.htmlEncode(props.getCacheFieldName(this.fieldIndex)),
            )
            this.inputCustomName.setValue(props.getPivotFieldName(this.fieldIndex))

            field.asc_getOutline()
              ? this.radioOutline.setValue(true)
              : this.radioTabular.setValue(true)
            ...
            this.btnFormat.setVisible(
              props.asc_getFieldGroupType(this.fieldIndex) !== Asc.c_oAscGroupType.Text,
            )
          }
        },
        ...
        getSettings: function () {
          ...
          field.asc_setCompact(
            this.radioOutline.getValue() && this.chCompact.getValue() === "checked",
          )
