...
define(["common/main/lib/view/AdvancedSettingsWindow"], () => {
  SSE.Views.GoalSeekStatusDlg = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 330,
            ...
            this.options,
            {
              ...
              contentTemplate: _.template(
                [
                  ...
                  '<div class="cell-1">',
                  `<label class="input-label" id="goal-seek-status-label">${this.textSearchIteration}</label>`,
                  "</div>",
                  '<div class="cell-2">',
                  ...
                  '<div class="cell-1">',
                  `<label class="input-label">${this.textTargetValue}</label>`,
                  "</div>",
                  '<div class="cell-2">',
                  ...
                  '<div class="row-2 padding-small">',
                  '<div class="cell-1">',
                  `<label class="input-label">${this.textCurrentValue}</label>`,
                  "</div>",
                  '<div class="cell-2">',
        ...
        setSettings: function (props) {
          if (props) {
            if (this._state.cellName === undefined) this._state.cellName = props.cellName
            this.$targetValue.text(props.targetValue)
            this.$currentValue.text(props.currentValue)
            this.$statusLabel.text(
              Common.Utils.String.format(this.textSearchIteration, props.cellName, props.iteration),
            )
          }
        },
        ...
        onStopSelection: function (isFound) {
          ...
          this.$statusLabel.text(
            Common.Utils.String.format(
              isFound ? this.textFoundSolution : this.textNotFoundSolution,
              this._state.cellName,
            ),
          )
        },
