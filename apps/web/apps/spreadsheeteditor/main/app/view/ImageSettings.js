...
define([
  ...
  SSE.Views.ImageSettings = Backbone.View.extend(
    _.extend(
      {
        ...
        ChangeSettings: function (props) {
          ...
          if (props) {
            ...
            this.btnOriginalSize.setDisabled(
              props.asc_getImageUrl() === null ||
                props.asc_getImageUrl() === undefined ||
                this._locked,
            )
            ...
            if (this._state.isOleObject) {
              const plugin = SSE.getCollection("Common.Collections.Plugins").findWhere({
                guid: pluginGuid,
              })
        ...
        setOriginalSize: function () {
          if (this.api) {
            ...
            const w = imgsize.asc_getImageWidth()
            const h = imgsize.asc_getImageHeight()
