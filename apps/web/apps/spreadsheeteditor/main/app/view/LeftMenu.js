...
define([
  ...
  SSE.Views.LeftMenu = Common.UI.SideMenu.extend(
    _.extend(
      {
        el: "#left-menu",
        ...
        onBtnMenuClick: function (btn, e) {
          ...
          if (btn.pressed) {
            ...
            this.isVisible() &&
              width > SCALE_MIN &&
              Common.localStorage.setItem("sse-mainmenu-width", width)
        ...
        onCoauthOptions: function (e) {
          ...
          if (this.panelSpellcheck) {
            ...
            } else this.panelSpellcheck.hide()
          }
          if (this.panelSearch) {
        ...
        setOptionsPanel: function (name, panel) {
          ...
          } else if (name === "spellcheck" && !this.panelSpellcheck) {
        ...
        showHistory: function () {
          ...
          this.panelHistory.$el.width(
            (Number.parseInt(Common.localStorage.getItem("sse-mainmenu-width")) ||
