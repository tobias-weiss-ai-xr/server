...
define([
  ...
  SSE.Views.ParagraphSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 370,
        ...
        initialize: function (options) {
          ...
          const curLineRule = this._originalProps.asc_getSpacing().asc_getLineRule()
          const curItem = _.findWhere(this._arrLineRule, { value: curLineRule })
        ...
        render: function () {
          ...
          this.numIndentsLeft.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              const numval = field.getNumberValue()
              if (this._changedProps) {
                if (
                  this._changedProps.asc_getInd() === null ||
                  this._changedProps.asc_getInd() === undefined
                )
          ...
          this.numSpacing.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.asc_putTextSpacing(
          ...
          this.numDefaultTab.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                this._changedProps.asc_putDefaultTab(
                  Number.parseFloat(
            ...
            switch (index) {
              ...
              case 1:
                ...
                if (e && e instanceof jQuery.Event)
                  this.api.asc_setDrawImagePlaceParagraph(
        ...
        getSettings: function () {
          if (this._tabListChanged) {
            if (
              this._changedProps.asc_getTabs() === null ||
              this._changedProps.asc_getTabs() === undefined
            )
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            this.FirstLine =
              props.asc_getInd() !== null ? props.asc_getInd().asc_getFirstLine() : null

            this.numIndentsLeft.setValue(
              props.asc_getInd() !== null && props.asc_getInd().asc_getLeft() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.asc_getInd().asc_getLeft())
                : "",
              true,
            )
            this.numIndentsRight.setValue(
              props.asc_getInd() !== null && props.asc_getInd().asc_getRight() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.asc_getInd().asc_getRight())
                : "",
              true,
            )

            this.cmbTextAlignment.setValue(
              props.asc_getJc() !== undefined && props.asc_getJc() !== null
                ? props.asc_getJc()
                : "",
            )
            ...
            if (this.CurSpecial === undefined) {
              this.CurSpecial =
                props.asc_getInd().asc_getFirstLine() === 0
            ...
            this.numSpacingBefore.setValue(
              props.asc_getSpacing() !== null && props.asc_getSpacing().asc_getBefore() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.asc_getSpacing().asc_getBefore())
                : "",
              true,
            )
            this.numSpacingAfter.setValue(
              props.asc_getSpacing() !== null && props.asc_getSpacing().asc_getAfter() !== null
                ? Common.Utils.Metric.fnRecalcFromMM(props.asc_getSpacing().asc_getAfter())
                : "",
              true,
            )

            const linerule = props.asc_getSpacing().asc_getLineRule()
            ...
            if (props.asc_getSpacing() !== null && props.asc_getSpacing().asc_getLine() !== null) {
              this.numLineHeight.setValue(
                linerule === c_paragraphLinerule.LINERULE_AUTO
                  ? props.asc_getSpacing().asc_getLine()
                  : Common.Utils.Metric.fnRecalcFromMM(props.asc_getSpacing().asc_getLine()),
                true,
              )
            } else {
            ...
            this.chStrike.setValue(
              props.asc_getStrikeout() !== null && props.asc_getStrikeout() !== undefined
                ? props.asc_getStrikeout()
                : "indeterminate",
              true,
            )
            this.chDoubleStrike.setValue(
              props.asc_getDStrikeout() !== null && props.asc_getDStrikeout() !== undefined
                ? props.asc_getDStrikeout()
                : "indeterminate",
              true,
            )
            this.chSubscript.setValue(
              props.asc_getSubscript() !== null && props.asc_getSubscript() !== undefined
                ? props.asc_getSubscript()
                : "indeterminate",
              true,
            )
            this.chSuperscript.setValue(
              props.asc_getSuperscript() !== null && props.asc_getSuperscript() !== undefined
                ? props.asc_getSuperscript()
                : "indeterminate",
              true,
            )
            this.chSmallCaps.setValue(
              props.asc_getSmallCaps() !== null && props.asc_getSmallCaps() !== undefined
                ? props.asc_getSmallCaps()
                : "indeterminate",
              true,
            )
            this.chAllCaps.setValue(
              props.asc_getAllCaps() !== null && props.asc_getAllCaps() !== undefined
                ? props.asc_getAllCaps()
                : "indeterminate",
              true,
            )

            this.numSpacing.setValue(
              props.asc_getTextSpacing() !== null && props.asc_getTextSpacing() !== undefined
                ? Common.Utils.Metric.fnRecalcFromMM(props.asc_getTextSpacing())
                : "",
              true,
            )
            ...
            this.numDefaultTab.setValue(
              props.asc_getDefaultTab() !== null && props.asc_getDefaultTab() !== undefined
                ? Common.Utils.Metric.fnRecalcFromMM(
                    Number.parseFloat(props.asc_getDefaultTab().toFixed(1)),
                  )
                : "",
              true,
            )
            ...
            const tabs = props.asc_getTabs()
            if (tabs) {
              const arr = []
              const count = tabs.asc_getCount()
              for (let i = 0; i < count; i++) {
                const tab = tabs.asc_getTab(i)
                const pos = Common.Utils.Metric.fnRecalcFromMM(
                  Number.parseFloat(tab.asc_getPos().toFixed(1)),
                )
        ...
        updateMetricUnit: function () {
          ...
          this._arrLineRule[1].minValue = Number.parseFloat(
            Common.Utils.Metric.fnRecalcFromMM(0.3).toFixed(2),
          )
          this._arrLineRule[1].step =
            Common.Utils.Metric.getCurrentMetric() === Common.Utils.Metric.c_MetricUnits.pt
              ? 1
              : 0.01
        ...
        onStrikeChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putDStrikeout(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onDoubleStrikeChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putStrikeout(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSuperscriptChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putSubscript(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSubscriptChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putSuperscript(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onSmallCapsChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putAllCaps(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onAllCapsChange: function (field, newValue, oldValue, eOpts) {
          ...
          if (field.getValue() === "checked") {
            ...
            if (this._changedProps) this._changedProps.asc_putSmallCaps(false)
            this.checkGroup = 0
          }
          if (this.api && !this._noApply) {
            const properties = this._originalProps
        ...
        onLineRuleSelect: function (combo, record) {
          ...
          const selectItem = _.findWhere(this._arrLineRule, { value: record.value })
          const indexSelectItem = this._arrLineRule.indexOf(selectItem)
          if (this.CurLineRuleIdx !== indexSelectItem) {
            ...
            if (this.Spacing.get_LineRule() === c_paragraphLinerule.LINERULE_AUTO) {
              ...
              this.numLineHeight.setValue(
                Common.Utils.Metric.fnRecalcFromMM(this._arrLineRule[indexSelectItem].defaultValue),
              )
            }
