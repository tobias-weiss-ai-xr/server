...
define([
  ...
  SSE.Views.ShapeSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 300,
        ...
        render: function () {
          ...
          this.spnWidth.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._changedProps) {
                this._changedProps.asc_putWidth(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
                this._changedProps.asc_putHeight(
          ...
          this.spnMarginTop.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                if (
                  this._changedProps.asc_getShapeProperties() === null ||
                  this._changedProps.asc_getShapeProperties() === undefined
                )
                ...
                if (this._changedProps.asc_getShapeProperties().asc_getPaddings() === null)
                  this._changedProps
                    ...
                    .asc_putPaddings(new Asc.asc_CPaddings())

                this._changedProps
                  .asc_getShapeProperties()
                  .asc_getPaddings()
                  .asc_putTop(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_getPaddings()
                  .asc_putBottom(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_getPaddings()
                  .asc_putLeft(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_getPaddings()
                  .asc_putRight(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
          ...
          this.chOverflow.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_putVertOverflowType(
                    field.getValue() === "checked" ? AscFormat.nOTOwerflow : AscFormat.nOTClip,
                  )
              }
            }, this),
          )
          ...
          for (i = 0; i < _arrStyles.length; i++) _arrStyles[i].offsety += 200

          for (i = 0; i < _arrSize.length; i++) _arrSize[i].offsety += 200
          ...
          this.spnColumns.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_putColumnNumber(field.getNumberValue())
              }
            }, this),
          )
          ...
          this.spnSpacing.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              if (this._changedProps) {
                ...
                this._changedProps
                  .asc_getShapeProperties()
                  .asc_putColumnSpace(Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()))
              }
            }, this),
          )
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              this.spnWidth,
              this.btnRatio,
              this.spnHeight, // 0 tab
              this.spnAngle,
              this.chFlipHor,
              this.chFlipVert, // 1 tab
              this.cmbCapType,
              this.cmbJoinType,
              this.btnBeginStyle,
              this.btnEndStyle,
              this.btnBeginSize,
              this.btnEndSize, // 2 tab
              this.chAutofit,
              this.chOverflow,
              this.spnMarginTop,
              this.spnMarginLeft,
              ...
              this.spnColumns,
              this.spnSpacing, // 4 tab
              this.radioTwoCell,
              this.radioOneCell,
              this.radioAbsolute, // 5 tab
              this.inputAltTitle,
              this.textareaAltDescription, // 6 tab
            ])
        ...
        _setDefaults: function (props) {
          if (props?.asc_getShapeProperties()) {
            ...
            let value = props.asc_getLockAspect()
            ...
            const margins = shapeprops.asc_getPaddings()
            if (margins) {
              let val = margins.asc_getLeft()
            ...
            this.btnsCategory[4].setDisabled(
        ...
        getSettings: function () {
          ...
          this._changedProps.asc_putRot((this.spnAngle.getNumberValue() * Math.PI) / 180)
        ...
        _setShapeDefaults: function (props) {
          if (props) {
            const stroke = props.asc_getStroke()
            if (stroke) {
              this.btnsCategory[2].setDisabled(
                stroke.asc_getType() === Asc.c_oAscStrokeType.STROKE_NONE,
              ) // Weights & Arrows

              let value = stroke.asc_getLinejoin()
              ...
              const canchange = stroke.asc_getCanChangeArrows()
        ...
        onSelectBeginStyle: function (combo, picker, view, record) {
          if (this._changedProps) {
            ...
            this._changedProps
              .asc_getShapeProperties()
              .asc_getStroke()
              .asc_putLinebeginstyle(record.get("type"))
          }
        ...
        onSelectBeginSize: function (combo, picker, view, record) {
          if (this._changedProps) {
            ...
            this._changedProps
              .asc_getShapeProperties()
              .asc_getStroke()
              .asc_putLinebeginsize(record.get("type"))
          }
        ...
        onSelectEndStyle: function (combo, picker, view, record) {
          if (this._changedProps) {
            ...
            this._changedProps
              .asc_getShapeProperties()
              .asc_getStroke()
              .asc_putLineendstyle(record.get("type"))
          }
        ...
        onSelectEndSize: function (combo, picker, view, record) {
          if (this._changedProps) {
            ...
            this._changedProps
              .asc_getShapeProperties()
              .asc_getStroke()
              .asc_putLineendsize(record.get("type"))
          }
