...
define([
  ...
  SSE.Views.SlicerSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 330,
        ...
        render: function () {
          ...
          this.btnSlicerStyle = new Common.UI.Button({
            ...
            menu: new Common.UI.Menu({
              ...
              items: [
                {
                  template: _.template(
                    '<div id="sliceradv-menu-style" class="menu-slicer-template"  style="margin: 5px 5px 5px 10px;"></div>',
                  ),
                },
              ],
            }),
          ...
          this.mnuSlicerPicker = new Common.UI.DataView({
            ...
            itemTemplate: _.template(
              '<div id="<%= id %>" class="item"><img src="<%= imageUrl %>" height="49" width="36"></div>',
            ),
            style: "max-height: 325px;",
          })
          this.mnuSlicerPicker.on(
            "item:click",
            _.bind(this.onSelectSlicerStyle, this, this.btnSlicerStyle),
          )
          ...
          this.numWidth.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._originalProps) {
                this._originalProps.put_Width(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
                this._originalProps.put_Height(
                  Common.Utils.Metric.fnRecalcToMM(this.numHeight.getNumberValue()),
                )
              }
            }, this),
          )
          ...
          this.numHeight.on(
            ...
            _.bind(function (field, newValue, oldValue, eOpts) {
              ...
              if (this._originalProps) {
                this._originalProps.put_Width(
                  Common.Utils.Metric.fnRecalcToMM(this.numWidth.getNumberValue()),
                )
                this._originalProps.put_Height(
                  Common.Utils.Metric.fnRecalcToMM(field.getNumberValue()),
                )
          ...
          this.numColHeight.on(
            "change",
            _.bind(function (field, newValue, oldValue, eOpts) {
              const numval = field.getNumberValue()
              if (this._changedProps) {
                this._changedProps.asc_setRowHeight(
                  Common.Utils.Metric.fnRecalcToMM(numval) * 36000,
                )
              }
            }, this),
          )
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([
              ...
              this.numHeight,
              this.numCols,
              this.numColHeight, // 0 tab
              this.radioAsc,
              this.radioDesc,
              this.chHideNoData,
              this.chIndNoData,
              this.chShowNoData, // 1 tab
              this.inputName, // 2 tab
              this.radioTwoCell,
              this.radioOneCell,
              this.radioAbsolute, // 3 tab
              this.inputAltTitle,
              this.textareaAltDescription, // 4 tab
            ])
        ...
        getSettings: function () {
          if (this.isCaptionChanged) this._changedProps.asc_setCaption(this.inputHeader.getValue())
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            this.numWidth.setValue(
              value !== null ? Common.Utils.Metric.fnRecalcFromMM(value).toFixed(2) : "",
              true,
            )
            ...
            if (slicerprops) {
              ...
              this.numColHeight.setValue(
                Common.Utils.Metric.fnRecalcFromMM(slicerprops.asc_getRowHeight() / 36000).toFixed(
                  2,
                ),
                true,
              )
              ...
              let checked = slicerprops.asc_getShowCaption()
              this.chHeader.setValue(
                checked !== null && checked !== undefined ? checked : "indeterminate",
                true,
              )
              ...
              slicerprops.asc_getSortOrder() === Asc.ST_tabularSlicerCacheSortOrder.Ascending
              ...
              let rec = this.mnuSlicerPicker.store.findWhere({ type: value })
              ...
              if (rec) {
                ...
                this.$window.find(".icon-template-slicer").css({
        ...
        onSelectSlicerStyle: function (btn, picker, itemView, record) {
          ...
          this.$window.find(".icon-template-slicer").css({
            "background-image": `url(${record.get("imageUrl")})`,
            height: "49px",
            width: "36px",
            "background-position": "center",
            "background-size": "cover",
