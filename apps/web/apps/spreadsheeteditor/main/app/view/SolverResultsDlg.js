 ...
 */
define([], () => {
  SSE.Views.SolverResultsDlg = Common.UI.Window.extend(
    _.extend(
      {
        options: {
          width: 400,
          ...
          if (this.options.handler) {
            if (state === "ok") {
              Common.Utils.InternalSettings.set(
                "sse-solver-open-params",
                this.chParams.getValue() === "checked",
              )
            }
        ...
        getSettings: function () {
          return {
            keepSolution: this.radioKeep.getValue(),
            openParams: this.chParams.getValue() === "checked",
          }
        },
      },
