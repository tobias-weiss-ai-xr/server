...
define(["common/main/lib/view/AdvancedSettingsWindow"], () => {
  SSE.Views.SortOptionsDialog = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 230,
        ...
        _setDefaults: function (props) {
          if (props) {
            ...
            props.sortcol || props.lockOrientation
              ? this.radioTop.setValue(true)
              : this.radioLeft.setValue(true)
        ...
        getSettings: function () {
          return {
            headers: this.radioTop.getValue() && this.chHeaders.getValue() === "checked",
            /*sensitive: this.chCase.getValue()=='checked',*/ sortcol: this.radioTop.getValue(),
            lockHeaders: this.props.lockHeaders,
