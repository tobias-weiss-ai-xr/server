...
define([
  ...
  SSE.Views.TableSettingsAdvanced = Common.Views.AdvancedSettingsWindow.extend(
    _.extend(
      {
        options: {
          contentWidth: 300,
        ...
        initialize: function (options) {
          _.extend(
            this.options,
            {
              ...
              items: [{ panelId: "id-adv-table-alttext", panelCaption: this.textAlt }],
        ...
        getFocusedComponents: function () {
          return this.btnsCategory
            .concat([this.inputAltTitle, this.textareaAltDescription])
            .concat(this.getFooterButtons()) // 0 tab
        },
        ...
        getSettings: function () {
          if (this.isAltTitleChanged || this.isAltDescChanged) {
            const info = new Asc.AdvancedTableInfoSettings()
