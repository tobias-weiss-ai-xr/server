...
define([
...
], (Backbone, template, simple, template_view) => {
  ...
  SSE.Views.Toolbar = Common.UI.Mixtbar.extend(
    _.extend(
      {
        el: "#toolbar",
          ...
          this.numFormatData = [
            {
              ...
              format: this.ascFormatOptions.General,
              displayValue: this.txtGeneral,
              exampleval: "100",
            },
            {
              value: Asc.c_oAscNumFormatType.Number,
              format: this.ascFormatOptions.Number,
              displayValue: this.txtNumber,
              exampleval: "100,00",
            },
            {
              value: Asc.c_oAscNumFormatType.Scientific,
              format: this.ascFormatOptions.Scientific,
              displayValue: this.txtScientific,
              exampleval: "1,00E+02",
            },
            {
              value: Asc.c_oAscNumFormatType.Accounting,
              format: this.ascFormatOptions.Accounting,
              displayValue: this.txtAccounting,
              exampleval: "100,00 $",
            },
            {
              value: Asc.c_oAscNumFormatType.Currency,
              format: this.ascFormatOptions.Currency,
              displayValue: this.txtCurrency,
              exampleval: "100,00 $",
            },
            {
              value: Asc.c_oAscNumFormatType.Date,
              format: "MM-dd-yyyy",
              displayValue: this.txtDateShort,
              exampleval: "04-09-1900",
              customDisplayValue: this.txtDate,
            },
            {
              value: Asc.c_oAscNumFormatType.Date,
              format: "MMMM d yyyy",
              displayValue: this.txtDateLong,
            ...
            },
            {
              ...
              format: "HH:MM:ss",
              displayValue: this.txtTime,
              exampleval: "00:00:00",
            },
            {
              value: Asc.c_oAscNumFormatType.Percent,
              format: this.ascFormatOptions.Percentage,
              displayValue: this.txtPercentage,
              exampleval: "100,00%",
            },
            {
              value: Asc.c_oAscNumFormatType.Fraction,
              format: this.ascFormatOptions.Fraction,
              displayValue: this.txtFraction,
              exampleval: "100",
            },
            {
              value: Asc.c_oAscNumFormatType.Text,
              format: this.ascFormatOptions.Text,
              displayValue: this.txtText,
              exampleval: "100",
            },
          ]
        ...
        onUpdateLastCustomMargins: function (props) {
          ...
          const top = props ? props.asc_getTop() : Common.localStorage.getItem("sse-pgmargins-top")
          const left = props
            ? props.asc_getLeft()
          ...
          if (top !== null && left !== null && bottom !== null && right !== null) {
            ...
            mnu.setVisible(true)
            $(mnu.el).html(
              mnu.template({ id: Common.UI.getId(), caption: mnu.caption, options: mnu.options }),
            )
          } else this.btnPageMargins.menu.items[0].setVisible(false)
        },
        ...
        applyLayout: function (config) {
          ...
          this.btnCopy = new Common.UI.Button({
            ...
            dataHint: "1",
            dataHintDirection:
              config.isEditDiagram || config.isEditMailMerge || config.isEditOle ? "bottom" : "top",
            dataHintTitle: "C",
          })
          ...
          this.btnPaste = new Common.UI.Button({
            ...
            lock: [
              /*_set.editCell,*/ _set.coAuth,
              _set.lostConnect,
              _set.editVisibleArea,
              _set.userProtected,
              _set.externalChartProtected,
            ],
            dataHint: "1",
          ...
          if (config.isEditDiagram || config.isEditMailMerge || config.isEditOle) {
            this.$el.addClass("type-simple")
            this.$layout = $(_.template(simple)(config))
            if (config.isEditDiagram || config.isEditOle) {
              this.btnInsertFormula = new Common.UI.Button({
              ...
              this.shortcutHints.CellInsertSumFunction = {
                btn: this.btnInsertFormula,
                label: this.txtAutosumTip,
                applyCallback: (item, hintText) => {
                  item.btn.updateHint([hintText, item.btn.options.hint[1]])
                },
              }
              this.shortcutHints.OpenInsertFunctionDialog = {
                btn: this.btnInsertFormula,
                label: this.txtFormula,
                applyCallback: (item, hintText) => {
              ...
              const formatTemplate = _.template(
                [
                  ...
                  "<% }); %>",
                  '<li class="divider">',
                  `<li id="id-toolbar-mnu-item-more-formats" data-value="-1"><a tabindex="-1" type="menuitem">${this.textMoreFormats}</a></li>`,
                ].join(""),
              )
              ...
              this.cmbNumberFormat = new Common.UI.ComboBoxCustom({
                ...
                updateFormControl: function (record) {
                  this.clearSelection()
                  record &&
                    this.setRawValue(record.get("customDisplayValue") || record.get("displayValue"))
                },
              })
            }
            ...
            if (config.isEditDiagram || config.isEditOle) {
              this.btnTextDir = new Common.UI.Button({
                ...
                menu: new Common.UI.Menu({
                  ...
                  items: [
                    {
                      caption: this.textDirLtr,
                      value: Asc.c_oReadingOrderTypes.LTR,
                      iconCls: "menu__icon btn-ltr",
                    },
                    {
                      caption: this.textDirRtl,
                      value: Asc.c_oReadingOrderTypes.RTL,
                      iconCls: "menu__icon btn-rtl",
                    },
                    {
                      caption: this.textDirContext,
                      value: Asc.c_oReadingOrderTypes.Context,
                      iconCls: "menu__icon btn-context",
                    },
                    { caption: "--" },
            ...
            if (config.isEditDiagram) {
              this.btnDecDecimal = new Common.UI.Button({
              ...
              this.btnIncDecimal = new Common.UI.Button({
              ...
              this.btnEditChartData = new Common.UI.Button({
                id: "id-toolbar-rtn-edit-chart-data",
                cls: "btn-toolbar",
                iconCls: "toolbar__icon btn-select-range",
                caption: this.tipEditChartData,
            ...
            if (config.isEditMailMerge) {
              ...
              this.btnSetAutofilter = new Common.UI.Button({
              ...
              this.shortcutHints.ToggleAutoFilter = {
                btn: this.btnSetAutofilter,
                label: this.txtFilter,
              }

              this.btnClearAutofilter = new Common.UI.Button({
            ...
            if (config.isEditOle) {
              ...
              this.btnWrap = new Common.UI.Button({
              ...
              this.mnuTextColorPicker = dummyCmp()
              ...
              this.mnuBackColorPicker = dummyCmp()
              this.btnBackColor = new Common.UI.ButtonColored({
              ...
              this.btnTableTemplate = new Common.UI.Button({
                ...
                menu: new Common.UI.Menu({
                  items: [
                    {
                      template: _.template(
                        '<div id="id-toolbar-menu-table-templates" style="width: 487px; height: 300px; margin: 0px 4px;"></div>',
                      ),
                    },
                  ],
                }),
              ...
              this.btnCellStyle = new Common.UI.Button({
                ...
                menu: new Common.UI.Menu({
                  items: [
                    {
                      template: _.template(
                        '<div id="id-toolbar-menu-cell-styles" style="width: 645px; height: 306px; margin: 0px 4px;"></div>',
                      ),
                    },
                  ],
                }),
              ...
              this.btnTextFormatting = new Common.UI.Button({
              ...
              this.btnVisibleArea = new Common.UI.Button({
                id: "id-toolbar-btn-visible-area",
                cls: "btn-toolbar btn-icon-default",
                iconCls: "toolbar__icon btn-sheet-view",
                menu: new Common.UI.Menu({
                  items: [
                    { caption: this.textShowVA, value: "show" },
                    { caption: this.textHideVA, value: "hide", visible: false },
                    { caption: this.textEditVA, value: "edit" },
                  ],
                }),
                lock: [_set.lostConnect],
                dataHint: "1",
            ...
            Common.UI.Mixtbar.prototype.initialize.call(this, {
              ...
              tabs: [
                ...
                {
                  caption: this.textTabLayout,
                  action: "layout",
                  extcls: "canedit",
                  layoutname: "toolbar-layout",
                  dataHintTitle: "L",
                },
                {
                  caption: this.textTabFormula,
                  action: "formula",
                  extcls: "canedit",
                  dataHintTitle: "O",
                },
                {
                  caption: this.textTabData,
                  action: "data",
                  extcls: "canedit",
                  dataHintTitle: "D",
                },
            ...
            this.shortcutHints.Superscript = {
              btn: this.btnSubscript.menu.items[0],
            ...
            this.shortcutHints.Subscript = {
              btn: this.btnSubscript.menu.items[1],
            ...
            this.btnBackColor = new Common.UI.ButtonColored({
              ...
              additionalItemsAfter:
                ...
                !Common.UI.LayoutManager.isElementVisible("rightMenu")
                  ? []
                  : [
                      (this.mnuFormatCellFill = new Common.UI.MenuItem({
                        caption: this.textFormatCellFill,
                      })),
                    ],
              dataHint: "1",
              dataHintDirection: "bottom",
            ...
            this.btnAlignTop = new Common.UI.Button({
            ...
            this.btnAlignMiddle = new Common.UI.Button({
            ...
            this.btnAlignBottom = new Common.UI.Button({
            ...
            this.btnTextOrient = new Common.UI.Button({
              ...
              menu: new Common.UI.Menu({
                ...
                items: [
                  ...
                  (config.canBrandingExt &&
                    ...
                    !Common.UI.LayoutManager.isElementVisible("rightMenu")
                    ? []
                    : [{ caption: "--" }, { caption: this.textCellAlign, value: "options" }],
                ),
              }),
            ...
            this.btnInsertChartRecommend = new Common.UI.Button({
              id: "tlbtn-insertchartrecommend",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-recommended-chart",
              lock: [_set.editCell, _set.lostConnect, _set.coAuth, _set.coAuthText, _set.Objects],
              caption: this.capInsertChartRecommend,
              dataHint: "1",
              dataHintDirection: "bottom",
              dataHintOffset: "small",
            })

            this.btnInsertSparkline = new Common.UI.Button({
            ...
            this.btnInsertTextArt = new Common.UI.Button({
              ...
              menu: new Common.UI.Menu({
                ...
                items: [
                  {
                    template: _.template(
                      '<div id="id-toolbar-menu-insart" class="margin-left-5" style="width: 239px;"></div>',
                    ),
                  },
                ],
              }),
            ...
            this.listStyles = new Common.UI.ComboDataView({
              ...
              beforeOpenHandler: function (e) {
                ...
                if (menu.cmpEl) {
                  const itemEl = $(menu.menuRoot.find(".dataview .item").get(0))
                  const groupContainerEl = $(
                    menu.menuRoot.find(".dataview .group-items-container").get(0),
                  )
                  let itemMargin =
                    Number.parseFloat(itemEl.css("margin-left")) +
                    Number.parseFloat(itemEl.css("margin-right"))
                  Common.Utils.applicationPixelRatio() > 1 &&
                    Common.Utils.applicationPixelRatio() < 2 &&
                    (itemMargin = -1 / Common.Utils.applicationPixelRatio())
                  ...
                  const menuPickerEl = $(menu.menuRoot.find(".menu-picker-container").get(0))
                  const paddings =
                    15 +
                    Number.parseFloat(groupContainerEl.css("padding-left")) +
                    Number.parseFloat(groupContainerEl.css("padding-right")) +
                    Number.parseFloat(menuPickerEl.css("margin-left")) +
                    Number.parseFloat(menuPickerEl.css("margin-right"))
                  let menuWidth = Math.ceil(+columnCount * (itemWidth + itemMargin) + paddings)
                  const buttonOffsetLeft = Common.Utils.getOffset(this.openButton.$el).left
                  if (menuWidth > Common.Utils.innerWidth())
                    menuWidth =
                      Math.max(
                        Math.floor(
                          (Common.Utils.innerWidth() - paddings) / (itemMargin + itemWidth),
                        ),
                        2,
                      ) *
            ...
            this.btnPercentStyle = new Common.UI.Button({
            ...
            this.btnCommaStyle = new Common.UI.Button({
            ...
            this.btnCurrencyStyle = new Common.UI.Button({
            ...
            this.btnNamedRange = new Common.UI.Button({
              ...
              menu: new Common.UI.Menu({
                ...
                items: [
                  {
                    caption: this.txtManageRange,
                    lock: [_set.editCell],
                    value: "manage",
                  },
                  {
                    caption: this.txtNewRange,
                    lock: [_set.editCell],
                    value: "new",
                  },
                  {
                    caption: this.txtPasteRange,
            ...
            this.btnFillNumbers = new Common.UI.Button({
              ...
              menu: new Common.UI.Menu({
                ...
                items: [
                  ...
                  {
                    caption: this.textFillLeft,
                    value: Asc.c_oAscFillType.fillLeft,
                  },
                  { caption: "--" },
                  {
                    caption: this.textSeries,
            ...
            this.btnAddCell = new Common.UI.Button({
            ...
            this.shortcutHints.OpenInsertCellsWindow = {
              btn: this.btnAddCell,
              label: this.tipInsertOpt,
            }

            this.btnDeleteCell = new Common.UI.Button({
            ...
            this.shortcutHints.OpenDeleteCellsWindow = {
              btn: this.btnDeleteCell,
              label: this.tipDeleteOpt,
            }

            this.btnFormatCell = new Common.UI.Button({
              id: "id-toolbar-btn-formatcell",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-menu-cell",
              lock: [_set.editCell, _set.selRangeEdit, _set.lostConnect, _set.coAuth],
              caption: this.textCellFormat,
              menu: true,
              action: "format-cell",
              dataHint: "1",
              dataHintDirection: "bottom",
            ...
            this.shortcutHints.OpenFormatCell = {
              btn: this.btnFormatCell,
              label: this.tipFormatCell,
            }
            ...
            this.btnColorSchemas = new Common.UI.Button({
              ...
              caption: this.capBtnColorSchemas,
            ...
            const hidetip = Common.localStorage.getItem("sse-hide-synch")
            this.showSynchTip = !(hidetip && Number.parseInt(hidetip) === 1)
            ...
            const pageSizeTemplate = !Common.UI.isRTL()
              ? _.template(
                  '<a id="<%= id %>" tabindex="-1" type="menuitem"><div><b><%= caption %></b></div>' +
            ...
            this.btnPrintArea = new Common.UI.Button({
              id: "tlbtn-printarea",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-print-area",
              caption: this.capBtnPrintArea,
              lock: [
                _set.selChart,
                _set.selChartText,
                _set.selShape,
            ...
            this.btnPageBreak = new Common.UI.Button({
              id: "tlbtn-pagebreak",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-pagebreak",
              caption: this.capBtnPageBreak,
              lock: [
                _set.docPropsLock,
                _set.selChart,
                _set.selChartText,
            ...
            this.mnuCustomScale = new Common.UI.MenuItem({
              template: _.template(
                '<div id="id-toolbar-scale-updownpicker" class="custom-scale" data-stopPropagation="true"></div>',
              ),
              stopPropagation: true,
              value: 4,
            })

            this.btnScale = new Common.UI.Button({
              id: "tlbtn-scale",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-scale",
              caption: this.capBtnScale,
              lock: [
                _set.docPropsLock,
                _set.lostConnect,
                _set.coAuth,
            ...
            const menuWidthItem = new Common.UI.MenuItem({
              caption: this.textWidth,
              menu: new Common.UI.Menu({
                menuAlign: "tl-tr",
                items: [
                  { caption: this.textAuto, value: 0, checkable: true, toggleGroup: "scaleWidth" },
                  {
                    caption: `1 ${this.textOnePage}`,
                    value: 1,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `2 ${this.textFewPages}`,
                    value: 2,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `3 ${this.textFewPages}`,
                    value: 3,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `4 ${this.textFewPages}`,
                    value: 4,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `5 ${this.textManyPages}`,
                    value: 5,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `6 ${this.textManyPages}`,
                    value: 6,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `7 ${this.textManyPages}`,
                    value: 7,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `8 ${this.textManyPages}`,
                    value: 8,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
                  {
                    caption: `9 ${this.textManyPages}`,
                    value: 9,
                    checkable: true,
                    toggleGroup: "scaleWidth",
                  },
            ...
            const menuHeightItem = new Common.UI.MenuItem({
              caption: this.textHeight,
              menu: new Common.UI.Menu({
                menuAlign: "tl-tr",
                items: [
            ...
            this.btnScale.menu.addItem(menuWidthItem)
            this.btnScale.menu.addItem(menuHeightItem)
            this.btnScale.menu.addItem(this.mnuCustomScale)
            this.btnScale.menu.addItem({ caption: "--" })
            this.btnScale.menu.addItem({ caption: this.textScaleCustom, value: "custom" })
            this.menuWidthScale = this.btnScale.menu.items[0].menu
            this.menuHeightScale = this.btnScale.menu.items[1].menu

            this.mnuScale = this.btnScale.menu
            this.mnuScale.on("show:after", _.bind(this.onAfterShowMenuScale, this))

            this.btnPrintTitles = new Common.UI.Button({
              id: "tlbtn-printtitles",
              cls: "btn-toolbar x-huge icon-top",
              iconCls: "toolbar__icon btn-print-titles",
              caption: this.capBtnPrintTitles,
              lock: [
                _set.docPropsLock,
                _set.lostConnect,
                _set.coAuth,
            ...
            this.chPrintGridlines = new Common.UI.CheckBox({
            ...
            this.chPrintHeadings = new Common.UI.CheckBox({
            ...
            this.btnRtlSheet = new Common.UI.Button({
              cls: "btn-toolbar x-huge icon-top",
          ...
          if (config.isEdit) {
            this.lockControls = [
              ...
              this.btnMerge,
              this.btnTextDir,
              this.btnInsertFormula,
              this.btnNamedRange,
              this.btnFillNumbers,
              this.btnIncDecimal,
              this.btnInsertShape,
              this.btnInsertSmartArt,
              this.btnInsertEquation,
              this.btnInsertSymbol,
              this.btnInsertSlicer,
              this.btnInsertText,
              this.btnInsertTextArt,
              this.btnSortUp,
              this.btnSortDown,
              this.btnSetAutofilter,
              this.btnClearAutofilter,
              this.btnTableTemplate,
              this.btnCellStyle,
              this.btnPercentStyle,
              this.btnCommaStyle,
              this.btnCurrencyStyle,
              this.btnDecDecimal,
              this.btnAddCell,
              this.btnDeleteCell,
              this.btnFormatCell,
              this.btnCondFormat,
              this.cmbNumberFormat,
              this.btnBorders,
              this.btnInsertImage,
              this.btnInsertHyperlink,
              this.btnInsertChart,
              this.btnInsertChartRecommend,
              this.btnColorSchemas,
              this.btnInsertSparkline,
              this.btnCopy,
              this.btnPaste,
              this.btnCut,
              this.btnSelectAll,
              ...
              this.btnImgGroup,
              this.btnScale,
              this.chPrintGridlines,
              this.chPrintHeadings,
              this.btnRtlSheet,
              this.btnVisibleArea,
              this.btnVisibleAreaClose,
              this.btnTextFormatting,
              this.btnHorizontalAlign,
              this.btnVerticalAlign,
              this.btnShapesMerge,
            ]

            _.each(this.lockControls.concat([this.btnSave]), (cmp) => {
              if (cmp && _.isFunction(cmp.setDisabled)) cmp.setDisabled(true)
            })
            this.lockToolbar(Common.enumLock.disableOnStart, true, { array: [this.btnPrint] })
            Common.UI.LayoutManager.addControls(this.lockControls.concat([this.btnSave]))
        ...
        onAfterShowMenuScale: function () {
          if (!this.mnuScalePicker) {
            this.mnuScalePicker = new Common.UI.UpDownPicker({
              el: $("#id-toolbar-scale-updownpicker"),
              caption: this.textScale,
            })
            this.mnuScalePicker.on(
              "click",
              _.bind((direction) => {
                this.fireEvent("change:scalespn", [direction, this.valueCustomScale], this)
              }, this),
            )
          }
          if (this.api) {
            this.valueCustomScale = this.api.asc_getPageOptions().asc_getPageSetup().asc_getScale()
            this.mnuScalePicker.setValue(`${this.valueCustomScale}%`)
          }
          if (!this.itemCustomScale) {
            this.itemCustomScale = $(".custom-scale", this.mnuCustomScale.$el).on(
              "click",
              _.bind(() => {
                this.fireEvent(
                  "click:customscale",
                  ["scale", undefined, undefined, undefined, this.valueCustomScale],
                  this,
                )
              }, this),
            )
        ...
        render: function (mode) {
          ...
          if (mode.isEdit) {
            if (!mode.isEditDiagram && !mode.isEditMailMerge && !mode.isEditOle) {
              ...
              this.btnInsertImage.menu.items[2].setVisible(
                mode.canRequestInsertImage ||
                  (mode.fileChoiceUrl && mode.fileChoiceUrl.indexOf("{documentType}") > -1),
              )
        ...
        onTabClick: function (e) {
          ...
          if (this.isTabActive("home")) this.fireEvent("home:open")

          if (this.isTabActive("pivot")) {
            const pivottab = SSE.getController("PivotTable")
            pivottab?.getView("PivotTable").fireEvent("pivot:open")
          }
        },
        ...
        rendererComponents: function (html) {
          ...
          this.btnsEditHeader = Common.Utils.injectButtons(
            $host.find(".slot-editheader"),
            "tlbtn-editheader-",
            "toolbar__icon btn-editheader",
            this.capBtnInsHeader,
            [
              Common.enumLock.editCell,
              Common.enumLock.selRangeEdit,
              Common.enumLock.headerLock,
              Common.enumLock.lostConnect,
              Common.enumLock.coAuth,
            ],
            undefined,
            undefined,
            undefined,
        ...
        updateHints: function () {
          const isDiagramOrOle = this.mode && (this.mode.isEditDiagram || this.mode.isEditOle)
          ...
          this.btnsEditHeader.forEach((btn) => {
            _updateHint(btn, this.tipEditHeader)
          })
        ...
        createDelayedElements: function () {
              ...
              new Common.UI.Menu({
                ...
                items: [
                  ...
                  { caption: "--" },
                  {
                    ...
                    menu: (() => {
                      const itemTemplate = _.template(
                        '<a id="<%= id %>" tabindex="-1" type="menuitem"><div class="border-size-item"><svg><use xlink:href="#<%= options.imgId %>"></use></svg></div></a>',
                      )
                        ...
                        items: [
                          {
                            ...
                            value: Asc.c_oAscBorderStyles.Thin,
                            imgId: "solid-s",
                            checked: true,
                          },
                          {
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.Hair,
                            imgId: "dots-s",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.Dotted,
                            imgId: "dashes-s",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.Dashed,
                            imgId: "dashes-m",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.DashDot,
                            imgId: "dash-dot-s",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.DashDotDot,
                            imgId: "dash-dot-dot-s",
                          },
                          {
                            template: itemTemplate,
                            stopPropagation: true,
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.Medium,
                            imgId: "solid-m",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.MediumDashed,
                            imgId: "dashes-l",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.MediumDashDot,
                            imgId: "dash-dot-m",
                          },
                          {
                            template: itemTemplate,
                            ...
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.MediumDashDotDot,
                            imgId: "dash-dot-dot-m",
                          },
                          {
                            template: itemTemplate,
                            stopPropagation: true,
                            checkable: true,
                            toggleGroup: "border-width",
                            value: Asc.c_oAscBorderStyles.Thick,
                            imgId: "solid-l",
                          },
                        ],
                      })
                  ...
                  (this.mnuBorderColor = new Common.UI.MenuItem({
                    ...
                    template: _.template(
                      '<a id="<%= id %>"tabindex="-1" type="menuitem"><span class="menu-item-icon"></span><%= caption %></a>',
                    ),
                    menu: new Common.UI.Menu({
                      menuAlign: "tl-tr",
                      cls: "shifted-left",
                      items: [
                        {
                          ...
                          template: _.template(
                            '<a tabindex="-1" type="menuitem"><span class="menu-item-icon color-auto"></span><%= caption %></a>',
                          ),
                          stopPropagation: true,
                        },
                        { caption: "--" },
                        {
                          template: _.template(
                            '<div id="id-toolbar-menu-bordercolor" style="width: 164px;display: inline-block;"></div>',
                          ),
                          stopPropagation: true,
                        },
                        { caption: "--" },
                        {
                          ...
                          template: _.template(
                            `<a tabindex="-1" type="menuitem">${this.textNewColor}</a>`,
                          ),
                        },
                      ],
                    }),
                  ...
                  this.mode.isEditOle ||
                    (this.mode.canBrandingExt &&
                      ...
                      this.mode.customization.rightMenu === false) ||
                    !Common.UI.LayoutManager.isElementVisible("rightMenu")
                    ? []
          ...
          if (this.btnInsertChart) {
            ...
            const onShowBeforeChart = (menu) => {
              const picker = new Common.UI.DataView({
                ...
                restoreHeight: 535,
                groups: new Common.UI.DataViewGroupStore(
                  Common.define.chartData.getChartGroupData() /*.concat(Common.define.chartData.getSparkGroupData(true))*/,
                ),
                store: new Common.UI.DataViewStore(
                  Common.define.chartData.getChartData() /*.concat(Common.define.chartData.getSparkData())*/,
                ),
              ...
              picker.on("item:click", (picker, item, record, e) => {
                if (record) this.fireEvent("add:chart", [record.get("group"), record.get("type")])
          ...
          if (this.btnInsertSparkline) {
            this.btnInsertSparkline.setMenu(
              new Common.UI.Menu({
                style: "width: 166px;padding: 5px 0 10px;",
                items: [
                  {
                    template: _.template(
                      '<div id="id-toolbar-menu-insertspark" class="menu-insertchart"></div>',
                    ),
                  },
                ],
              }),
            ...
            const onShowBefore = (menu) => {
              ...
              picker.on("item:click", (picker, item, record, e) => {
                if (record) this.fireEvent("add:spark", [record.get("type")])
                if (e.type !== "click") menu.hide()
              })
          ...
          if (this.btnInsertTextArt) {
            const onShowBeforeTextArt = (menu) => {
              const collection = SSE.getCollection("Common.Collections.TextArt")
          ...
          if (this.btnCondFormat?.rendered) {
            this.btnCondFormat.setMenu(
              new Common.UI.Menu({
                items: [
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        ...
                        {
                          caption: Common.define.conditionalData.textGreaterEq,
                          type: Asc.c_oAscCFType.cellIs,
                          value: Asc.c_oAscCFOperator.greaterThanOrEqual,
                        },
                        {
                        ...
                        {
                          caption: Common.define.conditionalData.textLessEq,
                          type: Asc.c_oAscCFType.cellIs,
                          value: Asc.c_oAscCFOperator.lessThanOrEqual,
                        },
                        {
                        ...
                        {
                          caption: Common.define.conditionalData.textNotEqual,
                          type: Asc.c_oAscCFType.cellIs,
                          value: Asc.c_oAscCFOperator.notEqual,
                        },
                        {
                        ...
                        {
                          caption: Common.define.conditionalData.textNotBetween,
                          type: Asc.c_oAscCFType.cellIs,
                          value: Asc.c_oAscCFOperator.notBetween,
                        },
                      ],
                    }),
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          caption: `${Common.define.conditionalData.textTop} 10 ${this.textItems}`,
                          type: Asc.c_oAscCFType.top10,
                          value: 0,
                          percent: false,
                        },
                        {
                          caption: `${Common.define.conditionalData.textTop} 10%`,
                          type: Asc.c_oAscCFType.top10,
                          value: 0,
                          percent: true,
                        },
                        {
                          caption: `${Common.define.conditionalData.textBottom} 10 ${this.textItems}`,
                          type: Asc.c_oAscCFType.top10,
                          value: 1,
                          percent: false,
                        },
                        {
                          caption: `${Common.define.conditionalData.textBottom} 10%`,
                          type: Asc.c_oAscCFType.top10,
                          value: 1,
                          percent: true,
                        },
                  ...
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          caption: Common.define.conditionalData.textAbove,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 0,
                        },
                        {
                          caption: Common.define.conditionalData.textBelow,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 1,
                        },
                        {
                          caption: Common.define.conditionalData.textEqAbove,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 2,
                        },
                        {
                          caption: Common.define.conditionalData.textEqBelow,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 3,
                        },
                        {
                          caption: Common.define.conditionalData.text1Above,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 4,
                        },
                        {
                          caption: Common.define.conditionalData.text1Below,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 5,
                        },
                        {
                          caption: Common.define.conditionalData.text2Above,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 6,
                        },
                        {
                          caption: Common.define.conditionalData.text2Below,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 7,
                        },
                        {
                          caption: Common.define.conditionalData.text3Above,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 8,
                        },
                        {
                          caption: Common.define.conditionalData.text3Below,
                          type: Asc.c_oAscCFType.aboveAverage,
                          value: 9,
                        },
                      ],
                  ...
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          caption: Common.define.conditionalData.textContains,
                          type: Asc.c_oAscCFType.containsText,
                        },
                        {
                          caption: Common.define.conditionalData.textNotContains,
                          type: Asc.c_oAscCFType.notContainsText,
                        },
                        {
                          caption: Common.define.conditionalData.textBegins,
                          type: Asc.c_oAscCFType.beginsWith,
                        },
                        {
                          caption: Common.define.conditionalData.textEnds,
                          type: Asc.c_oAscCFType.endsWith,
                        },
                      ],
                    }),
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          caption: Common.define.conditionalData.textYesterday,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.yesterday,
                        },
                        {
                          caption: Common.define.conditionalData.textToday,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.today,
                        },
                        {
                          caption: Common.define.conditionalData.textTomorrow,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.tomorrow,
                        },
                        {
                          caption: Common.define.conditionalData.textLast7days,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.last7Days,
                        },
                        {
                          caption: Common.define.conditionalData.textLastWeek,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.lastWeek,
                        },
                        {
                          caption: Common.define.conditionalData.textThisWeek,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.thisWeek,
                        },
                        {
                          caption: Common.define.conditionalData.textNextWeek,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.nextWeek,
                        },
                        {
                          caption: Common.define.conditionalData.textLastMonth,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.lastMonth,
                        },
                        {
                          caption: Common.define.conditionalData.textThisMonth,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.thisMonth,
                        },
                        {
                          caption: Common.define.conditionalData.textNextMonth,
                          type: Asc.c_oAscCFType.timePeriod,
                          value: Asc.c_oAscTimePeriod.nextMonth,
                        },
                      ],
                    }),
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          caption: Common.define.conditionalData.textBlanks,
                          type: Asc.c_oAscCFType.containsBlanks,
                        },
                        {
                          caption: Common.define.conditionalData.textNotBlanks,
                          type: Asc.c_oAscCFType.notContainsBlanks,
                        },
                        {
                          caption: Common.define.conditionalData.textErrors,
                          type: Asc.c_oAscCFType.containsErrors,
                        },
                        {
                          caption: Common.define.conditionalData.textNotErrors,
                          type: Asc.c_oAscCFType.notContainsErrors,
                        },
                      ],
                    }),
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        ...
                        {
                          caption: Common.define.conditionalData.textUnique,
                          type: Asc.c_oAscCFType.uniqueValues,
                        },
                      ],
                    }),
                  },
                  ...
                  },
                  {
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          value: "clear",
                          type: Asc.c_oAscSelectionForCFType.selection,
                          caption: this.textSelection,
                        },
                        {
                          value: "clear",
                          type: Asc.c_oAscSelectionForCFType.worksheet,
                          caption: this.textThisSheet,
                        },
                        {
                          value: "clear",
                          type: Asc.c_oAscSelectionForCFType.table,
                          caption: this.textThisTable,
                        },
                        {
                          value: "clear",
                          type: Asc.c_oAscSelectionForCFType.pivot,
                          caption: this.textThisPivot,
                        },
                      ],
                    }),
                  },
          ...
          if (this.btnFormatCell?.rendered) {
            const _set = Common.enumLock
            this.btnFormatCell.setMenu(
              new Common.UI.Menu({
                cls: "shifted-right",
                items: [
                  ...
                  (this.mnuHide = new Common.UI.MenuItem({
                    ...
                    menu: new Common.UI.Menu({
                      menuAlign: "tl-tr",
                      items: [
                        (this.mniHideRows = new Common.UI.MenuItem({
                          caption: this.textRows,
                          type: Asc.c_oAscCFType.cellIs,
                          value: "hideCell",
                          isRowMenu: true,
                          lock: [
                        ...
                        (this.mniHideCols = new Common.UI.MenuItem({
                          caption: this.textColumns,
                          type: Asc.c_oAscCFType.cellIs,
                          value: "hideCell",
                          isRowMenu: false,
                          lock: [
                        ...
                        (this.mniHideSheets = new Common.UI.MenuItem({
                  ...
                  (this.mnuShow = new Common.UI.MenuItem({
                    ...
                    menu: new Common.UI.Menu({
                      menuAlign: "tl-tr",
                      items: [
                        (this.mniShowRows = new Common.UI.MenuItem({
                          caption: this.textRows,
                          type: Asc.c_oAscCFType.cellIs,
                          value: "showCell",
                          isRowMenu: true,
                        ...
                        (this.mniShowCols = new Common.UI.MenuItem({
                          caption: this.textColumns,
                          type: Asc.c_oAscCFType.cellIs,
                          value: "showCell",
                          isRowMenu: false,
                  ...
                  (this.mnuTabColorToolbar = new Common.UI.MenuItem({
                    ...
                    menu: new Common.UI.Menu({
                      ...
                      items: [
                        {
                          template: _.template(
                            '<div id="id-toolbar-menu-tab-color" style="width: 164px;display: inline-block;"></div>',
                          ),
                        },
                        { caption: "--" },
                        {
            ...
            this.mnuTabColorToolbar.menu.setInnerMenu([
              { menu: this.mnuTabColorToolbarPicker, index: 0 },
            ])
            this.mnuTabColorToolbarPicker.on(
              "select",
              _.bind(function (picker, color) {
        ...
        setApi: function (api) {
          ...
          if (!this.mode.isEditMailMerge && !this.mode.isEditDiagram && !this.mode.isEditOle) {
            this.api.asc_registerCallback(
              ...
              _.bind(this.onApiCollaborativeChanges, this),
            )
            this.api.asc_registerCallback(
              "asc_onSendThemeColorSchemes",
              _.bind(this.onApiSendThemeColorSchemes, this),
            )
            this.api.asc_registerCallback(
        ...
        onApiSendThemeColorSchemes: function (schemas) {
          ...
          _.each(
            ...
            function (schema, index) {
              const colors = schema.get_colors()
              const schemecolors = []
              for (let j = 2; j < 7; j++) {
        ...
        onAppReady: function (config) {
          ...
          if (!config.isEdit || config.isEditMailMerge || config.isEditDiagram || config.isEditOle)
            return
          ...
          const _holder_view = SSE.getController("DocumentHolder").getView("DocumentHolder")
          this.btnImgForward.updateHint(this.tipSendForward)
          this.btnImgForward.setMenu(
            new Common.UI.Menu({
              items: [
                {
          ...
          this.btnPageBreak.updateHint(this.tipPageBreak)
          this.btnPageBreak.setMenu(
            new Common.UI.Menu({
              items: [
                {
                ...
                {
                  caption: this.textDelPageBreak,
                  value: "del",
                },
                {
                  caption: this.textResetPageBreak,
                  value: "reset",
                },
              ],
            }),
        ...
        loadRecentSymbolsFromStorage: function () {
          const recents = Common.localStorage.getItem("sse-fastRecentSymbols")
          const arr = !!recents
            ? JSON.parse(recents)
            : [
