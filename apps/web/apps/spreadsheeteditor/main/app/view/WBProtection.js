...
define([
  ...
  SSE.Views.WBProtection = Common.UI.BaseView.extend(
    _.extend(
      (() => {
        const template =
          '<div class="group">' +
        ...
        function setEvents() {
          this.btnProtectWB.on("click", (btn, e) => {
            this.fireEvent("protect:workbook", [btn.pressed])
          })
          this.btnProtectSheet.on("click", (btn, e) => {
            this.fireEvent("protect:sheet", [btn.pressed])
          })
          this.btnAllowRanges.on("click", (btn, e) => {
            this.fireEvent("protect:allow-ranges")
          })
          this.chLockedCell.on("change", (field, value) => {
            this.fireEvent("protect:lock-options", [0, value])
          })
          this.chLockedShape.on("change", (field, value) => {
            this.fireEvent("protect:lock-options", [1, value])
          })
          this.chLockedText.on("change", (field, value) => {
            this.fireEvent("protect:lock-options", [2, value])
          })
          this.chHiddenFormula.on("change", (field, value) => {
            this.fireEvent("protect:lock-options", [3, value])
          })
          this.btnProtectRange.on("click", (btn, e) => {
            this.fireEvent("protect:range")
          })
        ...
        return {
          ...
          onAppReady: function (config) {
            new Promise((accept, reject) => {
              ...
              this.btnProtectWB.updateHint(this.hintProtectWB)
              this.btnProtectSheet.updateHint(this.hintProtectSheet)
              this.btnAllowRanges.updateHint(this.hintAllowRanges)
              this.btnProtectRange.updateHint(this.hintProtectRange)

              config.isOffline &&
                this.btnProtectRange.cmpEl.parents(".group").hide().prev(".separator").hide()
