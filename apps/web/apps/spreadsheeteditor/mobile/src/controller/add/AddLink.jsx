...
import { AddLink, PageSheet, PageTypeLink } from "../../view/add/AddLink"
...
class AddLinkController extends Component {
  constructor(props) {
    ...
    this.allowInternal =
      celltype !== Asc.c_oAscSelectionType.RangeImage &&
      celltype !== Asc.c_oAscSelectionType.RangeShape &&
      celltype !== Asc.c_oAscSelectionType.RangeShapeText &&
      celltype !== Asc.c_oAscSelectionType.RangeChart &&
  ...
  onInsertLink(args) {
    ...
    if (args.type === "ext") {
      ...
      if (
        urltype !== AscCommon.c_oAscUrlType.Unsafe &&
      ...
      const isValid = api.asc_checkDataRange(
    ...
    return !this.props.isNavigate ? (
      Device.phone ? (
        ...
        <Popover
          ...
          onPopoverClosed={() => this.props.closeOptions("add-link")}
        >
