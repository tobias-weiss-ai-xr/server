...
export class storeCellSettings {
  ...
  initCellSettings(cellInfo) {
    ...
    const color = xfs.asc_getFillColor()
    // console.log(color);
  ...
  initTextFormat(xfs) {
    const hAlign = xfs.asc_getHorAlign()
    const vAlign = xfs.asc_getVertAlign()
    const isWrapText = xfs.asc_getWrapText()

    if (vAlign === Asc.c_oAscVAlign.Top) this.vAlignStr = "top"
    else if (vAlign === Asc.c_oAscVAlign.Center) this.vAlignStr = "center"
    else if (vAlign === Asc.c_oAscVAlign.Bottom) this.vAlignStr = "bottom"
    ...
    switch (hAlign) {
      ...
      case AscCommon.align_Center:
        this.hAlignStr = "center"
        break
      case AscCommon.align_Right:
        this.hAlignStr = "right"
        break
      case AscCommon.align_Justify:
        this.hAlignStr = "justify"
        break
    }
  ...
  initTextOrientation(xfs) {
    switch (xfs.asc_getAngle()) {
      case 45:
        this.orientationStr = "anglecount"
        break
      case -45:
        this.orientationStr = "angleclock"
        break
      case 255:
        this.orientationStr = "vertical"
        break
      case 90:
        this.orientationStr = "rotateup"
        break
      case -90:
        this.orientationStr = "rotatedown"
        break
      case 0:
        this.orientationStr = "horizontal"
        break
    }
  }
