...
import { PageEditSheet, PageEditTypeLink } from "../../view/edit/EditLink"
import { PageFunctionGroup, PageFunctionInfo } from "./AddFunction"
import { PageImageLinkSettings } from "./AddImage"
import { PageSheet, PageTypeLink } from "./AddLink"
...
const AddView = (props) => {
  ...
  useEffect(() => {
    if (Device.phone) {
      ...
      const targetElem =
        !props.showOptions || !props.showOptions.button ? "#btn-add" : props.showOptions.button
