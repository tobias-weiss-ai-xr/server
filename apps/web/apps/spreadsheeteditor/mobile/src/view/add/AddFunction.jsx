...
import { BlockTitle, Icon, List, ListItem, Navbar, Page, f7 } from "framework7-react"
...
const PageGroup = ({ name, type, functions, onInsertFunction, f7router }) => {
  ...
  items.sort((a, b) => (a.caption.toLowerCase() > b.caption.toLowerCase() ? 1 : -1))
...
const AddFunction = (props) => {
  ...
  const isHaveCustomFunctions = useMemo(
    () => Object.values(functions).some((func) => func.group === "Custom"),
    [functions],
  )
