  ...
  observer((props) => {
    ...
    return (
      <List>
        <ListItem
          title={_t.textImage}
          className={wsProps.Objects && "disabled"}
          link={"/add-image/"}
        >
          {Device.ios ? (
        ...
        {!hideAddComment && canComments && !wsProps.Objects && (
          <ListItem
          ...
          >
            {Device.ios ? (
              <SvgIcon
                slot="media"
                symbolId={IconInsertCommentIos.id}
        ...
        <ListItem
          title={_t.textSortAndFilter}
          className={wsProps.Sort || !canModifyFilter ? "disabled" : ""}
          link={"/add-sort-and-filter/"}
        >
          <SvgIcon slot="media" symbolId={IconSort.id} className={"icon icon-svg"} />
        </ListItem>
        <ListItem
          title={_t.textLink}
          className={wsProps.InsertHyperlinks && "disabled"}
          link={isHyperLink ? "/edit-link/" : "/add-link/"}
          routeProps={{
            isNavigate: true,
          }}
        >
