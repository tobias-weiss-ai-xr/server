...
const EditCell = (props) => {
  ...
  const fillColorPreview =
    fillColor !== "transparent" ? (
      <span
        className="color-preview"
        style={{ background: `#${typeof fillColor === "object" ? fillColor.color : fillColor}` }}
      />
    ) : (
      ...
      {!wsProps.FormatCells && (
        <>
          <List>
            ...
            <ListItem
              title={_t.textTextColor}
              link="/edit-cell-text-color/"
              routeProps={{
            ...
            <ListItem
              title={_t.textFillColor}
              link="/edit-cell-fill-color/"
              routeProps={{
            ...
            <ListItem
              title={_t.textTextFormat}
              link="/edit-cell-text-format/"
              routeProps={{
            ...
            <ListItem
              title={_t.textBorderStyle}
              link="/edit-cell-border-style/"
              routeProps={{
            ...
            >
              {!isAndroid ? (
                <SvgIcon
                  slot="media"
                  symbolId={IconTableBordersAll.id}
                  className={"icon icon-svg"}
                />
              ) : null}
            </ListItem>
          ...
          <List>
            <ListItem
              title={t("View.Edit.textCellStyle")}
              link="/edit-cell-style/"
              routeProps={{
                onStyleClick: props.onStyleClick,
              }}
            >
              {!isAndroid && (
                <SvgIcon slot="media" symbolId={IconCellStyle.id} className={"icon icon-svg"} />
              )}
              <div slot="after">
                <div
                  className="preview-cell-style"
                  style={{ backgroundImage: `url(${curStyle ? curStyle.image : null})` }}
                />
              </div>
            </ListItem>
          </List>
      ...
      {cellStyles?.length ? (
        <Swiper pagination={true}>
          {arraySlides.map((_, indexSlide) => {
            const stylesSlide = cellStyles.slice(
              indexSlide * countStylesSlide,
              indexSlide * countStylesSlide + countStylesSlide,
            )
              ...
              <SwiperSlide key={indexSlide}>
                <List className="cell-styles-list">
                  {stylesSlide.map((elem, index) => (
                    <ListItem
                      key={index}
                      className={elem.name === styleName ? "item-theme active" : "item-theme"}
                      onClick={() => props.onStyleClick(elem.name)}
                    >
                      <div className="thumb" style={{ backgroundImage: `url(${elem.image})` }} />
                    </ListItem>
                  ))}
                </List>
              </SwiperSlide>
...
const PageTextColorCell = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          className={`item-color-auto${fontColor === "auto" ? " active" : ""}`}
          title={t("View.Edit.textAutomatic")}
          onClick={() => {
            props.onTextColorAuto()
          }}
        >
          <div slot="media">
            <div id="font-color-auto" className={"color-auto"} />
          </div>
        </ListItem>
      </List>
      <ThemeColorPalette
      ...
      <List>
        <ListItem
          title={t("View.Edit.textAddCustomColor")}
          link={"/edit-cell-text-custom-color/"}
          routeProps={{
            onTextColor: props.onTextColor,
          }}
        />
    ...
    <Page>
      ...
      <List>
        <ListItem
          ...
          link={"/edit-cell-fill-custom-color/"}
          routeProps={{
            onFillColor: props.onFillColor,
          }}
        />
    ...
    <Page>
      ...
      <List>
        <ListItem className="buttons">
          <div className="row">
            <a
              className={`button${hAlignStr === "left" ? " active" : ""}`}
              onClick={() => {
            ...
            <a
              className={`button${hAlignStr === "center" ? " active" : ""}`}
              onClick={() => {
            ...
            <a
              className={`button${hAlignStr === "right" ? " active" : ""}`}
              onClick={() => {
            ...
            <a
              className={`button${hAlignStr === "justify" ? " active" : ""}`}
              onClick={() => {
        ...
        <ListItem className="buttons">
          <div className="row">
            <a
              className={`button${vAlignStr === "top" ? " active" : ""}`}
              onClick={() => {
            ...
            <a
              className={`button${vAlignStr === "center" ? " active" : ""}`}
              onClick={() => {
            ...
            <a
              className={`button${vAlignStr === "bottom" ? " active" : ""}`}
              onClick={() => {
        ...
        <ListItem
          ...
          link="/edit-cell-text-orientation/"
          routeProps={{
            onTextOrientationChange: props.onTextOrientationChange,
          }}
        >
        ...
        >
          {!isAndroid && (
            <SvgIcon
              slot="media"
              symbolId={textDirectionIcon[textDirection] ?? textDirectionIcon.default}
              className="icon icon-svg"
            />
          )}
        </ListItem>
        <ListItem title={_t.textWrapText}>
          {!isAndroid ? (
            <SvgIcon slot="media" symbolId={IconCellWrap.id} className="icon icon-svg" />
          ) : null}
          <Toggle
            checked={isWrapText}
            onToggleChange={() => {
...
const PageTextOrientationCell = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textHorizontalText}
          radio
          checked={orientationStr === "horizontal"}
          radioIcon="end"
          onChange={() => {
        ...
        <ListItem
          title={_t.textAngleCounterclockwise}
          radio
          checked={orientationStr === "anglecount"}
          radioIcon="end"
          onChange={() => {
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationAnglecount.id}
            className={"icon icon-svg"}
          />
        </ListItem>
        <ListItem
          title={_t.textAngleClockwise}
          radio
          checked={orientationStr === "angleclock"}
          radioIcon="end"
          onChange={() => {
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationAngleclock.id}
            className={"icon icon-svg"}
          />
        </ListItem>
        <ListItem
          title={_t.textVerticalText}
          radio
          checked={orientationStr === "vertical"}
          radioIcon="end"
          onChange={() => {
        ...
        >
          <SvgIcon
            slot="media"
            symbolId={IconTextOrientationVertical.id}
            className={"icon icon-svg"}
          />
        </ListItem>
        <ListItem
          title={_t.textRotateTextUp}
          radio
          checked={orientationStr === "rotateup"}
          radioIcon="end"
          onChange={() => {
        ...
        <ListItem
          title={_t.textRotateTextDown}
          radio
          checked={orientationStr === "rotatedown"}
          radioIcon="end"
          onChange={() => {
    ...
    <Page>
      ...
      <List>
        ...
        <ListItem
          link="#"
          className="no-indicator"
          title={_t.textInsideVerticalBorder}
          onClick={() => {
        ...
        <ListItem
          link="#"
          className="no-indicator"
          title={_t.textInsideHorizontalBorder}
          onClick={() => {
        ...
        <ListItem
          link="#"
          className="no-indicator"
          title={_t.textDiagonalDownBorder}
          onClick={() => {
      ...
      <List>
        ...
        >
          <span
            ...
            slot="after"
            style={{
              background: storeCellSettings.colorAuto === "auto" ? "#000" : displayBorderColor,
            }}
          />
        </ListItem>
        <ListItem
          title={_t.textSize}
          link="/edit-border-size-cell/"
          after={borderSizes[borderInfo.width]}
          routeProps={{
            onBorderStyle: props.onBorderStyle,
          }}
        ></ListItem>
...
const PageBorderColorCell = (props) => {
  ...
  const changeColor = (color, effectId, effectValue) => {
    if (color !== "empty") {
      ...
      props.f7router.navigate("/edit-border-custom-color-cell/", {
        props: { onBorderStyle: props.onBorderStyle },
      })
    }
  }
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          className={`item-color-auto${storeCellSettings.colorAuto === "auto" ? " active" : ""}`}
          title={t("View.Edit.textAutomatic")}
          onClick={() => {
      ...
      <ThemeColorPalette
        changeColor={changeColor}
        curColor={storeCellSettings.colorAuto || borderColor}
        customColors={customColors}
      />
      <List>
        <ListItem
          title={t("View.Edit.textAddCustomColor")}
          link={"/edit-border-custom-color-cell/"}
          routeProps={{
            onBorderStyle: props.onBorderStyle,
          }}
        />
...
const PageCustomBorderColorCell = (props) => {
  ...
  const borderStyle = storeCellSettings.borderStyle
  const autoColor =
    storeCellSettings.colorAuto === "auto"
      ? window.getComputedStyle(document.getElementById("font-color-auto")).backgroundColor
      : null
  const onAddNewColor = (colors, color) => {
      ...
      <List>
        {Object.keys(borderSizes).map((key) => {
          return (
            <ListItem
              key={key}
              title={borderSizes[key]}
              radio
              checked={+key === borderInfo.width}
              onChange={() => {
...
const PageCustomFormats = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={t("View.Edit.textCreateCustomFormat")}
          link="/create-custom-format/"
          className="no-indicator"
          routeProps={{
            setCustomFormat: props.setCustomFormat,
  ...
  return (
    <Page>
      <Navbar title={t("View.Edit.textCreateFormat")} backLink={_t.textBack}>
        <NavRight>
          <Link
            text={isIos ? t("View.Edit.textSave") : ""}
            className={!formatValue && "disabled"}
            onClick={() => handleSetCustomFormat(formatValue)}
          >
            {!isIos && <SvgIcon symbolId={IconCheck.id} className="icon icon-svg" />}
          </Link>
        </NavRight>
      </Navbar>
      <>
  ...
  return (
    <Page>
      ...
      <List>
        ...
        <ListItem
          title={_t.textContextTextDirection}
          radio
...
const TextColorCell = inject(
  "storeCellSettings",
  "storePalette",
  "storeFocusObjects",
)(observer(PageTextColorCell))
const FillColorCell = inject(
  "storeCellSettings",
  "storePalette",
  "storeFocusObjects",
)(observer(PageFillColorCell))
const CustomTextColorCell = inject(
  "storeCellSettings",
  "storePalette",
  "storeFocusObjects",
)(observer(PageCustomTextColorCell))
const CustomFillColorCell = inject(
  "storeCellSettings",
  "storePalette",
  "storeFocusObjects",
)(observer(PageCustomFillColorCell))
const FontsCell = inject(
  "storeCellSettings",
  "storeTextSettings",
  "storeFocusObjects",
)(observer(PageFontsCell))
const TextFormatCell = inject(
  "storeCellSettings",
  "storeFocusObjects",
)(observer(PageTextFormatCell))
const TextOrientationCell = inject(
  "storeCellSettings",
  "storeFocusObjects",
)(observer(PageTextOrientationCell))
const BorderStyleCell = inject(
  "storeCellSettings",
  "storeFocusObjects",
)(observer(PageBorderStyleCell))
const BorderColorCell = inject("storeCellSettings", "storePalette")(observer(PageBorderColorCell))
const CustomBorderColorCell = inject(
  "storeCellSettings",
  "storePalette",
)(observer(PageCustomBorderColorCell))
