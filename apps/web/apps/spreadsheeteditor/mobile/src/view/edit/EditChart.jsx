...
const PaletteFill = inject(
  ...
  observer((props) => {
    ...
    const curFillColor = storeChartSettings.fillColor
      ? storeChartSettings.fillColor
      : storeChartSettings.getFillColor(shapeProperties)
    ...
    const changeColor = (color, effectId, effectValue) => {
      if (color !== "empty") {
        ...
        props.f7router.navigate("/edit-chart-custom-fill-color/", {
          props: { onFillColor: props.onFillColor },
        })
      }
    }
      ...
      <Fragment>
        ...
        <List>
          <ListItem
            ...
            link={"/edit-chart-custom-fill-color/"}
            routeProps={{
  ...
  const changeColor = (color, effectId, effectValue) => {
    if (color !== "empty") {
      ...
      props.f7router.navigate("/edit-chart-custom-border-color/", {
        props: { onBorderColor: props.onBorderColor },
      })
    }
  }
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textAddCustomColor}
          link={"/edit-chart-custom-border-color/"}
          routeProps={{
...
const PageChartBorder = (props) => {
  ...
  const storeChartSettings = props.storeChartSettings
  const storeFocusObjects = props.storeFocusObjects
  const shapeProperties = storeFocusObjects.shapeObject?.get_ShapeProperties()
  ...
  const displayBorderSize =
    borderType === Asc.c_oAscStrokeType.STROKE_NONE || borderType === undefined
      ? 0
      : borderSizeTransform.indexSizeByValue(borderSize)
  const displayTextBorderSize =
    borderType === Asc.c_oAscStrokeType.STROKE_NONE || borderType === undefined
      ? 0
      : borderSizeTransform.sizeByValue(borderSize)
  ...
  const displayBorderColor =
    borderColor === "transparent"
      ? borderColor
      : `#${typeof borderColor === "object" ? borderColor.color : borderColor}`
  ...
  return (
    <Page>
      ...
      <div id={"edit-chart-border"} className="page-content no-padding-top">
        <List>
          <ListItem>
            <div slot="root-start" className="inner-range-title">
            ...
            <div slot="inner" style={{ width: "100%" }}>
              <Range
                ...
                max="7"
                step="1"
                value={stateBorderSize}
                onRangeChange={(value) => {
                  setBorderSize(value)
                  setTextBorderSize(borderSizeTransform.sizeByIndex(value))
                }}
                onRangeChanged={(value) => {
                  props.onBorderSize(borderSizeTransform.sizeByIndex(value))
                }}
              />
            </div>
          ...
          <ListItem
            title={t("View.Edit.textColor")}
            link="/edit-chart-border-color/"
            routeProps={{
              onBorderColor: props.onBorderColor,
            }}
          >
  ...
  return (
    <Page>
      ...
      <Fragment>
        <List>
          <ListItem
            title={t("View.Edit.textType")}
            link="/edit-chart-type/"
            routeProps={{ onType: props.onType }}
          />
          <ListItem
            title={t("View.Edit.textStyle")}
            link="/edit-chart-style/"
            routeProps={{ onStyle: props.onStyle }}
          />
          <ListItem
            title={t("View.Edit.textFill")}
            link="/edit-chart-fill/"
            routeProps={{ onFillColor: props.onFillColor }}
          />
          <ListItem
            title={t("View.Edit.textBorder")}
            link="/edit-chart-border/"
            routeProps={{
...
const PageReorder = (props) => {
  ...
  const _t = t("View.Edit", { returnObjects: true })
  if (
    (!props.storeFocusObjects.chartObject || props.storeFocusObjects.focusOn === "cell") &&
    Device.phone
  ) {
    $$(".sheet-modal.modal-in").length > 0 && f7.sheet.close()
    return null
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textBringToForeground}
          onClick={() => {
...
const PageLayout = (props) => {
  ...
  return (
    <Page>
      ...
      <List>
        <ListItem
          title={_t.textChartTitle}
          after={chartLayoutTitles[chartTitle]}
          link="/edit-chart-title/"
          routeProps={{
            chartLayoutTitles,
            chartTitle,
            setTitle,
        ...
        <ListItem
          title={_t.textLegend}
          after={chartLayoutLegends[chartLegend]}
          link="/edit-chart-legend/"
          routeProps={{
            chartLayoutLegends,
            setLayoutProperty: props.setLayoutProperty,
            chartLegend,
      ...
      <List>
        <ListItem
          title={_t.textHorizontal}
          link="/edit-horizontal-axis-title/"
          after={chartLayoutAxisTitleHorizontal[chartAxisHorTitle]}
          disabled={disableEditAxis}
          routeProps={{
        ...
        ></ListItem>
        <ListItem
          title={_t.textVertical}
          link="/edit-vertical-axis-title/"
          after={chartLayoutAxisTitleVertical[chartAxisVertTitle]}
          disabled={disableEditAxis}
          routeProps={{
      ...
      <List>
        <ListItem
          title={_t.textHorizontal}
          link="/edit-horizontal-gridlines/"
          after={chartLayoutGridlinesHorizontal[chartHorGridlines]}
          disabled={disableEditAxis}
          routeProps={{
        ...
        <ListItem
          title={_t.textVertical}
          link="/edit-vertical-gridlines/"
          after={chartLayoutGridlinesVertical[chartVertGridlines]}
          disabled={disableEditAxis}
          routeProps={{
      ...
      <List>
        <ListItem
          title={_t.textDataLabels}
          link="/edit-data-labels/"
          after={chartDataLabels[chartDataLabel]}
          routeProps={{
            chartDataLabels,
            setLayoutProperty: props.setLayoutProperty,
            chartDataLabel,
      ...
      <List>
        {Object.keys(chartLayoutTitles).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutTitles[key]}
              radio
              checked={+key === currentTitle}
              onChange={() => {
                props.setTitle(+key)
                setTitle(+key)
      ...
      <List>
        {Object.keys(chartLayoutLegends).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutLegends[key]}
              radio
              checked={+key === currentLegend}
              onChange={() => {
                props.setLegend(+key)
                setLegend(+key)
      ...
      <List>
        {Object.keys(chartLayoutAxisTitleHorizontal).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutAxisTitleHorizontal[key]}
              radio
              checked={+key === currentAxisHorTitle}
              onChange={() => {
      ...
      <List>
        {Object.keys(chartLayoutAxisTitleVertical).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutAxisTitleVertical[key]}
              radio
              checked={+key === currentAxisVertTitle}
              onChange={() => {
      ...
      <List>
        {Object.keys(chartLayoutGridlinesHorizontal).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutGridlinesHorizontal[key]}
              radio
              checked={+key === currentChartHorGridlines}
              onChange={() => {
      ...
      <List>
        {Object.keys(chartLayoutGridlinesVertical).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartLayoutGridlinesVertical[key]}
              radio
              checked={+key === currentChartVertGridlines}
              onChange={() => {
      ...
      <List>
        {Object.keys(chartDataLabels).map((key) => {
          return (
            <ListItem
              key={key}
              title={chartDataLabels[key]}
              radio
              checked={+key === currentChartDataLabel}
              onChange={() => {
...
const PageVerticalAxis = (props) => {
  ...
  const axisProps =
    verAxisProps.getAxisType() === Asc.c_oAscAxisType.val
      ? verAxisProps
      : chartProperty.getHorAxisProps()
  ...
  const defineCurrentDisplayUnits = () =>
    vertAxisDisplayUnits.find((elem) => elem.value === axisProps.getDispUnitsRule())
  ...
  const defineLabelsPosition = () =>
    verticalAxisLabelsPosition.find((elem) => elem.value === axisProps.getTickLabelsPos())
  const [currentLabelsPosition, setLabelsPosition] = useState(defineLabelsPosition())

  const [minValue, setMinValue] = useState(
    axisProps.getMinValRule() === Asc.c_oAscValAxisRule.auto ? "" : axisProps.getMinVal(),
  )
  const [maxValue, setMaxValue] = useState(
    axisProps.getMaxValRule() === Asc.c_oAscValAxisRule.auto ? "" : axisProps.getMaxVal(),
  )
  ...
  return (
    <Page>
      ...
      <List inlineLabels className="inputs-list">
        <ListItem
          title={_t.textAxisCrosses}
          link="/edit-vert-axis-crosses/"
          after={currentAxisCrosses.display}
          routeProps={{
            axisCrosses,
      ...
      <List>
        <ListItem
          title={_t.textDisplayUnits}
          link="/edit-display-units/"
          after={currentDisplayUnits.display}
          routeProps={{
      ...
      <List>
        <ListItem
          title={_t.textMajorType}
          after={currentMajorType.display}
          link="/edit-vert-major-type/"
          routeProps={{
            tickOptions,
        ...
        />
        <ListItem
          title={_t.textMinorType}
          after={currentMinorType.display}
          link="/edit-vert-minor-type/"
          routeProps={{
            tickOptions,
      ...
      <List>
        <ListItem
          title={_t.textLabelPosition}
          after={currentLabelsPosition.display}
          link="/edit-vert-label-position/"
          routeProps={{
...
const PageHorizontalAxis = (props) => {
  ...
  const axisProps =
    horAxisProps.getAxisType() === Asc.c_oAscAxisType.val
      ? chartProperty.getVertAxisProps()
      : horAxisProps
  const crossValue = axisProps.getCrossesRule()
  ...
  const defineAxisPosition = () =>
    horAxisPosition.find((elem) => elem.value === axisProps.getLabelsPosition())
  ...
  const defineLabelsPosition = () =>
    horAxisLabelsPosition.find((elem) => elem.value === axisProps.getTickLabelsPos())
  const [currentLabelsPosition, setLabelsPosition] = useState(defineLabelsPosition())
    ...
    <Page>
      ...
      <List>
        {!props.disableAxisPos ? (
          <ListItem
            title={_t.textAxisPosition}
            link="/edit-hor-axis-position/"
            after={axisPosition.display}
            disabled={isRadar}
            routeProps={{
              horAxisPosition,
...
const EditChart = (props) => {
  ...
  return (
    <Fragment>
      <List>
        <ListItem
          title={t("View.Edit.textDesign")}
          link="/edit-chart-design/"
          routeProps={{
            onType: props.onType,
        ...
        />
        <ListItem
          title={t("View.Edit.textLayout")}
          link="/edit-chart-layout/"
          routeProps={{
            disableEditAxis,
            setLayoutProperty: props.setLayoutProperty,
        ...
        />
        <ListItem
          title={t("View.Edit.textVerticalAxis")}
          link={needReverse ? "/edit-chart-horizontal-axis/" : "/edit-chart-vertical-axis/"}
          disabled={disableEditAxis}
          routeProps={
            needReverse
              ? {
        ...
        />
        <ListItem
          title={t("View.Edit.textHorizontalAxis")}
          link={
            needReverse || chartType === Asc.c_oAscChartTypeSettings.scatter
              ? "/edit-chart-vertical-axis/"
              : "/edit-chart-horizontal-axis/"
          }
          disabled={disableEditAxis}
          routeProps={
            needReverse || chartType === Asc.c_oAscChartTypeSettings.scatter
        ...
        />
        <ListItem
          title={t("View.Edit.textArrange")}
          link="/edit-chart-reorder/"
          routeProps={{
      ...
      <List className="buttons-list">
        <ListButton
          title={t("View.Edit.textRemoveChart")}
          onClick={() => {
            props.onRemoveChart()
          }}
...
const PageChartDesignType = inject(
  "storeChartSettings",
  "storeFocusObjects",
)(observer(PageChartType))
const PageChartDesignStyle = inject("storeChartSettings")(observer(PageChartStyle))
const PageChartDesignBorder = inject(
  "storeChartSettings",
  "storeFocusObjects",
)(observer(PageChartBorder))
const PageChartCustomFillColor = inject(
  "storeChartSettings",
  "storePalette",
)(observer(PageCustomFillColor))
const PageChartBorderColor = inject("storeChartSettings", "storePalette")(observer(PageBorderColor))
const PageChartCustomBorderColor = inject(
  "storeChartSettings",
  "storePalette",
)(observer(PageCustomBorderColor))
