        ...
        <Fragment>
          <List>
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${paragraphAlign === AscCommon.align_Left ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphAlign === AscCommon.align_Center ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphAlign === AscCommon.align_Right ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphAlign === AscCommon.align_Justify ? " active" : ""}`}
                  onClick={() => {
            ...
            <ListItem className="buttons">
              <div className="row">
                <a
                  className={`button${paragraphValign === Asc.c_oAscVAlign.Top ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphValign === Asc.c_oAscVAlign.Center ? " active" : ""}`}
                  onClick={() => {
                ...
                <a
                  className={`button${paragraphValign === Asc.c_oAscVAlign.Bottom ? " active" : ""}`}
                  onClick={() => {
...
const PageTextAdditionalFormatting = inject(
  "storeTextSettings",
  "storeFocusObjects",
