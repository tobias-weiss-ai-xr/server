...
const PageSpreadsheetMargins = (props) => {
  ...
  const onChangeMargins = (align, isDecrement) => {
    ...
    let marginValue
    const maxMarginsH = 482.5
    const maxMarginsW = 482.5
    ...
    if (isDecrement) {
      ...
      marginValue = Math.min(
        align === "left" || align === "right" ? maxMarginsW : maxMarginsH,
        marginValue + step,
      )
    }
    ...
    <Page>
      ...
      <List>
        <ListItem
          ...
          className={wsProps.FormatCells ? "disabled" : ""}
          link="/color-schemes/"
          routeProps={{
...
const SpreadsheetSettings = inject(
  "storeSpreadsheetSettings",
  "storeWorksheets",
)(observer(PageSpreadsheetSettings))
const SpreadsheetColorSchemes = inject("storeSpreadsheetSettings")(
  observer(PageSpreadsheetColorSchemes),
)

export { SpreadsheetSettings, SpreadsheetFormats, SpreadsheetMargins, SpreadsheetColorSchemes }
