 ...
 *
 */
define(["core", "common/main/lib/component/MetricSpinner"], () => {
  VE.Controllers.Print = Backbone.Controller.extend(
    _.extend(
      {
        ...
        setApi: function (o) {
          ...
          this.api.asc_registerCallback(
            ...
            _.bind(this.onLockSlideHdrFtrApplyToAll, this, true),
          )
          this.api.asc_registerCallback(
            "asc_onUnLockSlideHdrFtrApplyToAll",
            _.bind(this.onLockSlideHdrFtrApplyToAll, this, false),
          )
        ...
        onCountPages: function (count) {
          ...
          if (this.printSettings?.isVisible()) {
            ...
            this.printSettings.$previewEmpty.toggleClass(
              "hidden",
        ...
        onBtnPrint: function (print, useSystemDialog) {
          ...
          if (this._navigationPreview.pageCount < 1) return
          ...
          const rec = this.printSettings.cmbPaperSize.getSelectedRecord()
          const printerOption = this.printSettings.cmbPrinter.getSelectedRecord()
          const size = rec ? rec.size : this._paperSize
        ...
        SetDisabled: function () {
          if (this.printSettings?.isVisible()) {
            const disable = !this.mode.isEdit
          }
        },
