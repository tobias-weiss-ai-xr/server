...
define([
  ...
  VE.Controllers.Viewport = Backbone.Controller.extend(
    _.assign(
      {
          ...
          this.addListeners({
            ...
            Toolbar: {
              "render:before": (toolbar) => {
                const config = VE.getController("Main").appOptions
        ...
        applyCommonMode: function () {
          ...
          Common.localStorage.getBool("ve-hidden-leftmenu", value) &&
