...
define([], () => {
  ...
  VE.Views.FileMenuPanels.Settings = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-settings",
        menu: undefined,
        ...
        updateSettings: function () {
          ...
          let value = Common.Utils.InternalSettings.get("ve-settings-zoom")
          value =
            value !== null
        ...
        applySettings: function () {
          ...
          Common.localStorage.setItem(
            "ve-settings-show-alt-hints",
            this.chUseAltKey.isChecked() ? 1 : 0,
          )
          Common.Utils.InternalSettings.set(
            "ve-settings-show-alt-hints",
            Common.localStorage.getBool("ve-settings-show-alt-hints"),
          )
  ...
  VE.Views.FileMenuPanels.CreateNew = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-createnew",
        menu: undefined,
  ...
  VE.Views.FileMenuPanels.DocumentInfo = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-info",
        menu: undefined,
        ...
        updateInfo: function (doc) {
          ...
          const value = this.coreProps ? this.coreProps.asc_getCreated() : ""
  ...
  VE.Views.FileMenuPanels.DocumentRights = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-rights",
        menu: undefined,
      ...
      this.en_data = [
        {
          ...
          name: "Introducing Visio Editor user interface",
        ...
        {
          src: "UsageInstructions/ViewVisioInfo.htm",
  ...
  VE.Views.PrintWithPreview = Common.UI.BaseView.extend(
    _.extend(
      {
        el: "#panel-print",
        menu: undefined,
