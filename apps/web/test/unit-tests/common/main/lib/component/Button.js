...
define([
  ...
  describe("Common.UI.Button", () => {
    ...
    it("Button update caption", () => {
      ...
      // dom
      assert.equal(
        button.cmpEl.find("button:first").andSelf().filter("button").text(),
        "update caption",
        "dom caption",
      )
    })
