ace.define(
  ...
  (e, t, n) => {
    ...
    var r = e("./lib/dom"),
      ...
      h = {
        ...
        CLIPBOARD: (e) => c.getText && c.getText(),
        FILENAME: function (e) {
      ...
      return (
        ...
        (e.prototype.tmStrFormat = function (e, t, n) {
          ...
          var s = typeof t.fmt == "string" ? this.tokenizeTmSnippet(t.fmt, "formatString") : t.fmt,
            u = e.replace(i, () => {
              var e = this.variables.__
              this.variables.__ = [].slice.call(arguments)
              var t = this.resolveVariables(s, n),
                r = "E"
        ...
        (e.prototype.expandWithTab = function (e, t) {
          var r = e.forEachSelection(() => this.expandSnippetForSelection(e, t), null, {
            keepOrder: !0,
          })
          ...
          function e(e) {
            ...
            e && e.appendChild(t),
              ...
              n.renderer.$textLayer.element.setAttribute(
                ...
                f("autocomplete.popup.aria-roledescription", "Autocomplete suggestions"),
              ),
              n.renderer.$textLayer.element.setAttribute(
                "aria-label",
            ...
            ;(n.focus = r),
              ...
              n.on("mousedown", (e) => {
                ...
                n.selection.moveToPosition(t), (m.start.row = m.end.row = t.row), e.stop()
              })
            var i,
              l = new s(-1, 0, -1, Number.POSITIVE_INFINITY),
              m = new s(-1, 0, -1, Number.POSITIVE_INFINITY)
            ;(m.id = n.session.addMarker(m, "ace_active-line", "fullLine")),
              (n.setSelectOnHover = (e) => {
                e
              ...
              n.renderer.on("afterRender", () => {
                ...
                if (r) {
                  ...
                  ;(r.id = s),
                    ...
                    r.setAttribute("role", p),
                    r.setAttribute(
                      "aria-roledescription",
                      f("autocomplete.popup.item.aria-roledescription", "item"),
                    ),
                    r.setAttribute("aria-label", n.getData(e).caption || n.getData(e).value),
            ...
            ;(n.getHoveredRow = () => l.start.row),
              o.addListener(n.container, "mouseout", () => {
                ;(n.isMouseOver = !1), g()
              }),
              n.on("hide", g),
              n.on("changeSelection", g),
              (n.session.doc.getLength = () => n.data.length),
              (n.session.doc.getLine = (e) => {
                var t = n.data[e]
            ...
            return (
              ...
              (n.getData = (e) => n.data[e]),
              (n.getRow = () => m.start.row),
              (n.setRow = function (e) {
              ...
              (n.tryShow = function (e, t, r, s) {
                ...
                r || (p <= h || h >= l ? (r = "bottom") : (r = "top")),
                  r === "top"
                    ...
                    : r === "bottom" &&
                      ((c.top = e.top + t + this.$borderSize), (c.bottom = c.top + l))
                var d = c.top >= 0 && c.bottom <= u
                if (!s && !d) return !1
                d
                  ? (f.$maxPixelHeight = null)
                  : r === "top"
                    ? (f.$maxPixelHeight = p)
                    : (f.$maxPixelHeight = h),
                  r === "top"
                    ? ((o.style.top = ""),
                      (o.style.bottom = u - c.bottom + "px"),
                      (n.isTopdown = !1))
            ...
            (e.prototype.show = function (e, t, n) {
              ;(n = n || ""),
                e &&
                  this.editor &&
                  this.editor !== e &&
                  (this.hide(), (this.editor = null), (this.inlineScreenReader = null))
              if (!e || !t) return !1
            ...
            (e.prototype.destroy = function () {
              this.hide(),
                ...
                this.inlineScreenReader &&
                  (this.inlineScreenReader.destroy(), (this.inlineScreenReader = null))
            }),
            e
          )
        })()
  ...
  ace.define("ace/autocomplete/util", ["require", "exports", "module"], (e, t, n) => {
    t.parForEach = (e, t, n) => {
      var r = 0,
        i = e.length
      i === 0 && n()
    ...
    var r = /[a-zA-Z_0-9\$\-\u00A2-\u2000\u2070-\uFFFF]/
    ;(t.retrievePrecedingIdentifier = (e, t, n) => {
      n = n || r
      var i = []
      for (var s = t - 1; s >= 0; s--) {
        if (!n.test(e[s])) break
      ...
      (t.retrieveFollowingIdentifier = (e, t, n) => {
        n = n || r
        var i = []
      ...
      (t.triggerAutocomplete = (e, t) => {
        var t = t == null ? e.session.getPrecedingCharacter() : t
        return e.completers.some((e) => {
  ...
  ace.define(
    ...
    (e, t, n) => {
        ...
        v = (() => {
          ...
          return (
            Object.defineProperty(e, "completionsForLoading", {
              get: () => [{ caption: c.nls("autocomplete.loading", "Loading..."), value: "" }],
              enumerable: !1,
              configurable: !0,
            }),
            ...
            (e.prototype.observeLayoutChanges = function () {
              ...
              while (e)
                t.push(e),
                  e.addEventListener("scroll", this.onLayoutChange, { passive: !0 }),
                  (e = e.parentNode)
              this.$elements = t
            }),
              ...
              window.removeEventListener("resize", this.onLayoutChange, { passive: !0 }),
                ...
                this.$elements &&
                  this.$elements.forEach((t) => {
                    t.removeEventListener("scroll", this.onLayoutChange, { passive: !0 })
                  }),
                (this.$elements = null)
            }),
                    ...
                    if (!s.length) {
                      ...
                      if (a) {
                        ...
                        ;(this.completions = new g(f)),
                          ...
                          this.popup.renderer.setStyle("ace_empty-message", !0)
                        return
                      }
                      return this.detach()
                    }
            ...
            (e.prototype.showDocTooltip = function (e) {
              ...
              this.tooltipNode.className =
                "ace_tooltip ace_doc-tooltip " + (t.isDark ? "ace_dark " : "") + (t.cssClass || "")
      ...
      ;(v.prototype.commands = {
        ...
        "Ctrl-Down|Ctrl-End": (e) => {
          e.completer.goTo("end")
        },
        Esc: (e) => {
          e.completer.detach()
        },
        Return: (e) => e.completer.insertMatch(),
        "Shift-Return": (e) => {
        ...
        (v.for = (e) =>
          e.completer instanceof v
            ? e.completer
            : (e.completer && (e.completer.destroy(), (e.completer = null)),
              c.get("sharedPopups")
                ? (v.$sharedInstance || (v.$sharedInstance = new v()),
                  (e.completer = v.$sharedInstance))
                : ((e.completer = new v()), e.once("destroy", d)),
              e.completer)),
        (v.startCommand = {
      ...
      var m = (() => {
          ...
          return (
              ...
              if (t.completer && t.completer.insertMatch) t.completer.insertMatch(e, t)
                ...
                if (r || i) {
                  ...
                  for (var o = 0, u; (u = s[o]); o++)
                    (u.start.column -= r), (u.end.column += i), e.session.remove(u)
                }
            ...
            (e.prototype.gatherCompletions = function (e, t) {
              ...
              return (
                e.completers.forEach((a, f) => {
                  a.getCompletions(e, n, r, i, (n, r) => {
                    a.hideInlinePreview &&
                      (r = r.map((e) =>
                        Object.assign(e, { hideInlinePreview: a.hideInlinePreview }),
                      )),
                      !n && r && (s = s.concat(r)),
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      var r = e("../range").Range,
        i = /[^a-zA-Z_0-9\$\-\u00C0-\u1FFF\u2C00-\uD7FF\w]+/
      t.getCompletions = (e, t, n, r, i) => {
        var s = o(t, n),
          u = Object.keys(s)
        i(
          null,
          u.map((e) => ({ caption: e, value: e, score: s[e], meta: "local" })),
        )
      }
    },
  ),
  ace.define(
    ...
    (e, t, n) => {
      var r = e("../snippets").snippetManager,
        ...
        f = {
          getCompletions: (e, t, n, r, i) => {
            ...
            ;(o = o.map((e) => ((e.completerId = f.id), e))), i(null, o)
          },
          id: "keywordCompleter",
        },
        l = (e) => {
      ...
      var p = { name: "expandSnippet", exec: (e) => r.expandWithTab(e), bindKey: "Tab" },
        d = (e, t) => {
          v(t.session.$mode)
        },
        v = (e) => {
      ...
      e("../config").defineOptions(E.prototype, "editor", {
        enableBasicAutocompletion: {
          set: function (e) {
            e
              ? (this.completers || (this.completers = Array.isArray(e) ? e : h),
