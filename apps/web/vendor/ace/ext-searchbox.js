ace.define("ace/ext/searchbox-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const i = e("../lib/lang")
      const s = e("../lib/event")
      const o = e("./searchbox-css")
      const u = e("../keyboard/hash_handler").HashHandler
      const a = e("../lib/keys")
      const f = e("../config").nls
      const l = 999
      ...
      const c = (() => {
            ...
            [
              ...
              [
                ...
                [
                  "input",
                  {
                    ...
                    placeholder: f("search-box.find.placeholder", "Search for"),
                    spellcheck: "false",
                  },
                ],
              ...
              [
                ...
                [
                  ...
                  {
                    class: "ace_search_field",
                    placeholder: f("search-box.replace.placeholder", "Replace with"),
                    spellcheck: "false",
                  },
                ],
                [
              ...
              [
                ...
                [
                  "span",
                  {
                    ...
                    class: "ace_button",
                    title: f("search-box.toggle-replace.title", "Toggle Replace mode"),
                ...
                [
                  "span",
                  {
                    ...
                    class: "ace_button",
                    title: f("search-box.toggle-regexp.title", "RegExp Search"),
                  },
                  ".*",
                ],
                [
                  "span",
                  {
                    ...
                    class: "ace_button",
                    title: f("search-box.toggle-case.title", "CaseSensitive Search"),
                  },
                  "Aa",
                ],
                [
                  "span",
                  {
                    ...
                    class: "ace_button",
                    title: f("search-box.toggle-whole-word.title", "Whole Word Search"),
                  },
                  "\\b",
                ],
                [
                  "span",
                  {
                    ...
                    class: "ace_button",
                    title: f("search-box.toggle-in-selection.title", "Search In Selection"),
                  },
                  "S",
                ],
              ],
        ...
        return (
          ...
          (e.prototype.$init = function () {
            ...
            s.addListener(e, "mousedown", (e) => {
              ...
              s.addListener(e, "click", (e) => {
                ...
                r && this[r] ? this[r]() : this.$searchBarKb.commands[r]?.exec(this),
                  s.stopPropagation(e)
              }),
              s.addCommandKeyListener(e, (e, n, r) => {
                const i = a.keyCodeToString(r)
                const o = this.$searchBarKb.findKeyCommand(n, i)
                o?.exec && (o.exec(this), s.stopEvent(e))
              }),
          ...
          (e.prototype.$syncOptions = function (e) {
            ...
            const t = this.editor.getReadOnly()
          ...
          (e.prototype.find = function (e, t, n) {
            const i = this.editor.find(this.searchInput.value, {
              skipCurrent: e,
              backwards: t,
              wrap: !0,
            ...
            const s = !i && this.searchInput.value
          ...
          (e.prototype.updateCounter = function () {
            const e = this.editor
            const t = e.$search.$options.re
            const n = t.unicode
            let r = 0
            let s = 0
            if (t) {
              const o = this.searchRange ? e.session.getTextRange(this.searchRange) : e.getValue()
              let u = e.session.doc.positionToIndex(e.selection.anchor)
            ...
            this.searchCounter.textContent = f("search-box.search-counter", "$0 of $1", [
              s,
              r > l ? `${l}+` : r,
            ])
          }),
          ...
          (e.prototype.findAll = function () {
            const e = this.editor.findAll(this.searchInput.value, {
              regExp: this.regExpOption.checked,
              caseSensitive: this.caseSensitiveOption.checked,
              wholeWord: this.wholeWordOption.checked,
            })
            const t = !e && this.searchInput.value
