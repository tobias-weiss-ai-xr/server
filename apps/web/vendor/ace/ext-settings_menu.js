ace.define("ace/ext/menu_tools/settings_menu.css", ["require", "exports", "module"], (e, t, n) => {
  ...
  ace.define("ace/ext/modelist", ["require", "exports", "module"], (e, t, n) => {
    function i(e) {
      let t = a.text
      const n = e.split(/[\/\\]/).pop()
    ...
    for (const f in o) {
      const l = o[f]
      const c = (u[f] || f).replace(/_/g, " ")
      const h = f.toLowerCase()
      const p = new s(h, c, l[0])
      ;(a[h] = p), r.push(p)
    }
    n.exports = { getModeForPath: i, modes: r, modesByName: a }
  }),
  ace.define("ace/ext/themelist", ["require", "exports", "module"], (e, t, n) => {
    const r = [
      ["Chrome"],
      ["Clouds"],
      ["Crimson Editor"],
    ...
    ;(t.themesByName = {}),
      (t.themes = r.map((e) => {
        const n = e[1] || e[0].replace(/ /g, "_").toLowerCase()
        const r = { caption: e[0], theme: `ace/theme/${n}`, isDark: e[2] === "dark", name: n }
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const i = e("../lib/oop")
      const s = e("../config")
      const o = e("../lib/event_emitter").EventEmitter
      const u = r.buildDom
      const a = e("./modelist")
      const f = e("./themelist")
      const l = { Bright: [], Dark: [] }
      ...
      const c = a.modes.map((e) => ({ caption: e.caption, value: e.mode }))
      const h = {
        Main: {
        ...
        More: {
          ...
          "Gutter tooltip follows mouse": { path: "tooltipFollowsMouse", defaultValue: !0 },
        },
      }
      const p = (() => {
        function e(e, t) {
        ...
        return (
          ...
          (e.prototype.renderOptionControl = function (e, t) {
            const n = this
            if (Array.isArray(t)) return t.map((t) => n.renderOptionControl(e, t))
            let r
            let i = n.getOption(t)
            t.values &&
              t.type !== "checkbox" &&
              (typeof t.values === "string" && (t.values = t.values.split("|")),
              (t.items = t.values.map((e) => ({ value: e, name: e }))))
            if (t.type === "buttonBar")
              r = [
                "div",
                ...
                t.items.map((e) => [
                  "button",
                  {
                    ...
                    onclick: function () {
                      ...
                      const r = this.parentNode.querySelectorAll("[ace_selected_button]")
                      for (let i = 0; i < r.length; i++)
              ...
              (r = [
                "input",
                {
                  ...
                  style: "width:3em",
                  oninput: function () {
                    n.setOption(t, Number.parseInt(this.value))
                  },
                },
              ]),
                ...
                t.defaults &&
                  (r = [
                    ...
                    t.defaults.map((e) => [
                      ...
                      {
                        onclick: function () {
                          const t = this.parentNode.firstChild
              ...
              const o = Array.isArray(t.items)
                ? s(t.items)
                : Object.keys(t.items).map((e) => ["optgroup", { label: e }, s(t.items[e])])
              r = [
                "select",
                {
                  id: e,
          ...
          (e.prototype.renderOption = function (e, t) {
            ...
            const n = Array.isArray(t) ? t[0].path : t.path
            this.options[n] = t
            const r = `-${n}`
            const i = `${n}-label`
            const s = this.renderOptionControl(r, t)
            return [
              "tr",
      ...
      i.implement(p.prototype, o), (t.OptionPanel = p)
    },
  ),
  ace.define(
    ...
    (e, t, n) => {
      ...
      const r = e("./options").OptionPanel
      const i = e("./menu_tools/overlay_page").overlayPage
      n.exports.init = () => {
        const t = e("../editor").Editor
