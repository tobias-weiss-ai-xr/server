ace.define(
  ...
  (e, t, n) => {
    ...
    const u = e("./virtual_renderer").VirtualRenderer
    const a = e("./edit_session").EditSession
    let f
    ;(f = function (e, t, n) {
      ;(this.BELOW = 1),
        (this.BESIDE = 0),
      ...
      function () {
        r.implement(this, s),
          (this.$createEditor = function () {
            ...
            const t = new o(new u(e, this.$theme))
            return (
              t.on(
                "focus",
                function () {
          ...
          (this.$cloneSession = (e) => {
            const t = new a(e.getDocument(), e.getMode())
            const n = e.getUndoManager()
            return (
              t.setUndoManager(n),
          ...
          (this.setSession = function (e, t) {
            ...
            const r = this.$editors.some((t) => t.session === e)
  ...
  ace.define("ace/ext/split", ["require", "exports", "module", "ace/split"], (e, t, n) => {
    n.exports = e("../split")
  })
;(() => {
