ace.define(
  "ace/ext/textarea",
  ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/ace"],
  (e, t, n) => {
    function u(e, t) {
    ...
    function a(e, t) {
      ...
      const s = () => {
        ...
        const n = o(e, i, "width") || `${e.clientWidth}px`
        const r = o(e, i, "height") || `${e.clientHeight}px`
        ;(t += `height:${r};width:${n};`), (t += "display:inline-block;"), (i.style.cssText = t)
      }
    ...
    function l(e, n, i) {
      ...
      for (const l in t.defaultOptions)
        a.push("<tr><td>", o[l], "</td>"),
          a.push("<td>"),
      ...
      const p = e.getElementsByTagName("select")
      for (let d = 0; d < p.length; d++) p[d].onchange = c
      const v = e.getElementsByTagName("input")
      for (let d = 0; d < v.length; d++) v[d].onclick = h
    ...
    ;(t.transformTextarea = (e, n) => {
      const o = e.autofocus || document.activeElement === e
      let c
      const h = a(e, () => c.getValue())
      ...
      return (
        ...
        r.addListener(d, "mousedown", (e) => {
          ...
          const n = t.width + t.left - e.clientX
          const i = t.height + t.top - e.clientY
          r.capture(
            d,
            (e) => {
