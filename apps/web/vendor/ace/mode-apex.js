ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("../mode/text_highlight_rules").TextHighlightRules
      const s = e("../mode/doc_comment_highlight_rules").DocCommentHighlightRules
      const o = function () {
        function t(t) {
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const r = e("../lib/oop")
      const i = e("../mode/text").Mode
      const s = e("./apex_highlight_rules").ApexHighlightRules
      const o = e("../mode/folding/cstyle").FoldMode
      r.inherits(u, i),
