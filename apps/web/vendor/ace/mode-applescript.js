ace.define(
  ...
  (e, t, n) => {
    ...
    const s = function () {
      ...
      const t = "AppleScript|false|linefeed|return|pi|quote|result|space|tab|true"
      const n = "activate|beep|count|delay|launch|log|offset|read|round|run|say|summarize|write"
      const r =
      ...
      const i = this.createKeywordMapper(
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./applescript_highlight_rules").AppleScriptHighlightRules
