ace.define(
  ...
  (e, t, n) => {
    ...
    const s = function () {
      ...
      for (const r in this.$rules) {
        const i = this.$rules[r]
        for (let s = i.length; s--; ) {
          const o = i[s]
          if (o.include || typeof o === "string") {
            let u = [s, 1].concat(this.$rules[o.include || o])
            o.noEscape && (u = u.filter((e) => !e.next)), i.splice.apply(i, u)
        ...
        function () {
          ;(this.foldingStartMarker = /^(?:\|={10,}|[\.\/=\-~^+]{4,}\s*$|={1,5} )/),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              function l(t) {
                return (f = e.getTokens(t)[0]), f?.type
              }
              function d() {
                const t = f.value.match(p)
                if (t) return t[0].length
                const r = c.indexOf(f.value[0]) + 1
              ...
              const p = this.singleLineHeadingRe
              if (l(n) === h) {
                const v = d()
                while (++n < o) {
                  if (l(n) !== h) continue
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./asciidoc_highlight_rules").AsciidocHighlightRules
      const o = e("./folding/asciidoc").FoldMode
      const u = function () {
