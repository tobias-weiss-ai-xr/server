ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const o = function () {
        ...
        const s = "__FILE__|__PATH__|__LINE__|__DATE__|__IASL__"
        const o = "One|Ones|Zero"
        const u = "Memory24|Processor"
        const a = this.createKeywordMapper(
          {
            keyword: e,
            "constant.numeric": o,
            "keyword.operator": t,
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./asl_highlight_rules").ASLHighlightRules
