ace.define(
  ...
  (e, t, n) => {
    ...
    ;(s.metaData = { fileTypes: ["s"], name: "Assembly ARM32", scopeName: "source.assembly" }),
      r.inherits(s, i),
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./assembly_arm32_highlight_rules").AssemblyARM32HighlightRules
...
;(() => {
  ace.require(["ace/mode/assembly_arm32"], (m) => {
