        ...
        o = function () {
          function r(e) {
            for (var t in this.$rules[e + "jsxAttributes"])
              if (
                this.$rules[e + "jsxAttributes"][t].token === "meta.tag.punctuation.tag-close.xml"
              ) {
                this.$rules[e + "jsxAttributes"][t].onMatch = function (t, n, r) {
                  return (
                    n == r[0] && r.shift(),
                    t.length == 2 &&
                      (r[0] == this.nextState && r[1]--, (!r[1] || r[1] < 0) && r.splice(0, 2)),
          ...
          for (var t in this.$rules) {
            if (t.startsWith("js") || t.startsWith("css") || t.startsWith("comment")) continue
          ...
          var n = [
            {
              ...
              onMatch: function (e, t, n) {
                return n[0] === "inline-js-start"
                  ? (n.shift(),
                    (this.next = n.shift()),
                    this.next.indexOf("string") !== -1 ? "paren.quasi.end" : "paren.rparen")
