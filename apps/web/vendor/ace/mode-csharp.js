ace.define(
      ...
      r.inherits(o, s),
        function () {
          ;(this.usingRe = /^\s*using \S/),
            ...
            (this.getFoldWidget = function (e, t, n) {
              const r = this.getFoldWidgetBase(e, t, n)
              if (!r) {
                const i = e.getLine(n)
                if (/^\s*#region\b/.test(i)) return "start"
                const s = this.usingRe
                if (s.test(i)) {
                  const o = e.getLine(n - 1)
                  const u = e.getLine(n + 1)
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              const r = this.getFoldWidgetRangeBase(e, t, n)
              if (r) return r
              const i = e.getLine(n)
            ...
            (this.getUsingStatementBlock = function (e, t, n) {
              const r = t.match(this.usingRe)[0].length - 1
              const s = e.getLength()
              const o = n
              let u = n
              while (++n < s) {
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./csharp_highlight_rules").CSharpHighlightRules
      const o = e("./matching_brace_outdent").MatchingBraceOutdent
      const u = e("./folding/csharp").FoldMode
      const a = function () {
