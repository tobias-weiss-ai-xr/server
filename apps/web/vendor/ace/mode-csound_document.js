ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const s = function () {
        ...
        const t = "true|false|nil|_G|_VERSION"
        const n =
        ...
        const r = "string|package|os|io|math|debug|table|coroutine"
        const i = "setn|foreach|foreachi|gcinfo|log10|maxn"
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const s = function () {
        ...
        const t = "True|False|None|NotImplemented|Ellipsis|__debug__"
        const n =
        ...
        const g = `(?:(?:${m}|${v})${p})`
        const y = `(?:${g}|${m})`
        const b = "\\\\(x[0-9A-Fa-f]{2}|[0-7]{3}|[\\\\abfnrtv'\"]|U[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})"
        ;(this.$rules = {
          start: [
            { token: "comment", regex: "#.*$" },
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/lang")
      const i = e("../lib/oop")
      const s = e("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules
      const o = e("./csound_score_highlight_rules").CsoundScoreHighlightRules
      const u = e("./lua_highlight_rules").LuaHighlightRules
      const a = e("./python_highlight_rules").PythonHighlightRules
      const f = function (e) {
        s.call(this, e)
        let t = [
          "ATSadd",
          ...
          i.push(
            ...
            { token: "support.variable.csound", regex: /\bp\d+\b/ },
            {
              ...
              onMatch: function (e, r, i, s) {
                const o = e.split(this.splitRegex)
                const u = o[1]
                let a
                return (
                  t.hasOwnProperty(u)
        ...
        const l = [this.popRule({ token: "punctuation.definition.string.end.csound", regex: /}}/ })]
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./csound_orchestra_highlight_rules").CsoundOrchestraHighlightRules
      const s = e("./csound_score_highlight_rules").CsoundScoreHighlightRules
      const o = e("./html_highlight_rules").HtmlHighlightRules
      const u = e("./text_highlight_rules").TextHighlightRules
      const a = function () {
        const e = new i("csound-")
        const t = new s("csound-score-")
        ;(this.$rules = {
          start: [
            {
              token: [
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./csound_document_highlight_rules").CsoundDocumentHighlightRules
      const o = function () {
