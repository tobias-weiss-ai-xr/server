ace.define(
      ...
      function () {
        ;(this.pushRule = function (e) {
          if (Array.isArray(e.next))
            for (let t = 0; t < e.next.length; t++) e.next[t] = this.embeddedRulePrefix + e.next[t]
          return {
            regex: e.regex,
            onMatch: function (t, n, r, i) {
              r.length === 0 && r.push(n)
              if (Array.isArray(e.next)) for (let s = 0; s < e.next.length; s++) r.push(e.next[s])
              else r.push(e.next)
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules
      const s = function (e) {
        i.call(this, e),
          this.quotedStringContents.push({ token: "invalid.illegal.csound-score", regex: /[^"]*$/ })
        const t = this.$rules.start
        t.push(
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./csound_score_highlight_rules").CsoundScoreHighlightRules
      const o = function () {
