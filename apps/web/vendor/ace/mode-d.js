ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const o = function () {
        ...
        const s = "class|struct|union|template|interface|enum|macro"
        const o = {
        ...
        const a =
          "/|/\\=|&|&\\=|&&|\\|\\|\\=|\\|\\||\\-|\\-\\=|\\-\\-|\\+|\\+\\=|\\+\\+|\\<|\\<\\=|\\<\\<|\\<\\<\\=|\\<\\>|\\<\\>\\=|\\>|\\>\\=|\\>\\>\\=|\\>\\>\\>\\=|\\>\\>|\\>\\>\\>|\\!|\\!\\=|\\!\\<\\>|\\!\\<\\>\\=|\\!\\<|\\!\\<\\=|\\!\\>|\\!\\>\\=|\\?|\\$|\\=|\\=\\=|\\*|\\*\\=|%|%\\=|\\^|\\^\\=|\\^\\^|\\^\\^\\=|~|~\\=|\\=\\>|#"
        const f = (this.$keywords = this.createKeywordMapper(
          {
            "keyword.modifier": r,
            "keyword.control": t,
            "keyword.type": n,
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./d_highlight_rules").DHighlightRules
