ace.define(
    ...
    (e, t, n) => {
      ...
      const o = function () {
        ...
        const s = this.createKeywordMapper(
          { "variable.language": "this", "constant.language": n, "support.function": r },
          "identifier",
        )
        ;(this.$rules = {
          start: [
          ...
          statements: [
            { token: ["keyword", "text", "identifier"], regex: `(record)(\\s+)(${e})\\b` },
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text_highlight_rules").TextHighlightRules
      const s = e("./java_highlight_rules").JavaHighlightRules
      const o = e("./doc_comment_highlight_rules").DocCommentHighlightRules
      const u = "[a-zA-Z\\$_\u00a1-\uffff][a-zA-Z\\d\\$_\u00a1-\uffff]*"
      const a = "[a-zA-Z\\$_\u00a1-\uffff][\\.a-zA-Z\\d\\$_\u00a1-\uffff]*"
      const f = function () {
        const e =
        ...
        function () {
          ;(this.foldingStartMarker = /\b(rule|declare|query|when|then)\b/),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              const r = e.getLine(n)
              const s = r.match(this.foldingStartMarker)
              if (s) {
                const u = s.index
                if (s[1]) {
                  const a = { row: n, column: r.length }
                  const f = new o(e, a.row, a.column)
                  let l = "end"
                  let c = f.getCurrentToken()
                  c.value === "when" && (l = "then")
                  while (c) {
                    if (c.value === l)
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./drools_highlight_rules").DroolsHighlightRules
      const o = e("./folding/drools").FoldMode
      const u = function () {
