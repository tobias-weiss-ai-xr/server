ace.define(
    ...
    const s = function () {
      ...
      ;(this.$rules = {
        start: [
          ...
          {
            regex: `${r + i}+\\.?`,
            token: (e) => (e[e.length - 1] === "." ? "entity.name.function" : "constant.language"),
          },
          { regex: `^${n}${i}+`, token: (e) => "constant.language" },
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./elm_highlight_rules").ElmHighlightRules
