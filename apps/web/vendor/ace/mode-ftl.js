ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const r = e("../lib/oop")
      const i = e("./jsdoc_comment_highlight_rules").JsDocCommentHighlightRules
      const s = e("./text_highlight_rules").TextHighlightRules
      const o = "[a-zA-Z\\$_\u00a1-\uffff][a-zA-Z\\d\\$_\u00a1-\uffff]*"
      const u = function (e) {
        const t = {
          "variable.language":
        ...
        const n = this.createKeywordMapper(t, "identifier")
        const r = "case|do|else|finally|in|instanceof|return|throw|try|typeof|yield|void"
        const s =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const i = e("./text_highlight_rules").TextHighlightRules
      const s = function (e) {
        const t = "[_:a-zA-Z\u00c0-\uffff][-_:.a-zA-Z0-9\u00c0-\uffff]*"
        ;(this.$rules = {
          start: [
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      const o = e("./javascript_highlight_rules").JavaScriptHighlightRules
      const u = e("./xml_highlight_rules").XmlHighlightRules
      const a = i.createMap({
        a: "anchor",
        button: "form",
        form: "form",
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./html_highlight_rules").HtmlHighlightRules
      const s = e("./text_highlight_rules").TextHighlightRules
      const o = function () {
        const e =
        ...
        const t = "c|round|floor|ceiling"
        const n = "iso_[a-z_]+"
        const r =
          "first|last|seq_contains|seq_index_of|seq_last_index_of|reverse|size|sort|sort_by|chunk"
        const i = "keys|values"
        const s = "children|parent|root|ancestors|node_name|node_type|node_namespace"
        const o =
        ...
        const u = e + t + n + r + i + s + o
        const a = "default|exists|if_exists|web_safe"
        const f =
        ...
        const l = "gt|gte|lt|lte|as|in|using"
        const c = "true|false"
        const h =
      ...
      const u = function () {
        ...
        for (const r in this.$rules) this.$rules[r].unshift.apply(this.$rules[r], t)
  ...
  ace.define(
    ...
    (e, t, n) => {
      const r = e("../lib/oop")
      const i = e("./text").Mode
      const s = e("./ftl_highlight_rules").FtlHighlightRules
      const o = function () {
