        ...
        o = function () {
                ...
                push: [
                  {
                    ...
                    regex: "(?:_|=|[a-z]\\w*(?:[.:-]\\w+)*)?",
                    next: [
                      { token: "meta.tag.punctuation.tag-close.latte", regex: "\\}", next: "pop" },
          ...
          this.$rules.tag_stuff.unshift({
            ...
            next: [
              { include: "tag_whitespace" },
              {
                ...
                next: [
                  ...
                  { token: "text.tag-whitespace.xml", regex: "\\s", next: "tag_stuff" },
                  { token: "meta.tag.punctuation.tag-close.xml", regex: "/?>", next: "tag_stuff" },
                  { include: "latte-content" },
                ],
              },
            ...
            (this.$rules["latte-content"] = [
              ...
              { token: "constant.language", regex: "\\b(?:true|false|null|TRUE|FALSE|NULL)\\b" },
              { token: "variable", regex: /\$\w+/ },
              { token: "constant.numeric", regex: "[+-]?[0-9]+(?:\\.[0-9]+)?(?:e[0-9]+)?" },
      ...
      r.inherits(u, i),
        function () {
          ;(this.blockComment = { start: "{*", end: "*}" }),
            ...
            (this.checkOutdent = (e, t, n) => /^\s+\{\/$/.test(t + n)),
