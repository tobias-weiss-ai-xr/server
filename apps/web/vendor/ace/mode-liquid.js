  ...
  ace.define(
    ...
    (e, t, n) => {
      function a() {
        ...
        ;(this.$rules.jsx = [n, t, { include: "reference" }, { defaultToken: "string.xml" }]),
      ...
      var r = e("../../lib/oop"),
        ...
        u = function () {
          ...
          this.addBehaviours(e),
            this.inherit(s),
            this.add("autoclosing-fragment", "insertion", (e, t, n, r, s) => {
              if (s == ">") {
    ...
    (e, t, n) => {
      ...
      ;(function () {
        ;(this.getFoldWidget = function (e, t, n) {
          ...
          (this.getCommentFoldWidget = (e, t) =>
            /comment/.test(e.getState(t)) && /<!-/.test(e.getLine(t)) ? "start" : ""),
          ...
          ;(this.lineCommentStart = "//"),
            ...
            (this.getNextLineIndent = function (e, t, n) {
              ...
              if (e == "start" || e == "no_regex") {
                ...
                u && (r += n)
              } else if (e == "doc-start") if (o == "start" || o == "no_regex") return ""
              return r
            }),
      ...
      ;(function () {
        ;(this.getCompletions = function (e, t, n, r) {
          ...
          (this.getTagCompletions = (e, t, n, r) =>
            a.map((e) => ({ value: e, meta: "tag", score: 1e6 }))),
          (this.getAttributeCompletions = (e, t, n, r) => {
            ...
            return (
              ...
              s.map((e) => ({ caption: e, snippet: e + '="$0"', meta: "attribute", score: 1e6 }))
            )
          }),
          (this.getAttributeValueCompletions = (e, t, n, r) => {
            ...
            return (
              ...
              o.map((e) => ({ caption: e, snippet: e, meta: "attribute value", score: 1e6 }))
            )
          }),
          (this.getHTMLEntityCompletions = (e, t, n, r) => {
            ...
            return i.map((e) => ({ caption: e, snippet: e, meta: "html entity", score: 1e6 }))
          })
      }).call(h.prototype),
        (t.HtmlCompletions = h)
    },
      ...
      var r = e("../lib/oop"),
        ...
        f = function () {
            ...
            return (n) => {
              var r = n.indexOf(e),
                i = [
                  ...
                  { type: "keyword.tag" + e + ".tag-name", value: n.slice(r, r + t) },
            ...
            this.$rules[t].unshift(
              {
                ...
                regex: /{%-?\s*comment\s*-?%}/,
                next: [
                  { token: "comment.block", regex: /{%-?\s*endcomment\s*-?%}/, next: "pop" },
              ...
              { regex: /({%-?\s*\bschema\b\s*-?%})/, next: "schema-start", onMatch: e("schema") },
              {
              ...
              },
              {
                ...
                next: [
                  ...
                  { token: "meta.tag.punctuation.tag-close", regex: /(-?)(%})/, next: "pop" },
                ],
              },
              { token: "meta.tag.punctuation.ouput-open", regex: /({{)/, push: "liquid-start" },
            )
          this.embedRules(u, "schema-", [
            ...
            this.addRules({
              "liquid-start": [
                { token: "meta.tag.punctuation.ouput-close", regex: /}}/, next: "pop" },
                { token: "meta.tag.punctuation.tag-close", regex: /%}/, next: "pop" },
                { token: "string", regex: /['](?:(?:\\.)|(?:[^'\\]))*?[']/ },
                { token: "string", regex: /["](?:(?:\\.)|(?:[^'\\]))*?["]/ },
                { token: "constant.numeric", regex: /0[xX][0-9a-fA-F]+\b/ },
                ...
                { token: "keyword.operator", regex: /\*|\-|\+|=|!=|\?\|\:/ },
                { token: "constant.language.boolean", regex: /(?:true|false|nil|empty)\b/ },
                { token: "keyword.operator", regex: /\s+(?:and|contains|in|with)\b\s+/ },
                { token: ["keyword.operator", "support.function"], regex: /(\|\s*)([a-zA-Z_]+)/ },
                ...
                { token: "variable.parameter", regex: /\.([a-zA-Z_$][a-zA-Z0-9_$]*\b)$/ },
                {
                  token: "support.class",
                  regex:
