  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      var C = {
        ...
        interpolation: () => [k(d, /\s*\w*\s*:/), "js-interpolation-start"],
        tagHead: (e) =>
          k(v, e, [k(v, /[\w\-_]+/), k(b + "." + g, /~\[/, C.interpolation()), C.goUp()]),
        tag: () => ({
          token: "tag",
          onMatch: (e) =>
            void 0 !== S[e]
        ...
        attribute: () =>
          k((e) => (/^x\-/.test(e) ? v + "." + y : v), /[\w_-]+/, [
            k(m, /\s*=\s*/, [C.string('"'), C.string("'"), C.word(), C.goUp()]),
            C.goUp(),
          ]),
        expression: () => k(b, /\(/, ["js-statement-start"]),
        word: () => k("string", /[\w-_]+/),
        goUp: () => k("text", "", "pop"),
        goStart: () => k("text", "", "start"),
      }
    },
  ),
  ace.define(
