          ...
          "#template": [
            {
              ...
              push: [
                { token: "storage.type.function", regex: /}}/, next: "pop" },
                {
                  ...
                  regex: /(\|)(\s*)([a-zA-Z-]*)(\s*)(=)(\s*)([^|}]*)/,
                  push: [
                    { token: "meta.structure.dictionary", regex: /(?=}}|[|])/, next: "pop" },
          ...
          "#link": [
            {
              ...
              push: [
                { token: "punctuation.definition.tag.end", regex: /\]\]/, next: "pop" },
                { include: "$self" },
          ...
          "#comment": [
            {
              ...
              regex: /<!--/,
              push: [
                { token: "punctuation.definition.comment.html", regex: /-->/, next: "pop" },
...
;(() => {
  ace.require(["ace/mode/mediawiki"], (m) => {
