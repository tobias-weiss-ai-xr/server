ace.define(
  ...
  (e, t, n) => {
    var r = e("../lib/oop"),
      ...
      s = function () {
        var e = /\\(?:['"?\\abfnrtv]|[0-7]{1,3}|x[a-fA-F\d]{2}|u[a-fA-F\d]{4}U[a-fA-F\d]{8}|.)/
          .source
        ;(this.$rules = {
          start: [
            {
            ...
            { token: "entity.name.function.mips", regex: /\bsyscall\b/, comment: "Other" },
            ...
            { token: "comment.assembly", regex: /#.*$/, comment: "Single line comments" },
          ],
        }),
          this.normalizeRules()
      }
    ;(s.metaData = { fileTypes: ["s", "asm"], name: "MIPS", scopeName: "source.mips" }),
      r.inherits(s, i),
