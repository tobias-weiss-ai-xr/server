ace.define(
  ...
  (e, t, n) => {
      ...
      s = function () {
        ;(this.$rules = {
          start: [
            ...
            { token: "variable.language.nasal", regex: /\b(?:me|arg|parents|obj)\b/ },
            ...
            { token: "constant.language.nil.nasal", regex: /\bnil\b/ },
            {
              ...
              regex: /'/,
              push: [
                { token: "punctuation.definition.string.end.nasal", regex: /'/, next: "pop" },
            ...
            { token: "constant.numeric.nasal", regex: /0[x|X][0-9a-fA-F]+/, comment: "Hex codes" },
            ...
            },
            {
              todo: {
                ...
                regex: /\{/,
                push: [
                  { token: "punctuation.section.scope.end.nasal", regex: /\}/, next: "pop" },
                  { include: "$self" },
                ],
              },
            },
            ...
            { token: "support.class.nasal", regex: /\bNode\b/, comment: "FG node class" },
            {
              token: "variable.language.nasal",
            ...
            },
            {
              todo: {
                ...
                regex: /\b([a-zA-Z_?$][\w?$]*)(\()/,
                push: [
                  { token: "punctuation.definition.arguments.end.nasal", regex: /\)/, next: "pop" },
                  { include: "$self" },
    ...
    ;(s.metaData = { fileTypes: ["nas"], name: "Nasal", scopeName: "source.nasal" }),
      r.inherits(s, i),
