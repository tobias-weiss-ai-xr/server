      ...
      var r = e("../lib/oop"),
        ...
        u = function (e) {
          var t =
            ...
            l = /\\(?:['"?\\abfnrtv]|[0-7]{1,3}|x[a-fA-F\d]{2}|u[a-fA-F\d]{4}U[a-fA-F\d]{8}|.)/
              .source,
            c =
              "%" +
              /(\d+\$)?/.source +
      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          var e = {
            ...
            t = "\\\\(?:[abefnrtv'\"?\\\\]|[0-3]\\d{1,2}|[4-7]\\d?|222|x[a-zA-Z0-9]+)",
            n = [
          ...
          ;(this.$keywordList = r.$keywordList),
            (this.$rules = {
              start: [
                ...
                { token: r.getKeywords(), regex: "[a-zA-Z_$][a-zA-Z0-9_$]*\\b" },
                {
          ...
          for (var u in o)
            this.$rules[u]
              ? this.$rules[u].push && this.$rules[u].push.apply(this.$rules[u], o[u])
              : (this.$rules[u] = o[u])
...
;(() => {
  ace.require(["ace/mode/objectivec"], (m) => {
