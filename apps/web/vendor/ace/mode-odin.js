        ...
        a = function () {
          var e =
            ...
            t = () => {
              ...
              return e
                .reduce((e, t) => e.flatMap((e) => t.map((t) => [e, t].flat())))
                .map((e) => e.join(""))
            },
            n = i(
              i(
            ...
            f = this.createKeywordMapper(
              { keyword: e, "constant.language": a, "support.function": u, "support.type": n },
              "",
            ),
            l = "\\\\(?:[0-7]{3}|x\\h{2}|u{4}|U\\h{6}|[abfnrtv'\"\\\\])".replace(
              /\\h/g,
              "[a-fA-F\\d]",
            )
          ;(this.$rules = {
            start: [
              ...
              },
              {
                token: (e) =>
                  e[e.length - 1] == "("
                    ? [
                        { type: f(e.slice(0, -1)) || "support.function", value: e.slice(0, -1) },
