      ...
      s = function () {
        var e = "TRUE|FALSE",
          ...
          i = this.createKeywordMapper(
            { "constant.language.bool.ion": t, "constant.language.null.ion": r },
        ...
        ;(this.$rules = {
          ...
          sexp: [
            {
              ...
              regex: "\\(",
              push: [
                { token: "punctuation.definition.sexp.end.ion", regex: "\\)", next: "pop" },
                { include: "comment" },
                { include: "value" },
                {
          ...
          list: [
            {
              ...
              regex: "\\[",
              push: [
                { token: "punctuation.definition.list.end.ion", regex: "\\]", next: "pop" },
                { include: "comment" },
                { include: "value" },
                { token: "punctuation.definition.list.separator.ion", regex: "," },
              ],
            },
          ],
          struct: [
            {
              ...
              regex: "\\{",
              push: [
                { token: "punctuation.definition.struct.end.ion", regex: "\\}", next: "pop" },
                { include: "comment" },
                { include: "value" },
                { token: "punctuation.definition.struct.separator.ion", regex: ",|:" },
              ],
            },
          ],
          blob: [
          ...
          symbol: [
            ...
            { token: "storage.type.symbol.identifier.ion", regex: "[\\$_a-zA-Z][\\$_a-zA-Z0-9]*" },
          ],
          number: [
            {
            ...
            { token: "constant.numeric.timestamp.ion", regex: "\\d{4}-\\d{2}-\\d{2}T?" },
            { token: "constant.numeric.integer.binary.ion", regex: "-?0[bB][01](?:_?[01])*" },
            {
            ...
            { token: "constant.numeric.float.ion", regex: "(?:[-+]inf)|(?:nan)" },
            {
              token: "constant.numeric.decimal.ion",
              regex:
                "-?(?:0|[1-9](?:_?\\d)*)(?:(?:(?:\\.(?:\\d(?:_?\\d)*)?)(?:[dD][+-]?\\d+)|\\.(?:\\d(?:_?\\d)*)?)|(?:[dD][+-]?\\d+))",
            },
            { token: "constant.numeric.integer.ion", regex: "-?(?:0|[1-9](?:_?\\d)*)" },
          ],
          string: [
            {
              token: [
            ...
            },
            {
              ...
              regex: "'{3}",
              push: [
                { token: "punctuation.definition.string.end.ion", regex: "'{3}", next: "pop" },
    ...
    (e, t, n) => {
      var r = e("../lib/oop"),
        ...
        o = function () {
          ...
          ;(this.$rules = {
            start: [{ include: "whitespace" }, { include: "comment" }, { include: "value" }],
            value: [
              { include: "whitespace" },
              { include: "comment" },
              { include: "tuple_value" },
            ...
            punctuation: [{ token: "punctuation.partiql", regex: "[;:()\\[\\]\\{\\},.]" }],
            operator: [{ token: "keyword.operator.partiql", regex: "[+*/<>=~!@#%&|?^-]+" }],
            identifier: [
              {
                token: "variable.language.identifier.quoted.partiql",
                regex: '(["])((?:(?:\\\\.)|(?:[^"\\\\]))*?)(["])',
              },
              { token: "variable.language.identifier.at.partiql", regex: "@\\w+" },
              { token: "variable.language.identifier.partiql", regex: "\\b\\w+(?:\\.\\w+)?\\b" },
            ],
            number: [
              {
            ...
            bag_value: [
              {
                ...
                regex: "<<",
                push: [
                  { token: "punctuation.definition.bag.end.partiql", regex: ">>", next: "pop" },
                  { include: "comment" },
                  { token: "punctuation.definition.bag.separator.partiql", regex: "," },
                  { include: "value" },
                ],
              },
            ],
            comment: [
              ...
              { token: "comment.block.partiql", regex: "/\\*", push: "comment__1" },
            ],
            comment__1: [
            ...
            array_value: [
              {
                ...
                regex: "\\[",
                push: [
                  { token: "punctuation.definition.array.end.partiql", regex: "\\]", next: "pop" },
                  { include: "comment" },
                  { token: "punctuation.definition.array.separator.partiql", regex: "," },
                  { include: "value" },
                ],
              },
            ],
            tuple_value: [
              {
                ...
                regex: "\\{",
                push: [
                  { token: "punctuation.definition.tuple.end.partiql", regex: "\\}", next: "pop" },
                  { include: "comment" },
                  { token: "punctuation.definition.tuple.separator.partiql", regex: ",|:" },
                  { include: "value" },
                ],
              },
            ],
            ...
            (this.$rules["embed-ion"] = [
              { token: "punctuation.definition.ion.begin.partiql", regex: "`", next: "ion-start" },
            ]),
...
;(() => {
  ace.require(["ace/mode/partiql"], (m) => {
