ace.define(
            ...
            heredoc: [
              {
                onMatch: function (e, t, n) {
                  return n[1] != e
                    ? ((this.next = ""), "string")
                    : (n.shift(), n.shift(), (this.next = this.nextState), "markup.list")
                },
                regex: "^\\w+(?=;?$)",
                nextState: "start",
              },
      ...
      var r = e("../lib/oop"),
        ...
        s = function () {
          ...
          var e = {
              ...
              comments: [
                { include: "bladeComments" },
                { token: "punctuation.definition.comment.blade", regex: "(\\/\\/(.)*)|(\\#(.)*)" },
                {
  ...
  ace.define("ace/mode/php_completions", ["require", "exports", "module"], (e, t, n) => {
    function s(e, t) {
    ...
    ;(function () {
      ;(this.getCompletions = function (e, t, n, r) {
        ...
        (this.getVariableCompletions = (e, t, n, r) => {
          var s = Object.keys(i)
          return s.map((e) => ({ caption: e, value: e, meta: "php variable", score: 1e6 }))
        }),
        (this.getArrayKeyCompletions = (e, t, n, r) => {
          ...
          return (
            ...
            u.map((e) => ({ caption: e, value: e, meta: "php array key", score: 1e6 }))
          )
        })
    }).call(o.prototype),
      (t.PhpCompletions = o)
        ...
        function () {
          ;(this.getFoldWidgetRangeBase = this.getFoldWidgetRange),
            ...
            (this.getFoldWidgetRange = function (e, t, n) {
              ...
              return i ? this.phpBlock(e, n, i.index + 2) : this.getFoldWidgetRangeBase(e, t, n)
            }),
            (this.getFoldWidget = function (e, t, n) {
              var r = e.getLine(n),
            ...
            (this.phpBlock = function (e, t, n, r) {
              ...
              if (!l) return
              var c = l === -1 ? i.getCurrentTokenColumn() : e.getLine(t).length,
                h = t
    ...
    (e, t, n) => {
      ...
      var b = function (e) {
        ...
        v.call(this),
          ...
          (this.foldingRules = new h(new p(), { "js-": new d(), "css-": new d(), "php-": new l() }))
      }
      r.inherits(b, v),
        function () {
          ;(this.createWorker = function (e) {
...
;(() => {
  ace.require(["ace/mode/php_laravel_blade"], (m) => {
