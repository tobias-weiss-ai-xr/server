    ...
    var r = e("../lib/oop"),
      ...
      s = function () {
        var e =
          ...
          f = { token: "constant.language.boolean", regex: "(?:True|False)\\b" },
          l = { token: "constant.other", regex: "v[0-9](?:\\.[a-zA-Z0-9*])*\\b" },
          c = { token: s, regex: "[a-zA-Z][\\:a-zA-Z0-9_-]*\\b" },
          h = { token: "variable.language", regex: "[$@%&][?*!.]?[a-zA-Z0-9_-]+\\b" },
          ...
          v = { token: "constant.language", regex: "\ud835\udc52|\u03c0|\u03c4|\u221e" },
          m = { token: "string.quoted.single", regex: "['](?:(?:\\\\.)|(?:[^'\\\\]))*?[']" },
          g = { token: "string.quoted.single", regex: "[<](?:[a-zA-Z0-9 ])*[>]" },
          y = {
            token: "string.regexp",
            regex:
              "[m|rx]?[/](?:(?:\\[(?:\\\\]|[^\\]])+\\])|(?:\\\\/|[^\\]/]))*[/]\\w*\\s*(?=[).,;]|$)",
