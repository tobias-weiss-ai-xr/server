ace.define(
  ...
  ace.define(
    ...
    (e, t, n) => {
      var r = e("../lib/oop"),
        ...
        f = function () {
          u.call(this)
          var e = (e, t) => (typeof t == "function" ? t(e) : t),
            t = "in-braces"
      ...
      var l = function () {
        ...
        var e = {
          ...
          s = {
            ...
            onMatch: function (e, t, n) {
              return (
                n.unshift((e) => (e !== "}" ? "start" : n.shift() || "start")),
                (this.next = "razor-block-start"),
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      ;(function () {
        ;(this.getCompletions = function (e, t, n, r) {
          if (e.lastIndexOf("razor-short-start") == -1 && e.lastIndexOf("razor-block-start") == -1)
            return []
          var i = t.getTokenAt(n.row, n.column)
          if (!i) return []
          ...
          (this.getShortStartCompletions = (e, t, n, r) =>
            s.map((e) => ({ value: e, meta: "keyword", score: 1e6 }))),
          (this.getKeywordCompletions = (e, t, n, r) =>
            s.concat(i).map((e) => ({ value: e, meta: "keyword", score: 1e6 })))
      }).call(o.prototype),
