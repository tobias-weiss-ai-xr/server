      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          var e = "break|continue|do|else|for|if|return|with|while|use|class|all|void",
            ...
            a = /\\(?:['"?\\abfnrtv]|[0-7]{1,3}|x[a-fA-F\d]{2}|u[a-fA-F\d]{4}U[a-fA-F\d]{8}|.)/
              .source,
            f =
              "%" +
              /(\d+\$)?/.source +
          ...
          ;(this.$rules = {
            start: [
              ...
              { token: "support.function", regex: "fold|foldfix|genarray|modarray|propagate" },
