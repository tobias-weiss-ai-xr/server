ace.define(
      ...
      var r = e("../lib/oop"),
        ...
        o = function () {
          var e = new i({ noES6: !0 }),
            ...
            n = (e) => ((e.isContextAware = !0), e),
            r = (e) => ({
              token: e.token,
              regex: e.regex,
              next: n((t, n) => (n.length === 0 && n.unshift(t), n.unshift(e.next), e.next)),
            }),
            s = (e) => ({
              token: e.token,
              regex: e.regex,
              next: n((e, t) => (t.shift(), t[0] || "start")),
            })
          ;(this.$rules = e.$rules),
            (this.$rules.no_regex = [
  ...
  ace.define(
    ...
    (e, t, n) => {
      ...
      r.inherits(a, i),
        function () {
          ;(this.createWorker = (e) => null), (this.$id = "ace/mode/sjs")
        }.call(a.prototype),
        (t.Mode = a)
    },
  )
;(() => {
  ace.require(["ace/mode/sjs"], (m) => {
