        ...
        u = function () {
          ...
          this.$rules = {
            start: [
              ...
              {
                token: (i) =>
                  e.hasOwnProperty(i.toLowerCase())
                    ? "support.type"
                    : s.hasOwnProperty(i)
                      ? "keyword"
                      : n.hasOwnProperty(i)
        ...
        o = function () {
          ...
          ;(this.$rules = {
            start: [
              ...
              {
                token: (e) => (t.indexOf(e.toLowerCase()) > -1 ? "keyword" : "variable"),
                regex: "[@\\$][a-z0-9_\\-@\\$]*\\b",
              },
              { token: "variable", regex: "[@\\$]\\{[a-z0-9_\\-@\\$]*\\}" },
              {
                token: (e, t) =>
                  n.indexOf(e.toLowerCase()) > -1
      ...
      var r =
          ...
          ((e, t) => {
            ...
            var r = n.call(e),
              ...
              o
            try {
              while ((t === void 0 || t-- > 0) && !(i = r.next()).done) s.push(i.value)
            } catch (u) {
              o = { error: u }
            } finally {
              try {
          ...
          ((e, t, n) => {
            if (n || arguments.length === 2)
              for (var r = 0, i = t.length, s; r < i; r++)
                if (s || !(r in t)) s || (s = Array.prototype.slice.call(t, 0, r)), (s[r] = t[r])
        ...
        b = function (e) {
          ...
          ;(n.start = t.concat(n.start)),
            (n["vue-interpolations"] = [
              { token: "punctuation", regex: /\{\{\{?/, next: "js-interpolation-start" },
            ])
          var s = this
          n.tag_stuff.unshift(
            {
                ...
                { token: "string", regex: /$/, next: "tag_stuff" },
                {
                  ...
                  onMatch: function (e, t, n, o) {
                    ...
                    if (a.length > 1) {
                      n.shift()
                      var l = n.shift(),
                        c = new v(s.$rules).getLineTokens(a.slice(1).join(u), l)
                      c.tokens.unshift({ type: "string", value: u }),
                        (this.next = Array.isArray(c.state) ? c.state[c.state.length - 1] : c.state)
                    }
  ...
  ace.define(
    ...
    (e, t, n) => {
      var r = e("../lib/oop"),
        ...
        c = ["li", "dt", "dd", "p", "rt", "rp", "optgroup", "option", "colgroup", "td", "th"],
        h = function () {
