ace.define(
  ...
  (e, t, n) => {
      ...
      s = function () {
        ;(this.$rules = {
          start: [
            ...
            { token: "constant.numeric.port", regex: /\b\d{1,5}\/(?:udp|tcp|icmp|unknown)\b/ },
            {
            ...
            { token: "constant.numeric.integer.hexadecimal", regex: /\b0x[0-9a-fA-F]+\b/ },
            ...
            { token: "keyword.control", regex: /\b(?:return|break|next|continue|fallthrough)\b/ },
            ...
            { token: "storage.modifier", regex: /\b(?:global|local|const|option)\b/ },
            {
    ...
    ;(s.metaData = { fileTypes: ["bro", "zeek"], name: "Zeek", scopeName: "source.zeek" }),
      r.inherits(s, i),
