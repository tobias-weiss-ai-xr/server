ace.define("ace/theme/crimson_editor-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ;(t.isDark = !1), (t.cssText = e("./crimson_editor-css")), (t.cssClass = "ace-crimson-editor")
      var r = e("../lib/dom")
      r.importCssString(t.cssText, t.cssClass, !1)
    },
  )
;(() => {
  ace.require(["ace/theme/crimson_editor"], (m) => {
