ace.define("ace/theme/kr_theme-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ;(t.isDark = !0), (t.cssClass = "ace-kr-theme"), (t.cssText = e("./kr_theme-css"))
      var r = e("../lib/dom")
      r.importCssString(t.cssText, t.cssClass, !1)
    },
  )
;(() => {
  ace.require(["ace/theme/kr_theme"], (m) => {
