ace.define("ace/theme/merbivore-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ;(t.isDark = !0), (t.cssClass = "ace-merbivore"), (t.cssText = e("./merbivore-css"))
      var r = e("../lib/dom")
      r.importCssString(t.cssText, t.cssClass, !1)
    },
  )
;(() => {
  ace.require(["ace/theme/merbivore"], (m) => {
