ace.define("ace/theme/merbivore_soft-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ;(t.isDark = !0), (t.cssClass = "ace-merbivore-soft"), (t.cssText = e("./merbivore_soft-css"))
      var r = e("../lib/dom")
      r.importCssString(t.cssText, t.cssClass, !1)
    },
  )
;(() => {
  ace.require(["ace/theme/merbivore_soft"], (m) => {
