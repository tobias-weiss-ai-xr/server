ace.define("ace/theme/one_dark-css", ["require", "exports", "module"], (e, t, n) => {
  n.exports =
  ...
  ace.define(
    ...
    (e, t, n) => {
      ;(t.isDark = !0), (t.cssClass = "ace-one-dark"), (t.cssText = e("./one_dark-css"))
      var r = e("../lib/dom")
      r.importCssString(t.cssText, t.cssClass, !1)
    },
  )
;(() => {
  ace.require(["ace/theme/one_dark"], (m) => {
