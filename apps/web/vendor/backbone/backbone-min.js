;((r) => {
  ...
  if (typeof define === "function" && define.amd) {
    define(["underscore", "jquery", "exports"], (t, e, i) => {
  ...
  x.extend(g.prototype, r, {
    ...
    fetch: function (i) {
      ...
      var n = i.success
      i.success = (t) => {
        var e = i.parse ? this.parse(t, i) : t
        if (!this.set(e, i)) return false
        if (n) n.call(i.context, this, t, i)
        this.trigger("sync", this, t, i)
      }
      G(this, i)
    ...
    save: function (t, e, i) {
      ...
      i.success = (t) => {
        ...
        var e = i.parse ? this.parse(t, i) : t
        if (n) e = x.extend({}, r, e)
        if (e && !this.set(e, i)) return false
        if (a) a.call(i.context, this, t, i)
        this.trigger("sync", this, t, i)
      }
      G(this, i)
    ...
    destroy: function (e) {
      ...
      e.success = (t) => {
        if (n) s()
        if (r) r.call(e.context, this, t, e)
        if (!this.isNew()) this.trigger("sync", this, t, e)
      }
      var t = false
      if (this.isNew()) {
        x.defer(e.success)
  ...
  x.extend(m.prototype, r, {
    ...
    set: function (t, e) {
      ...
      var b = !d && l && c
      if (n.length && b) {
        y = this.length !== n.length || x.some(this.models, (t, e) => t !== n[e])
    ...
    fetch: function (i) {
      ...
      i.success = (t) => {
        ...
        this[e](t, i)
        if (r) r.call(i.context, this, t, i)
        this.trigger("sync", this, t, i)
      }
      G(this, i)
      return this.sync("read", this, i)
  ...
  x.extend(A.prototype, r, {
    ...
    _createElement: (t) => document.createElement(t),
  ...
  var C = (e, t) => {
    ...
    if (x.isString(e)) return (t) => t.get(e)
    return e
  }
  var R = (t) => {
    var e = x.matches(t)
    return (t) => e(t.attributes)
  }
  var M = {
    forEach: 3,
    each: 3,
  ...
  h.ajax = () => h.$.ajax.apply(h.$, arguments)
  ...
  x.extend(O.prototype, r, {
    ...
    route: function (i, r, n) {
      ...
      h.history.route(i, (t) => {
        ...
        if (this.execute(n, e, r) !== false) {
          this.trigger.apply(this, ["route:" + r].concat(e))
          this.trigger("route", r, e)
          h.history.trigger("route", this, r, e)
        }
      })
      return this
    },
  ...
  x.extend(B.prototype, r, {
    ...
    decodeFragment: (t) => decodeURI(t.replace(/%25/g, "%2525")),
    getSearch: function () {
    ...
    start: function (t) {
      ...
      var n = window.addEventListener || ((t, e) => attachEvent("on" + t, e))
    ...
    stop: function () {
      var t = window.removeEventListener || ((t, e) => detachEvent("on" + t, e))
      if (this._usePushState) {
