...
;((window, undefined) => {
  ...
  jQuery.extend({
    ...
    type: (obj) => (obj == null ? String(obj) : class2type[core_toString.call(obj)] || "object"),
    ...
    trim:
      core_trim && !core_trim.call("\uFEFF\xA0")
        ? (text) => (text == null ? "" : core_trim.call(text))
    ...
    proxy: (fn, context) => {
      ...
      proxy = () => fn.apply(context, args.concat(core_slice.call(arguments)))
