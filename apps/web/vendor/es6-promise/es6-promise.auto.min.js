!((t, e) => {
  ...
  function u() {
    ...
    return (t.port1.onmessage = a), () => t.port2.postMessage(0)
  }
  function c() {
    var t = setTimeout
    return () => t(a, 1)
  ...
  function k(t) {
    return new this(
      L(t)
        ? (n, r) => {
            for (var o = t.length, i = 0; i < o; i++) this.resolve(t[i]).then(n, r)
          }
  ...
  var K = void 0
  K = Array.isArray ? Array.isArray : (t) => "[object Array]" === Object.prototype.toString.call(t)
  var L = K,
    N = 0,
    U = void 0,
    W = void 0,
      ...
      return (
        ...
        (t.prototype._willSettleAt = function (t, e) {
          j(
            t,
            void 0,
            (t) => this._settledAt(Z, e, t),
            (t) => this._settledAt($, e, t),
          )
        }),
        t
      )
