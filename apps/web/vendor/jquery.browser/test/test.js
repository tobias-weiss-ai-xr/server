...
var ua = {
  chrome: {
    windows:
      "Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1664.3 Safari/537.36",
    mac: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1664.3 Safari/537.36",
    android:
      "Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1664.3 Mobile Safari/537.36",
    linux:
      "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1664.3 Safari/537.36",
  ...
  safari: {
    ...
    iphone:
      "Mozilla/5.0 (iPhone; CPU iPhone OS 7_0 like Mac OS X) AppleWebKit/537.71 (KHTML, like Gecko) Version/7.0 Mobile/11A465 Safari/9537.53",
  ...
  android: {
    v_4_4: {
      android:
        "Mozilla/5.0 (Linux; Android 4.4.1; Nexus 5 Build/KOT49E) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile Safari/537.36",
      version: "537.36",
      versionNumber: 4,
    },
    name: "android",
...
casper.test.begin("when using Chrome on Windows", 7, (test) => {
  casper.userAgent(ua.chrome.windows)

  casper
    .start(test_url)
    .then(() => {
      var browser = casper.evaluate(() => $.browser)
      ...
      test.assertEquals(
        browser.version,
        ua.chrome.version,
        "String version should be " + ua.chrome.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.chrome.versionNumber,
        "Number version should be " + ua.chrome.versionNumber,
      )
...
casper.test.begin("when using Chrome on Mac", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.chrome.version,
        "Version should be " + ua.chrome.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.chrome.versionNumber,
...
casper.test.begin("when using Chrome on an Android device", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.versionNumber,
        ua.chrome.versionNumber,
        "Version should be " + ua.chrome.versionNumber,
      )
...
casper.test.begin("when using Chrome on Linux", 7, (test) => {
...
casper.test.begin("when using Chrome on Chrome OS", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.chrome.chromeOsVersion,
        "Version should be " + ua.chrome.chromeOsVersion,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.chrome.chromeOsVersionNumber,
        "Version should be " + ua.chrome.chromeOsVersionNumber,
      )
...
casper.test.begin("when using Firefox on Windows", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.firefox.version,
        "Version should be " + ua.firefox.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.firefox.versionNumber,
        "Version should be " + ua.firefox.versionNumber,
      )
...
casper.test.begin("when using Firefox on Mac", 7, (test) => {
...
casper.test.begin("when using Firefox on Linux", 7, (test) => {
...
casper.test.begin("when using Safari on Mac", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.safari.version,
        "Version should be " + ua.safari.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.safari.versionNumber,
        "Version should be " + ua.safari.versionNumber,
      )
...
casper.test.begin("when using Safari on iPad", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.versionNumber,
        ua.safari.versionNumber,
        "Version number should be " + ua.safari.versionNumber,
      )
...
casper.test.begin("when using Safari on iPhone", 7, (test) => {
...
casper.test.begin("when using Safari on iPod", 7, (test) => {
...
casper.test.begin("when using IE9", 7, (test) => {
...
casper.test.begin("when using IE10", 7, (test) => {
...
casper.test.begin("when using IE10 on a Windows Phone", 7, (test) => {
...
casper.test.begin("when using IE11", 7, (test) => {
...
casper.test.begin("when using IE11 on a Windows Phone", 7, (test) => {
...
casper.test.begin("when using Microsoft Edge 12", 7, (test) => {
...
casper.test.begin("when using Microsoft Edge 13", 7, (test) => {
...
casper.test.begin("when using Microsoft Edge v13 on a Windows Phone", 7, (test) => {
...
casper.test.begin("when using Opera 15+ on Windows", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.opera.v_15.version,
        "Version should be " + ua.opera.v_15.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.opera.v_15.versionNumber,
        "Version number should be " + ua.opera.v_15.versionNumber,
      )
...
casper.test.begin("when using Opera 15+ on Mac", 7, (test) => {
...
casper.test.begin("when using Opera 10 on Windows", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.opera.v_10.version,
        "Version should be " + ua.opera.v_10.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.opera.v_10.versionNumber,
        "Version number should be " + ua.opera.v_10.versionNumber,
      )
...
casper.test.begin("when using Opera 10 on Mac", 7, (test) => {
...
casper.test.begin("when using Opera 12.11 on Windows", 7, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.opera.v_12.version,
        "Version should be " + ua.opera.v_12.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.opera.v_12.versionNumber,
        "Version number should be " + ua.opera.v_12.versionNumber,
      )
...
casper.test.begin("when using Opera 12.11 on Mac", 7, (test) => {
...
casper.test.begin("when using Android 4.4 stock browser on Android", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.android.v_4_4.version,
        "Version should be " + ua.android.v_4_4.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.android.v_4_4.versionNumber,
        "Version number should be " + ua.android.v_4_4.versionNumber,
      )
...
casper.test.begin("when using Kindle 4 stock browser", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.kindle.v_4.version,
        "Version should be " + ua.kindle.v_4.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.kindle.v_4.versionNumber,
        "Version number should be " + ua.kindle.v_4.versionNumber,
      )
...
casper.test.begin("when using Kindle Silk 5 browser", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.silk.v_5.version,
        "Version should be " + ua.silk.v_5.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.silk.v_5.versionNumber,
        "Version number should be " + ua.silk.v_5.versionNumber,
      )
...
casper.test.begin("when using BlackBerry 7 stock browser", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.name,
        ua.blackberry.name,
        "Browser name should be " + ua.blackberry.name,
      )

      test.assertEquals(
        browser.version,
        ua.blackberry.v_7.version,
        "Version should be " + ua.blackberry.v_7.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.blackberry.v_7.versionNumber,
        "Version number should be " + ua.blackberry.v_7.versionNumber,
      )
...
casper.test.begin("when using BB10 stock browser", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.version,
        ua.bb.v_10.version,
        "Version should be " + ua.bb.v_10.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.bb.v_10.versionNumber,
        "Version number should be " + ua.bb.v_10.versionNumber,
      )
...
casper.test.begin("when using BlackBerry PlayBook stock browser", 6, (test) => {
  ...
  casper
    ...
    .then(() => {
      ...
      test.assertEquals(
        browser.name,
        ua.playbook.name,
        "Browser name should be " + ua.playbook.name,
      )

      test.assertEquals(
        browser.version,
        ua.playbook.v_7.version,
        "Version should be " + ua.playbook.v_7.version,
      )
      test.assertEquals(
        browser.versionNumber,
        ua.playbook.v_7.versionNumber,
        "Version number should be " + ua.playbook.v_7.versionNumber,
      )
...
casper.test.begin("when using Chrome on Windows w/o jQuery", 7, (test) => {
  casper.userAgent(ua.chrome.windows)

  casper
    .start(test_url)
    .then(() => {
      var browser = casper.evaluate(() => window.jQBrowser)
...
casper.test.begin(
  "when trying to match a browser that is not the browser used by the user",
  7,
  (test) => {
