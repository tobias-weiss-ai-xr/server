...
;((jQuery, window, undefined) => {
  ...
  var attrFn = jQuery("<input/>", { size: 1 }).attr("size") && jQuery.attrFn,
    oldAttr = jQuery.attr,
    valueAttrGet = (jQuery.attrHooks.value && jQuery.attrHooks.value.get) || (() => null),
    valueAttrSet = (jQuery.attrHooks.value && jQuery.attrHooks.value.set) || (() => undefined),
  ...
  jQuery.each(ajaxEvents.split("|"), (_, name) => {
    jQuery.event.special[name] = {
      setup: function () {
        // The document needs no shimming; must be !== for oldIE
        if (this !== document) {
          jQuery.event.add(document, name + "." + jQuery.guid, () => {
            jQuery.event.trigger(name, Array.prototype.slice.call(arguments, 1), this, true)
          })
  ...
  if (jQuery.Callbacks) {
    ...
    jQuery.Deferred = (func) => {
      ...
      deferred.pipe = promise.pipe = (/* fnDone, fnFail, fnProgress */) => {
        var fns = arguments
