...
"undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
  ((a, b, c) => {
    ...
    var g = a("<input/>", { size: 1 }).attr("size") && a.attrFn,
      h = a.attr,
      i = (a.attrHooks.value && a.attrHooks.value.get) || (() => null),
      j = (a.attrHooks.value && a.attrHooks.value.set) || (() => c),
      k = /^(?:input|button)$/i,
      l = /^[238]$/,
      m =
    ...
    var y = !1
    a.swap &&
      a.each(["height", "width", "reliableMarginRight"], (b, c) => {
    ...
    var B = a.event.add,
      ...
      K = /(?:^|\s)hover(\.\S+|)\b/,
      L = (b) =>
        "string" != typeof b || a.event.special.hover
          ? b
      ...
      a.each(I.split("|"), (b, c) => {
        a.event.special[c] = {
          setup: function () {
            return (
              this !== document &&
                (a.event.add(document, c + "." + a.guid, () => {
                  a.event.trigger(c, Array.prototype.slice.call(arguments, 1), this, !0)
                }),
    ...
    if (
      ...
      a.Deferred = (b) => {
        ...
        return (
          ...
          (c.isResolved = () => (d("deferred.isResolved is deprecated"), "resolved" === c.state())),
          (c.isRejected = () => (d("deferred.isRejected is deprecated"), "rejected" === c.state())),
          b && b.call(c, c),
          c
        )
      }
