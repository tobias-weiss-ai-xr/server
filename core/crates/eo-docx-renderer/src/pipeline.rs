...
use eo_ooxml::model::{DocxBody, OoxmlFormat};
use eo_ooxml::parser::OoxmlParser;
use eo_renderer::{Canvas, Color, Paint};
...
fn render_table_cell(
    ...
    canvas.set_stroke_style(eo_renderer::StrokeStyle::default());
