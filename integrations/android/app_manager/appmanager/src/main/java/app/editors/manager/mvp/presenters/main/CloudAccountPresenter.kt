...
//            preferenceTool.fileData = ""
    ...
    private fun deleteFromAccountProvider(accountId: String) {
        ...
        if (BuildConfig.APPLICATION_ID == "com.world-office.documents" && ActivitiesUtils.isPackageExist(
                App.getApp(),
                "com.world-office.projects"
            )
        ) {
            try {
                context.contentResolver.delete(
                    Uri.parse("content://com.world-office.projects.accounts/accounts/$accountId"),
                    null,
                    null
                )
