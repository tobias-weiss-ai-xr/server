...
import app.editors.manager.mvp.presenters.login.WorldOfficeCloudPresenter
import app.editors.manager.mvp.views.login.WorldOfficeCloudView
...
class WorldOfficeCloudFragment : BaseAppFragment(), WorldOfficeCloudView {

    @InjectPresenter
    lateinit var presenter: WorldOfficeCloudPresenter
    ...
    companion object {
        val TAG = WorldOfficeCloudFragment::class.java.simpleName
        private const val KEY_PROFILE = "KEY_PROFILE"

        fun newInstance(isProfile: Boolean): WorldOfficeCloudFragment =
            WorldOfficeCloudFragment().apply {
