...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BOX_INFO_CLIENT_ID", "\"\"")
        buildConfigField("String", "BOX_INFO_REDIRECT_URL", "\"\"")
        buildConfigField("String", "BOX_COM_CLIENT_ID", "\"\"")
        buildConfigField("String", "BOX_COM_REDIRECT_URL", "\"\"")
        buildConfigField("String", "BOX_AUTH_URL", "\"\"")
        buildConfigField("String", "BOX_VALUE_RESPONSE_TYPE", "\"\"")
    }
