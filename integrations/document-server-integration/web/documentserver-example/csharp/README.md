...
This example will help you integrate WORLDOFFICE Docs into your web application written in .Net (C#).
...
Download the [.Net (C#) example](https://api.world-office.com/docs/docs-api/samples/language-specific-examples/) from our site.
...
Open the *settings.config* file and [specify the same secret key](https://helpcenter.world-office.com/installation/docs-configure-jwt.aspx) as used in your Document Server to enable JWT: 
