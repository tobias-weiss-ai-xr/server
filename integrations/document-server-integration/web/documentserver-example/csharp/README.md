...
This example will help you integrate World-Office Docs into your web application written in .Net (C#).
...
Download the [.Net (C#) example](https://api.worldoffice.com/docs/docs-api/samples/language-specific-examples/) from our site.
...
Open the *settings.config* file and [specify the same secret key](https://helpcenter.worldoffice.com/installation/docs-configure-jwt.aspx) as used in your Document Server to enable JWT: 
