...
package com.world-office.integration.sdk.service;

import com.google.gson.Gson;
import com.world-office.integration.documentserver.models.enums.Action;
import com.world-office.integration.documentserver.storage.FileStoragePathBuilder;
import com.world-office.integration.entities.Group;
import com.world-office.integration.entities.Permission;
import com.world-office.integration.sdk.manager.UrlManager;
import com.world-office.integration.services.UserServices;
...
import com.world-office.model.common.User;
import com.world-office.model.documenteditor.Config;
import com.world-office.model.documenteditor.config.document.Info;
import com.world-office.model.documenteditor.config.document.Permissions;
import com.world-office.model.documenteditor.config.document.ReferenceData;
import com.world-office.model.documenteditor.config.document.Type;
import com.world-office.model.documenteditor.config.document.permissions.CommentGroups;
import com.world-office.model.documenteditor.config.editorconfig.CoEditing;
import com.world-office.model.documenteditor.config.editorconfig.Customization;
import com.world-office.model.documenteditor.config.editorconfig.Embedded;
import com.world-office.model.documenteditor.config.editorconfig.Mode;
import com.world-office.model.documenteditor.config.editorconfig.Template;
import com.world-office.model.documenteditor.config.editorconfig.customization.Goback;
import com.world-office.model.documenteditor.config.editorconfig.customization.Close;
import com.world-office.model.documenteditor.config.editorconfig.customization.Features;
import com.world-office.model.documenteditor.config.editorconfig.embedded.Toolbar;
import com.world-office.service.documenteditor.config.DefaultConfigService;
...
public class ConfigServiceImpl extends DefaultConfigService implements ConfigService {
    ...
    public Config createConfig(final String fileId, final Action action, final Type type) {
        com.world-office.integration.entities.User appUser = userService.getCurrentUser();
    ...
    public CoEditing getCoEditing(final String fileId, final Mode mode, final Type type) {
        ...
        if (mode.equals(Mode.VIEW) && appUser.getName().equals("Anonymous")) {
            return CoEditing.builder()
                    .mode(com.world-office.model.documenteditor.config.editorconfig.coediting.Mode.STRICT)
                    .change(false)
                    .build();
        }
