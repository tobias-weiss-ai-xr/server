...
import com.worldoffice.integration.dto.Mentions;
import com.worldoffice.integration.dto.Protect;
import com.worldoffice.integration.dto.UserInfo;
...
import static com.worldoffice.integration.documentserver.util.Constants.ANONYMOUS_USER_ID;
    ...
    public String index(@RequestParam("fileName") final String fileName,
        ...
        if (actionParam != null) {
            try {
                ...
                logger.warn("Invalid action parameter: {}", actionParam);
            }
        }
        if (typeParam != null) {
            try {
                ...
                logger.warn("Invalid type parameter: {}", typeParam);
            }
        }
        ...
        try {
            ...
            logger.warn("Invalid uid cookie value: {}", uid);
            return "index.html";
        }
        Optional<User> optionalUser = userService.findUserById(userId);

        // if the user is not present, return the World-Office start page
