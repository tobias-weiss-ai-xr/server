...
package com.worldoffice.integration.documentserver.managers.callback;
...
import com.worldoffice.model.documenteditor.callback.Action;
import com.worldoffice.model.documenteditor.callback.ForcesaveType;
import com.worldoffice.model.documenteditor.callback.action.Type;
...
public class DefaultCallbackManager implements CallbackManager {
    ...
    public void processForceSave(final Callback callback, final String fileNameParam) {  // file force saving process
        ...
        if (isSubmitForm) {  // if the form is submitted
            ...
            List<com.worldoffice.model.documenteditor.callback.Action> actions = callback.getActions();
            com.worldoffice.model.documenteditor.callback.Action action = actions.get(0);
