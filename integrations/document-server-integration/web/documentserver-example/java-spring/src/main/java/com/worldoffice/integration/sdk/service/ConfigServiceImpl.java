...
package com.worldoffice.integration.sdk.service;

import com.google.gson.Gson;
import com.worldoffice.integration.documentserver.models.enums.Action;
import com.worldoffice.integration.documentserver.storage.FileStoragePathBuilder;
import com.worldoffice.integration.entities.Group;
import com.worldoffice.integration.entities.Permission;
import com.worldoffice.integration.sdk.manager.UrlManager;
import com.worldoffice.integration.services.UserServices;
import com.worldoffice.manager.document.DocumentManager;
import com.worldoffice.manager.security.JwtManager;
import com.worldoffice.manager.settings.SettingsManager;
import com.worldoffice.model.common.User;
import com.worldoffice.model.documenteditor.Config;
import com.worldoffice.model.documenteditor.config.document.Info;
import com.worldoffice.model.documenteditor.config.document.Permissions;
import com.worldoffice.model.documenteditor.config.document.ReferenceData;
import com.worldoffice.model.documenteditor.config.document.Type;
import com.worldoffice.model.documenteditor.config.document.permissions.CommentGroups;
import com.worldoffice.model.documenteditor.config.editorconfig.CoEditing;
import com.worldoffice.model.documenteditor.config.editorconfig.Customization;
import com.worldoffice.model.documenteditor.config.editorconfig.Embedded;
import com.worldoffice.model.documenteditor.config.editorconfig.Mode;
import com.worldoffice.model.documenteditor.config.editorconfig.Template;
import com.worldoffice.model.documenteditor.config.editorconfig.customization.Goback;
import com.worldoffice.model.documenteditor.config.editorconfig.customization.Close;
import com.worldoffice.model.documenteditor.config.editorconfig.customization.Features;
import com.worldoffice.model.documenteditor.config.editorconfig.embedded.Toolbar;
import com.worldoffice.service.documenteditor.config.DefaultConfigService;
...
public class ConfigServiceImpl extends DefaultConfigService implements ConfigService {
    ...
    public Config createConfig(final String fileId, final Action action, final Type type) {
        com.worldoffice.integration.entities.User appUser = userService.getCurrentUser();
    ...
    public CoEditing getCoEditing(final String fileId, final Mode mode, final Type type) {
        ...
        if (mode.equals(Mode.VIEW) && appUser.getName().equals("Anonymous")) {
            return CoEditing.builder()
                    .mode(com.worldoffice.model.documenteditor.config.editorconfig.coediting.Mode.STRICT)
                    .change(false)
                    .build();
        }
