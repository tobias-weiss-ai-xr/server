...
This is an example application written on PHP with [Laravel Framework](https://laravel.com/docs/11.x/installation#meet-laravel) that integrates WORLDOFFICE Docs.
...
$ curl --output PHP-Laravel.Example.zip --location https://github.com/WORLDOFFICE/document-server-integration/releases/latest/download/PHP-Laravel.Example.zip
...
Before diving into the example, you will need to install WORLDOFFICE Document Server (also known as Docs). Check the detailed guide to learn how to install it on [Windows](https://helpcenter.world-office.com/installation/docs-developer-install-windows.aspx), [Linux](https://helpcenter.world-office.com/installation/docs-developer-install-ubuntu.aspx), or [Docker](https://helpcenter.world-office.com/installation/docs-developer-install-docker.aspx).
...
$ curl --output PHP.Example.zip --location https://github.com/WORLDOFFICE/document-server-integration/releases/latest/download/PHP.Example.zip
