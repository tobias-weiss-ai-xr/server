...
use WorldOffice\DocsIntegrationSdk\Manager\Document\DocumentManager as WorldOfficeDocumentManager;

class DocumentManager extends WorldOfficeDocumentManager
{
    private array $file;
