...
namespace App\WorldOffice\Managers;

use Exception;
use WorldOffice\DocsIntegrationSdk\Manager\Settings\SettingsManager as WorldOfficeSettingsManager;

class SettingsManager extends WorldOfficeSettingsManager
{
