...
namespace App\WorldOffice\Services;
...
use WorldOffice\DocsIntegrationSdk\Service\Callback\CallbackService as WorldOfficeCallbackService;

class CallbackService extends WorldOfficeCallbackService
{
    private $data;
