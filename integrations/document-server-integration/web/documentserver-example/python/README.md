...
This example will help you integrate World-Office Docs into your web application written on Python.
...
```sh
$ curl --output Python.Example.zip --location https://github.com/World-Office/document-server-integration/releases/latest/download/Python.Example.zip
