...
This example will help you integrate WORLDOFFICE Docs into your web application written on Python.
...
```sh
$ curl --output Python.Example.zip --location https://github.com/WORLDOFFICE/document-server-integration/releases/latest/download/Python.Example.zip
