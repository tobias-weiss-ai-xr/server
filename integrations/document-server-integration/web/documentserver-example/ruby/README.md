...
This example will help you integrate World-Office Docs into your web application written on Ruby.
...
```sh
$ curl --output Ruby.Example.zip --location https://github.com/World-Office/document-server-integration/releases/latest/download/Ruby.Example.zip
