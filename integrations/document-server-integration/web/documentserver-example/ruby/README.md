...
This example will help you integrate WORLDOFFICE Docs into your web application written on Ruby.
...
```sh
$ curl --output Ruby.Example.zip --location https://github.com/WORLDOFFICE/document-server-integration/releases/latest/download/Ruby.Example.zip
