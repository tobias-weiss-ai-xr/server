OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "Приложението word-office не конфигурирано. Моля, свържете се с администратора",
    ...
    "word-office cannot be reached. Please contact admin" : "Приложението word-office не е достъпно. Моля, свържете се с администратора",
    "Loading, please wait." : "Зареждане. Моля, изчакайте.",
    "File created" : "Файлът е създаден",
    "Open in word-office" : "Отвори в word-office",
    "Convert with word-office" : "Конвертирай с word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Адреса на word-office определя адреса на сървъра с инсталирани услуги за документи. Моля, променете '<documentserver>' адреса на сървъра в долния ред.",
    "word-office address" : "Адрес на word-office",
    "Advanced server settings" : "Допълнителни настройки на сървъра",
    "word-office address for internal requests from the server" : "Адрес на word-office за вътрешни заявки към сървъра",
    "Server address for internal requests from word-office" : "Адрес на сървъра за вътрешни заявки на word-office",
    ...
    "Save" : "Запази",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Смесеното активно съдържание е недопустимо. За word-office е необходимо използването на HTTPS-адрес.",
    ...
    "Connect to demo word-office server" : "Свързване с демо word-office сървър",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30-дневният тестов период приключи, вече не можете да се свържете с демо word-office сървър.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Използвате обществения демо word-office сървър. Моля, не съхранявайте чувствителни частни данни на него.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Използвайте word-office, за да генерирате преглед на документа (ще заеме дисково пространство)",
    ...
    "Provide advanced document permissions using word-office": "Предоставете нови разрешения за документи с помощта на word-office",
    ...
    "word-office server is not available": "word-office сървърът не е достъпен",
    ...
    "word-office Document Server is unavailable": "word-office Сървъра за документи не е достъпен",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Това е имейл съобщение, известяващо, че връзката с word-office сървъра за документи беше прекъсната. Моля, проверете настройките на свързване:",
