OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin": "Aplicació word-office no està configurada. Si us plau, contacti amb l'administrador",
    ...
    "word-office cannot be reached. Please contact admin": "No es pot accedir a l'word-office. Si us plau, contacti amb l'administrador",
    "Loading, please wait.": "Carregant, esperi, si us plau.",
    "File created": "Arxiu creat",
    "Open in word-office": "Obrir en word-office",
    "Convert with word-office": "Convertir amb word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Ubicació de l'word-office especifica la direcció del servidor amb els serveis de documents instal·lats. Si us plau, canviï '<documentserver>' per a la direcció de servidor en la línia inferior.",
    "word-office address": "Direcció d'word-office",
    "Advanced server settings": "Ajustos de servidor avançats",
    "word-office address for internal requests from the server": "Direcció d'word-office per a sol·licituds internes del servidor",
    "Server address for internal requests from word-office": "Direcció de servidor per a sol·licituds internes de l'word-office",
    ...
    "Save": "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required.": "Contingut Mixt Actiu no està permès. Es requereix la direcció HTTPS per a word-office.",
    ...
    "Connect to demo word-office server": "Connectar-se al servidor de word-office de demostració",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server.": "El període de prova de 30 dies ha acabat, ja no pots connectar-te al servidor d'word-office de demostració",
    "You are using public demo word-office server. Please do not store private sensitive data.": "Estàs fent servir el servidor d'word-office de demostració. Si us plau, no emmagatzemis les teves dades confidencials aquí.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Usar word-office per a generar una vista prèvia del document (ocuparà espai en el disc)",
    ...
    "group": "agrupa",
    "Advanced": "Avançat",
    "Provide advanced document permissions using word-office": "Proporcioneu permisos avançats de documents mitjançant word-office",
    ...
    "word-office server is not available": "El servidor word-office no està disponible",
    ...
    "word-office Document Server is unavailable": "El servidor de documents word-office no està disponible",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Aquest és un missatge de correu electrònic per notificar que s'ha perdut la connexió amb el servidor de documents word-office. Comproveu la configuració de connexió:",
