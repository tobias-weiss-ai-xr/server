OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-office-appen er ikke konfigureret. Kontakt venligst administrator",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office kan ikke nås. Kontakt venligst administrator",
    "Loading, please wait." : "Indlæser... vent venligst.",
    "File created" : "Fil oprettet",
    "Open in word-office" : "Åben i word-office",
    "Convert with word-office" : "Konverter med word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-office Lokation angiver adressen på serveren med dokumenttjenesterne installeret. Skift venligst '<dokumentserver>' for serveradressen i linjen nedenfor.",
    "word-office address" : "word-office-adresse",
    "Advanced server settings" : "Avancerede serverindstillinger",
    "word-office address for internal requests from the server" : "word-office-adresse for interne anmodninger fra serveren",
    "Server address for internal requests from word-office" : "Serveradresse for interne anmodninger fra word-office",
    ...
    "Save" : "Gem",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Blandet aktivt indhold er ikke tilladt. HTTPS-adresse for word-office er påkrævet.",
    ...
    "Connect to demo word-office server" : "Opret forbindelse til demo word-office-server",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30-dages testperioden er forbi, du kan ikke længere oprette forbindelse til demo word-office-server.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Du bruger den offentlige demo word-office-server. Gem venligst ikke private følsomme data.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Brug word-office til at generere et dokumenteksempel (...dette vil optage diskplads)",
    ...
    "group": "gruppe",
    "Advanced": "Avanceret",
    "Provide advanced document permissions using word-office": "Giv avancerede dokumenttilladelser ved brug af word-office",
    ...
    "word-office server is not available": "word-office-serveren er ikke tilgængelig",
    ...
    "Open file": "Åbn fil",
    "word-office Document Server is unavailable": "word-office-dokumentserveren er ikke tilgængelig",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Dette er en e-mailbesked, der giver besked om, at forbindelsen til word-office-dokumentserveren er blevet afbrudt. Kontroller venligst forbindelsesindstillingerne:",
