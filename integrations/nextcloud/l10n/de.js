OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-office App ist nicht konfiguriert. Bitte wende Dich an Deinen Administrator",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office ist zurzeit nicht erreichbar.  Bitte wende Dich an Deinen Administrator",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-officestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Ändere bitte '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "Der 30-tägige Testzeitraum ist abgelaufen. Du kannst keine Verbindung mehr zu Demo word-office Server herstellen.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Du verwendest den öffentlichen Demo word-office Server. Bitte benutze ihn nicht zum Speichern von Deinen privaten sensiblen Daten.",
