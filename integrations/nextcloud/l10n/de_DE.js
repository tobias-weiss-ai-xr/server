OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-office App ist nicht konfiguriert. Bitte wenden Sie sich an Ihren Administrator",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office ist zurzeit nicht erreichbar.  Bitte wenden Sie sich an Ihren Administrator",
    "Loading, please wait." : "Laden... Bitte warten.",
    "File created" : "Erstellte Datei",
    "Open in word-office" : "In word-office öffnen",
    "Convert with word-office" : "Mit word-office umwandeln",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-officestandort gibt die Adresse des Servers mit den installierten Dokumentdiensten an. Bitte ändern Sie '<documenterver>' für die Serveradresse in der folgenden Zeile.",
    "word-office address" : "Die Adresse von word-office",
    "Advanced server settings" : "Erweiterte Servereinstellungen",
    "word-office address for internal requests from the server" : "Die Adresse von word-office für interne Anforderungen vom Server",
    "Server address for internal requests from word-office" : "Serveradresse für interne Anforderungen vom word-office",
    ...
    "Save" : "Speichern",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Mixed Active Content ist nicht möglich. HTTPS-Adresse für word-office ist erforderlich.",
    ...
    "Connect to demo word-office server": "Verbindung zu Demo word-office Server herstellen",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server.": "Der 30-tägige Testzeitraum ist abgelaufen. Sie können keine Verbindung mehr zu Demo word-office Server herstellen.",
    "You are using public demo word-office server. Please do not store private sensitive data.": "Sie verwenden den öffentlichen Demo word-office Server. Bitte benutzen Sie ihn nicht zum Speichern von Ihren privaten sensiblen Daten.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "word-office verwenden, um eine Dokumentvorschau zu erstellen (Speicherplatz erforderlich)",
    ...
    "group": "gruppe",
    "Advanced": "Erweitert",
    "Provide advanced document permissions using word-office": "Erweiterte Zugriffsrechte in word-office vergeben",
    ...
    "word-office server is not available": "word-office-Server ist nicht verfügbar",
    ...
    "word-office Document Server is unavailable": "word-office Document Server ist nicht verfügbar",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Dies ist eine E-Mail-Nachricht, die Sie darüber informiert, dass die Verbindung mit dem word-office Document Server unterbrochen wurde. Bitte überprüfen Sie die Verbindungseinstellungen:",
    ...
    "Welcome to word-office!": "Willkommen bei word-office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Mit word-office können Sie Textdokumente, Tabellenkalkulationen, Präsentationen und PDFs innerhalb von Nextcloud gemeinsam bearbeiten.",
