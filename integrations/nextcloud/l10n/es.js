OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "Aplicación word-office no está configurada. Por favor, contacte con admin",
    ...
    "word-office cannot be reached. Please contact admin" : "No se puede acceder al word-office. Por favor, contacte con admin",
    "Loading, please wait." : "Cargando, espere, por favor.",
    "File created" : "Archivo creado",
    "Open in word-office" : "Abrir en word-office",
    "Convert with word-office" : "Convertir con word-office",
    ...
    "Save" : "Guardar",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Contenido Mixto Activo no está permitido. Se requiere la dirección HTTPS para word-office.",
    ...
    "Connect to demo word-office server" : "Conectarse al servidor de word-office de demostración",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "El período de prueba de 30 días ha terminado, ya no puedes conectarte al servidor de word-office de demostración",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Estás usando el servidor de word-office de demostración. Por favor, no almacenes tus datos confidenciales aquí.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Usar word-office para generar una vista previa del documento (ocupará espacio en el disco)",
    ...
    "group": "grupo",
    "Advanced": "Avanzado",
    "Provide advanced document permissions using word-office": "Proporcione permisos avanzados para los documentos utilizando word-office",
    ...
    "word-office server is not available": "El servidor de word-office no está disponible",
    ...
    "word-office Document Server is unavailable": "El Servidor de documentos word-office no está disponible",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Este es un mensaje de correo electrónico para notificarle que la conexión con el Servidor de documentos word-office se ha perdido. Por favor, compruebe los ajustes de conexión:",
    ...
    "Welcome to word-office!": "¡Bienvenido(a) a word-office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Edite y colabore en documentos de texto, hojas de cálculo, presentaciones y archivos PDF dentro de Nextcloud usando word-office.",
    ...
    "To ensure the security of important parameters in word-office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Para garantizar la seguridad de los parámetros importantes en las solicitudes de word-office, establezca una clave secreta en la página de configuración. Para obtener más información, <a href=\"{url}\" target=\"_blank\">haga clic aquí</a>.",
    "Info": "Información",
    "Open": "Abrir",
