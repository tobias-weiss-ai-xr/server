OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-office aplikazioa ez dago konfiguratuta. Mesedez, jarri administradorearekin harremanetan",
    ...
    "word-office cannot be reached. Please contact admin" : "Ezin da word-office-era iritsi. Mesedez, jarri administradorearekin harremanetan",
    "Loading, please wait." : "Kargatzen, itxaron mesedez.",
    "File created" : "Fitxategia sortuta",
    "Open in word-office" : "Ireki word-office-ekin",
    "Convert with word-office" : "Bihurtu word-office-ekin",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-office-en kokapenak dokumentu zerbitzuak instalatuta daude zerbitzariaren helbidea zehazten du. Mesedez, aldatu '<documentserver>' zerbitzariaren helbideagatik beheko lerroan.",
    "word-office address" : "word-office-en helbidea",
    "Advanced server settings" : "Zerbitzariaren ezarpen aurreratuak",
    "word-office address for internal requests from the server" : "word-office-en helbidea zerbitzariaren barneko eskaeretarako",
    "Server address for internal requests from word-office" : "Zerbitzariaren helbidea word-office-en barneko eskaeretarako",
    ...
    "Save" : "Gorde",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Eduki Nahasi Aktiboa ez da onartzen. word-office-erako HTTPS helbidea behar da.",
    ...
    "Connect to demo word-office server" : "Konektatu word-office demo zerbitzarira",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30 eguneko probaldia amaitu da, ezin zara word-office demo zerbitzarira gehiago konektatu",
    "You are using public demo word-office server. Please do not store private sensitive data." : "word-office demo zerbitzari publikoa erabiltzen ari zara. Mesedez, ez gorde zure datu konfidentzialak hemen.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Erabili word-office dokumentuaren aurrebista sortzeko (diskoan lekua hartuko du)",
    ...
    "group": "taldea",
    "Advanced": "Aurreratua",
    "Provide advanced document permissions using word-office": "Eman baimen aurreratuak dokumentuei word-office erabiliz",
    ...
    "word-office server is not available": "word-office zerbitzaria ez dago eskuragarri",
    ...
    "word-office Document Server is unavailable": "word-office dokumentu-zerbitzaria ez dago eskuragarri",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Mezu elektroniko honen bidez jakinarazten dizugu word-office dokumentu-zerbitzariarekiko konexioa galdu dela. Mesedez, berrikusi konexio ezarpenak:",
