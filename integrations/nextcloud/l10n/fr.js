OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "L'application word-office n'est pas configuré. Veuillez contacter votre administrateur",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office est indisponible. Veuillez contacter votre administrateur",
    "Loading, please wait." : "Chargement, veuillez patienter.",
    "File created" : "Fichier créé",
    "Open in word-office" : "Ouvrir dans word-office",
    "Convert with word-office" : "Convertir avec word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "L'emplacement du word-office désigne l'adresse du serveur sur lequel est installé le service de document. Veuillez modifier le '<documentserver>' avec l'adresse du serveur de service de document dans la ligne ci-dessous",
    "word-office address" : "Adresse du word-office",
    "Advanced server settings" : "Paramètres avancés du serveur",
    "word-office address for internal requests from the server" : "Adresse du word-office pour les demandes internes du serveur",
    "Server address for internal requests from word-office" : "Adresse du serveur pour les demandes internes du word-office",
    ...
    "Save" : "Enregistrer",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Le contenu mixte actif n'est pas autorisé. Une adresse HTTPS pour le word-office est requise",
    ...
    "Connect to demo word-office server" : "Se connecter à la version démo de word-office",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "La période d'essai de 30 jours est expirée, vous n'êtes plus en mesure de vous connecter à la version démo de word-office.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Vous utilisez la version démo de word-office, proposée à des fins de tests. Veuillez ne pas stocker vos données confidentielles.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Utilisez word-office pour générer l'aperçu du document (occupe de l'espace disque)",
    ...
    "group": "groupe",
    "Advanced": "Avancé",
    "Provide advanced document permissions using word-office": "Fournir des autorisations avancées pour les documents en utilisant word-office",
    ...
    "word-office server is not available": "Le serveur word-office n'est pas disponible",
    ...
    "word-office Document Server is unavailable": "word-office Document Server n'est pas disponible",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Ceci est un message pour vous informer que la connexion avec word-office Document Server a été interrompue. Veuillez vérifier les paramètres de connexion :",
    ...
    "Welcome to word-office!": "Bienvenue dans word-office !",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Modifiez et collaborez sur des documents texte, des feuilles de calcul, des présentations et des fichiers PDF dans Nextcloud à l'aide de word-office.",
    ...
    "To ensure the security of important parameters in word-office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Pour garantir la sécurité des paramètres importants dans les requêtes word-office, veuillez définir une clé secrète sur la page Paramètres. Pour en savoir plus, <a href=\"{url}\" target=\"_blank\">cliquez ici</a>.",
    "Info": "Information",
    "Open": "Ouvrir",
