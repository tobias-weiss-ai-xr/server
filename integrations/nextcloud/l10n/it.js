OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "L'applicazione word-office non è configurata. Si prega di contattare l'amministratore",
    ...
    "word-office cannot be reached. Please contact admin" : "Non è possibile raggiungere word-office. Si prega di contattare l'amministratore",
    "Loading, please wait." : "Caricamento in corso, attendere prego",
    "File created" : "File creato",
    "Open in word-office" : "Apri in word-office",
    "Convert with word-office" : "Converti con word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-office Location specifica l'indirizzo del server con i servizi documenti installati. Modifica il '<documentserver>' con l'indirizzo del server nella riga sottostante.",
    "word-office address" : "Indirizzo di word-office",
    "Advanced server settings" : "Impostazioni avanzate del server",
    "word-office address for internal requests from the server" : "Indirizzo di word-office per le richieste interne del server",
    "Server address for internal requests from word-office" : "Indirizzo del server per le richieste interne da word-office",
    ...
    "Save" : "Salva",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Il contenuto attivo misto non è consentito. È richiesto l'indirizzo HTTPS per word-office.",
    ...
    "Connect to demo word-office server" : "Collegati alla versione demo di word-office",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "Il periodo di prova di 30 giorni è terminato; non è più possibile connettersi alla versione demo di word-office.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Stai utilizzando la versione demo pubblica di word-office. Non memorizzare dati sensibili privati.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Usare word-office per generare anteprima documenti (occuperà spazio su disco)",
    ...
    "group": "gruppo",
    "Advanced": "Avanzate",
    "Provide advanced document permissions using word-office": "Fornisci autorizzazioni avanzate per i documenti utilizzando word-office",
    ...
    "word-office server is not available": "Il server di word-office non è disponibile",
    ...
    "Welcome to word-office!": "Benvenuto in word-office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Modifica e collabora su documenti di testo, fogli di calcolo, presentazioni e PDF all'interno di Nextcloud usando word-office.",
    ...
    "To ensure the security of important parameters in word-office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Per garantire la sicurezza dei parametri importanti nelle richieste di word-office, imposta una Chiave Segreta nella pagina delle Impostazioni. Per saperne di più, <a href=\"{url}\" target=\"_blank\">clicca qui</a>.",
    "Info": "Info",
    "Open": "Apri",
