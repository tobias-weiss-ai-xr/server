OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-officeアプリが設定されていません。管理者に相談してください",
    ...
    "word-office cannot be reached. Please contact admin" : "word-officeに接続できません。管理者に相談してください",
    "Loading, please wait." : "読み込み中です...。しばらくお待ちください。",
    "File created": "ファイルが作成されました",
    "Open in word-office" : "word-officeで開く",
    "Convert with word-office" : "word-officeで変換",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "Docsアドレスにはドキュメントサービスがインストールされているサーバーのアドレスを指定します。以下の行の'<documentserver>'をサーバーアドレスに変更してください。",
    "word-office address" : "word-office アドレス",
    "Advanced server settings": "サーバー詳細設定",
    "word-office address for internal requests from the server": "サーバーから内部リクエストに利用されるword-office アドレス",
    "Server address for internal requests from word-office": "word-officeから内部リクエストに利用されるサーバーアドレス",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "アクティブコンテンツの混在は許可されていません。word-officeにはHTTPSアドレスが必要です",
    ...
    "Connect to demo word-office server" : "word-officeのデモサーバーに接続する",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30日間のテスト期間が終了したら、word-office デモサーバーには繋がらなくなります。",
    "You are using public demo word-office server. Please do not store private sensitive data." : "パブリック word-office サーバーを使っているので、プライベートな機密データを利用しないようにしてください。",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "word-officeを使用してドキュメントのサムネールを生成する(ディスク容量を消費します)",
    ...
    "group": "グループ",
    "Advanced": "詳細",
    "Provide advanced document permissions using word-office": "word-officeを利用した高度なドキュメント権限の提供",
    ...
    "word-office server is not available": "word-officeサーバーは只今利用できません",
    ...
    "Open file": "ファイルを開く",
    "word-office Document Server is unavailable": "word-officeドキュメントサーバーは只今ご利用いただけません",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "これは、word-officeドキュメントサーバーとの接続が失われたことを通知するメッセージです。接続設定をご確認ください：",
    ...
    "Welcome to word-office!": "word-officeへようこそ！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "word-officeを使用して、Nextcloud内でテキストドキュメント、スプレッドシート、プレゼンテーション、PDFを編集・共同作業できます。",
    "Learn more": "詳細を見る",
    ...
    "To ensure the security of important parameters in word-office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "word-officeリクエストの重要なパラメータのセキュリティを確保するため、設定ページでシークレットキーを設定してください。詳細については、<a href=\"{url}\" target=\"_blank\">こちらをクリック</a>してください。",
    "Info": "情報",
    "Open": "開く",
