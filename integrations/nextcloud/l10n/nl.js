OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin": "word-office app is niet geconfigureerd. Neem contact op met de admin",
    ...
    "word-office cannot be reached. Please contact admin": "word-office kan niet worden bereikt. Neem contact op met de admin",
    "Loading, please wait.": "Laden, wacht alstublieft.",
    "File created": "Bestand Aangemaakt",
    "Open in word-office": "Openen in word-office",
    "Convert with word-office": "Converteer met word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line.": "word-office Location geeft het adres op van de server waarop de documentdiensten geïnstalleerd zijn. Verander de '<documenterver>' voor het serveradres in de onderstaande regel.",
    "word-office address": "word-office adres",
    "Advanced server settings": "Geavanceerde serverinstellingen",
    "word-office address for internal requests from the server": "Adres van de word-office voor interne verzoeken van de server",
    "Server address for internal requests from word-office": "Serveradres voor interne verzoeken van de word-office",
    ...
    "Save": "Opslaan",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required.": "Gemende Actieve Inhoud is niet toegestaan. HTTPS-adres voor word-office is vereist.",
    ...
    "Connect to demo word-office server": "Verbinden met de demo word-office server",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server.": "De 30-dagen proefperiode is voorbij, u kunt niet langer verbinding maken met demo word-office server.",
    "You are using public demo word-office server. Please do not store private sensitive data.": "U gebruikt de openbare demo word-office server. Sla geen vertrouwelijke gegevens op.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Gebruik word-office om een voorbeeld van een document te genereren (dit neemt schijfruimte in beslag)",
    ...
    "Provide advanced document permissions using word-office": "Geavanceerde documentrechten geven met word-office",
    ...
    "word-office server is not available": "word-office server is niet beschikbaar",
    ...
    "word-office Document Server is unavailable": "word-office Document Server is niet beschikbaar",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Dit is een e-mailbericht om te melden dat de verbinding met de word-office Document Server verbroken is. Controleer de verbindingsinstellingen:",
    ...
    "Welcome to word-office!": "Welkom bij word-office!",
