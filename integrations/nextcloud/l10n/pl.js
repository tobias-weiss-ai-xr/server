OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "OAplikacja word-office nie jest skonfigurowana. Skontaktuj się z administratorem",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office jest nieosiągalny. Skontaktuj się z administratorem",
    "Loading, please wait." : "Ładowanie, proszę czekać.",
    "File created" : "Plik utworzony",
    "Open in word-office" : "Otwórz w word-office",
    "Convert with word-office" : "Konwertuj",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Lokacja word-office to adres serwera na którym Usługi Dokumentów są zainstalowe. Proszę zmienić '<documentserver>' na adres poniżej.",
    "word-office address" : "Adres word-office",
    "Advanced server settings" : "Zaawansowane ustawienia serwera",
    "word-office address for internal requests from the server" : "Adres word-office dla zapytań wewnętrznych",
    "Server address for internal requests from word-office" : "Adres serwera dla zapytań wewnętrznych z word-office",
    ...
    "Save" : "Zapisz",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Aktywna Zawartość Mieszana nie jest dozwolona. Adres HTTPS jest wymagany dla word-office.",
    ...
    "Connect to demo word-office server" : "Połącz się z serwerem demo word-office",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "Upłyneło 30 dni, nie możesz się już łączyć z serwerem demo.",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Używasz publicznego serwera demo. Nie przechowuj tu prywatnych danych.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Skorzystaj z word-office, aby wygenerować podgląd dokumentu (zajmie to miejsce na dysku)",
    ...
    "Provide advanced document permissions using word-office": "Udziel zaawansowanych uprawnień do edycji dokumentów w word-office",
    ...
    "word-office server is not available": "Serwer word-office jest niedostępny",
    ...
    "word-office Document Server is unavailable": "Serwer dokumentów word-office jest niedostępny",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "To jest wiadomość e-mail informująca, że połączenie z serwerem dokumentów word-office zostało utracone. Proszę sprawdzić ustawienia połączenia:",
    ...
    "Welcome to word-office!": "Witaj w word-office!",
