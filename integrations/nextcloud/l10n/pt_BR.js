OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "Aplicação word-office não está configurada. Favor contatar o administrador",
    ...
    "word-office cannot be reached. Please contact admin" : "Não foi possível conectar ao word-office. Favor contatar o administrador.",
    "Loading, please wait." : "Carregando, por favor aguarde.",
    "File created" : "Arquivo criado",
    "Open in word-office" : "Abrir no word-office",
    "Convert with word-office" : "Converta com word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "O Endereço do word-office especifica o servidor onde o serviço de documentos está instalado.\nPor favor mude '<documentserver>' para o endereço do servidor na linha abaixo.",
    "word-office address" : "Endereço do word-office",
    "Advanced server settings" : "Configurações avançadas do servidor",
    "word-office address for internal requests from the server" : "Endereço do word-office para pedidos internos do servidor",
    "Server address for internal requests from word-office" : "Endereço do servidor para pedidos internos do word-office",
    ...
    "Save" : "Salvar",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Conteúdo Misto não é permitido. É necessário um endereço HTTPS para o word-office.",
    ...
    "Connect to demo word-office server" : "Conectar ao Servidor de demonstração do word-office",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "O período de teste de 30 dias acabou, você não pode mais se conectar ao Servidor de demonstração do word-office",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Você está usando o Servidor de demonstração pública. Não armazene dados confidenciais.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Usar word-office para gerar uma visualização do documento (ocupará espaço em disco)",
    ...
    "group": "grupo",
    "Advanced": "Avançado",
    "Provide advanced document permissions using word-office": "Forneça permissões avançadas de documentos usando o word-office",
    ...
    "word-office server is not available": "O servidor word-office não está disponível",
    ...
    "word-office Document Server is unavailable": "O servidor de documentos word-office não está disponível",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "Esta é uma mensagem de e-mail para notificar que a conexão com o servidor de documentos word-office foi perdida. Verifique as configurações de conexão:",
    ...
    "Welcome to word-office!": "Bem-vindo ao word-office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Edite e colabore em documentos de texto, planilhas, apresentações e PDFs no Nextcloud usando o word-office.",
