OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "Приложение word-office не сконфигурировано. Пожалуйста, свяжитесь с администратором.",
    ...
    "word-office cannot be reached. Please contact admin" : "Приложение word-office недоступно. Пожалуйста, свяжитесь с администратором.",
    "Loading, please wait." : "Загрузка. Пожалуйста, подождите.",
    "File created" : "Файл создан",
    "Open in word-office" : "Открыть в word-office",
    "Convert with word-office" : "Конвертировать в word-office",
    ...
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "Расположение word-office определяет адрес сервера с установлеными службами документов. Пожалуйста, замените '<documentserver>' в поле ниже на адрес сервера.",
    "word-office address" : "Адрес word-office",
    "Advanced server settings" : "Дополнительные настройки сервера",
    "word-office address for internal requests from the server" : "Адрес word-office для внутренних запросов сервера",
    "Server address for internal requests from word-office" : "Адрес сервера для внутренних запросов word-office",
    ...
    "Save" : "Сохранить",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "Смешанное активное содержимое запрещено. Для word-office необходимо использовать HTTPS-адрес.",
    ...
    "Connect to demo word-office server" : "Подключиться к демонстрационному серверу word-office",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30-дневный тестовый период закончен, вы больше не можете подключаться к демонстрационному серверу word-office",
    "You are using public demo word-office server. Please do not store private sensitive data." : "Вы используете публичный демонстрационный сервер word-office. Пожалуйста, не храните конфиденциальные данные.",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "Использовать word-office для создания превью документа (займет место на диске)",
    ...
    "Provide advanced document permissions using word-office": "Предоставление расширенных прав доступа к документам с помощью word-office",
    ...
    "word-office server is not available": "Сервер word-office недоступен",
    ...
    "word-office Document Server is unavailable" : "Сервер документов word-office недоступен",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:" : "Это почтовое сообщение, уведомляющее о том, что соединение с сервером документов word-office потеряно. Пожалуйста, проверьте настройки подключения:",
    ...
    "Welcome to word-office!": "Добро пожаловать в word-office!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "Редактируйте текстовые документы, электронные таблицы, презентации и PDF-файлы, а также работайте над ними вместе с другими пользователями в Nextcloud, используя word-office.",
