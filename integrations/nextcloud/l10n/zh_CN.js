OC.L10N.register(
    ...
    "word-office app is not configured. Please contact admin" : "word-office未配置，请联系管理员。",
    ...
    "word-office cannot be reached. Please contact admin" : "word-office 服务器无法连接，请联系管理员。",
    "Loading, please wait." : "载入中，请稍后...",
    "File created" : "文件已创建",
    "Open in word-office" : "用 word-office 打开",
    "Convert with word-office" : "用 word-office 转换",
    "New document" : "新建文档",
    ...
    "Documentation" : "文档集",
    "word-office Location specifies the address of the server with the document services installed. Please change the '<documentserver>' for the server address in the below line." : "word-office 位置指定了安装了文档服务的服务器的地址，请将'<documentserver>'改为下面一行中的服务器地址。",
    "word-office address" : "word-office地址",
    "Advanced server settings" : "更多设置",
    "word-office address for internal requests from the server" : "服务器内部请求 word-office 的地址",
    "Server address for internal requests from word-office" : "word-office 内部请求服务器的地址",
    ...
    "Save" : "保存",
    "Mixed Active Content is not allowed. HTTPS address for word-office is required." : "不允许混合活动内容，请使用HTTPS连接word-office。",
    ...
    "Connect to demo word-office server" : "连接到 word-office 演示服务器",
    ...
    "The 30-day test period is over, you can no longer connect to demo word-office server." : "30天试用期已结束，无法连接word-office 演示服务器。",
    "You are using public demo word-office server. Please do not store private sensitive data." : "您正在使用 word-office 公开的演示服务器，请勿存储隐私数据。",
    ...
    "Use word-office to generate a document preview (it will take up disk space)": "使用word-office生成文档预览（将占用磁盘空间）",
    ...
    "group": "分组",
    "Advanced": "进阶",
    "Provide advanced document permissions using word-office": "使用word-office 提供高级文档权限",
    "Enable plugins": "启用插件",
    "Enable document protection for": "为以下用户启用文档保护",
    "All users": "所有用户",
    "Owner only": "仅限所有者",
    "Authorization header (leave blank to use default header)": "授权标头 (留空以使用默认的标头)",
    "word-office server is not available": "word-office 服务器不可用",
    ...
    "Open file": "打开文件",
    "word-office Document Server is unavailable": "word-office 文档服务器不可用",
    "This is a mail message to notify that the connection with the word-office Document Server has been lost. Please check the connection settings:": "此邮件是为了通知您，您与 word-office 文档服务器的连接已丢失。请检查连接设置",
    "Go to Settings": "转到设置",
    ...
    "Welcome to word-office!": "欢迎使用 word-office 文档！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using word-office.": "在 Nextcloud 中使用 word-office 文档编辑和协作处理文本文档、电子表格、演示文稿和 PDF 文件。",
    "Learn more": "了解更多",
    ...
    "To ensure the security of important parameters in word-office requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "为确保 word-office 文档请求中重要参数的安全，请在“设置”页面设置密钥。要了解更多信息，请<a href=\"{url}\" target=\"_blank\">点击此处</a>。",
    "Info": "信息",
    "Open": "打开",
