...
export const SUPPORTED_LOCALES = [
  "ar", "ca", "cs", "de", "el", "en", "es", "fr", "he", "hu", "hy", "id", "it",
  "ja", "ko", "nl", "pl", "pt", "pt-pt", "ro", "ru", "si", "sq", "sr", "sr-cyrl",
  "sv", "tr", "uk", "ur", "vi", "zh", "zh-tw",
] as const
...
export function getLocaleLabel(locale: string): string {
  const labels: Record<string, string> = {
    ar: "العربية", ca: "Català", cs: "Čeština", de: "Deutsch", el: "Ελληνικά",
    en: "English", es: "Español", fr: "Français", he: "עברית", hu: "Magyar",
    hy: "Հայերեն", id: "Bahasa Indonesia", it: "Italiano", ja: "日本語",
    ko: "한국어", nl: "Nederlands", pl: "Polski", pt: "Português (Brasil)",
    "pt-pt": "Português (Portugal)", ro: "Română", ru: "Русский", si: "සිංහල",
    sq: "Shqip", sr: "Српски", "sr-cyrl": "Српски (ћирилица)", sv: "Svenska",
    tr: "Türkçe", uk: "Українська", ur: "اردو", vi: "Tiếng Việt", zh: "中文 (简体)",
    "zh-tw": "中文 (繁體)",
  }
