...
!((t, e) => {
  ...
  function n(t, e) {
    return Array.prototype.filter.call(t.children, (t) => r(t, e))
  }
  function o(t, e) {
  ...
  ;(X.prototype.bind = function (t, e) {
    ...
    (X.prototype.unbind = function (t, e) {
      this.handlers[t] = this.handlers[t].filter(
        (r) => !(!e || r === e) || (this.element.removeEventListener(t, r, !1), !1),
      )
    }),
    ...
    (w.isEmpty.get = function () {
      return Object.keys(this.handlers).every((e) => 0 === this.handlers[e].length)
    }),
  ...
  var W = (t, e, i, r, l) => {
    ...
    R = (t) => {
      ...
      ;(t.containerWidth = e.clientWidth),
        ...
        e.contains(t.scrollbarYRail) ||
          (n(e, m.element.rail("y")).forEach((t) => l(t)), e.appendChild(t.scrollbarYRail)),
    ...
    T = {
      ...
      keyboard: (t) => {
        ...
        var i = t.element,
          l = () => r(i, ":hover"),
          n = () => r(t.scrollbarX, ":focus") || r(t.scrollbarY, ":focus")
        t.event.bind(t.ownerDocument, "keydown", (r) => {
          if (
            ...
            if (o) {
              ...
              else while (o.shadowRoot) o = o.shadowRoot.activeElement
              if (d(o)) return
            }
            var s = 0,
              a = 0
    ...
    H = function (r, l) {
      ...
      for (var o in l) this.settings[o] = l[o]
      ;(this.containerWidth = null),
        (this.containerHeight = null),
        (this.contentWidth = null),
        (this.contentHeight = null)
      var s = () => r.classList.add(m.state.focus),
        a = () => r.classList.remove(m.state.focus)
      ...
      ;(this.scrollbarXBottom = Number.parseInt(c.bottom, 10)),
      ...
      ;(this.scrollbarYRight = Number.parseInt(h.right, 10)),
        ...
        (this.isAlive = !0),
        this.settings.handlers.forEach((t) => T[t](this)),
...
!((e) => {
  function n(n) {
    ...
    var e = "(?:" + Object.keys(n).join("|") + ")",
      u = RegExp(e),
      c = RegExp(e, "g")
    return (e) => ((e = null == e ? "" : "" + e), u.test(e) ? e.replace(c, t) : e)
  }
  ;(escape = n({
    "&": "&amp;",
    "<": "&lt;",
      ...
      return (
        (s.prototype.bind = function (e) {
          c.apply(this, arguments),
            e.on("open", () => {
              this.$selection.hide(), this.$searchContainer.show()
            }),
            e.on("close", () => {
              this.$searchContainer.hide(), this.$selection.show()
            })
        }),
        s
      )
