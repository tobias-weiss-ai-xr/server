...
function EmailConfig() {
  ...
  const { validateField, getFieldError, hasValidationErrors, clearFieldError } =
    useFieldValidation()
  ...
  const handleFieldChange = (field, value) => {
    ...
    if (CONFIG_PATHS[field]) {
      ...
      if (field === "smtpPort" && value !== "") {
        validationValue = Number.parseInt(value)
        if (!Number.isNaN(validationValue)) {
  ...
  const handleSave = async () => {
    ...
    Object.keys(CONFIG_PATHS).forEach((key) => {
      ...
      if (key === "smtpPort") {
        value = value ? Number.parseInt(value) : 587
      }
        ...
        return (
          <>
            <Section
              ...
              description="Configure email notifications when the license is about to expire"
            >
              <div className={styles.formRow}>
                <Checkbox
                  label="Enable"
            ...
            <Section
              title="License Expiration Error"
              description="Configure email notifications when the license has expired"
            >
              <div className={styles.formRow}>
                <Checkbox
                  label="Enable"
            ...
            <Section
              title="License Limit Edit"
              description="Configure email notifications when the edit limit is reached"
            >
              <div className={styles.formRow}>
                <Checkbox
                  label="Enable"
            ...
            <Section
              title="License Limit Live Viewer"
              description="Configure email notifications when the live viewer limit is reached"
            >
              <div className={styles.formRow}>
                <Checkbox
                  label="Enable"
  ...
  return (
    <div className={`${styles.emailConfig} ${styles.pageWithFixedSave}`}>
      ...
      <PageDescription>
        Configure SMTP server settings, security options, default email addresses, and notification
        rules
      </PageDescription>
