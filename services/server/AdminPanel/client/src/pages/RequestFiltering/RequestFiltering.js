...
function RequestFiltering() {
  ...
  return (
    <div className={`${styles.requestFiltering} ${styles.pageWithFixedSave}`}>
      ...
      <PageDescription>
        Configure request filtering settings to control which IP addresses are allowed to make
        requests to the server.
      </PageDescription>

      <Section
        title="IP Address Filtering"
        description="Control access based on IP address types to enhance security."
      >
