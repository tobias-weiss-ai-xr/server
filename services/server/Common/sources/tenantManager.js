...
async function readLicenseTenant(ctx, licenseFile, baseVerifiedLicense) {
  ...
  try {
    ...
    if (Object.hasOwn(oLicense, "branding")) {
      res.branding =
        true === oLicense.branding || "true" === oLicense.branding || "True" === oLicense.branding // Someone who likes to put json string instead of bool
    }
