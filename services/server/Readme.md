...
The backend server software layer which is a part of [World-Office Document Server](https://codeberg.org/World-Office/DocumentServer) and is the base for all other components.
