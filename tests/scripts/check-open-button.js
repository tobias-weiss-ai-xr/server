...
(async () => {
  ...
  await page.evaluate(async ({ token }) => {
    ...
    const doc = '<?xml version="1.0" encoding="UTF-8"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>Open with World-Office!</w:t></w:r></w:p></w:body></w:document>';
  ...
  if (await fileItem.isVisible().catch(() => false)) {
    ...
    await page.screenshot({ path: 'C:/Users/Tobias/git/World-Office/test-results/context-menu.png' });
