...
(async () => {
  ...
  await page.evaluate(async ({ token }) => {
    ...
    const doc = '<?xml version="1.0" encoding="UTF-8"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>E2E Test from World-Office</w:t></w:r></w:p><w:p><w:r><w:t>This document was created by the OpenCloud WOPI E2E test.</w:t></w:r></w:p></w:body></w:document>';
