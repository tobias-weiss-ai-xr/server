...
CONTAINER="eo-docs"
DOCROOT="/var/www/world-office/documentserver"
...
docker exec "$CONTAINER" sh -c 'echo "<svg xmlns=\"http://www.w3.org/2000/svg\"></svg>" > /var/www/world-office/documentserver/web-apps/apps/common/main/resources/img/doc-formats/formats@2.5x.svg'
