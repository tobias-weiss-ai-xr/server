...
(async () => {
  ...
  }, { url: `https://localhost:9200/app/open?file_id=${encodeURIComponent(freshFileId)}&app_name=WorldOffice`, token });
  ...
  try {
    ...
    console.log('Check: docker exec eo-docs tail -20 /var/log/world-office/documentserver/docservice/out.log');
  } catch(e) {
