...
;(async () => {
  ...
  await page.evaluate(
    async ({ token }) => {
      ...
      const doc =
        '<?xml version="1.0" encoding="UTF-8"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>Hello from World Office WOPI!</w:t></w:r></w:p><w:p><w:r><w:t>This proves the WOPI integration works end-to-end.</w:t></w:r></w:p></w:body></w:document>'
      const docRels =
      ...
      const r = await fetch("/dav/files/admin/wopi-test.docx", {
        method: "PUT",
        headers: { Authorization: `Bearer ${token}` },
        body: blob,
      })
  ...
  await editorPage.screenshot({
    path: "C:/Users/Tobias/git/World-Office/test-results/wopi-editor-final.png",
    fullPage: true,
  })
