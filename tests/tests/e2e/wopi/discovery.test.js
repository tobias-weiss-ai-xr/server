...
describe("WOPI Discovery", () => {
  ...
  describe("File Extension Support", () => {
    ...
    test("supports ODF formats (odt, ods, odp)", () => {
      ...
      const hasOdt = appNames.some((name) => name === "application/vnd.oasis.opendocument.text")
      const hasOds = appNames.some(
        (name) => name === "application/vnd.oasis.opendocument.spreadsheet",
      )
      const hasOdp = appNames.some(
        (name) => name === "application/vnd.oasis.opendocument.presentation",
      )
