...
describe("WOPI Lock/Unlock Operations", () => {
  ...
  describe("Lock Operation", () => {
    test(
      "Lock operation with X-WOPI-Lock header returns 200 OK and lock returned",
      async () => {
    ...
    test(
      "Lock operation without X-WOPI-Lock header returns 400 Bad Request",
      async () => {
    ...
    test(
      "Lock operation with empty X-WOPI-Lock returns 400 Bad Request",
      async () => {
  ...
  describe("Unlock Operation", () => {
    test(
      "Unlock operation with correct X-WOPI-Lock returns 200 OK",
      async () => {
    ...
    test(
      "Unlock with wrong X-WOPI-Lock returns 409 Conflict",
      async () => {
    ...
    test(
      "Unlock on unlocked file returns 409 Conflict",
      async () => {
  ...
  describe("RefreshLock Operation", () => {
    test(
      "RefreshLock operation extends lock",
      async () => {
    ...
    test(
      "RefreshLock with wrong lock token returns 409 Conflict",
      async () => {
    ...
    test(
      "RefreshLock on unlocked file returns 409 Conflict",
      async () => {
  ...
  describe("GetLock Operation", () => {
    test(
      "GetLock operation returns current lock status",
      async () => {
    ...
    test(
      "GetLock on unlocked file returns empty lock",
      async () => {
  ...
  describe("Concurrent Lock Prevention", () => {
    test(
      "Lock prevents concurrent edits (second lock attempt returns 409 Conflict)",
      async () => {
    ...
    test(
      "Lock with X-WOPI-OldLock allows lock transfer",
      async () => {
    ...
    test(
      "Lock with wrong X-WOPI-OldLock returns 409 Conflict",
      async () => {
  ...
  describe("Lock Response Headers", () => {
    test(
      "Lock response includes X-WOPI-Lock header",
      async () => {
    ...
    test(
      "Lock response includes item version info",
      async () => {
